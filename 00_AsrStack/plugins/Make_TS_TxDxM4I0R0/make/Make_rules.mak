...
# $(warning  CC_FILES_TO_BUILD is $(CC_FILES_TO_BUILD))
# $(warning  PROJECT_ROOT is $(PROJECT_ROOT))
# $(warning  OS_TOOLCHAIN is $(OS_TOOLCHAIN))
# $(warning  app is $(app))
# $(warning  AutosarOS_CORE_PATH is $(AutosarOS_CORE_PATH))
# $(warning  $(AutosarOS_CORE_PATH)\bin\cygtools\perl $(OS_GENLD) -o $@ $(OS_GENLD_OPT) $(OS_APP_SPECS) -numcores $(OS_N_CORES_MAX) -corecsas $(OS_TRICORE_NCSA_LIST))
