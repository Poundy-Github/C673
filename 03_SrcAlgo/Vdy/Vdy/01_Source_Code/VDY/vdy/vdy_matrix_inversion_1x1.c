...
/*
 * Output and update for atomic system: '<S12>/Matrix_Inversion_1x1'
 * Block description for: '<S12>/Matrix_Inversion_1x1'
 *   Compute an Inverse Matrix for a 1x1 Matrix
 */
void vdy_matrix_inversion_1x1(real32_T rtu_HPHt_R, rtB_vdy_matrix_inversion_1x1 *
  localB)
{
  /* Embedded MATLAB: '<S12>/Matrix_Inversion_1x1' */
  /* Embedded MATLAB Function 'Matrix_Inversion_1x1': '<S19>:1' */
  /* Inversion of 1x1 matrix */
  /* if value of HPHt_R value is too low, set det_flag */
  if (rtu_HPHt_R < 1.0E-16F) {
    /* '<S19>:1:5' */
    /* '<S19>:1:6' */
    localB->HPHt_R_inv = 1.0E-16F;

    /* '<S19>:1:7' */
    localB->det_flag = TRUE;
  } else {
    /* '<S19>:1:9' */
    localB->HPHt_R_inv = 1.0F / rtu_HPHt_R;
