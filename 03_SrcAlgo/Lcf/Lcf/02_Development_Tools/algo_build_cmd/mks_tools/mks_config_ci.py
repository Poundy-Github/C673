...
:date:          $Date: 2021/12/13 17:52:35CET $
"""
...
CHANGE LOG:
-----------
$Log: mks_config_ci.py  $
Revision 1.1 2021/12/13 17:52:35CET Wang, David (Wangd3) 
Initial revision
...
Revision 1.16 2017/10/24 12:39:25CEST Arndt, Bosse (uidq5253) 
2017/1.047
Revision 1.12 2016/07/01 11:59:22CEST Azam, Saad (uidg4889) 
Rolled back changes from 1.11 (not needed)
Revision 1.11 2016/06/29 11:14:47CEST Azam, Saad (uidg4889) 
fixed checkin failure due to mks being treated as Info, it is now treated as Error
Revision 1.10 2016/04/18 16:32:50CEST Azam, Saad (uidg4889) 
Updated LockCheckinUpdate' function for better checkin condition handeling
Revision 1.9 2016/01/25 14:49:46CET Sinnwell-EXT, Wolfgang (uidj6607) 
fixed missed Log "Error" on CheckIn errors
Revision 1.8 2016/01/15 18:06:57CET Sinnwell-EXT, Wolfgang (uidj6607) 
added user/password parameter handling to run with different user account under in Jenkins
Revision 1.7 2016/01/15 14:50:37CET Azam, Saad (uidg4889) 
Tabs converted to spaces
Revision 1.6 2015/12/21 12:46:23CET Sinnwell-EXT, Wolfgang (uidj6607) 
added comment & print rev.
Revision 1.5 2015/12/18 12:04:08CET Azam, Saad (uidg4889) 
Added --checklib option to be used for algo integration when a clean build is desired, this flag will raise an error in case a lib/dll is not modified despite a clean build meaning either an undetected compilation failure or compilation initiation failure for a certain lib
Revision 1.4 2015/10/28 10:33:14CET Azam, Saad (uidg4889) 
Added Host and Port option to LockCheckinUpdate
- Added comments -  uidg4889 [Oct 28, 2015 10:33:15 AM CET]
Change Package : 279146:2 http://mks-psad:7002/im/viewissue?selection=279146
Revision 1.3 2015/10/06 18:04:33CEST Azam, Saad (uidg4889) 
- Fixed wrongly inserted brackets
--- Added comments ---  uidg4889 [Oct 6, 2015 6:04:34 PM CEST]
Change Package : 382631:1 http://mks-psad:7002/im/viewissue?selection=382631
Revision 1.2 2015/10/01 17:46:23CEST Azam, Saad (uidg4889) 
Fix#1: Mks displays a modified flag if no working file is updated with a working file but in real added working = member revision in mks, so no modification should be detected
Fix#2: Script crashes when there is no working revision
--- Added comments ---  uidg4889 [Oct 1, 2015 5:46:24 PM CEST]
Change Package : 380502:1 http://mks-psad:7002/im/viewissue?selection=380502
Revision 1.1 2015/08/25 12:35:15CEST Sinnwell-EXT, Wolfgang (uidj6607) 
Initial revision
