...
package/%.xdc.inc package/%_dsp.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package dsp" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefineddsppackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js dsp $@
...
.PHONY: release,dsp
dsp.zip: package/package.bld.xml
dsp.zip: package/build.cfg
dsp.zip: package/package.xdc.inc
dsp.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/dsp.zip.dep
endif
package/rel/dsp/dsp/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

dsp.zip: package/rel/dsp.xdc.inc package/rel/dsp/dsp/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/dsp.xdc.inc,package/rel/dsp.zip.dep)


release release,dsp: all dsp.zip
clean:: .clean
	-$(RM) dsp.zip
	-$(RM) package/rel/dsp.xdc.inc
	-$(RM) package/rel/dsp.zip.dep
