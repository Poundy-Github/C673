/*! \file **********************************************************************
  ...
  VERSION:                   $Revision: 1.11.1.2 $

  ---*/ /*---
  CHANGES:                   $Log: cml_complex.h  $
  CHANGES:                   Revision 1.11.1.2 2019/06/21 15:15:04CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   QAF Level3 fixes for MFC431TA19
  CHANGES:                   Revision 1.11.1.1 2019/05/27 10:57:54CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   MFC431TA19: QAF L4 fixes added
  CHANGES:                   Revision 1.11 2018/02/27 06:51:08CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Removed the spaces after \ ; The change was lost while updating to the legacy release.
  CHANGES:                   Revision 1.10 2018/02/26 08:49:11CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Updated the source code with respect to AL_CML_01.09.18_INT-1
  CHANGES:                   Revision 1.9 2017/12/20 06:43:13CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Correction for the compilation warning
  CHANGES:                   Revision 1.8 2017/11/14 18:41:43CET Arulkumar-EXT, Nandu (uidr5428) 
...
/*****************************************************************************
  INCLUDE PROTECTION
*****************************************************************************/
#ifndef CML_COMPLEX_INCLUDED
#define CML_COMPLEX_INCLUDED
...
#endif  /* #ifndef CML_COMPLEX_INCLUDED */
