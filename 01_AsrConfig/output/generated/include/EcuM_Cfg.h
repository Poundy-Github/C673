...
#endif
#define ECUM_CFG_SIGNATURE 2576289525U /* Compile time verification value */

#if (defined ECUM_PUBLIC_INFO_SIGNATURE)
#error ECUM_PUBLIC_INFO_SIGNATURE already defined
#endif
#define ECUM_PUBLIC_INFO_SIGNATURE 1985246510U /* PublicInfoSignature */
...
#define ECUM_MULTICORE_ENABLED TRUE
...
#define ECUM_EB_DEFAULT_ASR_SERVICE_API                    ECUM_EB_SERVICE_API_ASR40
...
#define ECUM_COMM_CHANNELS_NUMBER 0U
...
#if (defined EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_STANDBY_RESET)
#error EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_STANDBY_RESET already defined
#endif
/** \brief Identifier for wakeup source ECUM_WKSOURCE_STANDBY_RESET */
#define EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_STANDBY_RESET   5U

#if (defined ECUM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined EcuM_ECUM_WKSOURCE_STANDBY_RESET)
#error EcuM_ECUM_WKSOURCE_STANDBY_RESET already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define EcuM_ECUM_WKSOURCE_STANDBY_RESET   32U
#endif /* ECUM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_PUBLIC_CAN)
#error EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_PUBLIC_CAN already defined
#endif
/** \brief Identifier for wakeup source ECUM_WKSOURCE_PUBLIC_CAN */
#define EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_PUBLIC_CAN   6U

#if (defined ECUM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined EcuM_ECUM_WKSOURCE_PUBLIC_CAN)
#error EcuM_ECUM_WKSOURCE_PUBLIC_CAN already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define EcuM_ECUM_WKSOURCE_PUBLIC_CAN   64U
#endif /* ECUM_PROVIDE_LEGACY_SYMBOLIC_NAMES */
...
#define ECUM_WKSMASKALL (EcuM_WakeupSourceType)(\
   ...
   ((EcuM_WakeupSourceType)1U << EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_STANDBY_RESET) | \
   ((EcuM_WakeupSourceType)1U << EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_PUBLIC_CAN) | \
   0U)
...
(1U << EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_EXTERNAL_WDG) | \
(1U << EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_INTERNAL_RESET) | \
(1U << EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_INTERNAL_WDG) | \
(1U << EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_POWER) | \
(1U << EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_RESET) | \
(1U << EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_PUBLIC_CAN) | \
0U)
