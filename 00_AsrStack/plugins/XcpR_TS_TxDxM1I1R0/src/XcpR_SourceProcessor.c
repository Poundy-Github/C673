 ...
 *
 * Reason:
 * In the context of "for(Iterator = 0U; Iterator < XCPR_SRC_PDU_FLAG_SIZE; Iterator++)"
 * when "XCPR_SRC_PDU_FLAG_SIZE = 1" the message condition is always true is expected;
 * Expression "Iterator < XCPR_SRC_PDU_FLAG_SIZE" is always evaluated as true
 * if "XCPR_SRC_PDU_FLAG_SIZE = 1".
 */
