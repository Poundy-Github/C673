 ...
 *
 * $Id: Os_syscalls.h 30075 2019-04-01 04:09:40Z sash270423 $
*/
...
#define OS_SC_ControlIdle				OS_SC(44)
#define OS_SC_TaskReturn				OS_SC(45)
#define OS_SC_ReturnFromCall			OS_SC(46)
#define OS_SC_SimTimerAdvance			OS_SC(47)
#define OS_SC_TryToGetSpinlock			OS_SC(48)
#define OS_SC_ReleaseSpinlock			OS_SC(49)
#define OS_SC_AllowAccess				OS_SC(50)
#define OS_SC_GetApplicationState		OS_SC(51)
#define OS_SC_ShutdownAllCores			OS_SC(52)
#define OS_SC_IocWrite					OS_SC(53)
#define OS_SC_IocSend					OS_SC(54)
#define OS_SC_IocEmptyQueue				OS_SC(55)
#define OS_SC_IocAddonExt				OS_SC(56)
#define OS_SC_ActivateTaskAsyn			OS_SC(57)
#define OS_SC_SetEventAsyn				OS_SC(58)
#define OS_SC_ClearPendingInterrupt		OS_SC(59)
#define OS_SC_GetCurrentApplicationId	OS_SC(60)
/* Comment: System calls 61, 62, and 63 are reserved for
 * CPU families. Define the prototypes in OS_types_<cpufamily>.h and
 * map them to OS_K_CPUFAMILY<1-3>.
*/
#define OS_SC_CPUFAMILY_1				OS_SC(61)
#define OS_SC_CPUFAMILY_2				OS_SC(62)
#define OS_SC_CPUFAMILY_3				OS_SC(63)
