...
/* patch version check */
#if (FEE_SW_PATCH_VERSION < 14U)
#error FEE_SW_PATCH_VERSION wrong (< 14U)
#endif
...
STATIC CONST(Fee_StateDescType, FEE_CONST) Fee_States[FEE_NUM_STATES] =
{
  ...
  {&Fee_SfOnEntryBlankCheckHeader, &Fee_SfBlankCheckHeader},
  {&Fee_SfOnEntryBlankCheckFooter, &Fee_SfBlankCheckFooter},
  {&Fee_SfOnEntryBlankCheckHeaderActive, &Fee_SfBlankCheckHeaderActive},
  {&Fee_SfOnEntryBlankCheckFooterActive, &Fee_SfBlankCheckFooterActive},
  {&Fee_SfOnEntryBlankCheckHeaderErasable, &Fee_SfBlankCheckHeaderErasable},
  {&Fee_SfOnEntryBlankCheckFooterErasable, &Fee_SfBlankCheckFooterErasable},
  {&Fee_SfOnEntryBcWrittenMarker, &Fee_SfBcWrittenMarker},
  {&Fee_SfOnEntryBcBlockStamp, &Fee_SfBcBlockStamp},
  {&Fee_SfOnEntryReadBlockStamp, &Fee_SfReadBlockStamp},
...
#if (FEE_USE_BLANKCHECK == STD_ON)
#if (FEE_CONSISTENCY_PATTERN_ENABLED == STD_ON)
  FEE_SET_FLAG(FEE_RETENTION_MASK);
