...
#endif /* __cplusplus */
/* ==================[Includes]=============================================== */
#include <SchM_CanTSynType.h>

/* ==================[Declaration of functions with external linkage]========= */
#define RTE_START_SEC_OSAPPLICATION_C0_CODE
#include <Rte_MemMap.h>
extern FUNC(void, RTE_CODE) SchM_Enter_CanTSyn_SCHM_CANTSYN_EXCLUSIVE_AREA_0 (void);
extern FUNC(void, RTE_CODE) SchM_Exit_CanTSyn_SCHM_CANTSYN_EXCLUSIVE_AREA_0 (void);
extern FUNC(void, RTE_CODE) SchM_Enter_CanTSyn_SCHM_CANTSYN_EXCLUSIVE_AREA_1 (void);
extern FUNC(void, RTE_CODE) SchM_Exit_CanTSyn_SCHM_CANTSYN_EXCLUSIVE_AREA_1 (void);
#define RTE_STOP_SEC_OSAPPLICATION_C0_CODE
#include <Rte_MemMap.h>
#define CANTSYN_START_SEC_CODE
#include <CanTSyn_MemMap.h>
#ifndef RTE_SCHM_SWCBSW_CANTSYN_MAINFUNCTION
#define RTE_SCHM_SWCBSW_CANTSYN_MAINFUNCTION
