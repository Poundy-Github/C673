/* $Header: DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter.h 1.7 2020/08/20 10:43:27CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter_h_
#define RTW_HEADER_DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter_h_
#ifndef DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter_COMMON_INCLUDES_
# define DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter_COMMON_INCLUDES_ */

#include "DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter_types.h"
...
extern void DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter(const uint32_T *rt_erh2I,
  const real32_T *rt_gd42I, const real32_T *rt_cpaoI, const real32_T *rt_e4hoI,
  const real32_T *rt_ngfdI, const real32_T *rt_f3r3I, const real32_T *rt_kkebI,
  const real32_T *rt_hny3I, const real32_T *rt_kwugI, const real32_T *rt_kafvI,
  const real32_T *rt_kaadI, const real32_T *rt_eltpI, const real32_T *rt_cjpeI,
  const real32_T *rt_ezusI, real32_T *rt_erh2sI, real32_T *rt_gd42sI, real32_T
  *rt_cpaomI, real32_T *rt_e4ho4I, real32_T *rt_ngfdoI, real32_T *rt_f3r3lI,
  real32_T *rt_kkeboI);

/* Model reference registration function */
extern void DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter_initialize(void);

/*-
 * These blocks were eliminated from the model due to optimizations:
 *
 * Block '<S1>/Scope' : Unused code path elimination
 * Block '<S2>/Scope (1)' : Unused code path elimination
 * Block '<S2>/Scope (2)' : Unused code path elimination
 * Block '<S2>/Scope (3)' : Unused code path elimination
 ...
 *
 * '<Root>' : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter'
 * '<S1>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Curvature_Command_Arbiter'
 * '<S2>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Kinematic_Signals_Arbiter'
 * '<S3>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Steer_Control_Command_Arbiter'
 * '<S4>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Curvature_Command_Arbiter/Compare To Constant'
 * '<S5>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Curvature_Command_Arbiter/System Requirements'
 * '<S6>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Kinematic_Signals_Arbiter/Compare To Constant'
 * '<S7>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Kinematic_Signals_Arbiter/System Requirements'
 * '<S8>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Steer_Control_Command_Arbiter/Compare To Constant (1)'
 * '<S9>'   : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Steer_Control_Command_Arbiter/Compare To Constant (2)'
 * '<S10>'  : 'DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter/LAT_Steer_Control_Command_Arbiter/System Requirements'
 */

/*-
 * Requirements for '<Root>': DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter
 */
#endif                                 /* RTW_HEADER_DMC_Soc_Lat_LAT_Kinematic_Signals_Arbiter_h_ */
