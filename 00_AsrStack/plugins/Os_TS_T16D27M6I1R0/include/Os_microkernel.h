 ...
 *
 * $Id: Os_microkernel.h 32485 2020-09-23 05:58:54Z dh $
*/
...
#define OS_InternalActivateTask(t)	MK_UsrAsyncActivateTask(t)
#define OS_InternalSetEvent(t,e)	MK_UsrAsyncSetEvent(t,e)
