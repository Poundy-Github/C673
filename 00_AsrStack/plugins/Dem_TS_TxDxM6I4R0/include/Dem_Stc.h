...
#if (defined DEM_SID_J1939DcmFirstDTCwithLampStatus)
#error DEM_SID_J1939DcmFirstDTCwithLampStatus already defined
#endif
/** \brief Service Id for Dem_J1939DcmFirstDTCwithLampStatus() */
#define DEM_SID_J1939DcmFirstDTCwithLampStatus                     0x93U

#if (defined DEM_SID_J1939DcmGetNextDTCwithLampStatus)
#error DEM_SID_J1939DcmGetNextDTCwithLampStatus already defined
#endif
/** \brief Service Id for Dem_J1939DcmGetNextDTCwithLampStatus() */
...
#if (defined DEM_SID_J1939DcmGetNextSPNInFreezeFrame)
#error DEM_SID_J1939DcmGetNextSPNInFreezeFrame already defined
#endif
/** \brief Service Id for Dem_J1939DcmGetNextSPNInFreezeFrame() */
