...
)
{
  ...
  /* entry code */
  FrArTp_SM_Tx_entry_Idle(actConnIdx, connIdx, NTFRSLT_OK);
}
...
{
  /* entry code */
  FrArTp_SM_Tx_entry_Idle(actConnIdx, connIdx, NTFRSLT_E_NOT_OK);
}
...
)
{
  ...
  /* Send TxConfirmation after going to IDLE state */
  FrArTp_SduMng_txConfirmation(connIdx, TxConfResult);
}
