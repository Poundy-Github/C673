...
**                                                                            **
*******************************************************************************/
[!MACRO "Adc_ConfigIClassVal","ChSampleTime" ="","ChPreChargeClkCycles"= "","ChConvMode"="","ChSESPSEnable"="",
"EmuxEnable"="","EmuxChSampleTime" ="","EmuxChPreChargeClkCycles"= "","EmuxChConvMode"="","EmuxChSESPSEnable"="",
"AdcChClassVal"=""!][!//
[!NOCODE!]
...
[!IF "$EmuxEnable = num:i(1)"!]
  [!VAR "AdcChClassVal" = "bit:or($AdcChClassVal, bit:shl(num:i($EmuxChSampleTime),16))"!]
  [!IF "$EmuxChSESPSEnable = 'true'"!]
    [!VAR "AdcChClassVal" = "bit:or($AdcChClassVal, bit:shl(1,26))"!]
  [!ENDIF!]

  [!IF "$EmuxChPreChargeClkCycles = 'ADC_INPUT_PRECHARGE_CYCLES_32'"!]
    [!VAR "AdcChClassVal" = "bit:or($AdcChClassVal, bit:shl(3,22))"!]
  [!ELSEIF "$EmuxChPreChargeClkCycles = 'ADC_INPUT_PRECHARGE_CYCLES_16'"!]
    [!VAR "AdcChClassVal" = "bit:or($AdcChClassVal, bit:shl(2,22))"!]
  [!ELSEIF "$EmuxChPreChargeClkCycles = 'ADC_INPUT_PRECHARGE_CYCLES_8'"!]
    [!VAR "AdcChClassVal" = "bit:or($AdcChClassVal, bit:shl(1,22))"!]
  [!ENDIF!]

  [!IF "$EmuxChConvMode = 'ADC_NOISE_REDUCTION_STEPS_7'"!]
    [!VAR "AdcChClassVal" = "bit:or($AdcChClassVal, bit:shl(3,24))"!]
  [!ELSEIF "$ChConvMode = 'ADC_NOISE_REDUCTION_STEPS_3'"!]
    [!VAR "AdcChClassVal" = "bit:or($AdcChClassVal, bit:shl(2,24))"!]
  [!ELSEIF "$ChConvMode = 'ADC_NOISE_REDUCTION_STEPS_1'"!]
    [!VAR "AdcChClassVal" = "bit:or($AdcChClassVal, bit:shl(1,24))"!]
  [!ENDIF!]
[!ENDIF!]
[!ENDNOCODE!][!//
[!ENDMACRO!][!//
...
/*******************************************************************************
** Name             : Adc_ConfigGlobEmuxGrpInterfaceCfgVal                    **
**                                                                            **
** Description      : This macro generates the value to be configured in the  **
**                    EMUXSEL register                                        **
**                                                                            **
*******************************************************************************/
[!MACRO "Adc_ConfigGlobEmuxGrpInterfaceCfgVal","EmuxGrpInterface0" ="","EmuxGrpInterface1"= "",
"AdcGlobEmuxGrpInterfaceCfg"= ""!][!//
[!NOCODE!]
[!VAR "AdcGlobEmuxGrpInterfaceCfg" = "num:i(0)"!]
[!VAR "AdcGlobEmuxGrpInterfaceCfg" = "bit:or($EmuxGrpInterface0, bit:shl($EmuxGrpInterface1,4))"!]
[!ENDNOCODE!][!//
[!ENDMACRO!][!//
...
/*******************************************************************************
** Name             : Adc_ConfigChDiagnosticsVal                              **
**                                                                            **
** Description      : This macro generates the diagnostic value to be         **
**                    configured to be in the GxQINR register                 **
*******************************************************************************/
[!MACRO "Adc_ConfigChDiagnosticsVal","PullDownDiagEnable"= "","MultiplexerDiagEnable" ="","MultiplexerDiagLevel"= "",
"ConverterDiagEnable"= "","ConverterDiagLevel"= "","AdcGrpAnChDiagData"=""!][!//
[!NOCODE!][!//
[!VAR "AdcGrpAnChDiagData" = "num:i(0)"!]
[!IF "$PullDownDiagEnable = 'true'"!]
  [!VAR "AdcGrpAnChDiagData"="bit:shl(1,9)"!]
[!ELSEIF "$MultiplexerDiagEnable = 'true'"!]
  [!IF "$MultiplexerDiagLevel = 'ADC_MD_PULL_DOWN'"!]
    [!VAR "AdcGrpAnChDiagData"="bit:shl(1,10)"!]
  [!ELSE!]
    [!VAR "AdcGrpAnChDiagData"="bit:shl(1,11)"!]
  [!ENDIF!]
[!ELSEIF "$ConverterDiagEnable = 'true'"!]
  [!VAR "AdcGrpAnChDiagData"="bit:shl(1,12)"!]
  [!IF "$ConverterDiagLevel = 'ADC_CD_PULL_DEVICE_VDDM'"!]
    [!VAR "AdcGrpAnChDiagData"="$AdcGrpAnChDiagData"!]
  [!ELSEIF "$ConverterDiagLevel = 'ADC_CD_PULL_DEVICE_VSSM'"!]
    [!VAR "AdcGrpAnChDiagData" = "bit:or($AdcGrpAnChDiagData,bit:shl(1,13))"!]
  [!ELSEIF "$ConverterDiagLevel = 'ADC_CD_PULL_DEVICE_HALF_VDDM'"!]
    [!VAR "AdcGrpAnChDiagData" = "bit:or($AdcGrpAnChDiagData,bit:shl(2,13))"!]
  [!ELSE!]
    [!VAR "AdcGrpAnChDiagData" = "bit:or($AdcGrpAnChDiagData,bit:shl(3,13))"!]
  [!ENDIF!]
[!ELSE!]
  [!VAR "AdcGrpAnChDiagData"="num:i(0)"!]
[!ENDIF!]
