...
override PKGDIR = Conti/MFC400/M3VPSS
...
package/%.xdc.inc package/%_Conti.MFC400.M3VPSS.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package Conti.MFC400.M3VPSS" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedConti/MFC400/M3VPSSpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js Conti.MFC400.M3VPSS $@
...
.PHONY: release,Conti_MFC400_M3VPSS
Conti_MFC400_M3VPSS.zip: package/package.bld.xml
Conti_MFC400_M3VPSS.zip: package/build.cfg
Conti_MFC400_M3VPSS.zip: package/package.xdc.inc
Conti_MFC400_M3VPSS.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/Conti_MFC400_M3VPSS.zip.dep
endif
package/rel/Conti_MFC400_M3VPSS/Conti/MFC400/M3VPSS/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

Conti_MFC400_M3VPSS.zip: package/rel/Conti_MFC400_M3VPSS.xdc.inc package/rel/Conti_MFC400_M3VPSS/Conti/MFC400/M3VPSS/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/Conti_MFC400_M3VPSS.xdc.inc,package/rel/Conti_MFC400_M3VPSS.zip.dep)


release release,Conti_MFC400_M3VPSS: all Conti_MFC400_M3VPSS.zip
clean:: .clean
	-$(RM) Conti_MFC400_M3VPSS.zip
	-$(RM) package/rel/Conti_MFC400_M3VPSS.xdc.inc
	-$(RM) package/rel/Conti_MFC400_M3VPSS.zip.dep
