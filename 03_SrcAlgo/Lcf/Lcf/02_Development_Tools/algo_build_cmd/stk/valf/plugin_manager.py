...
class PluginManager(object):
    ...
    def __get_plugin_list(self, module_name_list):
        ...
        for module_name in module_name_list:
            ...
            module_candidates = module.__dict__.items()
...
- add modules in STK with the absolute import method. Avoid conflicts if packages have the same name
