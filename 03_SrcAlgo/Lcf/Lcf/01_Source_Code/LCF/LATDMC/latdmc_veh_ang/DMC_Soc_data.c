/* $Header: DMC_Soc_data.c 1.64 2020/08/20 10:43:24CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_data.c
...
const ConstParam_DMC_Soc_T DMC_Soc_ConstP = {
  /* Computed Parameter: Steer_gain_tableData
   * Referenced by: '<S8>/Steer_gain!'
   */
  { 15.5F, 15.3701172F, 15.1904297F, 15.0195313F, 14.7001953F, 13.8496094F },
