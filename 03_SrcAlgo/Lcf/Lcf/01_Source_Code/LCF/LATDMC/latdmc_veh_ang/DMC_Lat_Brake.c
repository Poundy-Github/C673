/* $Header: DMC_Lat_Brake.c 1.6 2020/02/27 20:24:59CET Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_Brake.c
...
#include "DMC_Lat_Brake_private.h"

/*
 ***************************************************************************************************
   Table of INputs / OUTputs / STATEs / PARAms / CALLs / FILEs
   CALL: DMC_Lat_Brake_step()
   CALL: DMC_Lat_Brake_initialize(0)
   FILE: DMC_Lat_Brake.c
 ***************************************************************************************************
 */

/* Output and update for referenced model: 'DMC_Lat_Brake' */
void DMC_Lat_Brake(void)
{
}

/* Model initialize function */
void DMC_Lat_Brake_initialize(void)
{
