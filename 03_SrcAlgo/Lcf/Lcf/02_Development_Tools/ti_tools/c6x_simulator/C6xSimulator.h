...
/****************************************************************************/
/* Include defines for VisionMidEve                                         */
#include "C6xSimulator_C66x.h"
...
/* check to ensure that the target DSP is defined */
    ...
    && !defined(TMS320C6740)                       \
    && !defined(TMS320C66X)
#error "TMS320C62X, TMS320C64X, TMS320C64PX, TMS320C67X, TMS320C6740 or TMS320C66X (i.e. the target DSP) must be defined."
#endif
...
/* uidw3458: the 6740 is not defined by TI,
 *  therefore we define it as the union set of
 *  C6400+ and C67x
 *
 *  SPRUFE8B, page 20: The TMS320C674x™ DSP is the new
 *  generation floating-point DSP that combines
 *  the TMS320C67x+™ DSP and the TMS320C64x+™ DSP
 *  instruction set architectures into one core.
 */
#ifdef TMS320C6740
#define TMS320C62X
#define TMS320C64X
...
#endif      // corresponds to #ifndef __FLOAT2_DEFINES__

#endif      // corresponds to #ifndef _TMS320C6X      
#ifdef __cplusplus
}
#endif
 ...
 *  Changed: $Date: 2021/12/13 19:18:08CET $
