...
/* ------------------[API mapping]-------------------------------------------- */
#ifndef RTE_CORE /* if included by software component */
#if (!defined(RTE_RUNNABLEAPI_RE_RequestComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetCurrentComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetCurrentPNCComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetMaxComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetRequestedComMode)) && (!defined(RTE_RUNNABLEAPI_RE_Main_1))
#define Rte_Switch_UM_ComMUser_Public_currentMode Rte_Switch_ComM_UM_ComMUser_Public_currentMode
#endif
...
#define Rte_Switch_UM_ComMUser_Private_currentMode Rte_Switch_ComM_UM_ComMUser_Private_currentMode
#endif
#endif
...
#include <Rte_MemMap.h>
#if (!defined(RTE_RUNNABLEAPI_RE_RequestComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetCurrentComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetCurrentPNCComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetMaxComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetRequestedComMode)) && (!defined(RTE_RUNNABLEAPI_RE_Main_1))
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_ComM_UM_ComMUser_Public_currentMode (uint8 mode);
#endif
#if (!defined(RTE_RUNNABLEAPI_RE_RequestComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetCurrentComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetCurrentPNCComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetMaxComMode)) && (!defined(RTE_RUNNABLEAPI_RE_GetRequestedComMode)) && (!defined(RTE_RUNNABLEAPI_RE_Main_0))
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_ComM_UM_ComMUser_Private_currentMode (uint8 mode);
#endif
