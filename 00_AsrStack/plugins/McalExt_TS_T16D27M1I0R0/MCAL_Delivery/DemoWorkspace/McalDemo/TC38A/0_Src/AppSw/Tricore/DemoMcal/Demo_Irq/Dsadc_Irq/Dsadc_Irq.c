...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC0SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC1SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC2SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC3SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC4SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC5SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC6SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC7SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC8SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC9SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC10SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC11SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC12SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC13SRGM_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC0SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC1SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC2SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC3SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC4SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC5SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC6SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC7SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC8SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC9SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC10SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC11SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC12SRGA_EXIST == STD_ON)
...
**                                                                           **
******************************************************************************/
#if (IRQ_DSADC13SRGA_EXIST == STD_ON)
