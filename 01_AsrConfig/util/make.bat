...
::
:: Copyright (c) 2005 - 2020 Elektrobit Automotive GmbH
::  - all rights reserved -
::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@ECHO OFF
...
IF "%1"=="help" GOTO need_help
IF "%1"=="Start_EB" GOTO Run_EBTresos
...
:Run_EBTresos
echo "Open EBTresos Tools in your project!!"
cd "..\..\04_Script\04_EB_Tresos"
if exist "Run_EBTresos.bat" call Run_EBTresos.bat 
...
%MAKE_EXE% SHELL=cmd.exe %MAKE_OPTIONS% %*
