/*! \file **********************************************************************
  ...
  CHANGES:                   Revision 1.15 2017/11/27 06:18:21CET A, Nandu (uidr5428) (uidr5428) 
  CHANGES:                   Replaced TRUE and FALSE with b_TRUE and b_FALSE to match the Mainstream update
  CHANGES:                   Revision 1.14 2017/11/16 12:51:56CET Kotre-EXT, Jeevan (uidk9586) 
  CHANGES:                   Updated cml_complex module with coding guidelines.
  CHANGES:                   Revision 1.13 2017/09/11 04:23:42CEST Kotre-EXT, Jeevan (uidk9586) 
  CHANGES:                   Functions CML_v_DivideComplex and CML_v_MultiplyComplex optimized with use of CML_f_MultAdd.
