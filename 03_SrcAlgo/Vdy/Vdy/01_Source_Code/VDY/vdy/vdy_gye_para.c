...
const real32_T vdy_gye_H_p[2] = { 1.0F, 0.0F } ;

const real32_T vdy_gye_I_matrix_p[4] = { 1.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_gye_K_default_p[2] = { 0.0F, 0.0F } ;

const real32_T vdy_gye_P_correct_p[2] = { 100.0F, 4.0E-5F } ;

const real32_T vdy_gye_P_init_p[4] = { 1.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_gye_Q_gain_p = 30000.0F;
const real32_T vdy_gye_R_p[6] = { 2.5E-5F, 2.5E+7F, 5.29E-6F, 0.004F, 0.00017F,
  4.5E-5F } ;

const real32_T vdy_gye_x_init_p[2] = { 0.0F, 0.0F } ;
