...
/* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00028, 1 */
...
#if(ETHTSYN_MAX_SLAVE != 0U)
STATIC FUNC(Std_ReturnType, ETHTSYN_CODE) EthTSyn_GetSyncTime
(
  uint8 EthTSynCtrlIdx,
  P2VAR(Eth_TimeStampType, AUTOMATIC, ETHTSYN_APPL_DATA) TmpTimeStamp,
  P2VAR(Eth_TimeStampType, AUTOMATIC, ETHTSYN_APPL_DATA) TmpTimeStamp_T2,
  Eth_TimeStampType OriginTimeStamp,
  P2VAR(StbM_VirtualLocalTimeType, AUTOMATIC, ETHTSYN_APPL_DATA) VirtualLocalTimeT2
);
#endif
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00036, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00035, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00006, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00008, 1 */

  if(CfgPtr == NULL_PTR)
  {
#if(ETHTSYN_DEV_ERROR_DETECT == STD_ON)
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00030_ValueCheck_INIT_FAILED, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00044, 1 */
FUNC(void, ETHTSYN_CODE) EthTSyn_MainFunction(void)
{
  ...
  if(!ETHTSYN_UNINIT)
  {
    ...
    /*check for smallest */
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00130, 1 */
    if(GlobalMinDebounceTimeOffset == EthTSyn_GeneralCounter)
    {
      ...
      {
        /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00133, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00040, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00041_PARAMPTR, 1 */
...
#endif /* ETHTSYN_DEV_ERROR_DETECT == STD_ON */
  {
    ...
    if(ETHTSYN_PTP_FRAMETYPE == FrameType)
    {
      ...
      {
        /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00041_CTRLIDX, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00042, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00175, 1 */
...
#endif /* ETHTSYN_DEV_ERROR_DETECT == STD_ON */
  {
         ...
         )
      {
        if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].EthIfCtrlIdx == CtrlIdx)
        {
          if(EthTSyn_Ctrl[EthTSynCtrlIdx].Sync_BufIdx == BufIdx)
          {
            ...
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00127, 1 */
            ...
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00213, 1 */
#if((ETHTSYN_TIME_RECORDING == STD_ON) && (ETHTSYN_MAX_CTRL != ETHTSYN_MAX_SLAVE))
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00214, 1 */
          ...
          else if(EthTSyn_Ctrl[EthTSynCtrlIdx].PdelayResp_BufIdx == BufIdx)
          {
            ...
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00159, 1 */
            ...
            (
             ...
             if(E_OK == TmpRet)
             {
                ...
                /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00122, 1 */
          ...
          else if(EthTSyn_Ctrl[EthTSynCtrlIdx].PdelayReq_BufIdx == BufIdx)
          {
            ...
            if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx)) /* Slave */
            {
              ...
              /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00013, 1 */
              /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00123, 1 */
              TmpRet = EthTSyn_GetEgressTimeStamp
              (
                EthTSynCtrlIdx,
          ...
          else if(EthTSyn_Ctrl[EthTSynCtrlIdx].PdelayRespFup_BufIdx == BufIdx)
          {
            ...
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00219, 1 */
            (void)StbM_EthSetPdelayResponderData
                (
                    EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TimeBaseId,
                    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00220, 1 */
    ...
    {
      /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00176, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00043, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00174, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00039, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00172_Mode, 1 */
...
#if(ETHTSYN_DEV_ERROR_DETECT == STD_ON)
       /* Throw a DET error if the input parameter "CtrlIdx" is not valid */
       /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00172_CtrlIdx, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_91001, 1 */
...
)
{
  ...
  {
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00228, 1 */
...
#endif /* (ETHTSYN_DEV_ERROR_DETECT == STD_ON) */
  {
       ...
       )
    {
      ...
      {
        /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00226, 1 */
...
)
{
  ...
  {
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00229, 1 */
...
#endif /* (ETHTSYN_DEV_ERROR_DETECT == STD_ON) */
  {
       ...
       )
    {
      ...
      {
        SchM_Enter_EthTSyn_SCHM_ETHTSYN_EXCLUSIVE_AREA_2();
        /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00227, 1 */
...
{
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00061, 1 */
  Std_ReturnType RetVal;
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00202, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00203, 1 */
  ...
  if(E_OK == TmpRet)
  {
    ...
    /* Set PTP payload */
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00018, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00200, 1 */
  TmpRet = EthTSyn_GetTxBuffer(EthTSynCtrlIdx, PTPHeader.MsgLength, &BufIdx, &PTPPayloadPtr);
  ...
  if(E_OK == TmpRet)
  {
    ...
    if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx))
    {
      ...
      if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TimeValidationEnabled == TRUE)
      {
        ...
        /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00223, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00201, 1 */
STATIC FUNC(void, ETHTSYN_CODE) EthTSyn_TransmitPdelayRespFrame
(
  uint8 EthTSynCtrlIdx
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00012, 1 */
  TmpRet = EthTSyn_GetTxBuffer(EthTSynCtrlIdx, PTPHeader.MsgLength, &BufIdx, &PTPPayloadPtr);
  ...
  if(E_OK == TmpRet)
  {
    ...
    TS_MemCpy(
      ...
      if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TimeValidationEnabled == TRUE)
      {
        ...
        /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00218, 1 */
        (void)StbM_BusGetCurrentTime
          (
            EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TimeBaseId, /* timeBaseId */
...
)
{
  ...
  /* Get Tx buffer. */
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00202, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00162, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00163, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00148, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00063, 1 */
/* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00063_FUp, 1 */
STATIC FUNC(void, ETHTSYN_CODE) EthTSyn_FillPTPHeader
(
  uint8 EthTSynCtrlIdx,
  P2CONST(EthTSyn_PTPHeaderType, AUTOMATIC, ETHTSYN_APPL_DATA) PTPHeader,
...
)
{
  ...
  DBG_ETHTSYN_FILLFUPTLV_ENTRY(EthTSynCtrlIdx, BufPtr);
  ...
  DBG_ETHTSYN_FILLFUPTLV_EXIT(EthTSynCtrlIdx, BufPtr);
}

#if(ETHTSYN_MESSAGE_COMPLIANCE == STD_OFF)
/* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00063_AutosarTLVHeader, 1 */
STATIC FUNC(void, ETHTSYN_CODE) EthTSyn_FillFUpAutosarTLV
(
  uint8 EthTSynCtrlIdx,
  P2VAR(uint8, AUTOMATIC, ETHTSYN_APPL_DATA) BufPtr
...
{
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00093_TimeNotSecured, 1 */
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00070, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00068, 1 */

#if(ETHTSYN_TX_CRC_USED == STD_ON)
  /* If the Master -> EthTSynTLVFollowUpTimeSubTLV is set */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00063_TimeSecured, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00074, 1 */
  if(
    ...
    )
  {
    ...
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00077, 1 */
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00063_UserDataSecured, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00093_UserDataSecured, 1 */
  if(
      (EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TLVFollowUpUserDataSubTLV == TRUE) &&
      (EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].IsTxCrcSecuredUsed == ETHTSYN_CRC_SUPPORTED)
    )
  {
    ...
    if(EthTSyn_Ctrl[EthTSynCtrlIdx].StbMUserData.userDataLength != 0U)
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00078, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00079, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00082, 1 */
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00063_StatusNotSecured, 1 */
  if(
      (EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TLVFollowUpStatusSubTLV == TRUE) &&
      (
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00063_UserDataNotSecured, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00093_UserDataNotSecured, 1 */
  if(
      (EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TLVFollowUpUserDataSubTLV == TRUE) &&
      (
        EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].IsTxCrcSecuredUsed ==
    ...
    )
  {
    ...
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00153, 1 */
    if(EthTSyn_Ctrl[EthTSynCtrlIdx].StbMUserData.userDataLength != 0U)
    {
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00086, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00093_OFSSecured, 1 */
  if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TLVFollowUpOFSSubTLV == TRUE)
  {
    Std_ReturnType RetVal = E_NOT_OK;
    uint8 OfsIdx = 0U;
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00067, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00069, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00095, 1 */
  /* !LINKSTO EthTSyn.EB.OffsetSubTlv_GetOffset_NOK, 2 */
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00199, 1 */
  ...
  if(E_OK == Retval)
  {
    ...
    /* OfsTimeDomain */
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00085, 1 */
    ...
    else
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00063_OFSNotSecured, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00093_OFSnotSecured, 1 */
...
)
{
  ...
  {
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00094_SyncToGatewaySet, 1 */
    BufPtr[0U] |= ETHTSYN_SYNC_TO_SUBDOMAIN; /* the offset is 0 */
  }
  else
  {
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00094_SyncToGatewayNOTSet, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00182, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00184, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.ECUC_EthTSyn_00058_Conf, 1 */
  TS_MemCpy(DestMacAddr, EthTSyn_DestMacAddr, ETHTSYN_MAC_ADD_SIZE);
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00181, 1 */
...
)
{
  ...
  {
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00128, 1 */
  ...
  if(Length > (ETHTSYN_FUP_AUTOSAR_TLV_HEADER_START_ADDR + ETHTSYN_FUP_AUTOSAR_TLV_HEADER_LENGTH))
  {
    ...
    if(RetVal != E_NOT_OK)
    {
      ...
      if((DataPtr[ETHTSYN_FUP_AUTOSAR_SUBTLV_START_ADDR] == ETHTSYN_FUP_SUBTLV_TIME_TYPE) &&
        ...
        {
          /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00207, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00106, 1 */
STATIC FUNC(Std_ReturnType, ETHTSYN_CODE) EthTSyn_VerifyTLVHeader
(
  P2CONST(uint8, AUTOMATIC, ETHTSYN_APPL_DATA) DataPtr
)
  ...
  )
  {
    ...
    switch(DataPtr[Idx])
    {
      ...
      case ETHTSYN_FUP_SUBTLV_USERDATA_NOT_SECURED_TYPE:
      {
        ...
        {
          /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00081, 1 */
      ...
      case ETHTSYN_FUP_SUBTLV_OFS_NOT_SECURED_TYPE:
      {
        ...
        {
          /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00119_Sub_TlvType, 1 */
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00118, 1 */
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_TIME_LENGTH) <= Length)
  {
    ...
    {
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00107_TimeSecuredValidated, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00109_TimeSecured_Optional, 1 */
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00108_TimeSecured_Ignored, 1 */
      ...
      {
        /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00107_TimeNotValidated, 1 */
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_STATUS_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00107_StatusValidated, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00109_StatusSecured_Optional, 1 */
      case ETHTSYN_CRC_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
#if(ETHTSYN_RX_CRC_USED == STD_ON)
...
#endif /* ETHTSYN_RX_CRC_USED == STD_ON */
        {
          ...
          /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00156_SgwIsNOTSyncToSubDomain, 1 */
          if(
              (
          ...
          {
            /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00156_SgwIsSyncToSubDomain, 1 */
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00108_StatusSecured_Ignored, 1 */
      case ETHTSYN_CRC_IGNORED:
      {
        /* Verify that SubTLVPtr byte offset 2 is the status */
        if(
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_STATUS_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00107_StatusNotValidated, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00108_StatusNotSecured_Ignored, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00109_StatusNotSecured_Optional, 1 */
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_USERDATA_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00107_UsrDataValidated, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00109_UserDataSecured_Optional, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00116_Validated, 1 */
      case ETHTSYN_CRC_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
#if(ETHTSYN_RX_CRC_USED == STD_ON)
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00108_UserDataSecured_Ignored, 1 */
      case ETHTSYN_CRC_IGNORED:
      {
        EthTSyn_Ctrl[EthTSynCtrlIdx].StbMUserData.userDataLength  =
                      DataPtr[Offset + ETHTSYN_FUP_SUBTLV_USERDATA_B2_USER_DATA_LENGTH];
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_USERDATA_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00107_UsrDataNotValidated, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00108_UserDataNotSecured_Ignored, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00109_UserDataNotSecured_Optional, 1 */
      case ETHTSYN_CRC_IGNORED: /* Fall through */
      case ETHTSYN_CRC_NOT_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_OFS_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00107_OFSNotValidated, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00108_OFSNotSecured_Ignored, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00109_OFSNotSecured_Optional, 1 */
      case ETHTSYN_CRC_IGNORED: /* Fall through */
      case ETHTSYN_CRC_NOT_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_OFS_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00107_OFSValidated, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00109_OFSSecured_Optional, 1 */
      case ETHTSYN_CRC_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
#if(ETHTSYN_RX_CRC_USED == STD_ON)
        /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00117_Validated, 1 */
        /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00117_Optional, 1 */
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00108_OFSSecured_Ignored, 1 */
      case ETHTSYN_CRC_IGNORED:
      {
        RetVal = EthTSyn_SaveOfsData(EthTSynCtrlIdx, &DataPtr[0U], Offset);
        break;
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00110, 1 */
  /* OfsTimeDomain */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00119_OfsTimeDomain, 1 */
      ...
      )
  {
    ...
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00119_TimeDomain, 1 */
    if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].OfsInfo[Idx].OfsGlobalTimeDomainId == OfsTd)
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00119_OfsTimeNSec, 1 */
      ...
      /* userBytes */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00088, 1 */
      ...
      else
      {
        ...
        {
          /* Extract the SYNC_TO_GATEWAY bit if it is set */
          /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00213, 1 */
...
#if((ETHTSYN_RX_CRC_USED == STD_ON) || (ETHTSYN_TX_CRC_USED == STD_ON))
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00111, 1 */
STATIC FUNC(void, ETHTSYN_CODE) EthTSyn_CalculateCrc
(
  uint8 EthTSynCtrlIdx,
  P2CONST(uint8, AUTOMATIC, ETHTSYN_APPL_DATA) BufPtr,
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00096, 1 */
  Crc_Temp_0 = Crc_CalculateCRC8H2F(&EthTSyn_Ctrl[EthTSynCtrlIdx].Crc_Time_Flags, 1U, 0U, TRUE);
  Crc_Temp_1 = Crc_Temp_0;

  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00099, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00113, 1 */
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00100, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00114, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00102, 1 */
...
)
{
  ...
  if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx)) /* Slave */
  {
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00119_SuccessfulValidation, 1 */
    /* Compare calculated Crc with received Crc */
    if(
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00183, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00185, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00101, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00115, 1 */
  Crc_Status = Crc_CalculateCRC8H2F
...
#if(ETHTSYN_BRIDGE_WITH_GTM_NOT_MGM_CPU == STD_OFF)
    /* Get t4 */
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00049, 1 */
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00161, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00160, 1 */
...
#endif
     /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00120, 1 */
...
)
{
...
#if(ETHTSYN_HW_TIMESTAMP_SUPPORT == STD_ON)
  {
    ...
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00124, 1 */
...
{
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00059, 1 */
  ...
  else
  {
    ...
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00154, 1 */
  ...
  if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TimeValidationEnabled == TRUE)
  {
    ...
    /* Set the recorded timing measurement data for a pdelay of the
     *  corresponding Synchronized Time Base on Time Master */
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00221, 1 */
    (void)StbM_EthSetPdelayInitiatorData
        (
            EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TimeBaseId,
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00222, 1 */
  ...
  {
    /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00060, 1 */
    EthTSyn_Slave[EthTSynCtrlIdx].PdelayInitiatorTimeRecording.pdelay = EthTSyn_Slave[EthTSynCtrlIdx].Pdelay;
    /* requestReceiptTimeStamp as received in pdelay_Response message */
    EthTSyn_Slave[EthTSynCtrlIdx].PdelayInitiatorTimeRecording.requestReceiptTimestamp.
        seconds = EthTSyn_Slave[EthTSynCtrlIdx].Pdelay_TimeStamp_t2.seconds;
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00006, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00008, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00140, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00010, 1 */
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00142, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00135, 1 */
  if(
    ...
    if (TimeBaseUpdateCounter != EthTSyn_Ctrl[EthTSynCtrlIdx].LastTimeBaseUpdateCounter)
    {
        ...
        )
      {
        ...
        if(RetVal == E_OK)
        {
          ...
          /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00136, 1 */
          /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00137.1, 1 */
          /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00137.2, 1 */
  ...
  if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].SyncTxInterval != 0U)
  {
    ...
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00139, 1 */
    if(0U == EthTSyn_Ctrl[EthTSynCtrlIdx].SendNextSyncFrame_Timeout)
    {
      StbM_TimeBaseStatusType syncTimeBaseStatus;
      StbM_TimeBaseStatusType offsetTimeBaseStatus;
...
#endif
        /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00016_TxPeriodZero, 1 */
        /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00016, 1 */
...
)
{
    ...
    )
  {
    if(EthTSyn_Slave[EthTSynCtrlIdx].GlobalTimeFollowUpTimeout == 0U)
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00025, 1 */
  ...
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00164.TimeoutDeactivated, 1 */
  if(
    ...
    )
  {
    if(0U == EthTSyn_Slave[EthTSynCtrlIdx].PdelayFollowUpTimeout)
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00210, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00004, 1 */
...
STATIC FUNC(void, ETHTSYN_CODE) EthTSyn_TriggerPeriodicFrames(void)
{
     ...
     )
  {
    ...
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00021, 1 */
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00022, 1 */
    if(ETHTSYN_TX_ON == TxMode)
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00020, 1 */
      if(ETHTRCV_LINK_STATE_ACTIVE == LinkState)
      {
          /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00134, 1 */
...
#endif
          /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00011, 1 */
          /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00141, 1 */
          if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].PdelayReqTxInterval != 0U)
          {
            ...
            if(0U == EthTSyn_Ctrl[EthTSynCtrlIdx].SendNextPdelayReqFrame_Timeout)
            {
              ...
              if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx)) /* Slave */
              {
                 /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00005, 1 */
                 EthTSyn_ResetSlavePdelayData(EthTSynCtrlIdx);
                 ...
                 /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00164.PdelayReqTimeout, 1 */
                 EthTSyn_Slave[EthTSynCtrlIdx].PdelayFollowUpTimeout
      ...
      /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00019, 1 */
      else
      {
        /* Set Pdelay send timeout initial value different to the sync send timeout to reduce
           traffic on bus. */
    ...
    if(ETHTSYN_TX_ON == TxMode)
    {
      if(EthTSyn_Ctrl[EthTSynCtrlIdx].Frame2Transmit != 0U)
      {
        if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].PortCount == 0U)
        {
          ...
          {
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00131, 1 */
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00133, 1 */
            ...
            if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].GlobalTimeDebounceTime != 0U)
            {
              ...
              /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00132, 1 */
              (void)EthTSyn_NextMinDebounceOffset
                    (&GlobalMinDebounceTimeOffset,
                     EthTSyn_Ctrl[EthTSynCtrlIdx].DebounceTimeOffset
                    );
...
{
  /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00186, 1 */
...
)
{
  ...
  {
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00180, 1 */
  ...
  switch(MsgType)
  {
    case ETHTSYN_PTP_HEADER_MSGTYPE_SYNC:
    {
      ...
      if(LenByte >= ETHTSYN_SYNC_FRAME_SIZE)
      {
        ...
        if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx)) /* Slave */
        {
          ...
          {
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00146, 1 */
...
#endif /* ETHTSYN_MAX_SLAVE != 0U */
        {
          ...
          /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00145, 1 */
          ETHTSYN_DET_REPORT_ERROR
          (
            ETHTSYN_SID_RXINDICATION,
    ...
    case ETHTSYN_PTP_HEADER_MSGTYPE_PDELAY_REQ:
    {
      ...
      {
        /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00143, 1 */
      ...
      if((ETHTSYN_PTP_HEADER_SIZE + ETHTSYN_PTP_PDELAY_RESP_PAYLOADSIZE) <= LenByte)
      {
        ...
        if(
          ...
          ) /* Slave */
          {
            ...
            /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00164.PdelayRespTimeout, 1 */
            EthTSyn_Slave[EthTSynCtrlIdx].PdelayFollowUpTimeout
              = EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].PdelayRespAndRespFollowUpTimeout;
          }
#endif /* ETHTSYN_MAX_SLAVE != 0U */
    ...
    case ETHTSYN_PTP_HEADER_MSGTYPE_FUP:
    {
      if((ETHTSYN_PTP_HEADER_SIZE + ETHTSYN_PTP_SYNC_FUP_PAYLOADSIZE) <= LenByte)
      {
        ...
        if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx)) /* Slave */
        {
          /* !LINKSTO EthTSyn.EB.Master.RxIndication, 1 */
          /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00120, 1 */
          /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00179, 1 */
          /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00052, 1 */
          /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00190, 1 */
    ...
    default:
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00005, 1 */
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00206, 1 */
      /* Unknown message type: Ignore */
      break;
    }
  }
  ...
  if(E_OK == TmpRet)
  {
    if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].VltStbMIsEthFreerunningCounter == TRUE)
    {
      ...
      if(TmpRet == E_OK)
      {
        ...
        /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00188, 1 */
    ...
    else
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00017, 1 */
...
)
{
  ...
  /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00150,1 */
  ...
  {
    StbM_VirtualLocalTimeType VirtualLocalTimeT2 = {0U, 0U};

    RetVal = EthTSyn_GetSyncTime(EthTSynCtrlIdx, &TmpTimeStamp, &TmpTimeStamp_T2, OriginTimeStamp, &VirtualLocalTimeT2);
    ...
    if(E_OK == RetVal)
    {
      ...
      /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00080, 1 */
      ...
      /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00129, 1 */
...
#if(ETHTSYN_OFSTIMEBASES_CONFIGURED > 0U)
      if(EthTSyn_Slave[EthTSynCtrlIdx].OffsetIndex > EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].OfsIndex)
      {
        uint8 Idx;
        for(
        ...
        {
           /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00198, 1 */
          (void) StbM_BusSetGlobalTime
            (
      ...
      if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TimeValidationEnabled == TRUE)
      {
        /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00216, 1 */
        (void) StbM_EthSetSlaveTimingData
          (
            EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TimeBaseId, /* timeBaseId */
            /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00217, 1 */
...
)
{
                                                                                 ...
                                                                                 == TRUE)
  {
    SchM_Enter_EthTSyn_SCHM_ETHTSYN_EXCLUSIVE_AREA_0();
    /* !LINKSTO EthTSyn.EB.Slave.HWTimpStamp.GatewaySync, 1 */
    /* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00024, 1 */
...
/* minor version check */
#if (ETHTSYN_AR_RELEASE_MINOR_VERSION != 6U )
...
/* major version check */
#if (ETHTSYN_SW_MAJOR_VERSION != 3U)
#error ETHTSYN_SW_MAJOR_VERSION wrong (!= 3U)
#endif
