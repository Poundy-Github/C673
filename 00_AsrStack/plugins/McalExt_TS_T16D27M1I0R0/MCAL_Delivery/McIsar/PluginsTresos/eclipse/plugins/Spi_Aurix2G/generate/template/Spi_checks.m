...
[!// Check for AUTOSAR version 4.2.2 or 4.4.0
...
[!IF "(num:i(SpiGeneral/SpiLevelDelivered) = num:i(2))"!]
  [!LOOP "SpiDriver/SpiJob/*"!]
    ...
    [!IF "./SpiFrameBasedCS = 'false'"!]
      ...
      [!IF "$SumOfChannelIBLengthPerJob > num:i(8190)"!]
        [!WARNING!]
          Warning: Data buffers size of all the IB channels in the asynchonous job [!"$Spi_JobName"!] is greater than 8190 ([!"num:i($SumOfChannelIBLengthPerJob)"!]), when frame based chip select is false.
          ([!"node:path(.)"!])
        [!ENDWARNING!]]
      [!// sum is greater than 8190 generate error
      [!ELSEIF "$SumOfChannelEBLengthPerJob > num:i(8190)"!]
...
[!VAR "Spi_MacQspi0HwType440"="num:i(0)"!]
[!VAR "Spi_MacQspi1HwType440"="num:i(0)"!]
[!VAR "Spi_MacQspi2HwType440"="num:i(0)"!]
[!VAR "Spi_MacQspi3HwType440"="num:i(0)"!]
[!VAR "Spi_MacQspi4HwType440"="num:i(0)"!]
[!VAR "Spi_MacQspi5HwType440"="num:i(0)"!]
[!ENDIF!]
[!IF "SpiGeneral/SpiLevelDelivered != num:i(0)"!]
[!VAR "Spi_MacQspi0HwType440"="num:i(1)"!]
[!VAR "Spi_MacQspi1HwType440"="num:i(1)"!]
[!VAR "Spi_MacQspi2HwType440"="num:i(1)"!]
[!VAR "Spi_MacQspi3HwType440"="num:i(1)"!]
[!VAR "Spi_MacQspi4HwType440"="num:i(1)"!]
[!VAR "Spi_MacQspi5HwType440"="num:i(1)"!]
[!ENDIF!]
[!// For all QSPIx kernel
[!FOR "QspiIndex" = "0" TO "(num:i($QspiLastId))"!]
  ...
  [!IF "$SpiAS422Enable = num:i(1)"!]
    ...
    [!ELSE!] /* for ASR4.4.0 */
     [!//[cover parentID={3DE1C6D7-8EF9-41ac-84E5-7F6FD85BF1E8}][/cover][!//
     [!LOOP "SpiDriver/SpiJob/*"!]
      [!// If DMA channel is not configured for the QSPIx generate error
      [!IF "(node:ref(./SpiDeviceAssignment)/SpiHwUnit = concat('QSPI',$QspiIndex))
        and (count(../../../SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = concat('QSPI',$QspiIndex)]/SpiHwDmaConfigurationQspi/*) = num:i(0))"!]
        [!IF "$QspiIndex = num:i(0)"!]
           [!VAR "Spi_MacQspi0HwType440"="num:i(0)"!]
        [!ENDIF!]
        [!IF "$QspiIndex = num:i(1)"!]
           [!VAR "Spi_MacQspi1HwType440"="num:i(0)"!]
        [!ENDIF!]
        [!IF "$QspiIndex = num:i(2)"!]
           [!VAR "Spi_MacQspi2HwType440"="num:i(0)"!]
        [!ENDIF!]
        [!IF "$QspiIndex = num:i(3)"!]
           [!VAR "Spi_MacQspi3HwType440"="num:i(0)"!]
        [!ENDIF!]
        [!IF "$QspiIndex = num:i(4)"!]
           [!VAR "Spi_MacQspi4HwType440"="num:i(0)"!]
        [!ENDIF!]
        [!IF "$QspiIndex = num:i(5)"!]
           [!VAR "Spi_MacQspi5HwType440"="num:i(0)"!]
        [!ENDIF!]
      [!ENDIF!]
    [!ENDLOOP!]
...
[!IF "$Spi_FlagPin = num:i(2)"!]
  ...
  [!ENDIF!]
[!ENDIF!]
[!FOR "Spi_KernelID"="0" TO "(num:i($QspiLastId))"!]
...
MACRO: Spi_CGCalculateIBSizeQSPIz
Macro to Calculate the IB buffer size of a given QSPIz
******************************************************************************/!]
[!MACRO "Spi_CGCalculateIBSizeQSPIz", "Spi_OutQspiIndex" = ""!][!//
[!NOCODE!][!//
...
[!LOOP "SpiDriver/SpiJob/*"!]
  ...
  [!IF "node:ref(./SpiDeviceAssignment)/SpiHwUnit = 'QSPI0'"!]
    ...
    /* Only applicable for 4.2.2 */
    [!IF "$SpiAS422Enable = num:i(1)"!]
  [!//[cover parentID={FC1BF691-12DB-4769-9059-6B6E91E611D8}][/cover][!//
...
[!VAR "Spi_SeqQSPI0Count"="num:i(0)"!]
[!VAR "Spi_SeqQSPI1Count"="num:i(0)"!]
[!VAR "Spi_SeqQSPI2Count"="num:i(0)"!]
[!VAR "Spi_SeqQSPI3Count"="num:i(0)"!]
[!VAR "Spi_SeqQSPI4Count"="num:i(0)"!]
[!VAR "Spi_SeqQSPI5Count"="num:i(0)"!]
[!// for all sequence
[!LOOP "SpiDriver/SpiSequence/*"!]
    ...
    [!IF "(node:ref(node:ref(./SpiJobAssignment/*[1])/SpiDeviceAssignment))/SpiHwUnit = 'QSPI0'"!]
      ...
      [!VAR "Spi_SeqQSPI0Count"="$Spi_SeqQSPI0Count + num:i(1)"!]
      [!VAR "Spi_SeqQSPI0"="concat($Spi_SeqQSPI0,node:name(.),',')"!]
    [!ENDIF!]
    [!// Similar for job belongs to QSPI1
    [!IF "(node:ref(node:ref(./SpiJobAssignment/*[1])/SpiDeviceAssignment))/SpiHwUnit = 'QSPI1'"!]
      [!VAR "Spi_SeqQSPI1Count"="$Spi_SeqQSPI1Count + num:i(1)"!]
      [!VAR "Spi_SeqQSPI1"="concat($Spi_SeqQSPI1,node:name(.),',')"!]
    [!ENDIF!]
    [!// Similar for job belongs to QSPI2
    [!IF "(node:ref(node:ref(./SpiJobAssignment/*[1])/SpiDeviceAssignment))/SpiHwUnit = 'QSPI2'"!]
      [!VAR "Spi_SeqQSPI2Count"="$Spi_SeqQSPI2Count + num:i(1)"!]
      [!VAR "Spi_SeqQSPI2"="concat($Spi_SeqQSPI2,node:name(.),',')"!]
    [!ENDIF!]
    [!// Similar for job belongs to QSPI3
    [!IF "(node:ref(node:ref(./SpiJobAssignment/*[1])/SpiDeviceAssignment))/SpiHwUnit = 'QSPI3'"!]
      [!VAR "Spi_SeqQSPI3Count"="$Spi_SeqQSPI3Count + num:i(1)"!]
      [!VAR "Spi_SeqQSPI3"="concat($Spi_SeqQSPI3,node:name(.),',')"!]
    [!ENDIF!]
    [!// Similar for job belongs to QSPI4
    [!IF "(node:ref(node:ref(./SpiJobAssignment/*[1])/SpiDeviceAssignment))/SpiHwUnit = 'QSPI4'"!]
      [!VAR "Spi_SeqQSPI4Count"="$Spi_SeqQSPI4Count + num:i(1)"!]
      [!VAR "Spi_SeqQSPI4"="concat($Spi_SeqQSPI4,node:name(.),',')"!]
    [!ENDIF!]
    [!// Similar for job belongs to QSPI5
    [!IF "(node:ref(node:ref(./SpiJobAssignment/*[1])/SpiDeviceAssignment))/SpiHwUnit = 'QSPI5'"!]
      [!VAR "Spi_SeqQSPI5Count"="$Spi_SeqQSPI5Count + num:i(1)"!]
      [!VAR "Spi_SeqQSPI5"="concat($Spi_SeqQSPI5,node:name(.),',')"!]
    [!ENDIF!]
[!ENDLOOP!][!// end of LOOP "SpiDriver/SpiSequence/*"
[!ENDNOCODE!][!//
[!ENDMACRO!]
...
[!VAR "Spi_JobQSPI0Count"="num:i(0)"!]
[!VAR "Spi_JobQSPI1"="''"!]
[!VAR "Spi_JobQSPI1Count"="num:i(0)"!]
[!VAR "Spi_JobQSPI2"="''"!]
[!VAR "Spi_JobQSPI2Count"="num:i(0)"!]
[!VAR "Spi_JobQSPI3"="''"!]
[!VAR "Spi_JobQSPI3Count"="num:i(0)"!]
[!VAR "Spi_JobQSPI4"="''"!]
[!VAR "Spi_JobQSPI4Count"="num:i(0)"!]
[!VAR "Spi_JobQSPI5"="''"!]
[!VAR "Spi_JobQSPI5Count"="num:i(0)"!]

[!LOOP "SpiDriver/SpiJob/*"!]
    [!IF "(node:ref(./SpiDeviceAssignment))/SpiHwUnit = 'QSPI0'"!]
      [!VAR "Spi_JobQSPI0Count"="$Spi_JobQSPI0Count + num:i(1)"!]
      [!VAR "Spi_JobQSPI0"="concat($Spi_JobQSPI0,node:name(.),',')"!]
    [!ENDIF!]
    [!IF "(node:ref(./SpiDeviceAssignment))/SpiHwUnit = 'QSPI1'"!]
      [!VAR "Spi_JobQSPI1Count"="$Spi_JobQSPI1Count + num:i(1)"!]
      [!VAR "Spi_JobQSPI1"="concat($Spi_JobQSPI1,node:name(.),',')"!]
    [!ENDIF!]
    [!IF "(node:ref(./SpiDeviceAssignment))/SpiHwUnit = 'QSPI2'"!]
      [!VAR "Spi_JobQSPI2Count"="$Spi_JobQSPI2Count + num:i(1)"!]
      [!VAR "Spi_JobQSPI2"="concat($Spi_JobQSPI2,node:name(.),',')"!]
    [!ENDIF!]
    [!IF "(node:ref(./SpiDeviceAssignment))/SpiHwUnit = 'QSPI3'"!]
      [!VAR "Spi_JobQSPI3Count"="$Spi_JobQSPI3Count + num:i(1)"!]
      [!VAR "Spi_JobQSPI3"="concat($Spi_JobQSPI3,node:name(.),',')"!]
    [!ENDIF!]
    [!IF "(node:ref(./SpiDeviceAssignment))/SpiHwUnit = 'QSPI4'"!]
      [!VAR "Spi_JobQSPI4Count"="$Spi_JobQSPI4Count + num:i(1)"!]
      [!VAR "Spi_JobQSPI4"="concat($Spi_JobQSPI4,node:name(.),',')"!]
    [!ENDIF!]
    [!IF "(node:ref(./SpiDeviceAssignment))/SpiHwUnit = 'QSPI5'"!]
      [!VAR "Spi_JobQSPI5Count"="$Spi_JobQSPI5Count + num:i(1)"!]
      [!VAR "Spi_JobQSPI5"="concat($Spi_JobQSPI5,node:name(.),',')"!]
    [!ENDIF!]
[!ENDLOOP!]
[!ENDNOCODE!][!//
[!ENDMACRO!]
...
[!NOCODE!][!//
[!VAR "Spi_ChnlQSPIx"="''"!]
[!VAR "Spi_ChnlQSPIxCount"="num:i(0)"!]
[!VAR "Spi_MasterChnlList" = "''"!]
[!VAR "Spi_ChnlQSPI0"="''"!]
[!VAR "Spi_ChnlQSPI0Count"="num:i(0)"!]
[!VAR "Spi_ChnlQSPI1"="''"!]
[!VAR "Spi_ChnlQSPI1Count"="num:i(0)"!]
[!VAR "Spi_ChnlQSPI2"="''"!]
[!VAR "Spi_ChnlQSPI2Count"="num:i(0)"!]
[!VAR "Spi_ChnlQSPI3"="''"!]
[!VAR "Spi_ChnlQSPI3Count"="num:i(0)"!]
[!VAR "Spi_ChnlQSPI4"="''"!]
[!VAR "Spi_ChnlQSPI4Count"="num:i(0)"!]
[!VAR "Spi_ChnlQSPI5"="''"!]
[!VAR "Spi_ChnlQSPI5Count"="num:i(0)"!]
[!VAR "Spi_EBChnl"="''"!]
[!VAR "Spi_EBChnlCount"="num:i(0)"!]
[!VAR "Spi_EBChnl0"="''"!]
[!VAR "Spi_EBChnlCount0"="num:i(0)"!]
[!VAR "Spi_EBChnl1"="''"!]
[!VAR "Spi_EBChnlCount1"="num:i(0)"!]
[!VAR "Spi_EBChnl2"="''"!]
[!VAR "Spi_EBChnlCount2"="num:i(0)"!]
[!VAR "Spi_EBChnl3"="''"!]
[!VAR "Spi_EBChnlCount3"="num:i(0)"!]
[!VAR "Spi_EBChnl4"="''"!]
[!VAR "Spi_EBChnlCount4"="num:i(0)"!]
[!VAR "Spi_EBChnl5"="''"!]
[!VAR "Spi_EBChnlCount5"="num:i(0)"!]
  ...
  [!LOOP "SpiDriver/SpiChannel/*[SpiChannelType = 'IB']"!]
    [!VAR "Spi_IBChnlName"="node:name(.)"!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_IBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI0')
        ...
        [!VAR "Spi_ChnlQSPI0Count"="$Spi_ChnlQSPI0Count + num:i(1)"!]
        [!VAR "Spi_ChnlQSPI0"="concat($Spi_ChnlQSPI0,node:name(.),',')"!]
      ...
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_IBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI1')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_ChnlQSPI1Count"="$Spi_ChnlQSPI1Count + num:i(1)"!]
        [!VAR "Spi_ChnlQSPI1"="concat($Spi_ChnlQSPI1,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_IBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI2')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_ChnlQSPI2Count"="$Spi_ChnlQSPI2Count + num:i(1)"!]
        [!VAR "Spi_ChnlQSPI2"="concat($Spi_ChnlQSPI2,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_IBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI3')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_ChnlQSPI3Count"="$Spi_ChnlQSPI3Count + num:i(1)"!]
        [!VAR "Spi_ChnlQSPI3"="concat($Spi_ChnlQSPI3,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_IBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI4')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_ChnlQSPI4Count"="$Spi_ChnlQSPI4Count + num:i(1)"!]
        [!VAR "Spi_ChnlQSPI4"="concat($Spi_ChnlQSPI4,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_IBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI5')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_ChnlQSPI5Count"="$Spi_ChnlQSPI5Count + num:i(1)"!]
        [!VAR "Spi_ChnlQSPI5"="concat($Spi_ChnlQSPI5,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
  [!ENDLOOP!]
[!ENDIF!]
  ...
  [!LOOP "SpiDriver/SpiChannel/*[SpiChannelType = 'EB']"!]
    [!VAR "Spi_EBChnlName"="node:name(.)"!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_EBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI0')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_EBChnlCount0"="$Spi_EBChnlCount0 + num:i(1)"!]
        [!VAR "Spi_EBChnl0"="concat($Spi_EBChnl0,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_EBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI1')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_EBChnlCount1"="$Spi_EBChnlCount1 + num:i(1)"!]
        [!VAR "Spi_EBChnl1"="concat($Spi_EBChnl1,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_EBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI2')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_EBChnlCount2"="$Spi_EBChnlCount2 + num:i(1)"!]
        [!VAR "Spi_EBChnl2"="concat($Spi_EBChnl2,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_EBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI3')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_EBChnlCount3"="$Spi_EBChnlCount3 + num:i(1)"!]
        [!VAR "Spi_EBChnl3"="concat($Spi_EBChnl3,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_EBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI4')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_EBChnlCount4"="$Spi_EBChnlCount4 + num:i(1)"!]
        [!VAR "Spi_EBChnl4"="concat($Spi_EBChnl4,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
      [!IF "((node:ref(../../SpiJob/*[SpiChannelList/*[node:name(node:ref(SpiChannelAssignment)) = $Spi_EBChnlName]]/SpiDeviceAssignment))/SpiHwUnit = 'QSPI5')
        and (not(text:contains(text:split($Spi_MasterChnlList,','), node:name(.))))"!]
        [!VAR "Spi_EBChnlCount5"="$Spi_EBChnlCount5 + num:i(1)"!]
        [!VAR "Spi_EBChnl5"="concat($Spi_EBChnl5,node:name(.),',')"!]
        [!VAR "Spi_MasterChnlList" = "concat($Spi_MasterChnlList,node:name(.),',')"!]
      [!ENDIF!]
  [!ENDLOOP!]
[!ENDIF!]
  ...
  [!SELECT "SpiDriver/SpiSequence/*[node:name(.) = text:split($Spi_OutSeqQSPIx,',')[position() = $Spi_LoopCntr]]"!][!//
    ...
    [!IF "$SpiAS422Enable = num:i(1)"!]
      ...
      [!ELSEIF "(../../../SpiGeneral/SpiLevelDelivered) = num:i(1)"!]
        1U /* Async Sequence */
      [!ELSE!]
      [!IF "node:ref(./SpiJobAssignment/*[1])/SpiHwUnitSynchronous/*[1] = 'ASYNCHRONOUS'"!]
          1U /* Async Sequence */
      [!ELSE!]
        0U /* Sync Sequence */
      [!ENDIF!][!//
...
[!VAR "Spi_MacTotalSeqCount"="$Spi_MacTotalSeqCount + $Spi_SeqQSPI0Count + $Spi_SeqQSPI1Count + $Spi_SeqQSPI2Count + $Spi_SeqQSPI3Count + $Spi_SeqQSPI4Count + $Spi_SeqQSPI5Count"!]
[!/************* For Synchronous and ASYNCHRONOUS QSPI0 **************************/!][!//
[!IF "$QSPI0CoreID = $CPUID"!][!//
  [!IF "$Spi_SeqQSPI0Count != num:i(0)"!][!//
    [!CODE!][!//
    /* Synchronous Sequence[s] */
    [!ENDCODE!][!//
    [!CALL "Spi_CGGenerateSequenceConfigSyncOrAsync","Spi_OutSeqQSPIxCount" = "$Spi_SeqQSPI0Count","Spi_OutSeqQSPIx" = "$Spi_SeqQSPI0","SyncOrAsyncSeq" = "num:i(0)"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!ENDINDENT!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI1 **************************/!]
[!IF "$QSPI1CoreID = $CPUID"!]
  [!IF "$Spi_SeqQSPI1Count != num:i(0)"!]
    [!CODE!][!//
    [!INDENT "2"!][!//
    [!ENDINDENT!][!//
    [!ENDCODE!][!//
    [!CALL "Spi_CGGenerateSequenceConfigSyncOrAsync","Spi_OutSeqQSPIxCount" = "$Spi_SeqQSPI1Count","Spi_OutSeqQSPIx" = "$Spi_SeqQSPI1","SyncOrAsyncSeq" = "num:i(0)"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI2 **************************/!]
[!IF "$QSPI2CoreID = $CPUID"!]
  [!IF "$Spi_SeqQSPI2Count != num:i(0)"!]
    [!CODE!][!//
    [!INDENT "2"!][!//
    /* Synchronous Sequence[s] */
    [!ENDINDENT!][!//
    [!ENDCODE!][!//
    [!CALL "Spi_CGGenerateSequenceConfigSyncOrAsync","Spi_OutSeqQSPIxCount" = "$Spi_SeqQSPI2Count","Spi_OutSeqQSPIx" = "$Spi_SeqQSPI2","SyncOrAsyncSeq" = "num:i(0)"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI3 **************************/!]
[!IF "$QSPI3CoreID = $CPUID"!]
  [!IF "$Spi_SeqQSPI3Count != num:i(0)"!]
    [!CODE!][!//
    [!INDENT "2"!][!//
    /* Synchronous Sequence[s] */
    [!ENDINDENT!][!//
    [!ENDCODE!][!//
    [!CALL "Spi_CGGenerateSequenceConfigSyncOrAsync","Spi_OutSeqQSPIxCount" = "$Spi_SeqQSPI3Count","Spi_OutSeqQSPIx" = "$Spi_SeqQSPI3","SyncOrAsyncSeq" = "num:i(0)"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI4 **************************/!]
[!IF "$QSPI4CoreID = $CPUID"!]
  [!IF "$Spi_SeqQSPI4Count != num:i(0)"!]
    [!CODE!][!//
    [!INDENT "2"!][!//
    /* Synchronous Sequence[s] */
    [!ENDINDENT!][!//
    [!ENDCODE!][!//
    [!CALL "Spi_CGGenerateSequenceConfigSyncOrAsync","Spi_OutSeqQSPIxCount" = "$Spi_SeqQSPI4Count","Spi_OutSeqQSPIx" = "$Spi_SeqQSPI4","SyncOrAsyncSeq" = "num:i(0)"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI5 **************************/!]
[!IF "$QSPI5CoreID = $CPUID"!]
  [!IF "$Spi_SeqQSPI5Count != num:i(0)"!]
    [!CODE!][!//
    [!INDENT "2"!][!//
    /* Synchronous Sequence[s] */
    [!ENDINDENT!][!//
    [!ENDCODE!]
    [!CALL "Spi_CGGenerateSequenceConfigSyncOrAsync","Spi_OutSeqQSPIxCount" = "$Spi_SeqQSPI5Count","Spi_OutSeqQSPIx" = "$Spi_SeqQSPI5","SyncOrAsyncSeq" = "num:i(0)"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!ENDMACRO!]
...
[!VAR "Spi_MacTotalJobCount"="$Spi_MacTotalJobCount + $Spi_JobQSPI0Count + $Spi_JobQSPI1Count + $Spi_JobQSPI2Count + $Spi_JobQSPI3Count + $Spi_JobQSPI4Count + $Spi_JobQSPI5Count"!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI0 **************************/!]
[!IF "$QSPI0CoreID = $CPUID"!][!//
  [!IF "$Spi_JobQSPI0Count != num:i(0)"!][!//
    [!INDENT "2"!][!//
    [!CODE!][!//
    /* Synchronous Job[s] */
    [!//
    [!ENDCODE!][!//
    [!ENDINDENT!][!//
    [!CALL "Spi_CGGenerateJobConfigSyncOrAsync","Spi_OutJobQSPIxCount" = "$Spi_JobQSPI0Count","Spi_OutJobQSPIx" = "$Spi_JobQSPI0"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI1 **************************/!]
[!IF "$QSPI1CoreID = $CPUID"!]
  [!IF "$Spi_JobQSPI1Count != num:i(0)"!]
    [!INDENT "2"!]
    [!CODE!][!//
    /* Synchronous Job[s] */
    [!//
    [!ENDCODE!][!//
    [!ENDINDENT!][!//
    [!CALL "Spi_CGGenerateJobConfigSyncOrAsync","Spi_OutJobQSPIxCount" = "$Spi_JobQSPI1Count","Spi_OutJobQSPIx" = "$Spi_JobQSPI1"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI2 **************************/!]
[!IF "$QSPI2CoreID = $CPUID"!]
  [!IF "$Spi_JobQSPI2Count != num:i(0)"!]
    [!INDENT "2"!][!//
    [!CODE!][!//
    /* Synchronous Job[s] */
    [!//
    [!ENDCODE!][!//
    [!ENDINDENT!][!//
    [!CALL "Spi_CGGenerateJobConfigSyncOrAsync","Spi_OutJobQSPIxCount" = "$Spi_JobQSPI2Count","Spi_OutJobQSPIx" = "$Spi_JobQSPI2"!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI3 **************************/!]
[!IF "$QSPI3CoreID = $CPUID"!]
  [!IF "$Spi_JobQSPI3Count != num:i(0)"!]
    [!INDENT "2"!][!//
    [!CODE!][!//
    /* Synchronous Job[s] */
    [!//
    [!ENDCODE!][!//
    [!ENDINDENT!][!//
    [!CALL "Spi_CGGenerateJobConfigSyncOrAsync","Spi_OutJobQSPIxCount" = "$Spi_JobQSPI3Count","Spi_OutJobQSPIx" = "$Spi_JobQSPI3"!][!//
  [!ENDIF!]
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI4 **************************/!]
[!IF "$QSPI4CoreID = $CPUID"!]
  [!IF "$Spi_JobQSPI4Count != num:i(0)"!]
    [!INDENT "2"!][!//
    [!CODE!][!//
    /* Synchronous Job[s] */
    [!//
    [!ENDCODE!][!//
    [!ENDINDENT!][!//
    [!CALL "Spi_CGGenerateJobConfigSyncOrAsync","Spi_OutJobQSPIxCount" = "$Spi_JobQSPI4Count","Spi_OutJobQSPIx" = "$Spi_JobQSPI4"!][!//
  [!ENDIF!]
[!ENDIF!][!//
[!/************* For Synchronous and ASYNCHRONOUS QSPI5 **************************/!]
[!IF "$QSPI5CoreID = $CPUID"!]
  [!IF "$Spi_JobQSPI5Count != num:i(0)"!]
    [!INDENT "2"!][!//
    [!CODE!][!//
    /* Synchronous Job[s] */
    [!//
    [!ENDCODE!][!//
    [!ENDINDENT!][!//
    [!CALL "Spi_CGGenerateJobConfigSyncOrAsync","Spi_OutJobQSPIxCount" = "$Spi_JobQSPI5Count","Spi_OutJobQSPIx" = "$Spi_JobQSPI5"!][!//
  [!ENDIF!]
[!ENDIF!][!//
[!ENDNOCODE!][!//
[!ENDMACRO!]
...
[!IF "$Spi_OutQSPIx = 'QSPI0'"!]
  ...
  [!ELSE!]
  [!VAR "Spi_MacQspixHwType"="$Spi_MacQspi0HwType440"!]
  [!ENDIF!]
...
[!ELSEIF "$Spi_OutQSPIx = 'QSPI1'"!]
  ...
  [!ELSE!]
  [!VAR "Spi_MacQspixHwType"="$Spi_MacQspi1HwType440"!]
  [!ENDIF!]
  [!VAR "Spi_MacQspixHwref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHwDmaConfigurationQspi'"!]
  [!VAR "Spi_MacQspixSleepref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiSleepEnableQspix'"!]
  [!VAR "Spi_MacQspixMRSTref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHWPinMRSTQspix'"!]
[!ELSEIF "$Spi_OutQSPIx = 'QSPI2'"!]
  ...
  [!ELSE!]
  [!VAR "Spi_MacQspixHwType"="$Spi_MacQspi2HwType440"!]
  [!ENDIF!]
  [!VAR "Spi_MacQspixHwref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHwDmaConfigurationQspi'"!]
  [!VAR "Spi_MacQspixSleepref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiSleepEnableQspix'"!]
  [!VAR "Spi_MacQspixMRSTref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHWPinMRSTQspix'"!]]
[!ELSEIF "$Spi_OutQSPIx = 'QSPI3'"!]
  ...
  [!ELSE!]
  [!VAR "Spi_MacQspixHwType"="$Spi_MacQspi3HwType440"!]
  [!ENDIF!]
  [!VAR "Spi_MacQspixHwref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHwDmaConfigurationQspi'"!]
  [!VAR "Spi_MacQspixSleepref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiSleepEnableQspix'"!]
  [!VAR "Spi_MacQspixMRSTref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHWPinMRSTQspix'"!]
[!ELSEIF "$Spi_OutQSPIx = 'QSPI4'"!]
  ...
  [!ELSE!]
  [!VAR "Spi_MacQspixHwType"="$Spi_MacQspi4HwType440"!]
  [!ENDIF!]
  [!VAR "Spi_MacQspixHwref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHwDmaConfigurationQspi'"!]
  [!VAR "Spi_MacQspixSleepref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiSleepEnableQspix'"!]
  [!VAR "Spi_MacQspixMRSTref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHWPinMRSTQspix'"!]
[!ELSEIF "$Spi_OutQSPIx = 'QSPI5'"!]
  ...
  [!ELSE!]
  [!VAR "Spi_MacQspixHwType"="$Spi_MacQspi5HwType440"!]
  [!ENDIF!]
  [!VAR "Spi_MacQspixHwref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHwDmaConfigurationQspi'"!]
  [!VAR "Spi_MacQspixSleepref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiSleepEnableQspix'"!]
  [!VAR "Spi_MacQspixMRSTref"="'./SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*[SpiHwConfigKernel = $Spi_OutQSPIx]/SpiHWPinMRSTQspix'"!]
...
[!VAR "Spi_MacTotalChnlCount"="$Spi_MacTotalChnlCount + $Spi_EBChnlCount0 + $Spi_EBChnlCount1 + $Spi_EBChnlCount2 + $Spi_EBChnlCount3 + $Spi_EBChnlCount4 + $Spi_EBChnlCount5"!][!//
[!VAR "Spi_MacTotalChnlCount"="$Spi_MacTotalChnlCount + $Spi_ChnlQSPI0Count + $Spi_ChnlQSPI1Count + $Spi_ChnlQSPI2Count + $Spi_ChnlQSPI3Count + $Spi_ChnlQSPI4Count + $Spi_ChnlQSPI5Count"!][!//

[!IF "(SpiGeneral/SpiChannelBuffersAllowed = num:i(0)) or (SpiGeneral/SpiChannelBuffersAllowed = num:i(2))"!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI0 IB **************************/!]
  [!IF "$QSPI0CoreID = $CPUID"!][!//
    [!INDENT "2"!][!//
    [!IF "$Spi_ChnlQSPI0Count != num:i(0)"!][!//
      [!CODE!][!//
      ...
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_ChnlQSPI0Count","Spi_OutChnlQSPIx" = "$Spi_ChnlQSPI0","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
    [!ENDINDENT!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI1 IB **************************/!]
  [!IF "$QSPI1CoreID = $CPUID"!]
    [!IF "$Spi_ChnlQSPI1Count != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      ...
      [!/* bit:or(bit:shl(SYNC/ASYNC,4),QSPIx)
      SYNC=0, ASYNC=0, QSPIx=index of Qspi(0,1,2,3,4 or 5) */!]
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_ChnlQSPI1Count","Spi_OutChnlQSPIx" = "$Spi_ChnlQSPI1","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI2 IB **************************/!]
  [!IF "$QSPI2CoreID = $CPUID"!]
    [!IF "$Spi_ChnlQSPI2Count != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      ...
      [!/* bit:or(bit:shl(SYNC/ASYNC,4),QSPIx)
      SYNC=0, ASYNC=0, QSPIx=index of Qspi(0,1,2,3,4 or 5) */!]
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_ChnlQSPI2Count","Spi_OutChnlQSPIx" = "$Spi_ChnlQSPI2","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI3 IB **************************/!]
  [!IF "$QSPI3CoreID = $CPUID"!]
    [!IF "$Spi_ChnlQSPI3Count != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      ...
      [!/* bit:or(bit:shl(SYNC/ASYNC,4),QSPIx)
      SYNC=0, ASYNC=0, QSPIx=index of Qspi(0,1,2,3,4 or 5) */!]
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_ChnlQSPI3Count","Spi_OutChnlQSPIx" = "$Spi_ChnlQSPI3","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI4 IB **************************/!]
  [!IF "$QSPI4CoreID = $CPUID"!]
    [!IF "$Spi_ChnlQSPI4Count != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      ...
      [!/* bit:or(bit:shl(SYNC/ASYNC,4),QSPIx)
      SYNC=0, ASYNC=0, QSPIx=index of Qspi(0,1,2,3,4 or 5) */!]
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_ChnlQSPI4Count","Spi_OutChnlQSPIx" = "$Spi_ChnlQSPI4","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI5 IB **************************/!]
  [!IF "$QSPI5CoreID = $CPUID"!]
    [!IF "$Spi_ChnlQSPI5Count != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      ...
      [!/* bit:or(bit:shl(SYNC/ASYNC,4),QSPIx)
      SYNC=0, ASYNC=0, QSPIx=index of Qspi(0,1,2,3,4 or 5) */!]
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_ChnlQSPI5Count","Spi_OutChnlQSPIx" = "$Spi_ChnlQSPI5","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!IF "(SpiGeneral/SpiChannelBuffersAllowed = num:i(1)) or (SpiGeneral/SpiChannelBuffersAllowed = num:i(2))"!]
  ...
  [!IF "$QSPI0CoreID = $CPUID"!]
    [!IF "$Spi_EBChnlCount0 != num:i(0)"!][!//
      ...
      [!ENDCODE!][!//
      [!ENDINDENT!][!//
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_EBChnlCount0","Spi_OutChnlQSPIx" = "$Spi_EBChnl0","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI1 EB **************************/!]
  [!IF "$QSPI1CoreID = $CPUID"!]
    [!IF "$Spi_EBChnlCount1 != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      [!//
      ...
      [!ENDCODE!][!//
      [!ENDINDENT!][!//
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_EBChnlCount1","Spi_OutChnlQSPIx" = "$Spi_EBChnl1","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI2 EB **************************/!]
  [!IF "$QSPI2CoreID = $CPUID"!]
    [!IF "$Spi_EBChnlCount2 != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      [!//
      ...
      [!ENDCODE!][!//
      [!ENDINDENT!][!//
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_EBChnlCount2","Spi_OutChnlQSPIx" = "$Spi_EBChnl2","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI3 EB **************************/!]
  [!IF "$QSPI3CoreID = $CPUID"!]
    [!IF "$Spi_EBChnlCount3 != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      [!//
      ...
      [!ENDCODE!][!//
      [!ENDINDENT!][!//
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_EBChnlCount3","Spi_OutChnlQSPIx" = "$Spi_EBChnl3","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI4 EB **************************/!]
  [!IF "$QSPI4CoreID = $CPUID"!]
    [!IF "$Spi_EBChnlCount4 != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      [!//
      ...
      [!ENDCODE!][!//
      [!ENDINDENT!][!//
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_EBChnlCount4","Spi_OutChnlQSPIx" = "$Spi_EBChnl4","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
  [!/************* For Synchronous and ASYNCHRONOUS QSPI5 EB **************************/!]
  [!IF "$QSPI5CoreID = $CPUID"!]
    [!IF "$Spi_EBChnlCount5 != num:i(0)"!][!//
      [!INDENT "2"!][!//
      [!CODE!][!//
      [!//
      ...
      [!ENDCODE!][!//
      [!ENDINDENT!][!//
      [!CALL "Spi_CGGenerateChnlConfigSyncOrAsync","Spi_OutChnlQSPIxCount" = "$Spi_EBChnlCount5","Spi_OutChnlQSPIx" = "$Spi_EBChnl5","Spi_OutHwUnit"="bit:or(bit:shl(0,4),0)"!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
...
[!FOR "CPU_ID" = "0" TO "num:i($Spi_MaxCore)"!]
  ...
  [!IF "$QSPI0CoreID = $CPU_ID"!]
    ...
    [!IF "$Spi_SeqQSPI0Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateSequence_IDCode", "SpiOutQSPIxCount" = "$Spi_SeqQSPI0Count","SpiOutQSPIxSeq" = "$Spi_SeqQSPI0","Spi_OutSequenceID" = "$Spi_SequenceID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI1CoreID = $CPU_ID"!]
    [!IF "$Spi_SeqQSPI1Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateSequence_IDCode", "SpiOutQSPIxCount" = "$Spi_SeqQSPI1Count","SpiOutQSPIxSeq" = "$Spi_SeqQSPI1","Spi_OutSequenceID" = "$Spi_SequenceID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI2CoreID = $CPU_ID"!]
    [!IF "$Spi_SeqQSPI2Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateSequence_IDCode", "SpiOutQSPIxCount" = "$Spi_SeqQSPI2Count","SpiOutQSPIxSeq" = "$Spi_SeqQSPI2","Spi_OutSequenceID" = "$Spi_SequenceID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI3CoreID = $CPU_ID"!]
    [!IF "$Spi_SeqQSPI3Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateSequence_IDCode", "SpiOutQSPIxCount" = "$Spi_SeqQSPI3Count","SpiOutQSPIxSeq" = "$Spi_SeqQSPI3","Spi_OutSequenceID" = "$Spi_SequenceID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI4CoreID = $CPU_ID"!]
    [!IF "$Spi_SeqQSPI4Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateSequence_IDCode", "SpiOutQSPIxCount" = "$Spi_SeqQSPI4Count","SpiOutQSPIxSeq" = "$Spi_SeqQSPI4","Spi_OutSequenceID" = "$Spi_SequenceID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI5CoreID = $CPU_ID"!]
    [!IF "$Spi_SeqQSPI5Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateSequence_IDCode", "SpiOutQSPIxCount" = "$Spi_SeqQSPI5Count","SpiOutQSPIxSeq" = "$Spi_SeqQSPI5","Spi_OutSequenceID" = "$Spi_SequenceID"!]
    [!ENDIF!]
  [!ENDIF!]
[!ENDFOR!]
[!//
...
[!FOR "CPU_ID" = "0" TO "num:i($Spi_MaxCore)"!]
  ...
  [!IF "$QSPI0CoreID = $CPU_ID"!]
    ...
    [!IF "$Spi_JobQSPI0Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateJob_IDCode", "SpiOutQSPIxCount" = "$Spi_JobQSPI0Count","SpiOutQSPIxJob" = "$Spi_JobQSPI0","Spi_OutJobID" = "$Spi_JobID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI1CoreID = $CPU_ID"!]
    [!IF "$Spi_JobQSPI1Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateJob_IDCode", "SpiOutQSPIxCount" = "$Spi_JobQSPI1Count","SpiOutQSPIxJob" = "$Spi_JobQSPI1","Spi_OutJobID" = "$Spi_JobID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI2CoreID = $CPU_ID"!]
    [!IF "$Spi_JobQSPI2Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateJob_IDCode", "SpiOutQSPIxCount" = "$Spi_JobQSPI2Count","SpiOutQSPIxJob" = "$Spi_JobQSPI2","Spi_OutJobID" = "$Spi_JobID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI3CoreID = $CPU_ID"!]
    [!IF "$Spi_JobQSPI3Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateJob_IDCode", "SpiOutQSPIxCount" = "$Spi_JobQSPI3Count","SpiOutQSPIxJob" = "$Spi_JobQSPI3","Spi_OutJobID" = "$Spi_JobID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI4CoreID = $CPU_ID"!]
    [!IF "$Spi_JobQSPI4Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateJob_IDCode", "SpiOutQSPIxCount" = "$Spi_JobQSPI4Count","SpiOutQSPIxJob" = "$Spi_JobQSPI4","Spi_OutJobID" = "$Spi_JobID"!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "$QSPI5CoreID = $CPU_ID"!]
    [!IF "$Spi_JobQSPI5Count != num:i(0)"!]
      [!CALL "Spi_CGGenerateJob_IDCode", "SpiOutQSPIxCount" = "$Spi_JobQSPI5Count","SpiOutQSPIxJob" = "$Spi_JobQSPI5","Spi_OutJobID" = "$Spi_JobID"!]
    [!ENDIF!]
  [!ENDIF!]
[!ENDFOR!]
[!ENDNOCODE!][!//
...
[!FOR "CPU_ID" = "0" TO "num:i($Spi_MaxCore)"!]
  ...
  [!IF "SpiGeneral/SpiChannelBuffersAllowed != num:i(1)"!]
    [!IF "$QSPI0CoreID = $CPU_ID"!]
      [!IF "$Spi_ChnlQSPI0Count != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_ChnlQSPI0Count","SpiOutQSPIxChannel" = "$Spi_ChnlQSPI0","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI1CoreID = $CPU_ID"!]
      [!IF "$Spi_ChnlQSPI1Count != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_ChnlQSPI1Count","SpiOutQSPIxChannel" = "$Spi_ChnlQSPI1","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI2CoreID = $CPU_ID"!]
      [!IF "$Spi_ChnlQSPI2Count != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_ChnlQSPI2Count","SpiOutQSPIxChannel" = "$Spi_ChnlQSPI2","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI3CoreID = $CPU_ID"!]
      [!IF "$Spi_ChnlQSPI3Count != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_ChnlQSPI3Count","SpiOutQSPIxChannel" = "$Spi_ChnlQSPI3","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI4CoreID = $CPU_ID"!]
      [!IF "$Spi_ChnlQSPI4Count != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_ChnlQSPI4Count","SpiOutQSPIxChannel" = "$Spi_ChnlQSPI4","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI5CoreID = $CPU_ID"!]
      [!IF "$Spi_ChnlQSPI5Count != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_ChnlQSPI5Count","SpiOutQSPIxChannel" = "$Spi_ChnlQSPI5","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
  [!ENDIF!]
  [!// EB channel
  [!IF "SpiGeneral/SpiChannelBuffersAllowed != num:i(0)"!]
    [!IF "$QSPI0CoreID = $CPU_ID"!]
      [!IF "$Spi_EBChnlCount0 != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_EBChnlCount0","SpiOutQSPIxChannel" = "$Spi_EBChnl0","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI1CoreID = $CPU_ID"!]
      [!IF "$Spi_EBChnlCount1 != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_EBChnlCount1","SpiOutQSPIxChannel" = "$Spi_EBChnl1","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI2CoreID = $CPU_ID"!]
      [!IF "$Spi_EBChnlCount2 != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_EBChnlCount2","SpiOutQSPIxChannel" = "$Spi_EBChnl2","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI3CoreID = $CPU_ID"!]
      [!IF "$Spi_EBChnlCount3 != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_EBChnlCount3","SpiOutQSPIxChannel" = "$Spi_EBChnl3","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI4CoreID = $CPU_ID"!]
      [!IF "$Spi_EBChnlCount4 != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_EBChnlCount4","SpiOutQSPIxChannel" = "$Spi_EBChnl4","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
    [!IF "$QSPI5CoreID = $CPU_ID"!]
      [!IF "$Spi_EBChnlCount5 != num:i(0)"!]
        [!CALL "Spi_CGGenerateChannel_IDCode", "SpiOutQSPIxCount" = "$Spi_EBChnlCount5","SpiOutQSPIxChannel" = "$Spi_EBChnl5","Spi_OutChannelID" = "$Spi_ChannelID"!]
      [!ENDIF!]
    [!ENDIF!]
  [!ENDIF!]
[!ENDFOR!]
...
[!IF "text:split($Core_config,',')[position() = $CPU_ID + num:i(1)] = num:i(1)"!][!//
  ...
  [!IF "text:split($QSPICore_config,',')[position() = 6] = $CPU_ID"!][!//
    ...
    [!ENDIF!][!//
    [!ELSE!]
      [!IF "num:i($Spi_MacQspi5HwType440) = num:i(0)"!][!//
      [!VAR "Spi_HwMap1" = "num:i(1)"!]
      [!// if hardware type is asynchronous set 2nd bit (010)
    [!ELSE!][!//
      [!VAR "Spi_HwMap1" = "num:i(2)"!]
  ...
  (011 QSPI configured for core[!"num:i($CPU_ID)"!])
  ...
  [!IF "text:split($QSPICore_config,',')[position() = 5] = $CPU_ID"!]
    [!IF "$SpiAS422Enable = num:i(1)"!]
      ...
      [!ENDIF!]
    [!ELSE!]
      [!IF "num:i($Spi_MacQspi4HwType440) = num:i(0)"!]
        [!VAR "Spi_HwMap1" = "num:i(1)"!]
      [!ELSE!]
        [!VAR "Spi_HwMap1" = "num:i(2)"!]
      [!ENDIF!]
  ...
  [!IF "text:split($QSPICore_config,',')[position() = 4] = $CPU_ID"!]
    [!IF "$SpiAS422Enable = num:i(1)"!]
      ...
      [!ENDIF!]
    [!ELSE!]
         [!IF "num:i($Spi_MacQspi3HwType440) = num:i(0)"!]
        [!VAR "Spi_HwMap1" = "num:i(1)"!]
      [!ELSE!]
        [!VAR "Spi_HwMap1" = "num:i(2)"!]
      [!ENDIF!]
  ...
  [!IF "text:split($QSPICore_config,',')[position() = 3] = $CPU_ID"!]
    [!IF "$SpiAS422Enable = num:i(1)"!]
      ...
      [!ENDIF!]
    [!ELSE!]
        [!IF "num:i($Spi_MacQspi2HwType440) = num:i(0)"!]
        [!VAR "Spi_HwMap1" = "num:i(1)"!]
      [!ELSE!]
        [!VAR "Spi_HwMap1" = "num:i(2)"!]
      [!ENDIF!]
  ...
  [!IF "text:split($QSPICore_config,',')[position() = 2] = $CPU_ID"!]
    [!IF "$SpiAS422Enable = num:i(1)"!]
      ...
      [!ENDIF!]
    [!ELSE!]
        [!IF "num:i($Spi_MacQspi1HwType440) = num:i(0)"!]
        [!VAR "Spi_HwMap1" = "num:i(1)"!]
      [!ELSE!]
        [!VAR "Spi_HwMap1" = "num:i(2)"!]
      [!ENDIF!]
  ...
  [!IF "text:split($QSPICore_config,',')[position() = 1] = $CPU_ID"!]
    [!IF "$SpiAS422Enable = num:i(1)"!]
      ...
      [!ENDIF!]
    [!ELSE!]
       [!IF "num:i($Spi_MacQspi0HwType440) = num:i(0)"!]
        [!VAR "Spi_HwMap1" = "num:i(1)"!]
      [!ELSE!]
        [!VAR "Spi_HwMap1" = "num:i(2)"!]
      [!ENDIF!]
