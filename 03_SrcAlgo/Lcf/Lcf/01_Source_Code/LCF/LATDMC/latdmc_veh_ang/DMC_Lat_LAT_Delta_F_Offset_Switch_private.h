/* $Header: DMC_Lat_LAT_Delta_F_Offset_Switch_private.h 1.40 2020/08/20 10:42:50CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_LAT_Delta_F_Offset_Switch_private.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_LAT_Delta_F_Offset_Switch_private_h_
#define RTW_HEADER_DMC_Lat_LAT_Delta_F_Offset_Switch_private_h_
#include "rtwtypes.h"
...
typedef struct {
  /* Expression: single([1 1 1 1 1 1 1 1 1]) %single([0 0 0 0 0 0 0 0 0])
   * Referenced by: '<S9>/Steer_Angle_offset//Delta_ys'
   */
  real32_T Steer_Angle_offsetDelta_ys_tableData[9];

  /* Expression: single([10 30 50 70 90 110 130 150 170])
   * Referenced by: '<S9>/Steer_Angle_offset//Delta_ys'
   */
  real32_T Steer_Angle_offsetDelta_ys_bp01Data[9];
} ConstParam_DMC_Lat_LAT_Delta_F_Offset_Switch_T;

/* Constant parameters (auto storage) */
extern const ConstParam_DMC_Lat_LAT_Delta_F_Offset_Switch_T
  DMC_Lat_LAT_Delta_F_Offset_Switch_ConstP;

/* <== Enable QAC again after word size consistence check using limits.h has been done. */
/* PRQA L:LABEL_QAC_PRIVATE */
#endif                                 /* RTW_HEADER_DMC_Lat_LAT_Delta_F_Offset_Switch_private_h_ */
