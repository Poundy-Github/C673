...
const real32_T vdy_aye_I_matrix_p[16] = { 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F,
  0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_aye_K_default_p[8] = { 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
  0.0F, 0.0F } ;

const real32_T vdy_aye_P_correct_p[4] = { 3.0F, 10.0F, 14.28F, 100.0F } ;

const real32_T vdy_aye_P_init_p[16] = { 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F,
  0.0F, 0.0F, 0.0F, 0.001F, 0.0F, 0.0F, 0.0F, 0.0F, 0.001F } ;

const real32_T vdy_aye_Q_add_p[16] = { 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
  0.0F, 0.0F, 0.0F, 0.0025F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0E-10F } ;

const real32_T vdy_aye_Q_gain_p[2] = { 120.0F, 1.0F } ;

const real32_T vdy_aye_Q_sigmas_p[4] = { 6.0F, 6.0F, 0.0F, 0.0F } ;

const real32_T vdy_aye_R_ay_invalid_p = 2.5E+7F;
const real32_T vdy_aye_R_p[4] = { 0.25F, 0.0F, 0.0F, 0.04F } ;

const real32_T vdy_aye_x_init_p[4] = { 0.0001F, 0.0001F, 1.0E-5F, 1.0E-8F } ;
