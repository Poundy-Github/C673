...
IF [%TRACE32_PATH%]==[] set TRACE32_PATH=C:\T32
...
:: make -j
%MAKE_EXE% SHELL=cmd.exe %MAKE_OPTIONS% "-j"
...
echo.
echo ======================================================================================================================
echo                              Explanation of Pre-Build Process:
echo ======================================================================================================================
echo Rta Tools which will scan OS and RTE module and generate additional compile-requrired files
echo also requires the output files of Pdo tool.
echo Thus, the Pre-Build Process is essential and in which the tool generate order must be followed as below
echo 1.RtaTaskLutGenerator            (of Rta tool cluster)
echo 2.RteStandardRtaInstrGenerator   (of Rta tool cluster)
echo 3.Pdo tool
echo 4.Swc tool
echo 5.RtaXmlGenerator                (of Rta tool cluster)
echo 6.Copy Rte_Type.h to MTS workspace
echo.
echo  /-----------------------------------------------------------------------------------/
