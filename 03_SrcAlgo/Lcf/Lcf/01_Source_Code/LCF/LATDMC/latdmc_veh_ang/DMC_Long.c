/* $Header: DMC_Long.c 1.8 2020/02/27 20:25:43CET Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Long.c
...
/* --- Includes --- */
#include "DMC_Long.h"
#include "DMC_Long_private.h"

/*
 ***************************************************************************************************
   Table of INputs / OUTputs / STATEs / PARAms / CALLs / FILEs
   CALL: DMC_Long_step()
   CALL: DMC_Long_initialize(0)
   FILE: DMC_Long.c
 ***************************************************************************************************
 */

/* Output and update for referenced model: 'DMC_Long' */
void DMC_Long(const real32_T *rt_erh2I, const int16_T *rt_gd42I, const int16_T
              *rt_cpaoI, const int16_T rt_e4hoI[4], real32_T *rt_erh2sI,
              real32_T *rt_gd42sI)
{
  real32_T rtb_;

  /* Abs: '<Root>/Abs1' */
  rtb_ = (real32_T)fabs((real_T)(*rt_erh2I));
   ...
   */
  *rt_gd42sI = ((rtb_ + (((real32_T)(*rt_gd42I)) * 0.01F)) + ((real32_T)
    (*rt_cpaoI))) + ((real32_T)((int16_T)(((int32_T)((int16_T)(((int32_T)
    ((int16_T)(((int32_T)((int16_T)((real32_T)floor((real_T)((real32_T)
    (((real32_T)rt_e4hoI[(int8_T)0]) * 0.01F)))))) + ((int32_T)((real32_T)floor
                               ((real_T)((real32_T)(((real32_T)rt_e4hoI[(int8_T)
    1]) * 0.01F)))))))) + ((int32_T)((real32_T)floor((real_T)((real32_T)
    (((real32_T)rt_e4hoI[(int8_T)2]) * 0.01F)))))))) + ((int32_T)((real32_T)
    floor((real_T)((real32_T)(((real32_T)rt_e4hoI[(int8_T)3]) * 0.01F))))))));
