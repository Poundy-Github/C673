...
/* ==================[Types]================================================== */
#ifndef RTE_CORE /* if included by software component */
typedef CONSTP2CONST(Rte_CDS_FiM, TYPEDEF, RTE_CONST) Rte_Instance;
#endif

/* ==================[Definition of variables with external linkage]========== */
#define RTE_START_SEC_OSAPPLICATION_C0_CONST_8
#include <Rte_MemMap.h>
extern CONST(Rte_CDS_FiM, RTE_CONST) Rte_Instance_FiM;
...
extern FUNC(Std_ReturnType, RTE_CODE) FiM_GetFunctionPermission (FunctionIdType FID, P2VAR(boolean, AUTOMATIC, RTE_APPL_DATA) Permission);
