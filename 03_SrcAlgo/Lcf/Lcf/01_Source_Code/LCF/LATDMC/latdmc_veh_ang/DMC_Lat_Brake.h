/* $Header: DMC_Lat_Brake.h 1.8 2020/02/27 20:25:00CET Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_Brake.h
   C source code generated on           : Tue Nov 26 16:35:53 2019
   Filename of Simulink Model           : DMC_Lat_Brake.mdl/.slx
   Revision of Simulink Model           : 1.2347
 ***************************************************************************************************
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_Brake_h_
#define RTW_HEADER_DMC_Lat_Brake_h_
#ifndef DMC_Lat_Brake_COMMON_INCLUDES_
# define DMC_Lat_Brake_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Lat_Brake_COMMON_INCLUDES_ */

#include "DMC_Lat_Brake_types.h"
...
extern void DMC_Lat_Brake(void);

/* Model reference registration function */
extern void DMC_Lat_Brake_initialize(void);
 ...
 *
 * '<Root>' : 'DMC_Lat_Brake'
 * '<S1>'   : 'DMC_Lat_Brake/DMC_Lat_Brake'
 * '<S2>'   : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_OFF'
 * '<S3>'   : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON'
 * '<S4>'   : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Feed Forward'
 * '<S5>'   : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/LAT_Accuracy_Request_Limitation'
 * '<S6>'   : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/LAT_Delta_F_Processing1'
 * '<S7>'   : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/LAT_Stiffness_Request_Limitation'
 * '<S8>'   : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Torque Distribution'
 * '<S9>'   : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Torque Distribution1'
 * '<S10>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Rate Control'
 * '<S11>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request Limitation'
 * '<S12>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation'
 * '<S13>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/lat_dyn_ctrl_onbrk'
 * '<S14>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Feed Forward/Dynamic Feed Forward'
 * '<S15>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Feed Forward/Static Feed Forward'
 * '<S16>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Feed Forward/Static Feed Forward/static Gain Steer Angle to Yaw Rate'
 * '<S17>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Feed Forward/Static Feed Forward/static Gain Yaw Rate to Yaw Torque'
 * '<S18>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Torque Distribution/Torque Distribution - Constant'
 * '<S19>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Torque Distribution/Torque Distribution - Variable'
 * '<S20>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Torque Distribution1/Torque Distribution - Constant'
 * '<S21>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Torque Distribution1/Torque Distribution - Variable'
 * '<S22>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Rate Control/Control Deviation Determination'
 * '<S23>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Rate Control/Discrete Derivative'
 * '<S24>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Rate Control/Control Deviation Determination/Stationary Single Track Model'
 * '<S25>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request Limitation/Saturation Dynamic'
 * '<S26>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation/Rate Limiter Dynamic1'
 * '<S27>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation/Rate Limiter Dynamic2'
 * '<S28>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation/Sign_without_zero'
 * '<S29>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation/Sign_without_zero1'
 * '<S30>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation/Rate Limiter Dynamic1/Saturation Dynamic'
 * '<S31>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation/Rate Limiter Dynamic2/Saturation Dynamic'
 * '<S32>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation/Sign_without_zero/Compare To Zero'
 * '<S33>'  : 'DMC_Lat_Brake/DMC_Lat_Brake/DMC_Lat_Brake_ON/Yaw Torque Request VYC Limitation/Sign_without_zero1/Compare To Zero'
 */

/*-
 * Requirements for '<Root>': DMC_Lat_Brake
 */
#endif                                 /* RTW_HEADER_DMC_Lat_Brake_h_ */
