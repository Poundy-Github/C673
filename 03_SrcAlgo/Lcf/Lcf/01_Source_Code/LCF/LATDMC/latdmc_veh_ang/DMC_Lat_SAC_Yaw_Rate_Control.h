/* $Header: DMC_Lat_SAC_Yaw_Rate_Control.h 1.23 2020/08/20 10:43:14CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_SAC_Yaw_Rate_Control.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_SAC_Yaw_Rate_Control_h_
#define RTW_HEADER_DMC_Lat_SAC_Yaw_Rate_Control_h_
#include <math.h>
#ifndef DMC_Lat_SAC_Yaw_Rate_Control_COMMON_INCLUDES_
# define DMC_Lat_SAC_Yaw_Rate_Control_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Lat_SAC_Yaw_Rate_Control_COMMON_INCLUDES_ */

#include "DMC_Lat_SAC_Yaw_Rate_Control_types.h"
...
/* Block states (auto storage) for model 'DMC_Lat_SAC_Yaw_Rate_Control' */
#ifndef DMC_Lat_SAC_Yaw_Rate_Control_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T UnitDelay1_DSTATE;          /* '<S15>/Unit Delay1' */
  real32_T UnitDelay_DSTATE;           /* '<S18>/Unit Delay' */
  real32_T UnitDelay_DSTATE_bomv;      /* '<S3>/Unit Delay' */
  real32_T UnitDelay_DSTATE_o3wq;      /* '<S9>/Unit Delay' */
  real32_T UnitDelay_DSTATE_csnm;      /* '<S25>/Unit Delay' */
  real32_T UnitDelay_DSTATE_nt0t;      /* '<S22>/Unit Delay' */
  real32_T UnitDelay_DSTATE_eh21;      /* '<S24>/Unit Delay' */
  boolean_T nd_Delay_DSTATE;           /* '<S18>/2nd_Delay' */
  boolean_T st_Delay_DSTATE;           /* '<S18>/1st_Delay' */
} rtDW_DMC_Lat_SAC_Yaw_Rate_Control_T;

#endif                                 /*DMC_Lat_SAC_Yaw_Rate_Control_MDLREF_HIDE_CHILD_*/

extern void DMC_Lat_SAC_Yaw_Rate_Control_Init(void);
extern void DMC_Lat_SAC_Yaw_Rate_Control(const uint32_T *rt_erh2I, const
  ...
  boolean_T *rt_hny3I, const real32_T *rt_kwugI, const uint16_T *rt_kafvI,
  real32_T *rt_erh2sI, real32_T *rt_gd42sI);

/* Model reference registration function */
extern void DMC_Lat_SAC_Yaw_Rate_Control_initialize(void);

#ifndef DMC_Lat_SAC_Yaw_Rate_Control_MDLREF_HIDE_CHILD_

/* Block states (auto storage) */
extern rtDW_DMC_Lat_SAC_Yaw_Rate_Control_T DMC_Lat_SAC_Yaw_Rate_Control_DWork;
 ...
 * Block '<S6>/Data Type Conversion (1)' : Eliminate redundant data type conversion
 */
 ...
 *
 * '<Root>' : 'DMC_Lat_SAC_Yaw_Rate_Control'
 * '<S1>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Active_Yaw_Rate_Control_Enabling'
 * '<S2>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error'
 * '<S3>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Integral_Part_Limitation'
 * '<S4>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Proportional_Part'
 * '<S5>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Proportional_Part_Filter'
 * '<S6>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Kappa_Command_Arbitration'
 * '<S7>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Yrc_Control_Factor'
 * '<S8>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Yrc_Yaw_Accel_Feedback'
 * '<S9>'   : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Yrc_Yr_Req_Dot_Feed_Fwd'
 * '<S10>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Active_Yaw_Rate_Control_Enabling/Compare To Constant'
 * '<S11>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Active_Yaw_Rate_Control_Enabling/System Requirements'
 * '<S12>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error/System Requirements'
 * '<S13>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Integral_Part_Limitation/System Requirements'
 * '<S14>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Proportional_Part/Compare To Constant1'
 * '<S15>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Proportional_Part/LAT_Ramped_Input slow increase, slow decrease'
 * '<S16>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Proportional_Part/SAC_R_Factor_Fader'
 * '<S17>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Proportional_Part/System Requirements'
 * '<S18>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Proportional_Part_Filter/LAT_Eps_Torque_Filter'
 * '<S19>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Control_Error_Proportional_Part_Filter/System Requirements'
 * '<S20>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Kappa_Command_Arbitration/SAC_Div_By_Zero_Check'
 * '<S21>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Kappa_Command_Arbitration/System Requirements'
 * '<S22>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Yrc_Yaw_Accel_Feedback/HEC_Yaw_Rate_Dot_Estimation'
 * '<S23>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Yrc_Yaw_Accel_Feedback/Hec_r_dot_factor'
 * '<S24>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Yrc_Yaw_Accel_Feedback/HEC_Yaw_Rate_Dot_Estimation/LAT_Yaw_Rate_Dot_Filter'
 * '<S25>'  : 'DMC_Lat_SAC_Yaw_Rate_Control/SAC_Yrc_Yr_Req_Dot_Feed_Fwd/LAT_Yaw_Rate_Dot_Filter'
 */

/*-
 * Requirements for '<Root>': DMC_Lat_SAC_Yaw_Rate_Control
 */
#endif                                 /* RTW_HEADER_DMC_Lat_SAC_Yaw_Rate_Control_h_ */
