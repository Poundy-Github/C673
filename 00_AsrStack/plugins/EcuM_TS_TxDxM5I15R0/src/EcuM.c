 ...
 *
 * Reason:
 * The message "condition is always true" is a tasking compiler issue. If the condition
 * were always true, then an infinite loop would occur.
 */
...
/* patch version check */
#if (ECUM_SW_PATCH_VERSION < 8U)
#error ECUM_SW_PATCH_VERSION wrong (< 8U)
#endif
