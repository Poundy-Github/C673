 ...
 *
 * $Id: Os_TRICORE_stm.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
...
/* Tricore 64-bit system timer.
   The counter value can be accessed in 32 or 64 bits.
   The half higher part of the timer value is named stm6
...
typedef struct os_tricorestm_s
{
	...
	os_reg32_t	stm_tim0;		/* 0x20 Absolute timer bits 31..0 */
	os_reg32_t	stm_tim6;		/* 0x24 Absolute timer bits 63..32 (named stm for backward compatibility) */
...
#if (OS_TRICOREARCH == OS_TRICOREARCH_18)
#define OS_STM_LOW_OFFSET		0x20
#define OS_STM_HIGH_OFFSET		0x24
#else
#define OS_STM_LOW_OFFSET		0x10
#define OS_STM_HIGH_OFFSET		0x28
#endif 
