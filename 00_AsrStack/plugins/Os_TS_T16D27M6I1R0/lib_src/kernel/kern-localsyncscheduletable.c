 ...
 *
 * $Id: kern-localsyncscheduletable.c 34931 2021-08-16 09:54:42Z beoe851 $
*/
 ...
 *
 * Reason: Not an issue. This variable isn't used in Safety OS. Safety OS
 *   serializes all QM-OS calls. Therefore, we don't need to lock interrupts here.
 *   Standalone QM-OS uses this variable.
 *
 ...
 *
 * Reason:
 *   Not an issue. This variable isn't used in Safety OS. Safety OS serializes
 *   all QM-OS calls. Therefore, we don't need to lock interrupts here.
 *   Standalone QM-OS uses this variable.
*/
