 ...
 *
 * $Id: kern-crosscorenotifyisr.c 35018 2021-08-23 09:29:21Z saga272975 $
*/
...
OS_TOOL_FUNCTION_ATTRIB_POST
{
	...
	*/
	...
	if ((inFunction != OS_INSHUTDOWN) && (inFunction != OS_INSHUTDOWNHOOK))
	{
...
const os_uint8_t OS_dummy_kern_crosscorenotifyisr_c = 0xeb;
