/*! \file **********************************************************************
  ...
  CHANGES:                   Revision 1.23 2017/11/27 06:18:23CET A, Nandu (uidr5428) (uidr5428) 
  CHANGES:                   Replaced TRUE and FALSE with b_TRUE and b_FALSE to match the Mainstream update
  CHANGES:                   Revision 1.22 2017/11/24 06:31:06CET Kotre-EXT, Jeevan (uidk9586) 
...
float32 CML_f_calcGaussErrorFunction  ( float32 f_value )
{
  ...
  else
  {
    ...
    f_temp = ( ( ( (CML_f_GaussErrFctConst4 * f_temp4) - (CML_f_GaussErrFctConst3 * f_temp3) ) - (CML_f_GaussErrFctConst2 * f_temp2) ) + (CML_f_GaussErrFctConst1 * f_value) ) + CML_f_GaussErrFctConst0;
