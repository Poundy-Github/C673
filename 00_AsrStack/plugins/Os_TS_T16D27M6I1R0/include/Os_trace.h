 ...
 *
 * $Id: Os_trace.h 30063 2019-04-01 02:55:31Z sash270423 $
*/
...
#ifndef OS_TRACE_ACTIVATETASKASYN_ENTRY
#define OS_TRACE_ACTIVATETASKASYN_ENTRY(TaskId)
#endif

#ifndef OS_TRACE_ACTIVATETASKASYN_EXIT
#define OS_TRACE_ACTIVATETASKASYN_EXIT_P(r,TaskId)
#else
#ifdef TRACE_EXIT_WITH_PARAMS
#define OS_TRACE_ACTIVATETASKASYN_EXIT_P(r,TaskId) OS_TRACE_ACTIVATETASKASYN_EXIT(r,TaskId)
#else
#define OS_TRACE_ACTIVATETASKASYN_EXIT_P(r,TaskId) OS_TRACE_ACTIVATETASKASYN_EXIT()
#endif
#endif
...
#ifndef OS_TRACE_SETEVENTASYN_ENTRY
#define OS_TRACE_SETEVENTASYN_ENTRY(TaskId,EventMask)
#endif

#ifndef OS_TRACE_SETEVENTASYN_EXIT
#define OS_TRACE_SETEVENTASYN_EXIT_P(r,TaskId,EventMask)
#else
#ifdef TRACE_EXIT_WITH_PARAMS
#define OS_TRACE_SETEVENTASYN_EXIT_P(r,TaskId,EventMask) OS_TRACE_SETEVENT_EXIT(r,TaskId,EventMask)
#else
#define OS_TRACE_SETEVENTASYN_EXIT_P(r,TaskId,EventMask) OS_TRACE_SETEVENT_EXIT()
#endif
#endif
...
#ifndef OS_TRACE_GETCURRENTAPPLICATIONID_ENTRY
#define OS_TRACE_GETCURRENTAPPLICATIONID_ENTRY()
#endif

#ifndef OS_TRACE_GETCURRENTAPPLICATIONID_EXIT
#define OS_TRACE_GETCURRENTAPPLICATIONID_EXIT_P(r)
#else
#ifdef TRACE_EXIT_WITH_PARAMS
#define OS_TRACE_GETCURRENTAPPLICATIONID_EXIT_P(r) OS_TRACE_GETCURRENTAPPLICATIONID_EXIT(r)
#else
#define OS_TRACE_GETCURRENTAPPLICATIONID_EXIT_P(r) OS_TRACE_GETCURRENTAPPLICATIONID_EXIT()
#endif
#endif
...
#ifndef OS_TRACE_CLEARPENDINGINTERRUPT_ENTRY
#define OS_TRACE_CLEARPENDINGINTERRUPT_ENTRY(IsrId)
#endif

#ifndef OS_TRACE_CLEARPENDINGINTERRUPT_EXIT
#define OS_TRACE_CLEARPENDINGINTERRUPT_EXIT_P(r,IsrId)
#else
#ifdef TRACE_EXIT_WITH_PARAMS
#define OS_TRACE_CLEARPENDINGINTERRUPT_EXIT_P(r,IsrId) OS_TRACE_CLEARPENDINGINTERRUPT_EXIT(r,IsrId)
#else
#define OS_TRACE_CLEARPENDINGINTERRUPT_EXIT_P(r,IsrId) OS_TRACE_CLEARPENDINGINTERRUPT_EXIT()
#endif
#endif
