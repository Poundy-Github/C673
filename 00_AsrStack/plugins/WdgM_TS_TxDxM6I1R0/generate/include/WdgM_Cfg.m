...
[!VAR "WdgMGetAllExpiredSEIDs" = "node:exists(WdgMGeneral/WdgMGetAllExpiredSEIDs) and WdgMGeneral/WdgMGetAllExpiredSEIDs = 'true'"!]
...
[!LOOP "as:modconf('WdgM')[1]/WdgMConfigSet[1]/*/WdgMMode/*/WdgMTrigger/*"!]
  [!IF "(node:exists(as:ref(WdgMTriggerWatchdogRef)/WdgMMulticoreWdgEnable) and (node:value(as:ref(WdgMTriggerWatchdogRef)/WdgMMulticoreWdgEnable) = 'true')) or node:exists(as:ref(WdgMTriggerWatchdogRef)/WdgMMulticoreWdgCoreId)"!]
