...
#if (ETH_17_GETHMAC_SW_MINOR_VERSION != 0U)
  #error "ETH_17_GETHMAC_SW_MINOR_VERSION does not match. "
#endif

#if (ETH_17_GETHMAC_SW_PATCH_VERSION != 1U)
...
*/
#if(ETH_17_GETHMAC_DEM_ENABLED == ETH_17_GETHMAC_ENABLE_DEM_REPORT)
...
[/cover] */
...
#endif /* End of ETH_17_GETHMAC_DEV_ERROR_DETECT */
  {
    ...
    *(Eth_17_GEthMac_CoreInitStatus[CoreId]) =
      ...
      if(RegVal != (uint32) ETH_17_GETHMAC_MOD_ENABLE)
      {
                                            ...
                                            ETH_17_GETHMAC_DISABLE_DEM_REPORT)
        {
          /* [cover parentID={E0D09020-C4AF-480d-96F2-7DE34E753878}]
             Report DEM (Hardware Access failure) as DEM_EVENT_STATUS_PREFAILED
             [/cover] */
          /*DEM should be reported only if DEM has been enabled  */
          Dem_ReportErrorStatus(EthLocalCntrlCfgPtr->EthDemAccess, \
      ...
      else
      {
                                          ...
                                          ETH_17_GETHMAC_DISABLE_DEM_REPORT)
        {
          /* [cover parentID={F0DA4CD1-932A-4dbe-A1D9-216F05A4DACC}]
             Report DEM (Hardware Access failure) as DEM_EVENT_STATUS_PREPASSED
             [/cover] */
          Dem_ReportErrorStatus(EthLocalCntrlCfgPtr->EthDemAccess,
    ...
    /* Set Core status to INITIALIZED if no DEM is reported */
    ...
    else
    {
                                       ...
                                       == ETH_17_GETHMAC_CNTRL_NOT_INITIALIZED)
      {
        ...
        /*Info:Any error during Init Stage-2, will cause to raise
         Hardware Access failure DEM error from called function*/
...
void Eth_17_GEthMac_MainFunction(void)
{
                                        ...
                                        (uint32)ETH_17_GETHMAC_CORE_INIT)
  {
    ...
    Report to DEM for Statistics Counter values
    [/cover] */
                      ...
                      Eth_17_GEthMac_CoreCntrlConfigType* const EthCntrlCfgPtr)
{
  ...
  /* If Kernal Reset is failed due to hardware access failure, RetValue
    will be E_NOT_OK and Hardware Access failure DEM will be reported from
    called function*/
  ...
  if (RetValue == E_OK)
  {
    ...
    DEM will be reported from called function */
    if(RetValue == E_OK)
    {
    ...
    Hardware Access failure DEM will be reported from called function.
    Hence no action needed here.
    [/cover] */
  }
}
                                                          ...
                                                          const EthCntrlCfgPtr)
{
  ...
  also Hardware Access failure DEM will be reported from called function */
...
#endif
  {
    ...
    /* Ethernet controller is successfully initialized Report Pass to DEM*/
    /* [cover parentID={4FC52A3F-5428-436d-8D5F-9C7055CA40D9}]
    Report Pre Pass to DEM for all DEM Errors
    [/cover] */
    /* Report all DEM as prepass (except ETH_E_ACCESS) */
                              ...
                              const Eth_RateRatioType* const rateRatioPtr)
{
  ...
  { /* [cover parentID={7E4D7111-0C48-42d1-AEEE-228908F1AEA4}][/cover] */
                                                                         ...
                                                                         FALSE)
    {
      ...
      [/cover] */
      if (IngressTimeStampDelta != (float64)0.0)
      {
        ...
        [/cover] */
        if(FreqScaleFactor <= (float64)0.0)
        {
...
**                                                                   (void)   **
**                                                                            **
** Description      : Raise DEM for Statistics Counter values                 **
**                                                                            **
** [/cover]                                                                   **
**                                                                            **
** Service ID       : NA                                                      **
                                                               ...
                                                               ControllerIdx++)
  {
    ...
    if(TotalOverMissCnt > ETH_17_GETHMAC_ZERO)
    {
                                             ...
                                             ETH_17_GETHMAC_DISABLE_DEM_REPORT)
      {
        ...
        [/cover] */
        Dem_ReportErrorStatus(EthLocalCntrlCfgPtr->EthDemFramesLost, \
                                                 DEM_EVENT_STATUS_PREFAILED);
      }
    }
                              ...
                              CRCErrorFrameCounter.Count > ETH_17_GETHMAC_ZERO)
    {
      if(EthLocalCntrlCfgPtr->EthDemCRC != ETH_17_GETHMAC_DISABLE_DEM_REPORT)
      {
        ...
        [/cover] */
        Dem_ReportErrorStatus(EthLocalCntrlCfgPtr->EthDemCRC, \
                                           DEM_EVENT_STATUS_PREFAILED);
        EthLocalCoreStatusPtr->EthStatisticsCounters.CRCErrorFrameCounter.\
                             ...
                             UnderSizeFrameCounter.Count > ETH_17_GETHMAC_ZERO)
    {
                                             ...
                                             ETH_17_GETHMAC_DISABLE_DEM_REPORT)
      {
        ...
        [/cover] */
        Dem_ReportErrorStatus(EthLocalCntrlCfgPtr->EthDemUndersize, \
                                              DEM_EVENT_STATUS_PREFAILED);
        EthLocalCoreStatusPtr->EthStatisticsCounters.UnderSizeFrameCounter.\
        DemReportedCount = EthLocalCoreStatusPtr->EthStatisticsCounters.\
                                                   ...
                                                   Count > ETH_17_GETHMAC_ZERO)
    {
                                             ...
                                             ETH_17_GETHMAC_DISABLE_DEM_REPORT)
      {
        ...
        [/cover] */
        Dem_ReportErrorStatus(EthLocalCntrlCfgPtr->EthDemOversize, \
                                              DEM_EVENT_STATUS_PREFAILED);
        EthLocalCoreStatusPtr->EthStatisticsCounters.OverSizeFrameCounter.\
        DemReportedCount = EthLocalCoreStatusPtr->EthStatisticsCounters.\
                        ...
                        AlignmentErrorFrameCounter.Count > ETH_17_GETHMAC_ZERO)
    {
                                             ...
                                             ETH_17_GETHMAC_DISABLE_DEM_REPORT)
      {
        ...
        [/cover] */
        Dem_ReportErrorStatus(EthLocalCntrlCfgPtr->EthDemAlignment, \
                                                  DEM_EVENT_STATUS_PREFAILED);
        EthLocalCoreStatusPtr->EthStatisticsCounters.\
...
**                                                                            **
** Description      : Raise DEM for Half Duplex Statistics Counter values     **
**                                                                            **
** [/cover]                                                                   **
**                                                                            **
** Service ID       : NA                                                      **
                  ...
                  ,Eth_17_GEthMac_CntrlStatusType * const EthLocalCoreStatusPtr)
{
    ...
    If Single collision count > 0 and DEM is enabled
    [/cover] */
                                                   ...
                                                   Count > ETH_17_GETHMAC_ZERO)
    {
                                        ...
                                        ETH_17_GETHMAC_DISABLE_DEM_REPORT)
      {
        ...
        [/cover] */
        Dem_ReportErrorStatus(EthCntrlCfgPtr->EthDemSingleCollision, \
                                                 DEM_EVENT_STATUS_PREFAILED);
        EthLocalCoreStatusPtr->EthStatisticsCounters.SingleCollisionCounter.\
        DemReportedCount = EthLocalCoreStatusPtr->EthStatisticsCounters.\
        SingleCollisionCounter.DemReportedCount + \
    ...
    Multiple collision count > 0 and DEM is enabled
    [/cover] */
                          ...
                          MultipleCollisionCounter.Count > ETH_17_GETHMAC_ZERO)
    {
                                         ...
                                         ETH_17_GETHMAC_DISABLE_DEM_REPORT)
      {
        ...
        [/cover] */
        Dem_ReportErrorStatus(EthCntrlCfgPtr->EthDemMultipleCollision, \
                                                DEM_EVENT_STATUS_PREFAILED);
        EthLocalCoreStatusPtr->EthStatisticsCounters.\
        MultipleCollisionCounter.DemReportedCount = \
        EthLocalCoreStatusPtr->EthStatisticsCounters.MultipleCollisionCounter.\
    ...
    Late collision count > 0 and DEM is enabled
    [/cover] */
                                                   ...
                                                   Count > ETH_17_GETHMAC_ZERO)
    {
                                      ...
                                      ETH_17_GETHMAC_DISABLE_DEM_REPORT)
      {
        ...
        [/cover] */
        Dem_ReportErrorStatus(EthCntrlCfgPtr->EthDemLateCollision, \
                                              DEM_EVENT_STATUS_PREFAILED);
        EthLocalCoreStatusPtr->EthStatisticsCounters.LateCollisionCounter.\
        DemReportedCount = EthLocalCoreStatusPtr->EthStatisticsCounters.\
...
**                  Eth_17_GEthMac_CoreCntrlConfigType* const EthCntrlCfgPtr) **
**                                                                            **
** Description      : Report all DEM errors as Pass to DEM module             **
**                                                                            **
** [/cover]                                                                   **
**                                                                            **
** Service ID       : NA                                                      **
                      ...
                      Eth_17_GEthMac_CoreCntrlConfigType* const EthCntrlCfgPtr)
{
  ...
  If DEM id for corresponding DEM is enabled
  [/cover] */
  /* [cover parentID={74AB6821-C064-4141-84B3-30CAED0B51FE}]
  Report DEM error as DEM_EVENT_STATUS_PREPASSED ( except for ETH_E_ACCESS)
  [/cover] */
  if(EthCntrlCfgPtr->EthDemFramesLost != ETH_17_GETHMAC_DISABLE_DEM_REPORT)
  {
    Dem_ReportErrorStatus(EthCntrlCfgPtr->EthDemFramesLost, \
                                             DEM_EVENT_STATUS_PREPASSED);
  }

  if(EthCntrlCfgPtr->EthDemCRC != ETH_17_GETHMAC_DISABLE_DEM_REPORT)
  {
    Dem_ReportErrorStatus(EthCntrlCfgPtr->EthDemCRC, \
                                            DEM_EVENT_STATUS_PREPASSED);
  }

  if(EthCntrlCfgPtr->EthDemUndersize != ETH_17_GETHMAC_DISABLE_DEM_REPORT)
  {
    Dem_ReportErrorStatus(EthCntrlCfgPtr->EthDemUndersize, \
                                            DEM_EVENT_STATUS_PREPASSED);
  }

  if(EthCntrlCfgPtr->EthDemOversize != ETH_17_GETHMAC_DISABLE_DEM_REPORT)
  {
    Dem_ReportErrorStatus(EthCntrlCfgPtr->EthDemOversize, \
                                           DEM_EVENT_STATUS_PREPASSED);
  }

  if(EthCntrlCfgPtr->EthDemAlignment != ETH_17_GETHMAC_DISABLE_DEM_REPORT)
  {
    Dem_ReportErrorStatus(EthCntrlCfgPtr->EthDemAlignment, \
                                         DEM_EVENT_STATUS_PREPASSED);
  }
  /* [cover parentID={F8ADF8B9-C0AD-48d2-B927-C76B45107C1C}]
  If DEM id for corresponding DEM of Half Duplex  is enabled
  [/cover] */
  /* [cover parentID={EBE38236-8D9E-40dd-B421-59C776040A98}]
  Report corresponding DEM error as DEM_EVENT_STATUS_PREPASSED
  [/cover] */
  if(EthCntrlCfgPtr->EthDemSingleCollision != \
                                         ETH_17_GETHMAC_DISABLE_DEM_REPORT)
  {
...
**                                                          EthDemAccess)     **
**                                                                            **
** Description      : Report Hardware Access DEM error if timeout happened    **
**                                                                            **
** [/cover]                                                                   **
**                                                                            **
** Service ID       : NA                                                      **
...
**                    EthDemAccess - Dem Enable/Disable Status                **
**                                                                            **
** Parameters (out) : None                                                    **
**                                                                            **
                                                                  ...
                                                                  EthDemAccess)
{
  ...
  Detect timeout condition and report DEM
  [/cover] */
  /* Check if timeout happened */
  if(Timeout == TRUE)
  {
    ...
    if(EthDemAccess != ETH_17_GETHMAC_DISABLE_DEM_REPORT)
    {
      ...
      [/cover] */
      Dem_ReportErrorStatus(EthDemAccess, \
                                         DEM_EVENT_STATUS_PREFAILED);
    }
  }
return RetVal;
