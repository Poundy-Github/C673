...
#ifndef DBG_DEM_GETNUMBERJ1939DTCS_ENTRY
/** \brief Entry point of function Dem_GetNumberJ1939DTCs() */
#define DBG_DEM_GETNUMBERJ1939DTCS_ENTRY(a, b, c)
#endif

#ifndef DBG_DEM_GETNUMBERJ1939DTCS_EXIT
/** \brief Exit point of function Dem_GetNumberJ1939DTCs() */
#define DBG_DEM_GETNUMBERJ1939DTCS_EXIT(a, b, c, d)
#endif
...
#ifndef DBG_DEM_NOTIFYUSEDSTORAGEORDERID_ENTRY
/** \brief Entry point of function Dem_NotifyUsedStorageOrderId() */
#define DBG_DEM_NOTIFYUSEDSTORAGEORDERID_ENTRY(a, b)
#endif

#ifndef DBG_DEM_NOTIFYUSEDSTORAGEORDERID_EXIT
/** \brief Exit point of function Dem_NotifyUsedStorageOrderId() */
#define DBG_DEM_NOTIFYUSEDSTORAGEORDERID_EXIT(a, b)
#endif

#ifndef DBG_DEM_GETNEXTSTORAGEORDERID_ENTRY
/** \brief Entry point of function Dem_GetNextStorageOrderId() */
#define DBG_DEM_GETNEXTSTORAGEORDERID_ENTRY(a, b)
#endif

#ifndef DBG_DEM_GETNEXTSTORAGEORDERID_EXIT
/** \brief Exit point of function Dem_GetNextStorageOrderId() */
#define DBG_DEM_GETNEXTSTORAGEORDERID_EXIT(a, b)
#endif

#ifndef DBG_DEM_RESTOREDTCSTATUS_ENTRY
/** \brief Entry point of function Dem_RestoreDTCStatus() */
#define DBG_DEM_RESTOREDTCSTATUS_ENTRY(a, b)
#endif

#ifndef DBG_DEM_RESTOREDTCSTATUS_EXIT
/** \brief Exit point of function Dem_RestoreDTCStatus() */
#define DBG_DEM_RESTOREDTCSTATUS_EXIT(a, b)
#endif

#ifndef DBG_DEM_STOREDTCSTATUS_ENTRY
/** \brief Entry point of function Dem_StoreDTCStatus() */
#define DBG_DEM_STOREDTCSTATUS_ENTRY(a, b)
#endif

#ifndef DBG_DEM_STOREDTCSTATUS_EXIT
/** \brief Exit point of function Dem_StoreDTCStatus() */
#define DBG_DEM_STOREDTCSTATUS_EXIT(a, b)
#endif

#ifndef DBG_DEM_RESTOREINTERMEDIATEDTCSTATUS_ENTRY
/** \brief Entry point of function Dem_RestoreIntermediateDTCstatus() */
#define DBG_DEM_RESTOREINTERMEDIATEDTCSTATUS_ENTRY(a, b, c, d)
#endif

#ifndef DBG_DEM_RESTOREINTERMEDIATEDTCSTATUS_EXIT
/** \brief Exit point of function Dem_RestoreIntermediateDTCstatus() */
#define DBG_DEM_RESTOREINTERMEDIATEDTCSTATUS_EXIT(a, b, c, d, e)
#endif

#ifndef DBG_DEM_CLEARSTATUSBITSTORAGETESTFAILED_ENTRY
/** \brief Entry point of function Dem_ClearStatusBitStorageTestFailed() */
#define DBG_DEM_CLEARSTATUSBITSTORAGETESTFAILED_ENTRY()
#endif

#ifndef DBG_DEM_CLEARSTATUSBITSTORAGETESTFAILED_EXIT
/** \brief Exit point of function Dem_ClearStatusBitStorageTestFailed() */
#define DBG_DEM_CLEARSTATUSBITSTORAGETESTFAILED_EXIT()
#endif

#ifndef DBG_DEM_RESTOREDERIVEDEVENTSTATUS_ENTRY
/** \brief Entry point of function Dem_RestoreDerivedEventStatus() */
#define DBG_DEM_RESTOREDERIVEDEVENTSTATUS_ENTRY(a, b, c)
#endif

#ifndef DBG_DEM_RESTOREDERIVEDEVENTSTATUS_EXIT
/** \brief Exit point of function Dem_RestoreDerivedEventStatus() */
#define DBG_DEM_RESTOREDERIVEDEVENTSTATUS_EXIT(a, b, c)
#endif
...
#define DBG_DEM_PROCESSEVENTSTATUSUPDATE_ENTRY(a, b, c, d, e)
#endif

#ifndef DBG_DEM_PROCESSEVENTSTATUSUPDATE_EXIT
/** \brief Exit point of function Dem_ProcessEventStatusUpdate() */
#define DBG_DEM_PROCESSEVENTSTATUSUPDATE_EXIT(a, b, c, d, e)
#endif
...
#define DBG_DEM_PROCESSEVENT_ENTRY(a, b, c, d, e, f)
#endif

#ifndef DBG_DEM_PROCESSEVENT_EXIT
/** \brief Exit point of function Dem_ProcessEvent() */
#define DBG_DEM_PROCESSEVENT_EXIT(a, b, c, d, e, f)
#endif
...
#define DBG_DEM_PROCESSEVENTENTRY_EXIT(a, b, c, d)
#endif
...
/** \brief Exit point of function Dem_IsEventAdvancedPassive() */
...
#define DBG_DEM_STOREFF_ENTRY(a, b, c, d)
#endif
...
#define DBG_DEM_STOREDEVFFS_EXIT(a, b, c)
#endif
...
#define DBG_DEM_PERMANENTMEMORYREMOVEENTRY_EXIT(a)
#endif
...
#define DBG_DEM_UPDATEEVENTSTATUSONQUALIFICATION_ENTRY(a, b, c, d)
#endif

#ifndef DBG_DEM_UPDATEEVENTSTATUSONQUALIFICATION_EXIT
/** \brief Exit point of function Dem_UpdateEventStatusOnQualification() */
#define DBG_DEM_UPDATEEVENTSTATUSONQUALIFICATION_EXIT(a, b, c, d)
#endif
...
#ifndef DBG_DEM_UPDATEPID01VALUE_ENTRY
/** \brief Entry point of function Dem_UpdatePID01value() */
#define DBG_DEM_UPDATEPID01VALUE_ENTRY(a, b, c, d)
#endif

#ifndef DBG_DEM_UPDATEPID01VALUE_EXIT
/** \brief Exit point of function Dem_UpdatePID01value() */
#define DBG_DEM_UPDATEPID01VALUE_EXIT(a, b, c, d, e)
#endif
...
#define DBG_DEM_STOREJ1939FF_ENTRY(a,b,c)
#endif
...
#define DBG_DEM_COLLECTJ1939FFINFO_ENTRY(a,b,c,d)
#endif

#ifndef DBG_DEM_COLLECTJ1939FFINFO_EXIT
/** \brief Exit point of function Dem_CollectJ1939FFInfo() */
#define DBG_DEM_COLLECTJ1939FFINFO_EXIT(a,b,c,d,e)
#endif
...
#ifndef DBG_DEM_INITJ1939FREEZEFRAMEFILTER_ENTRY
/** \brief Entry point of function Dem_InitJ1939FreezeFrameFilter() */
#define DBG_DEM_INITJ1939FREEZEFRAMEFILTER_ENTRY()
#endif

#ifndef DBG_INITJ1939FREEZEFRAMEFILTER_EXIT
/** \brief Exit point of function Dem_InitJ1939FreezeFrameFilter() */
#define DBG_INITJ1939FREEZEFRAMEFILTER_EXIT()
#endif

#ifndef DBG_DEM_INITJ1939DTCFILTER_ENTRY
/** \brief Entry point of function Dem_InitJ1939DTCFilter() */
#define DBG_DEM_INITJ1939DTCFILTER_ENTRY()
#endif

#ifndef DBG_INITJ1939DTCFILTER_EXIT
/** \brief Exit point of function Dem_InitJ1939DTCFilter() */
#define DBG_INITJ1939DTCFILTER_EXIT()
#endif

#ifndef DBG_DEM_J1939DCMGETNEXTSPNINFREEZEFRAME_ENTRY
/** \brief Entry point of function Dem_J1939DcmGetNextSPNInFreezeFrame() */
#define DBG_DEM_J1939DCMGETNEXTSPNINFREEZEFRAME_ENTRY(a,b)
#endif

#ifndef DBG_DEM_J1939DCMGETNEXTSPNINFREEZEFRAME_EXIT
/** \brief Exit point of function Dem_J1939DcmGetNextSPNInFreezeFrame() */
#define DBG_DEM_J1939DCMGETNEXTSPNINFREEZEFRAME_EXIT(a,b,c)
#endif

#ifndef DBG_DEM_J1939DCMFIRSTDTCWITHLAMPSTATUS_ENTRY
/** \brief Entry point of function Dem_J1939DcmFirstDTCwithLampStatus() */
#define DBG_DEM_J1939DCMFIRSTDTCWITHLAMPSTATUS_ENTRY(a)
#endif

#ifndef DBG_DEM_J1939DCMFIRSTDTCWITHLAMPSTATUS_EXIT
/** \brief Exit point of function Dem_J1939DcmFirstDTCwithLampStatus() */
#define DBG_DEM_J1939DCMFIRSTDTCWITHLAMPSTATUS_EXIT(a)
#endif

#ifndef DBG_DEM_J1939DCMGETNEXTDTCWITHLAMPSTATUS_ENTRY
/** \brief Entry point of function Dem_J1939DcmGetNextDTCwithLampStatus() */
#define DBG_DEM_J1939DCMGETNEXTDTCWITHLAMPSTATUS_ENTRY(a,b,c)
#endif

#ifndef DBG_DEM_J1939DCMGETNEXTDTCWITHLAMPSTATUS_EXIT
/** \brief Exit point of function Dem_J1939DcmGetNextDTCwithLampStatus() */
#define DBG_DEM_J1939DCMGETNEXTDTCWITHLAMPSTATUS_EXIT(a,b,c,d)
#endif
...
#ifndef DBG_DEM_INTERNALGETJ1939DTC_ENTRY
/** \brief Entry point of function Dem_InternalGetJ1939DTC() */
#define DBG_DEM_INTERNALGETJ1939DTC_ENTRY(a)
#endif

#ifndef DBG_DEM_INTERNALGETJ1939DTC_EXIT
/** \brief Exit point of function Dem_InternalGetJ1939DTC() */
#define DBG_DEM_INTERNALGETJ1939DTC_EXIT(a, b)
#endif

#ifndef DBG_DEM_INTERNALGETJ1939NODE_ENTRY
/** \brief Entry point of function Dem_InternalGetJ1939Node() */
#define DBG_DEM_INTERNALGETJ1939NODE_ENTRY(a)
#endif

#ifndef DBG_DEM_INTERNALGETJ1939NODE_EXIT
/** \brief Exit point of function Dem_InternalGetJ1939Node() */
#define DBG_DEM_INTERNALGETJ1939NODE_EXIT(a, b)
#endif
