...
# The Os_configuration_dummies.c file is not needed in a proper library build. However, the Os_src_FILES list
# also builds a library, so adding it here is harmless.
# If the make env. ever changes back to the original intention that the OS configuration is not in a library,
# then the dummies file must be removed from this list.
Os_src_FILES += $(AutosarOS_CORE_PATH)\src\Os_configuration_dummies.c
...
ifeq ($(OS_TOOLCHAIN),multi)
OS_TOOLCHAIN := ghs
endif

ifeq ($(OS_TOOLCHAIN),gcc)
OS_TOOLCHAIN := gnu
endif

ifeq ($(OS_TOOLCHAIN),vc)
OS_TOOLCHAIN := vc
endif

ifeq ($(OS_TOOLCHAIN),gcc4)
OS_TOOLCHAIN := gnu
endif

ifeq ($(OS_TOOLCHAIN),bcgcc)
OS_TOOLCHAIN := gnu
endif

ifeq ($(OS_TOOLCHAIN),mgcc45)
OS_TOOLCHAIN := gnu
endif

ifeq ($(OS_TOOLCHAIN),mgcc62)
OS_TOOLCHAIN := gnu
endif

ifeq ($(OS_TOOLCHAIN),linaro)
OS_TOOLCHAIN := gnu
endif

ifeq ($(OS_TOOLCHAIN),dcc)
OS_TOOLCHAIN := diab
endif
...
ifeq ($(OS_TOOLCHAIN),cosmic)
OS_TOOLCHAIN := cosmic
endif

ifeq ($(OS_TOOLCHAIN),taskingvx)
...
# Constants to be used in file names
...
$(OS_KERNEL_LIB_NAME)_FILES += \
	$(addprefix $(AutosarOS_LIB_SRC_PATH)\kernel\,		\
		...
		$(OS_KERN_PREFIX)wrapnoop.$(CC_FILE_SUFFIX)					\
	)
endif
...
$(OS_KERNEL_LIB_NAME)_FILES += \
	$(addprefix $(AutosarOS_LIB_SRC_PATH)\kernel\,		\
		mka$(OS_HYPHEN)getactiveapplicationmode.$(CC_FILE_SUFFIX)				\
		mka$(OS_HYPHEN)getalarmbase.$(CC_FILE_SUFFIX)							\
		mka$(OS_HYPHEN)getelapsedcountervalue.$(CC_FILE_SUFFIX)				\
		mka$(OS_HYPHEN)getscheduletablestatus.$(CC_FILE_SUFFIX)				\
		mki$(OS_HYPHEN)getappmode.$(CC_FILE_SUFFIX)							\
		mki$(OS_HYPHEN)reporterror.$(CC_FILE_SUFFIX)							\
		mkw$(OS_HYPHEN)getalarm.$(CC_FILE_SUFFIX)								\
		mkw$(OS_HYPHEN)getcountervalue.$(CC_FILE_SUFFIX)						\
		mkw$(OS_HYPHEN)startos.$(CC_FILE_SUFFIX)								\
		mkw$(OS_HYPHEN)setrelalarm.$(CC_FILE_SUFFIX)							\
		mkw$(OS_HYPHEN)setabsalarm.$(CC_FILE_SUFFIX)							\
		mkw$(OS_HYPHEN)cancelalarm.$(CC_FILE_SUFFIX)							\
		mkw$(OS_HYPHEN)nextscheduletable.$(CC_FILE_SUFFIX)						\
		mkw$(OS_HYPHEN)setscheduletableasync.$(CC_FILE_SUFFIX)					\
		mkw$(OS_HYPHEN)startscheduletable.$(CC_FILE_SUFFIX)					\
		mkw$(OS_HYPHEN)stopscheduletable.$(CC_FILE_SUFFIX)						\
		mkw$(OS_HYPHEN)syncscheduletable.$(CC_FILE_SUFFIX)						\
		mkw$(OS_HYPHEN)terminateapplication.$(CC_FILE_SUFFIX)					\
		mkw$(OS_HYPHEN)updatecounter.$(CC_FILE_SUFFIX)							\
		mkw$(OS_HYPHEN)incrementcounter.$(CC_FILE_SUFFIX)						\
		mkw$(OS_HYPHEN)startscheduletablesynchron.$(CC_FILE_SUFFIX)			\
	)
...
$(OS_KERNEL_LIB_NAME)_FILES += \
	$(addprefix $(AutosarOS_LIB_SRC_PATH)\kernel\,			\
		...
		$(OS_KERN_PREFIX)sendactivatetaskasyn.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)recvactivatetask.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)recvactivatetaskasyn.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)recvunknowncall.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)recvsetevent.$(CC_FILE_SUFFIX)		\
		$(OS_KERN_PREFIX)recvseteventasyn.$(CC_FILE_SUFFIX)		\
		$(OS_KERN_PREFIX)sendsetevent.$(CC_FILE_SUFFIX)		\
		$(OS_KERN_PREFIX)sendseteventasyn.$(CC_FILE_SUFFIX)		\
		...
		$(OS_KERN_PREFIX)multidisableinterruptsource.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)multiclearpendinginterrupt.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)multienableinterruptsource.$(CC_FILE_SUFFIX)	\
		...
		$(OS_KERN_PREFIX)recvclearpendinginterrupt.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)sendclearpendinginterrupt.$(CC_FILE_SUFFIX)	\
		...
		$(OS_KERN_PREFIX)disableallinterruptsources.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)recvshutdowncore.$(CC_FILE_SUFFIX)				\
		$(OS_KERN_PREFIX)recvcontrolidle.$(CC_FILE_SUFFIX)				\
		$(OS_KERN_PREFIX)sendcontrolidle.$(CC_FILE_SUFFIX)				\
		$(OS_KERN_PREFIX)initautosarspinlocks.$(CC_FILE_SUFFIX)		\
		$(OS_KERN_PREFIX)multiactivatetask.$(CC_FILE_SUFFIX)		\
		$(OS_KERN_PREFIX)multiactivatetaskasyn.$(CC_FILE_SUFFIX)		\
		...
		$(OS_KERN_PREFIX)multiseteventasyn.$(CC_FILE_SUFFIX)		\
...
$(OS_KERNEL_LIB_NAME)_FILES += \
	$(addprefix $(AutosarOS_LIB_SRC_PATH)\kernel\,		\
		...
		$(OS_KERN_PREFIX)activatetaskasyn.$(CC_FILE_SUFFIX)				\
		...
		$(OS_KERN_PREFIX)clearpendinginterrupt.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)clearevent.$(CC_FILE_SUFFIX)				\
		$(OS_KERN_PREFIX)controlidle.$(CC_FILE_SUFFIX)				\
		...
		$(OS_KERN_PREFIX)localclearpendinginterrupt.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)localdisableinterruptsource.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)localenableinterruptsource.$(CC_FILE_SUFFIX)	\
		$(OS_KERN_PREFIX)docontrolidle.$(CC_FILE_SUFFIX)			\
		...
		$(OS_KERN_PREFIX)getcurrentapplicationid.$(CC_FILE_SUFFIX)			\
		$(OS_KERN_PREFIX)dogetcurrentapplicationid.$(CC_FILE_SUFFIX)		\
		...
		$(OS_KERN_PREFIX)checkratemonitor.$(CC_FILE_SUFFIX)			\
		...
		$(OS_KERN_PREFIX)seteventasyn.$(CC_FILE_SUFFIX)					\
...
$(OS_USER_LIB_NAME)_FILES += \
	$(addprefix $(AutosarOS_LIB_SRC_PATH)\user\,		\
		...
		$(OS_LIB_PREFIX)salsa$(OS_HYPHEN)getstackusage.$(CC_FILE_SUFFIX)		\
		$(OS_LIB_PREFIX)salsa$(OS_HYPHEN)getsystemstackusage.$(CC_FILE_SUFFIX)	\
	)
...
OS_ULIB_OBJS_ARCH_COMMON = \
	$(addprefix $(AutosarOS_LIB_SRC_PATH)\$(OS_ARCH)\,					\
		...
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)activatetaskasyn.$(ASM_FILE_SUFFIX)				\
		...
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)clearpendinginterrupt.$(ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)clearevent.$(ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)controlidle.$(ASM_FILE_SUFFIX)				\
		...
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getcurrentapplicationid.$(ASM_FILE_SUFFIX)			\
		...
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)seteventasyn.$(ASM_FILE_SUFFIX)					\
...
$(OS_ERROR_LIB_NAME)_FILES = \
	$(addprefix $(AutosarOS_LIB_SRC_PATH)\error\,					\
		...
		$(OS_ERROR_LIB_SRC)ActivateTaskAsyn.$(CC_FILE_SUFFIX)			\
		...
		$(OS_ERROR_LIB_SRC)ClearPendingInterrupt.$(CC_FILE_SUFFIX)				\
		$(OS_ERROR_LIB_SRC)ControlIdle.$(CC_FILE_SUFFIX)			\
		...
		$(OS_ERROR_LIB_SRC)GetCurrentApplicationId.$(CC_FILE_SUFFIX)		\
		...
		$(OS_ERROR_LIB_SRC)SetEventAsyn.$(CC_FILE_SUFFIX)				\
