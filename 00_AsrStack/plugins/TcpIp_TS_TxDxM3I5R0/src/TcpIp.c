...
/* patch version check */
#if (TCPIP_SW_PATCH_VERSION < 14U)
#error TCPIP_SW_PATCH_VERSION wrong (< 14U)
#endif
...
)
{
...
#endif /* TCPIP_DEV_ERROR_DETECT */
  {
    ...
    switch(MeasurementIdx)
    {
      ...
      {
        TcpIp_Tcp_GetAndResetCounter(MeasurementIdx, MeasurementResetNeeded, MeasurementDataPtr);
        RetVal = E_OK;
        break;
      }
#endif /* TCPIP_TCP_ENABLED == STD_ON */
      ...
      {
        TcpIp_Udp_GetAndResetCounter(MeasurementIdx, MeasurementResetNeeded, MeasurementDataPtr);
        RetVal = E_OK;
        break;
      }
      ...
      case TCPIP_MEAS_ALL:
      {
        ...
        {
#if (TCPIP_TCP_ENABLED == STD_ON)
          TcpIp_Tcp_GetAndResetCounter(MeasurementIdx, TRUE, NULL_PTR);
#endif /* TCPIP_TCP_ENABLED == STD_ON */
#if (TCPIP_UDP_ENABLED == STD_ON)
          TcpIp_Udp_GetAndResetCounter(MeasurementIdx, TRUE, NULL_PTR);
#endif /* TCPIP_UDP_ENABLED == STD_ON */
#if (TCPIP_IPV4_ENABLED == STD_ON)
