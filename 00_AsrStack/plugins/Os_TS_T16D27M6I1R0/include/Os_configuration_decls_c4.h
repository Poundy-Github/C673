 ...
 *
 * $Id: Os_configuration_decls_c4.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
...
#if (4 == OS_SHAREDHWCOUNTERTIMESTAMP_COREID)
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE4 1
#else
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE4 0
#endif

#define OS_TOTALALARMS_CORE4 (OS_NALARMS_CORE4 + OS_NSCHEDULES_CORE4 + OS_NSHAREDHWCOUNTERTIMESTAMP_CORE4)
