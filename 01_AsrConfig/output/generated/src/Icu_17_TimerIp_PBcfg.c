...
*******************************************************************************/
/******************************************************************************/
extern void Icu_J3_Ack_Notification (void);
extern void Icu_J3_Rdy_Notification (void);
/******************************************************************************/
/*******************************************************************************
...
static const Icu_17_TimerIp_ChannelConfigType Icu_17_TimerIp_kChannelConfigCore_0[ ] =
{
  {
    /* ICU Channel 0 */
    &Icu_J3_Ack_Notification,/*Notification-function name*/
    ...
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      ...
      (uint8)ICU_17_TIMERIP_FALLING_EDGE,/*Default Start Edge */
      ...
      ICU_GTM_INTERRUPT_PULSE_NOTIFY_MODE,/* TIM interrupt mode/ CCU6 Int Node */
      ICU_GTM_CONFIGURABLE_CLOCK_0, /* Channel Clock Select */
      /* CTRL data */
      ((ICU_GTM_TIM_MODE_TIEM << IFX_GTM_TIM_CH_CTRL_TIM_MODE_OFF)|ICU_GTM_TIM_ENABLE_CHANNEL|
      (ICU_ISL_DSL_FALLING)|
  ...
  {
    /* ICU Channel 1 */
    &Icu_J3_Rdy_Notification,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_SIGNAL_EDGE_DETECT,/*Measurement Mode*/
  ...
  },
  {
    ...
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      ...
      ((ICU_INPUT_OF_CURRENT_TIM_CHANNEL&IFX_GTM_TIM_CH_CTRL_CICTRL_MSK)<<IFX_GTM_TIM_CH_CTRL_CICTRL_OFF)|
      ((ICU_GTM_CONFIGURABLE_CLOCK_1&IFX_GTM_TIM_CH_CTRL_CLK_SEL_MSK)<<IFX_GTM_TIM_CH_CTRL_CLK_SEL_OFF)|
      0U|
      ((ICU_GTM_CONFIGURABLE_CLOCK_0&IFX_GTM_TIM_CH_CTRL_FLT_CNT_FRQ_MSK)<<IFX_GTM_TIM_CH_CTRL_FLT_CNT_FRQ_OFF)|
      ((ICU_IMMEDIATE_EDGE_PROPAGATION_MODE&IFX_GTM_TIM_CH_CTRL_FLT_MODE_RE_MSK)<<IFX_GTM_TIM_CH_CTRL_FLT_MODE_RE_OFF)|
      ((ICU_IMMEDIATE_EDGE_PROPAGATION_MODE&IFX_GTM_TIM_CH_CTRL_FLT_MODE_FE_MSK)<<IFX_GTM_TIM_CH_CTRL_FLT_MODE_FE_OFF)|
