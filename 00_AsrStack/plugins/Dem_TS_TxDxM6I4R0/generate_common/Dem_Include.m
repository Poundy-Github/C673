...
[!INDENT "0"!][!//
  ...
  [!IF "(DemGeneral/DemIntermediateNvStorageOfDTCStatus = 'true')"!][!//
    ...
    [!FOR "Ctr" = "1" TO "$DemNbOfCmbDTCs"!][!//
      ...
      [!IF "node:exists(DemConfigSet/*/DemEventParameter/*[DemEventId = $EventId]/DemDTCClassRef) and as:ref(DemConfigSet/*/DemEventParameter/*[DemEventId = $EventId]/DemDTCClassRef)/DemImmediateNvStorage = 'true'"!][!//
        [!IF "(DemConfigSet/*/DemEventParameter/*[DemEventId = $EventId]/DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_PRIMARY_MEMORY')"!][!//
          [!IF "($IntermediateDTCsMaxPriSize < ($NextNode - $CurrNode))"!][!//
            [!VAR "IntermediateDTCsMaxPriSize" = "$NextNode - $CurrNode"!][!//
          [!ENDIF!][!//
        [!ELSEIF "(DemConfigSet/*/DemEventParameter/*[DemEventId = $EventId]/DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_SECONDARY_MEMORY')"!][!//
          [!IF "($IntermediateDTCsMaxSecSize < ($NextNode - $CurrNode))"!][!//
            [!VAR "IntermediateDTCsMaxSecSize" = "$NextNode - $CurrNode"!][!//
          [!ENDIF!][!//
        [!ELSEIF "(DemConfigSet/*/DemEventParameter/*[DemEventId = $EventId]/DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_MIRROR_MEMORY')"!][!//
    ...
    [!IF "$IntermediateDTCsMaxPriSize = 0"!][!//
      [!IF "((DemGeneral/DemImmediateStorageInternalEvents = 'true') and node:exists(DemConfigSet/*/DemEventParameter/*[not(node:refexists(DemDTCClassRef)) and DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_PRIMARY_MEMORY'])) or
            node:exists(DemConfigSet/*/DemEventParameter/*[node:refexists(DemDTCClassRef) and as:ref(DemDTCClassRef)/DemImmediateNvStorage = 'true' and DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_PRIMARY_MEMORY'])"!][!//
        [!VAR "IntermediateDTCsMaxPriSize" = "1"!][!//
      [!ENDIF!][!//
    [!ENDIF!][!//
    [!IF "$IntermediateDTCsMaxSecSize = 0"!][!//
      [!IF "((DemGeneral/DemImmediateStorageInternalEvents = 'true') and node:exists(DemConfigSet/*/DemEventParameter/*[not(node:refexists(DemDTCClassRef)) and DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_SECONDARY_MEMORY'])) or
            node:exists(DemConfigSet/*/DemEventParameter/*[node:refexists(DemDTCClassRef) and as:ref(DemDTCClassRef)/DemImmediateNvStorage = 'true' and DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_SECONDARY_MEMORY'])"!][!//
        [!VAR "IntermediateDTCsMaxSecSize" = "1"!][!//
      [!ENDIF!][!//
    [!ENDIF!][!//
    [!IF "$IntermediateDTCsMaxMirSize = 0"!][!//
      [!IF "((DemGeneral/DemImmediateStorageInternalEvents = 'true') and node:exists(DemConfigSet/*/DemEventParameter/*[not(node:refexists(DemDTCClassRef)) and DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_MIRROR_MEMORY'])) or
            node:exists(DemConfigSet/*/DemEventParameter/*[node:refexists(DemDTCClassRef) and as:ref(DemDTCClassRef)/DemImmediateNvStorage = 'true' and DemEventClass/DemEventDestination = 'DEM_DTC_ORIGIN_MIRROR_MEMORY'])"!][!//
