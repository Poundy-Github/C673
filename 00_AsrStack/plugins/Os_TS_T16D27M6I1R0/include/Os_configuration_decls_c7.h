 ...
 *
 * $Id: Os_configuration_decls_c7.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
...
#if (7 == OS_SHAREDHWCOUNTERTIMESTAMP_COREID)
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE7 1
#else
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE7 0
#endif

#define OS_TOTALALARMS_CORE7 (OS_NALARMS_CORE7 + OS_NSCHEDULES_CORE7 + OS_NSHAREDHWCOUNTERTIMESTAMP_CORE7)
