#ifndef SCHM_CANTPHOOK_H
#define SCHM_CANTPHOOK_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
/*
 * This file contains Rte hook declarations for the basic software module instance CanTp
 *
...
#undef SchM_Schedulable_CanTp_MainFunction_Start
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_CanTp_MainFunction_Start (void);
#else
...
#undef SchM_Schedulable_CanTp_MainFunction_Return
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_CanTp_MainFunction_Return (void);
#else
