...
#define CANTRCV_TJA1043_DEM_REPORT_SUPPORT             ([!//
[!IF "CanTrcvConfigSet/CanTrcvChannel/CanTrcvChannel_0/CanTrcvDemReportSupport = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
...
[!SELECT "node:ref($CanTrcvConfigSetName)"!][!//
  ...
  #define CANTRCV_TJA1043_MAX_CHANNEL               ((uint8)[!"num:i($ChannelCount1)"!]U)
  [!ENDINDENT!]

  [!INDENT "0"!][!//
  [!VAR "ChannelCount2" = "0"!][!//
  [!LOOP "CanTrcvChannel/*"!][!//
    [!VAR "CanTrcvChUsed" = "./CanTrcvWakeupByBusUsed "!][!//
  ...
  #define CANTRCV_TJA1043_WAKEUP_BY_BUS_USED             ([!//
  [!IF "num:i($ChannelCount2) > 0"!][!//
  STD_ON[!//
  [!ELSE!][!//
  STD_OFF[!//
  [!ENDIF!][!//
...
*/
[!INDENT "0"!][!//
[!IF "CanTrcvGeneral/CanTrcvWakeUpSupport = 'CANTRCV_TJA1043_WAKEUP_BY_POLLING'"!][!//
...
[!ELSE!][!//
#define CANTRCV_TJA1043_GENERAL_WAKE_UP_SUPPORT           (CANTRCV_TJA1043_WAKEUP_NOT_SUPPORTED)[!//
[!ENDIF!][!//
[!ENDINDENT!][!//
[!CR!][!//
...
[!INDENT "0"!][!//
[!/* [cover parentID={0CDAF36C-ECAB-47cc-8D22-8724E3AC9B12}] [/cover] */!][!//
#define CANTRCV_TJA1043_GET_VERSION_INFO             ([!//
...
[!INDENT "0"!][!//
[!/* [cover parentID={C5860D9C-F770-43b6-B87B-EC15173D816B}] [/cover] */!][!//
#define CANTRCV_TJA1043_DEV_ERROR_DETECT             ([!//
...
[!INDENT "0"!][!//
[!/* [cover parentID={C5860D9C-F770-43b6-B87B-EC15173D816B}] [/cover] */!][!//
#define CANTRCV_TJA1043_DEV_ERROR_REPORT             ([!//
[!IF "CanTrcvGeneral/CanTrcvDevErrorDetect = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
