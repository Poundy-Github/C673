/* $Header: DMC_Soc_LAT_Yaw_Rate_Offset_Compensation.c 1.18 2020/08/20 10:43:51CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_LAT_Yaw_Rate_Offset_Compensation.c
...
#include "DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_private.h"
 ...
 ***************************************************************************************************
   ...
   CALL: DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_step()
   CALL: DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_initialize(0)
   FILE: DMC_Soc_LAT_Yaw_Rate_Offset_Compensation.c
 ***************************************************************************************************
 */

/* Output and update for referenced model: 'DMC_Soc_LAT_Yaw_Rate_Offset_Compensation' */
void DMC_Soc_LAT_Yaw_Rate_Offset_Compensation(const real32_T *rt_erh2I, const
  real32_T *rt_gd42I, const int16_T *rt_cpaoI, real32_T *rt_erh2sI)
{
  real32_T rtb_;

  /* Switch: '<S2>/Switch' incorporates:
   *  Constant: '<S2>/Constant'
   *  Constant: '<S2>/Lat_min_offset_state'
   *  RelationalOperator: '<S2>/Relational Operator'
   */
  if ((*rt_cpaoI) >= Lat_min_yaw_rate_offset_state) {
    rtb_ = *rt_gd42I;
  } else {
    rtb_ = 0.0F;
  }
   ...
   */
  if ((((int32_T)Dmc_configuration_mode) & ((int32_T)32)) == ((int32_T)32)) {
  } else {
    rtb_ = 0.0F;
  }
  ...
  /* Sum: '<Root>/Sub' */
  *rt_erh2sI = (*rt_erh2I) - rtb_;

  /* DataTypeConversion: '<Root>/Data Type Conversion' */
  VEH_Yaw_Rate_Oc_dbg = (int16_T)((real32_T)floor((*rt_erh2sI) / 0.00286F));
}

/* Model initialize function */
void DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_initialize(void)
{
