...
typedef struct /* CanIf_CanControllerConfigType */ {
    ...
    VAR( uint8, TYPEDEF ) driverIndex; /* CAN driver index */
...
/** 
 ...
 channels.
 */
typedef struct /* CanIf_CanTrcvChnlConfigType */ {
    VAR( uint8, TYPEDEF ) trcvChnlId; /* transceiver channel ID */
    VAR( uint8, TYPEDEF ) trcvDrvIdx; /* driver index */
...
typedef struct /* CanIf_TxLPduConfigType */ {
    ...
    VAR( CanIf_TxBufferIndexType, TYPEDEF ) bufferIndex; /* index of Tx buffer */
    VAR( CanIf_TxBufferIndexType, TYPEDEF ) memIndex; /* index in Tx memory */
    ...
    VAR( PduLengthType, TYPEDEF ) PduLength; /* PDU length in EcuC */
    VAR( uint8, TYPEDEF ) truncateOptions; /* PDU options regarding its truncation */
...
typedef struct /* CanIf_CanDriverConfigType */ {
    ...
    VAR( Can_HwHandleType, TYPEDEF ) nrOfHths; /* number of configured HTHs */
...
typedef struct /* CanIf_ConfigType */ {
    ...
    TS_REF2CFG( CanIf_CanTrcvChnlConfigType )  trcvChnlConfigPtr; /* pointer a transceiver channel configuration */
    ...
    VAR( CanIf_TxBufferIndexType, TYPEDEF ) nrOfTxBuffers; /* number of Tx buffers */
    VAR( uint8, TYPEDEF ) maxCanControllerId; /* maximum Can controller index */
    VAR( uint8, TYPEDEF ) nrOfTransceivers; /* number of transceivers configured */
} CanIf_ConfigType;
