...
ASCCANIF-1175: Trigger Transmit Support according to AUTOSAR 4.2.X

CanIf_TriggerTransmit Callback notification is not available in AUTOSAR-4.0.3 
CanIf Specification, as this Callback notification is part of AUTOSAR-4.2.2 
implementation, we have added this Callback as a stub and included a header file
to make compatible with Can driver "Can_17_McmCan_Aurix2G".
*/
...
typedef struct
{
  ...
  /*Trigger transmit enabled for the configuration for any of
  the hardware object*/
