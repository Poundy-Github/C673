...
#if ( LIN_17_ASCLIN_SW_PATCH_VERSION != 2U )
...
#if(DEM_AR_RELEASE_MAJOR_VERSION != LIN_17_ASCLIN_AR_RELEASE_MAJOR_VERSION)
...
/* Wake up low pulse in duration of 250 µs to 5ms can be generated by the module.
...
/* MISRA2012_RULE_5_5_JUSTIFICATION: External identifiers going beyond 32 chars
  in source code due to Autosar Naming constraints. Since compiler support
   more than 32 characters, no side affects seen*/
/*FE | RT | LC | BD | RFO | RFU */
#define LIN_17_ASCLIN_MASTER_RECEIVE_RESPONSE_ERROR   (0x0D340000U)
...
ASCINFINEON-864 : Incompatibility between the function prototype with ASR4.2 
				  LinDriver Specification. 
...
** Return value:     none                                                     **
**                                                                            **
** Description     : Function reports DEM based on the AS version             **
...
)
{
  ...
  {
    /*LIN_17_ASCLIN_MASTER_RECEIVE_RESPONSE_ERROR = FE | RT | LC | BD | RFO | RFU */
    if((HwErrorFlags & (uint32)LIN_17_ASCLIN_MASTER_RECEIVE_RESPONSE_ERROR) != LIN_17_ASCLIN_DISABLE_FLAG)
    {
      ...
      [/cover] */
      if(((HwErrorFlags & (uint32)LIN_17_ASCLIN_RT_BIT) !=                      \
