...
#define EB_INTGR_BSWM_GO_OFF_ONE_A   0u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_GO_OFF_ONE_B   1u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_PRP_SHUTDOWN	 2u
#define EB_INTGR_BSWM_RUN_TWO        3u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_STARTUP_TWO_A  4u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_STARTUP_TWO_B  5u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_WAKEUP_TWO     6u  /*!< ECU state handled by BswM module. */
