/* $Header: DMC_Soc_Lat_MOT_Modulation_Torque.h 1.19 2020/08/20 10:43:38CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_Lat_MOT_Modulation_Torque.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Soc_Lat_MOT_Modulation_Torque_h_
#define RTW_HEADER_DMC_Soc_Lat_MOT_Modulation_Torque_h_
#include <math.h>
#ifndef DMC_Soc_Lat_MOT_Modulation_Torque_COMMON_INCLUDES_
# define DMC_Soc_Lat_MOT_Modulation_Torque_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Soc_Lat_MOT_Modulation_Torque_COMMON_INCLUDES_ */

#include "DMC_Soc_Lat_MOT_Modulation_Torque_types.h"
...
/* Block signals for model 'DMC_Soc_Lat_MOT_Modulation_Torque' */
#ifndef DMC_Soc_Lat_MOT_Modulation_Torque_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T Product;                    /* '<S14>/Product' */
} rtB_DMC_Soc_Lat_MOT_Modulation_Torque_T;

#endif                                 /*DMC_Soc_Lat_MOT_Modulation_Torque_MDLREF_HIDE_CHILD_*/

/* Block states (auto storage) for model 'DMC_Soc_Lat_MOT_Modulation_Torque' */
#ifndef DMC_Soc_Lat_MOT_Modulation_Torque_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T UnitDelay_DSTATE;           /* '<S15>/Unit Delay' */
  real32_T UnitDelay_DSTATE_bbni;      /* '<S13>/Unit Delay' */
  real32_T UnitDelay_DSTATE_k2sb;      /* '<S5>/Unit Delay' */
  real32_T UnitDelay_DSTATE_fnko;      /* '<S2>/Unit Delay' */
} rtDW_DMC_Soc_Lat_MOT_Modulation_Torque_T;

#endif                                 /*DMC_Soc_Lat_MOT_Modulation_Torque_MDLREF_HIDE_CHILD_*/

extern void DMC_Soc_Lat_MOT_Modulation_Torque_Init(void);
extern void DMC_Soc_Lat_MOT_Modulation_Torque(const boolean_T *rt_erh2I, const
  int16_T *rt_gd42I, real32_T *rt_erh2sI);

/* Model reference registration function */
extern void DMC_Soc_Lat_MOT_Modulation_Torque_initialize(void);

#ifndef DMC_Soc_Lat_MOT_Modulation_Torque_MDLREF_HIDE_CHILD_

/* Block signals (auto storage) */
extern rtB_DMC_Soc_Lat_MOT_Modulation_Torque_T
  DMC_Soc_Lat_MOT_Modulation_Torque_B;

/* Block states (auto storage) */
extern rtDW_DMC_Soc_Lat_MOT_Modulation_Torque_T
  DMC_Soc_Lat_MOT_Modulation_Torque_DWork;
 ...
 *
 * '<Root>' : 'DMC_Soc_Lat_MOT_Modulation_Torque'
 * '<S1>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle'
 * '<S2>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/MOT_Mean_Value_Filter'
 * '<S3>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/MOT_Mod_Trq_Raw'
 * '<S4>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/MOT_Modulation_Torque_Enable'
 * '<S5>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/MOT_Torque_Rate_Limiter'
 * '<S6>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_Ampl_Modulated_Rect'
 * '<S7>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_Feedback_Enable'
 * '<S8>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_First_Signal_Generator'
 * '<S9>'   : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_Second_Signal_Generator'
 * '<S10>'  : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/MOT_Mod_Trq_Switch'
 * '<S11>'  : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_Feedback_Enable/Compare To Zero'
 * '<S12>'  : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_First_Signal_Generator/LME_Sig_Gen_Rect1'
 * '<S13>'  : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_First_Signal_Generator/LME_Sig_Gen_Triangle1'
 * '<S14>'  : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_Second_Signal_Generator/LME_Sig_Gen_Rect2'
 * '<S15>'  : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/LME_Second_Signal_Generator/LME_Sig_Gen_Triangle2'
 * '<S16>'  : 'DMC_Soc_Lat_MOT_Modulation_Torque/LME_Modulated_Rectangle/MOT_Mod_Trq_Switch/Compare To Zero'
 */

/*-
 * Requirements for '<Root>': DMC_Soc_Lat_MOT_Modulation_Torque
 */
#endif                                 /* RTW_HEADER_DMC_Soc_Lat_MOT_Modulation_Torque_h_ */
