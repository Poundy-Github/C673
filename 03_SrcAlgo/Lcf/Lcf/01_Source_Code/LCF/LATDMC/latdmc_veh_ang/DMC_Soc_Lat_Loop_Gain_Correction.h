/* $Header: DMC_Soc_Lat_Loop_Gain_Correction.h 1.18 2020/08/20 10:43:35CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_Lat_Loop_Gain_Correction.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Soc_Lat_Loop_Gain_Correction_h_
#define RTW_HEADER_DMC_Soc_Lat_Loop_Gain_Correction_h_
#include <math.h>
#ifndef DMC_Soc_Lat_Loop_Gain_Correction_COMMON_INCLUDES_
# define DMC_Soc_Lat_Loop_Gain_Correction_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Soc_Lat_Loop_Gain_Correction_COMMON_INCLUDES_ */

#include "DMC_Soc_Lat_Loop_Gain_Correction_types.h"
...
/* Block states (auto storage) for model 'DMC_Soc_Lat_Loop_Gain_Correction' */
#ifndef DMC_Soc_Lat_Loop_Gain_Correction_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T UnitDelay_DSTATE;           /* '<S2>/Unit Delay' */
} rtDW_DMC_Soc_Lat_Loop_Gain_Correction_T;

#endif                                 /*DMC_Soc_Lat_Loop_Gain_Correction_MDLREF_HIDE_CHILD_*/

extern void DMC_Soc_Lat_Loop_Gain_Correction_Init(void);
extern void DMC_Soc_Lat_Loop_Gain_Correction(const real32_T *rt_erh2I, const
  real32_T *rt_gd42I, const real32_T *rt_cpaoI, const uint16_T *rt_e4hoI, const
  boolean_T *rt_ngfdI, const boolean_T *rt_f3r3I, real32_T *rt_erh2sI, real32_T *
  rt_gd42sI);

/* Model reference registration function */
extern void DMC_Soc_Lat_Loop_Gain_Correction_initialize(void);

#ifndef DMC_Soc_Lat_Loop_Gain_Correction_MDLREF_HIDE_CHILD_

/* Block states (auto storage) */
extern rtDW_DMC_Soc_Lat_Loop_Gain_Correction_T
  DMC_Soc_Lat_Loop_Gain_Correction_DWork;
 ...
 * Block '<S3>/Display (1)' : Unused code path elimination
 * Block '<S3>/Display (2)' : Unused code path elimination
 ...
 *
 * '<Root>' : 'DMC_Soc_Lat_Loop_Gain_Correction'
 * '<S1>'   : 'DMC_Soc_Lat_Loop_Gain_Correction/Compare To Constant'
 * '<S2>'   : 'DMC_Soc_Lat_Loop_Gain_Correction/LAT_Control_Error_Membership_Filtering'
 * '<S3>'   : 'DMC_Soc_Lat_Loop_Gain_Correction/LAT_Kmc_Gain_Fading'
 * '<S4>'   : 'DMC_Soc_Lat_Loop_Gain_Correction/LAT_Control_Error_Membership_Filtering/System Requirements'
 * '<S5>'   : 'DMC_Soc_Lat_Loop_Gain_Correction/LAT_Kmc_Gain_Fading/System Requirements'
 */

/*-
 * Requirements for '<Root>': DMC_Soc_Lat_Loop_Gain_Correction
 */
#endif                                 /* RTW_HEADER_DMC_Soc_Lat_Loop_Gain_Correction_h_ */
