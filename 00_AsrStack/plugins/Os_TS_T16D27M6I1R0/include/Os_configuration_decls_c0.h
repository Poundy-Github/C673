 ...
 *
 * $Id: Os_configuration_decls_c0.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
...
#if (0 == OS_SHAREDHWCOUNTERTIMESTAMP_COREID)
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE0 1
#else
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE0 0
#endif

#define OS_TOTALALARMS_CORE0 (OS_NALARMS_CORE0 + OS_NSCHEDULES_CORE0 + OS_NSHAREDHWCOUNTERTIMESTAMP_CORE0)
