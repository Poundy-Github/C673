/* $Header: DMC_Lat_LAT_Kappa_Filter.h 1.23 2020/08/20 10:42:59CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_LAT_Kappa_Filter.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_LAT_Kappa_Filter_h_
#define RTW_HEADER_DMC_Lat_LAT_Kappa_Filter_h_
#include <math.h>
#ifndef DMC_Lat_LAT_Kappa_Filter_COMMON_INCLUDES_
# define DMC_Lat_LAT_Kappa_Filter_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Lat_LAT_Kappa_Filter_COMMON_INCLUDES_ */

#include "DMC_Lat_LAT_Kappa_Filter_types.h"
...
/* Block states (auto storage) for model 'DMC_Lat_LAT_Kappa_Filter' */
#ifndef DMC_Lat_LAT_Kappa_Filter_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T UnitDelay_DSTATE;           /* '<S4>/Unit Delay' */
  real32_T UnitDelay_DSTATE_afmt;      /* '<S23>/Unit Delay' */
  real32_T UnitDelay1_DSTATE;          /* '<S26>/Unit Delay (1)' */
  real32_T UnitDelay2_DSTATE;          /* '<S26>/Unit Delay (2)' */
  real32_T UnitDelay3_DSTATE;          /* '<S26>/Unit Delay (3)' */
} rtDW_DMC_Lat_LAT_Kappa_Filter_T;

#endif                                 /*DMC_Lat_LAT_Kappa_Filter_MDLREF_HIDE_CHILD_*/

extern void DMC_Lat_LAT_Kappa_Filter_Init(void);
extern void DMC_Lat_LAT_Kappa_Filter(const real32_T *rt_erh2I, const boolean_T
...
extern void DMC_Lat_LAT_Kappa_Filter_initialize(void);

#ifndef DMC_Lat_LAT_Kappa_Filter_MDLREF_HIDE_CHILD_

/* Block states (auto storage) */
extern rtDW_DMC_Lat_LAT_Kappa_Filter_T DMC_Lat_LAT_Kappa_Filter_DWork;
 ...
 *
 * '<Root>' : 'DMC_Lat_LAT_Kappa_Filter'
 * '<S1>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Command_Selection'
 * '<S2>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Filter_Output_Selection'
 * '<S3>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter'
 * '<S4>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Pre_Filter'
 * '<S5>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter'
 * '<S6>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Filt_Error_Class'
 * '<S7>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Filt_Heading_Class'
 * '<S8>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Filt_Height_Class'
 * '<S9>'   : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Filt_Lateral_Class'
 * '<S10>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Strght_Fwd_Class'
 * '<S11>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Membership_Arbitration'
 * '<S12>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Preview_Request'
 * '<S13>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Linz_Filt_Omega_Fading'
 * '<S14>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Linz_Pt1_Filter'
 * '<S15>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Filt_Heading_Class/LAT_Pt1_Filter'
 * '<S16>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Filt_Height_Class/LAT_Saturation'
 * '<S17>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Filt_Lateral_Class/LAT_Pt1_Filter'
 * '<S18>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Linz_Strght_Fwd_Class/LAT_Saturation'
 * '<S19>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Membership_Arbitration/LAT_Saturation'
 * '<S20>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Preview_Request/LAT_Kappa_Linz_Preview_Def'
 * '<S21>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Kappa_Preview_Request/LAT_Kappa_Linz_Preview_Filter'
 * '<S22>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Linzenkirchner_Filter/LAT_Linz_Filt_Omega_Fading/LAT_Kappa_Linz_Min_Omega'
 * '<S23>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Kappa_Command_Filtering'
 * '<S24>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Kappa_Gradient'
 * '<S25>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Saturation'
 * '<S26>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Kappa_Command_Filtering/LAT_Filtered_Kappa_Cmd_Slow_Start'
 * '<S27>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Kappa_Gradient/LAT_Kappa_Gradient_Fader'
 * '<S28>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Kappa_Gradient/LAT_Kappa_Gradient_Fading_Signal'
 * '<S29>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Kappa_Gradient/LAT_Max_Kappa_Gradient'
 * '<S30>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Kappa_Gradient/LAT_Kappa_Gradient_Fader/LAT_Faded_Kappa_Gradient'
 * '<S31>'  : 'DMC_Lat_LAT_Kappa_Filter/LAT_Kappa_Rate_Limiter/LAT_Kappa_Gradient/LAT_Kappa_Gradient_Fader/LAT_Kappa_Gradient_Selection'
 */

/*-
 * Requirements for '<Root>': DMC_Lat_LAT_Kappa_Filter
 */
#endif                                 /* RTW_HEADER_DMC_Lat_LAT_Kappa_Filter_h_ */
