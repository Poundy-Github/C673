#ifndef RTE_INTERN_OSAPPLICATION_C1_H
#define RTE_INTERN_OSAPPLICATION_C1_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
#ifdef OS_NsToTicks_Rte_Counter_C1
#define RTE_NS_TO_TICKS OS_NsToTicks_Rte_Counter_C1
#else
#define RTE_NS_TO_TICKS(ns) ((TickType)((ns) / 1000000))
#endif
#define Rte_StartScheduleTable_SchM_DefaultScheduleTable_OsApplication_C1() StartScheduleTableRel(SchM_DefaultScheduleTable_OsApplication_C1, 10U)
#define Rte_StartScheduleTable_Rte_DefaultScheduleTable_OsApplication_C1() StartScheduleTableRel(Rte_DefaultScheduleTable_OsApplication_C1, 10U)
...
#define Rte_SetEvent_IE_4ECECC5D0674FF38381A4F476742E5EE() \
    do { \
    Rte_Task_Activate(Core1_InitTask_Appl); \
    (void)ActivateTask(Core1_InitTask_Appl); \
    \
    } while (0)
...
#define RTE_TRANSITION_WdgM_CORE_1_WdgMMode 5U
#define RTE_MODE_WdgM_CORE_1_WdgMMode_SUPERVISION_DEACTIVATED 0U
#define RTE_MODE_WdgM_CORE_1_WdgMMode_SUPERVISION_EXPIRED 1U
#define RTE_MODE_WdgM_CORE_1_WdgMMode_SUPERVISION_FAILED 2U
#define RTE_MODE_WdgM_CORE_1_WdgMMode_SUPERVISION_OK 3U
#define RTE_MODE_WdgM_CORE_1_WdgMMode_SUPERVISION_STOPPED 4U
#define RTE_TRANSITION_BswM_1_OsApplication_C1_BSWM_ModeGroupCrossCore 4U
#define RTE_MODE_BswM_1_OsApplication_C1_BSWM_ModeGroupCrossCore_BSWM_GO_OFF_ONE_D 0U
#define RTE_MODE_BswM_1_OsApplication_C1_BSWM_ModeGroupCrossCore_BSWM_STARTUP_TWO_B 1U
#define RTE_MODE_BswM_1_OsApplication_C1_BSWM_ModeGroupCrossCore_BSWM_STARTUP_TWO_D 2U
#define RTE_MODE_BswM_1_OsApplication_C1_BSWM_ModeGroupCrossCore_BSWM_SWC_CYCLIC_SHUTDOWN_C1 3U
#define RTE_TRANSITION_BswM_1_OsApplication_C1_DcmEcuReset 7U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmEcuReset_EXECUTE 0U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmEcuReset_HARD 1U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmEcuReset_JUMPTOBOOTLOADER 2U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmEcuReset_JUMPTOSYSSUPPLIERBOOTLOADER 3U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmEcuReset_KEYONOFF 4U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmEcuReset_NONE 5U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmEcuReset_SOFT 6U
#define RTE_TRANSITION_BswM_1_OsApplication_C1_DcmCommunicationControl 12U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_ENABLE_RX_TX_NORM 0U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_ENABLE_RX_DISABLE_TX_NORM 1U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_DISABLE_RX_ENABLE_TX_NORM 2U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_DISABLE_RX_TX_NORM 3U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_ENABLE_RX_TX_NM 4U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_ENABLE_RX_DISABLE_TX_NM 5U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_DISABLE_RX_ENABLE_TX_NM 6U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_DISABLE_RX_TX_NM 7U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_ENABLE_RX_TX_NORM_NM 8U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_ENABLE_RX_DISABLE_TX_NORM_NM 9U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_DISABLE_RX_ENABLE_TX_NORM_NM 10U
#define RTE_MODE_BswM_1_OsApplication_C1_DcmCommunicationControl_DCM_DISABLE_RX_TX_NORM_NM 11U
...
} Rte_ClientRequestBufferType_OsApplication_C1;
typedef struct
{
  VAR(uint8, TYPEDEF) clientId;
  P2VAR(Rte_ClientRequestBufferType_OsApplication_C1, TYPEDEF, RTE_APPL_DATA) requestBuffer;
} Rte_ClientDS_208A9CA1A431DA6A28C9560009B533CF_Type;
typedef struct
{
  VAR(uint8, TYPEDEF) clientId;
  P2VAR(Rte_ClientRequestBufferType_OsApplication_C1, TYPEDEF, RTE_APPL_DATA) requestBuffer;
} Rte_ClientDS_AB3111EFF611E50C73CEC1DE3D4E4754_Type;
typedef struct
{
  VAR(uint8, TYPEDEF) clientId;
  P2VAR(Rte_ClientRequestBufferType_OsApplication_C1, TYPEDEF, RTE_APPL_DATA) requestBuffer;
} Rte_ClientDS_9486404C11164083091002F86C026F28_Type;
...
#define Rte_WaitGetClearEvent_OsApplication_C1(e, ep, tid) (Rte_Task_WaitEvent(tid, e), OS_WaitGetClearEvent(e, ep), Rte_Task_WaitEventRet(tid, e), (*(ep) & (EventMaskType)~(EventMaskType)(e)) != 0U ? (SetEvent(tid, *(ep) & (EventMaskType)~(EventMaskType)(e)), *(ep) &= (e), E_OK) : E_OK)
#else
extern FUNC(StatusType, RTE_CODE) Rte_WaitGetClearEvent_OsApplication_C1 (EventMaskType eventToWait, P2VAR(EventMaskType, AUTOMATIC, RTE_APPL_DATA) eventReceived, TaskType myTaskId);
#endif
