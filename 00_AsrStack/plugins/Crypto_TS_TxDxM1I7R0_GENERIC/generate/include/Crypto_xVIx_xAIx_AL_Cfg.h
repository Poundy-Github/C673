...
[!VAR "CRYPTO_XVIX_XAIX_SHA3_224_ENABLED"!]STD_OFF[!ENDVAR!]
[!VAR "CRYPTO_XVIX_XAIX_SHA3_256_ENABLED"!]STD_OFF[!ENDVAR!]
[!VAR "CRYPTO_XVIX_XAIX_SHA3_384_ENABLED"!]STD_OFF[!ENDVAR!]
[!VAR "CRYPTO_XVIX_XAIX_SHA3_512_ENABLED"!]STD_OFF[!ENDVAR!]
...
[!LOOP "CryptoDriverObjects/CryptoDriverObject/*/CryptoPrimitiveRef/*"!]
  ...
  [!IF "($CRYPTO_XVIX_XAIX_SHA3_224_ENABLED != 'STD_ON')"!]
    [!IF "
    as:ref(.)/CryptoPrimitiveService =                              'HASH' and
    node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_224')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_224_ENABLED"!]STD_ON[!ENDVAR!]
    [!ELSE!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_224_ENABLED"!]STD_OFF[!ENDVAR!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "($CRYPTO_XVIX_XAIX_SHA3_256_ENABLED != 'STD_ON')"!]
    [!IF "
    as:ref(.)/CryptoPrimitiveService =                              'HASH' and
    node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_256')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_256_ENABLED"!]STD_ON[!ENDVAR!]
    [!ELSE!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_256_ENABLED"!]STD_OFF[!ENDVAR!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "($CRYPTO_XVIX_XAIX_SHA3_384_ENABLED != 'STD_ON')"!]
    [!IF "
    as:ref(.)/CryptoPrimitiveService =                              'HASH' and
    node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_384')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_384_ENABLED"!]STD_ON[!ENDVAR!]
    [!ELSE!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_384_ENABLED"!]STD_OFF[!ENDVAR!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "($CRYPTO_XVIX_XAIX_SHA3_512_ENABLED != 'STD_ON')"!]
    [!IF "
    as:ref(.)/CryptoPrimitiveService =                              'HASH' and
    node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_512')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_512_ENABLED"!]STD_ON[!ENDVAR!]
    [!ELSE!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_512_ENABLED"!]STD_OFF[!ENDVAR!]
    [!ENDIF!]
  [!ENDIF!]
  ...
  node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmMode/*,    'CRYPTO_ALGOMODE_RSASSA_PSS')"!]
    ...
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA2_512')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA2_512_ENABLED"!]STD_ON[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_224')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_224_ENABLED"!]STD_ON[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_256')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_256_ENABLED"!]STD_ON[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_384')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_384_ENABLED"!]STD_ON[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_512')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_512_ENABLED"!]STD_ON[!ENDVAR!]
    [!ENDIF!]
  [!ENDIF!]
  [!IF "as:ref(.)/CryptoPrimitiveService =                        'SIGNATURE_VERIFY'    and
  ...
  node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmMode/*,    'CRYPTO_ALGOMODE_RSAES_OAEP')"!]
    ...
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_224')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_224_ENABLED"!]STD_ON[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_ENC_HASH_ALGORITHM"!]CRYPTO_ALGOFAM_SHA3_224[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_ENC_HASH_LENGTH"!]28U[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_256')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_256_ENABLED"!]STD_ON[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_ENC_HASH_ALGORITHM"!]CRYPTO_ALGOFAM_SHA3_256[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_ENC_HASH_LENGTH"!]32U[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_384')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_384_ENABLED"!]STD_ON[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_ENC_HASH_ALGORITHM"!]CRYPTO_ALGOFAM_SHA3_384[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_ENC_HASH_LENGTH"!]48U[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_512')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_512_ENABLED"!]STD_ON[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_ENC_HASH_ALGORITHM"!]CRYPTO_ALGOFAM_SHA3_512[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_ENC_HASH_LENGTH"!]64U[!ENDVAR!]
    [!ENDIF!]
  [!ENDIF!]
  ...
  node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmMode/*,    'CRYPTO_ALGOMODE_RSAES_OAEP')"!]
    ...
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_224')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_224_ENABLED"!]STD_ON[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_DEC_HASH_ALGORITHM"!]CRYPTO_ALGOFAM_SHA3_224[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_DEC_HASH_LENGTH"!]28U[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_256')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_256_ENABLED"!]STD_ON[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_DEC_HASH_ALGORITHM"!]CRYPTO_ALGOFAM_SHA3_256[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_DEC_HASH_LENGTH"!]32U[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_384')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_384_ENABLED"!]STD_ON[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_DEC_HASH_ALGORITHM"!]CRYPTO_ALGOFAM_SHA3_384[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_DEC_HASH_LENGTH"!]48U[!ENDVAR!]
    [!ENDIF!]
    [!IF "node:containsValue(as:ref(.)/CryptoPrimitiveAlgorithmSecondaryFamiliy/*, 'CRYPTO_ALGOFAM_SHA3_512')"!]
      [!VAR "CRYPTO_XVIX_XAIX_SHA3_512_ENABLED"!]STD_ON[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_DEC_HASH_ALGORITHM"!]CRYPTO_ALGOFAM_SHA3_512[!ENDVAR!]
      [!VAR "CRYPTO_XVIX_XAIX_RSAESOAEP_DEC_HASH_LENGTH"!]64U[!ENDVAR!]
    [!ENDIF!]
  [!ENDIF!]
[!ENDLOOP!]
...
#define CRYPTO_XVIX_XAIX_SHA3_224_ENABLED [!"$CRYPTO_XVIX_XAIX_SHA3_224_ENABLED"!]
#define CRYPTO_XVIX_XAIX_SHA3_256_ENABLED [!"$CRYPTO_XVIX_XAIX_SHA3_256_ENABLED"!]
#define CRYPTO_XVIX_XAIX_SHA3_384_ENABLED [!"$CRYPTO_XVIX_XAIX_SHA3_384_ENABLED"!]
#define CRYPTO_XVIX_XAIX_SHA3_512_ENABLED [!"$CRYPTO_XVIX_XAIX_SHA3_512_ENABLED"!]
