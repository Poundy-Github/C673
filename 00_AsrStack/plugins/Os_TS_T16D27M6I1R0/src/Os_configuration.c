 ...
 *
 * $Id: Os_configuration.c 34824 2021-08-05 13:57:39Z ache271795 $
*/
...
os_appmodeid_t
		...
		OS_appMode
		OS_DATA_SECTION_ATTRIB_POST(.data.shared.os.OS_appMode) = OS_NULLAPPMODE;
/* CHECK: PARSE */
...
#define OS_K_GETCURRENTAPPLICATIONID	&OS_KernUnknownSyscall
...
#define OS_K_ACTIVATETASKASYN	&OS_KernUnknownSyscall
...
#define OS_XC_RECVACTIVATETASKASYN	&OS_RecvUnknownCall
...
*/
#define OS_TOTALALARMS	(OS_NALARMS + OS_NSCHEDULES + OS_NSHAREDHWCOUNTERTIMESTAMP)
...
#define OS_K_SETEVENTASYN		&OS_KernUnknownSyscall
...
#define	OS_XC_RECVSETEVENTASYN	&OS_RecvUnknownCall
...
#define OS_K_CLEARPENDINGINTERRUPT		&OS_KernUnknownSyscall
...
os_rateindex_t
		...
		OS_BSS_SECTION_ATTRIB_POST(.bss.shared.os.OS_rateIndex);
/* CHECK: PARSE */
...
#define OS_CFG_RATEMONITOR	&OS_CheckRateMonitor
 ...
 * OS_CFG_STARTTICKERS
 *
 * Allows a generated function void OS_StartTickers(void) to start all the internal drivers
...
#define OS_XC_RECVACTIVATETASKASYN				&OS_RecvActivateTaskAsyn
#endif
...
#define OS_XC_RECVSETEVENTASYN					&OS_RecvSetEventAsyn
#endif
...
#ifndef OS_XC_RECVCLEARPENDINGINTERRUPT
#define OS_XC_RECVCLEARPENDINGINTERRUPT			&OS_RecvClearPendingInterrupt
#endif
...
#ifndef OS_XC_RECVCONTROLIDLE
#define OS_XC_RECVCONTROLIDLE					&OS_RecvControlIdle
#endif
...
const os_messagehandler_t OS_messageHandler[OS_N_CROSSCORE_HANDLERS] =
{
	...
	OS_XC_RECVACTIVATETASKASYN,				/* 23 */
	OS_XC_RECVSETEVENTASYN,					/* 24 */
	OS_XC_RECVCLEARPENDINGINTERRUPT,		/* 25 */
	OS_XC_RECVCONTROLIDLE,					/* 26 */	
	OS_XC_RETNRESULT,						/* 27 */
	OS_XC_RETNTASKSTATE,					/* 28 */
	OS_XC_RETNTICK,							/* 29 */
	OS_XC_RETNEVENT,						/* 30 */
	OS_XC_RETNSCHEDULETABLESTATUS,			/* 31 */
	OS_XC_RETNAPPLICATIONSTATE,				/* 32 */
};
#endif /* OS_N_CORES > 1 */
...
os_boolean_t
		...
		OS_BSS_SECTION_ATTRIB_POST(.bss.shared.os.OS_coreStarted);
/* CHECK: PARSE */
#include <memmap/Os_mm_var_end.h>
 ...
 * If the architecture/derivative does not provide hardware locks, all locks have to be implemented in software.
...
#define OS_NSOFTWARELOCKS	OS_NKERNELLOCKS
#elif OS_NKERNELLOCKS > OS_NHARDWARELOCKS
...
/* Deviation MISRAC2012-7 <1> */
		...
		OS_BSS_SECTION_ATTRIB_POST(.bss.shared.os.OS_softwareLock);
/* CHECK: PARSE */
#include <memmap/Os_mm_var_end.h>
...
static os_autosarspinlockdyn_t
		...
		OS_BSS_SECTION_ATTRIB_POST(.bss.shared.os.OS_autosarSpinlockDynamic);
/* CHECK: PARSE */
#include <memmap/Os_mm_var_end.h>
...
#ifndef OS_K_ACTIVATETASKASYN
#define OS_K_ACTIVATETASKASYN			&OS_KernActivateTaskAsyn
#endif
...
#ifndef OS_K_SETEVENTASYN
#define OS_K_SETEVENTASYN				&OS_KernSetEventAsyn
#endif

#ifndef OS_K_CLEARPENDINGINTERRUPT
#define OS_K_CLEARPENDINGINTERRUPT		&OS_KernClearPendingInterrupt
#endif
...
#ifndef OS_K_GETCURRENTAPPLICATIONID
#define OS_K_GETCURRENTAPPLICATIONID	&OS_KernGetCurrentApplicationId
#endif
...
#ifndef OS_K_CONTROLIDLE
#define OS_K_CONTROLIDLE				&OS_KernControlIdle
#endif
...
/* Deviation MISRAC2012-2 <START> */
	...
	(os_syscallptr_t) OS_K_CONTROLIDLE,					/* 44 */
	(os_syscallptr_t) OS_K_TASKRETURN,					/* 45 */
	(os_syscallptr_t) OS_K_RETURNFROMCALL,				/* 46 */
	(os_syscallptr_t) OS_K_SIMTIMERADVANCE,				/* 47 */
	(os_syscallptr_t) OS_K_TRYTOGETSPINLOCK,			/* 48 */
	(os_syscallptr_t) OS_K_RELEASESPINLOCK,				/* 49 */
	(os_syscallptr_t) OS_K_ALLOWACCESS,                 /* 50 */
	(os_syscallptr_t) OS_K_GETAPPLICATIONSTATE,         /* 51 */
	(os_syscallptr_t) OS_K_SHUTDOWNALLCORES,            /* 52 */
	(os_syscallptr_t) OS_K_IOCWRITE,					/* 53 */
	(os_syscallptr_t) OS_K_IOCSEND,						/* 54 */
	(os_syscallptr_t) OS_K_EMPTYQUEUE,					/* 55 */
	(os_syscallptr_t) OS_K_IOCADDONEXT,					/* 56 */
	(os_syscallptr_t) OS_K_ACTIVATETASKASYN,			/* 57 */
	(os_syscallptr_t) OS_K_SETEVENTASYN,				/* 58 */
	(os_syscallptr_t) OS_K_CLEARPENDINGINTERRUPT,		/* 59 */
	(os_syscallptr_t) OS_K_GETCURRENTAPPLICATIONID,		/* 60 */
	(os_syscallptr_t) OS_K_CPUFAMILY_1,					/* 61 */
	(os_syscallptr_t) OS_K_CPUFAMILY_2,					/* 62 */
	(os_syscallptr_t) OS_K_CPUFAMILY_3,					/* 63 */
...
const os_uint8_t OS_dummy_Os_configuration_c = 0xeb;
