...
/** \brief Read and reset Tcp Unit measurement data
 *
 * This function reads and resets invalid destination TCP-Port, invalid checksum and invalid packet
 * format counters.
 *
 ...
 */
TS_MOD_PRIV_DECL FUNC(void, TCPIP_CODE) TcpIp_Tcp_GetAndResetCounter
(
