/* $Header: look1_iflf_binlx.c 1.1 2018/01/24 16:29:55CET Asong, Wedndah Asaha (uidj2187) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : look1_iflf_binlx.c
   C source code generated on           : Mon Jan 11 14:17:31 2016
   Filename of Simulink Model           : DMC_Lat.mdl
   Revision of Simulink Model           : 1.2003
 ***************************************************************************************************
   Detailed informations needed to rebuild this code.

   MATLAB Version: 8.4.0.150421 (R2014b)
   MATLAB License Number: 247122
...
real32_T look1_iflf_binlx(real32_T tmp_, const real32_T tmp_0[], const real32_T
  tmp_1[], uint32_T tmp_2)
{
  real32_T tmp_4;
  uint32_T tmp_5;
  uint32_T tmp_6;
  ...
  if (tmp_ <= tmp_0[0U]) {
    tmp_6 = 0U;
    tmp_4 = (tmp_ - tmp_0[0U]) / (tmp_0[1U] - tmp_0[0U]);
  } else if (tmp_ < tmp_0[tmp_2]) {
    /* Binary Search */
    tmp_7 = (tmp_2 >> 1U);
    tmp_6 = 0U;
    tmp_5 = tmp_2;
    ...
    tmp_4 = (tmp_ - tmp_0[tmp_6]) / (tmp_0[tmp_6 + 1U] - tmp_0[tmp_6]);
  } else {
    tmp_6 = tmp_2 - 1U;
    tmp_4 = (tmp_ - tmp_0[tmp_2 - 1U]) / (tmp_0[tmp_2] - tmp_0[tmp_2 - 1U]);
  }
   ...
   */
  return ((tmp_1[tmp_6 + 1U] - tmp_1[tmp_6]) * tmp_4) + tmp_1[tmp_6];
}
