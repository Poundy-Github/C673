/*! \file **********************************************************************
   ...
   File: vdy_matrix_inversion_2x2.h
...
#ifndef RTW_HEADER_vdy_matrix_inversion_2x2_h_
#define RTW_HEADER_vdy_matrix_inversion_2x2_h_
...
/* Block signals for system '<S27>/Matrix_Inversion_2x2' */
typedef struct {
  real32_T HPHt_R_inv[4];              /* '<S27>/Matrix_Inversion_2x2' */
  boolean_T det_flag;                  /* '<S27>/Matrix_Inversion_2x2' */
} rtB_vdy_matrix_inversion_2x2;

extern void vdy_matrix_inversion_2x2(const real32_T rtu_HPHt_R[4],
  rtB_vdy_matrix_inversion_2x2 *localB);

#endif                                 /* RTW_HEADER_vdy_matrix_inversion_2x2_h_ */
