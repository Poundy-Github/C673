#ifndef SCHM_COMHOOK_H
#define SCHM_COMHOOK_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
/*
 * This file contains Rte hook declarations for the basic software module instance Com
 *
...
#undef SchM_Schedulable_Com_MainFunctionRx_Start
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Com_MainFunctionRx_Start (void);
#else
...
#undef SchM_Schedulable_Com_MainFunctionRx_Return
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Com_MainFunctionRx_Return (void);
#else
...
#undef SchM_Schedulable_Com_MainFunctionTx_Start
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Com_MainFunctionTx_Start (void);
#else
...
#undef SchM_Schedulable_Com_MainFunctionTx_Return
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Com_MainFunctionTx_Return (void);
#else
...
#undef SchM_Schedulable_Com_MainFunctionRouteSignals_Start
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Com_MainFunctionRouteSignals_Start (void);
#else
...
#undef SchM_Schedulable_Com_MainFunctionRouteSignals_Return
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Com_MainFunctionRouteSignals_Return (void);
#else
