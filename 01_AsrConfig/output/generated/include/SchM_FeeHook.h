#ifndef SCHM_FEEHOOK_H
#define SCHM_FEEHOOK_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
/*
 * This file contains Rte hook declarations for the basic software module instance Fee
 *
...
#undef SchM_Schedulable_Fee_MainFunction_Start
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Fee_MainFunction_Start (void);
#else
...
#undef SchM_Schedulable_Fee_MainFunction_Return
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Fee_MainFunction_Return (void);
#else
