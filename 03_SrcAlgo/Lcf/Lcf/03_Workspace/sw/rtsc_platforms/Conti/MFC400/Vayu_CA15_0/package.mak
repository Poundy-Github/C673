...
override PKGDIR = Conti/MFC400/Vayu_CA15_0
...
package/%.xdc.inc package/%_Conti.MFC400.Vayu_CA15_0.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package Conti.MFC400.Vayu_CA15_0" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedConti/MFC400/Vayu_CA15_0package/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js Conti.MFC400.Vayu_CA15_0 $@
...
.PHONY: release,Conti_MFC400_Vayu_CA15_0
Conti_MFC400_Vayu_CA15_0.zip: package/package.bld.xml
Conti_MFC400_Vayu_CA15_0.zip: package/build.cfg
Conti_MFC400_Vayu_CA15_0.zip: package/package.xdc.inc
Conti_MFC400_Vayu_CA15_0.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/Conti_MFC400_Vayu_CA15_0.zip.dep
endif
package/rel/Conti_MFC400_Vayu_CA15_0/Conti/MFC400/Vayu_CA15_0/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

Conti_MFC400_Vayu_CA15_0.zip: package/rel/Conti_MFC400_Vayu_CA15_0.xdc.inc package/rel/Conti_MFC400_Vayu_CA15_0/Conti/MFC400/Vayu_CA15_0/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/Conti_MFC400_Vayu_CA15_0.xdc.inc,package/rel/Conti_MFC400_Vayu_CA15_0.zip.dep)


release release,Conti_MFC400_Vayu_CA15_0: all Conti_MFC400_Vayu_CA15_0.zip
clean:: .clean
	-$(RM) Conti_MFC400_Vayu_CA15_0.zip
	-$(RM) package/rel/Conti_MFC400_Vayu_CA15_0.xdc.inc
	-$(RM) package/rel/Conti_MFC400_Vayu_CA15_0.zip.dep
