 ...
 *
 * $Id: kern-cat2entry.c 34824 2021-08-05 13:57:39Z ache271795 $
*/
...
/* DCG Deviations:
 *
 * DCG-1) Deviated Rule: [OS_C_COMPL_010:HIS_PATH]
...
const os_uint8_t OS_dummy_kern_cat2entry_c = 0xeb;
