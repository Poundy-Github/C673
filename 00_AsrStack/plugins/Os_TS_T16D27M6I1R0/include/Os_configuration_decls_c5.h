 ...
 *
 * $Id: Os_configuration_decls_c5.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
...
#if (5 == OS_SHAREDHWCOUNTERTIMESTAMP_COREID)
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE5 1
#else
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE5 0
#endif

#define OS_TOTALALARMS_CORE5 (OS_NALARMS_CORE5 + OS_NSCHEDULES_CORE5 + OS_NSHAREDHWCOUNTERTIMESTAMP_CORE5)
