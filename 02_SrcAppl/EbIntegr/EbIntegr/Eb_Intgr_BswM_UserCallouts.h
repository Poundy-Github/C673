...
#define EB_INTGR_BSWM_STARTUP_TWO_C  6u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_STARTUP_TWO_D  7u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_GO_OFF_ONE_C   8u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_GO_OFF_ONE_D   9u  /*!< ECU state handled by BswM module. */
#define EB_INTGR_BSWM_SWC_CYCLIC_SHUTDOWN    10u  /* SWC_CyclicCounter state */
#define EB_INTGR_BSWM_SWC_CYCLIC_SHUTDOWN_C1 11u  /* SWC_CyclicCounter state */
#define EB_INTGR_BSWM_RUN_TWO_SLAVE  12u  /*!< ECU state handled by BswM module. */
...
#define PDU_ENABLE                           3u
#define TX_PDU_DISABLE                       4u
...
extern FUNC(void, BSWM_APPL_CODE) Eb_Intgr_BswM_OnStartupTwoC(void);
...
extern FUNC(void, BSWM_APPL_CODE) Eb_Intgr_BswM_OnRunTwo_Slave(void);
...
extern FUNC(void, BSWM_APPL_CODE) Tja1043_RecorveryFun(void);
