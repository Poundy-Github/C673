/* $Header: DMC_Lat_DYC_Dynamic_Compensation_Filter_private.h 1.29 2020/08/20 10:42:47CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_DYC_Dynamic_Compensation_Filter_private.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_DYC_Dynamic_Compensation_Filter_private_h_
#define RTW_HEADER_DMC_Lat_DYC_Dynamic_Compensation_Filter_private_h_
#include "rtwtypes.h"
...
typedef struct {
  /* Expression: Dyc_kappa_a2_y_scheduling_Sc
   * Referenced by: '<S11>/DYC_Kappa_A2_Scheduling_Sc'
   */
  real32_T DYC_Kappa_A2_Scheduling_Sc_tableData[12];

  /* Pooled Parameter (Mixed Expressions)
   * Referenced by:
   *   '<S11>/DYC_Kappa_A2_Scheduling_Sc'
   *   '<S38>/DYC_Kappa_Angle_T_Factor_High_Ay'
   */
  real32_T pooled6[12];

  /* Expression: DYC_Kappa_A4_Y_Scheduling
   * Referenced by: '<S11>/DYC_Kappa_A4_Scheduling'
   */
  real32_T DYC_Kappa_A4_Scheduling_tableData[11];

  /* Expression: DYC_Kappa_A4_X_Scheduling
   * Referenced by: '<S11>/DYC_Kappa_A4_Scheduling'
   */
  real32_T DYC_Kappa_A4_Scheduling_bp01Data[11];

  /* Expression: DYC_Kappa_Angle_T_Y_Sch_Hi_Ay
   * Referenced by: '<S38>/DYC_Kappa_Angle_T_Factor_High_Ay'
   */
  real32_T DYC_Kappa_Angle_T_Factor_High_Ay_tableData[12];
} ConstParam_DMC_Lat_DYC_Dynamic_Compensation_Filter_T;

/* Constant parameters (auto storage) */
extern const ConstParam_DMC_Lat_DYC_Dynamic_Compensation_Filter_T
  DMC_Lat_DYC_Dynamic_Compensation_Filter_ConstP;

/* <== Enable QAC again after word size consistence check using limits.h has been done. */
/* PRQA L:LABEL_QAC_PRIVATE */
#endif                                 /* RTW_HEADER_DMC_Lat_DYC_Dynamic_Compensation_Filter_private_h_ */
