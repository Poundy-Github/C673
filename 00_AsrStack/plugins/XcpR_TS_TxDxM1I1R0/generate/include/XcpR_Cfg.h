...
#if (defined XCPR_DET_RUNTIME_CHECKS)
#error XCPR_DET_RUNTIME_CHECKS is already defined
#endif
/** \brief DET runtime checks reporting
 **
 ** En- or disables the reporting of the DET runtime checks */
#define XCPR_DET_RUNTIME_CHECKS   [!//
[!IF "XcpRDetRuntimeChecks = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
