/* $Header: DMC_Lat_SAT_Angle_Command_Saturation.h 1.28 2020/08/20 10:43:17CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_SAT_Angle_Command_Saturation.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_SAT_Angle_Command_Saturation_h_
#define RTW_HEADER_DMC_Lat_SAT_Angle_Command_Saturation_h_
#include <math.h>
#ifndef DMC_Lat_SAT_Angle_Command_Saturation_COMMON_INCLUDES_
# define DMC_Lat_SAT_Angle_Command_Saturation_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Lat_SAT_Angle_Command_Saturation_COMMON_INCLUDES_ */

#include "DMC_Lat_SAT_Angle_Command_Saturation_types.h"
...
/* Block states (auto storage) for model 'DMC_Lat_SAT_Angle_Command_Saturation' */
#ifndef DMC_Lat_SAT_Angle_Command_Saturation_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T UnitDelay_DSTATE;           /* '<S14>/Unit Delay' */
  real32_T UnitDelay_DSTATE_jqbs;      /* '<S15>/Unit Delay' */
  real32_T UnitDelay_DSTATE_hrg2;      /* '<S16>/Unit Delay' */
  real32_T UnitDelay_DSTATE_ioqj;      /* '<S9>/Unit Delay' */
  real32_T UnitDelay_DSTATE_hn0u;      /* '<S25>/Unit Delay' */
  real32_T UnitDelay_DSTATE_mqg2;      /* '<S26>/Unit Delay' */
} rtDW_DMC_Lat_SAT_Angle_Command_Saturation_T;

#endif                                 /*DMC_Lat_SAT_Angle_Command_Saturation_MDLREF_HIDE_CHILD_*/

extern void DMC_Lat_SAT_Angle_Command_Saturation_Init(void);
extern void DMC_Lat_SAT_Angle_Command_Saturation(const real32_T *rt_erh2I, const
...
extern void DMC_Lat_SAT_Angle_Command_Saturation_initialize(void);

#ifndef DMC_Lat_SAT_Angle_Command_Saturation_MDLREF_HIDE_CHILD_

/* Block states (auto storage) */
extern rtDW_DMC_Lat_SAT_Angle_Command_Saturation_T
 ...
 * Block '<S5>/Display (1)' : Unused code path elimination
 * Block '<S5>/Display (2)' : Unused code path elimination
 * Block '<S5>/Scope' : Unused code path elimination
 * Block '<S6>/Display (1)' : Unused code path elimination
 * Block '<S6>/Display (2)' : Unused code path elimination
 * Block '<S6>/Display (3)' : Unused code path elimination
 * Block '<S6>/Display (4)' : Unused code path elimination
 * Block '<S6>/Scope' : Unused code path elimination
 * Block '<S7>/Display (1)' : Unused code path elimination
 * Block '<S7>/Display (2)' : Unused code path elimination
 * Block '<S7>/Display (3)' : Unused code path elimination
 * Block '<S7>/Scope (1)' : Unused code path elimination
 * Block '<S7>/Scope (2)' : Unused code path elimination
 * Block '<S8>/Scope (2)' : Unused code path elimination
 * Block '<S9>/Display' : Unused code path elimination
 * Block '<S9>/Scope' : Unused code path elimination
 * Block '<S28>/Scope (1)' : Unused code path elimination
 * Block '<S28>/Scope (2)' : Unused code path elimination
 * Block '<S29>/Display' : Unused code path elimination
 * Block '<S29>/Scope (1)' : Unused code path elimination
 * Block '<S29>/Scope (2)' : Unused code path elimination
 * Block '<S30>/Display' : Unused code path elimination
 * Block '<S30>/Scope (1)' : Unused code path elimination
 * Block '<S30>/Scope (2)' : Unused code path elimination
 * Block '<S30>/Scope (3)' : Unused code path elimination
 * Block '<S30>/Scope (4)' : Unused code path elimination
 ...
 *
 * '<Root>' : 'DMC_Lat_SAT_Angle_Command_Saturation'
 * '<S1>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Limit_Filter'
 * '<S2>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Saturation'
 * '<S3>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Max_Ay_Dyc_Angle_Limit'
 * '<S4>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Max_Delta_F_Cmd'
 * '<S5>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Max_Requested_Dynamic_Steering_Angle'
 * '<S6>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Req_Delta_F_Max_Ay'
 * '<S7>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Req_Delta_F_Max_Ay_Psi'
 * '<S8>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Saturated_Angle_Cmd'
 * '<S9>'   : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Control'
 * '<S10>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Definition'
 * '<S11>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Limit_Filter/LAT_Support_Filter'
 * '<S12>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Limit_Filter/LAT_Support_Filter1'
 * '<S13>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Limit_Filter/LAT_Support_Filter2'
 * '<S14>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Limit_Filter/LAT_Support_Filter/SAC_Pt1_Filter2'
 * '<S15>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Limit_Filter/LAT_Support_Filter1/SAC_Pt1_Filter2'
 * '<S16>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Limit_Filter/LAT_Support_Filter2/SAC_Pt1_Filter2'
 * '<S17>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Angle_Saturation/System Requirements'
 * '<S18>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Max_Delta_F_Cmd/System Requirements'
 * '<S19>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Max_Requested_Dynamic_Steering_Angle/System Requirements'
 * '<S20>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Req_Delta_F_Max_Ay/System Requirements'
 * '<S21>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Req_Delta_F_Max_Ay/rad2deg'
 * '<S22>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Req_Delta_F_Max_Ay_Psi/System Requirements'
 * '<S23>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Req_Delta_F_Max_Ay_Psi/rad2deg'
 * '<S24>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Saturated_Angle_Cmd/System Requirements'
 * '<S25>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Control/SAT_Integrator'
 * '<S26>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Control/SAT_Pt1_Filter'
 * '<S27>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Control/System Requirements'
 * '<S28>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Definition/SAT_Active_Saturation_Encoder'
 * '<S29>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Definition/SAT_Max_Requested_Steering_Angle'
 * '<S30>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Definition/SAT_Max_Steering_Angle_Command_Selection'
 * '<S31>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Definition/SAT_Active_Saturation_Encoder/System Requirements'
 * '<S32>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Definition/SAT_Max_Requested_Steering_Angle/System Requirements'
 * '<S33>'  : 'DMC_Lat_SAT_Angle_Command_Saturation/SAT_Threshold_Definition/SAT_Max_Steering_Angle_Command_Selection/System Requirements'
 */

/*-
 * Requirements for '<Root>': DMC_Lat_SAT_Angle_Command_Saturation
 */
#endif                                 /* RTW_HEADER_DMC_Lat_SAT_Angle_Command_Saturation_h_ */
