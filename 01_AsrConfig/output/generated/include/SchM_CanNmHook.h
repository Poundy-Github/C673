#ifndef SCHM_CANNMHOOK_H
#define SCHM_CANNMHOOK_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
/*
 * This file contains Rte hook declarations for the basic software module instance CanNm
 *
...
#undef SchM_Schedulable_CanNm_MainFunction_Start
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_CanNm_MainFunction_Start (void);
#else
...
#undef SchM_Schedulable_CanNm_MainFunction_Return
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_CanNm_MainFunction_Return (void);
#else
