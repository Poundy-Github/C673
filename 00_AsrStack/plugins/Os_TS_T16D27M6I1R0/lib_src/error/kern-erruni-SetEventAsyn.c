/* kern-erruni-SetEventAsyn.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblSetEventAsyn[8] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_SetEventAsyn =
{
    OS_errtblSetEventAsyn,
    OS_SID_SetEventAsyn,
    8
};
