/* $Header: look1_ifbu16n6lftu16n12dfif_binlcs.c 1.1 2018/01/24 16:29:51CET Asong, Wedndah Asaha (uidj2187) none  $ */
/* !MksAtrtribute: CodeSrc=Mdl;CodeGrp=Core !*/
/*
 ***************************************************************************************************
 ...
 ***************************************************************************************************
   Filename of C source                 : look1_ifbu16n6lftu16n12DfIf_binlcs.c
   C source code generated on           : Fri Dec 04 13:05:12 2015
   Filename of Simulink Model           : DMC_Lat.mdl
   Revision of Simulink Model           : 1.1977
 ***************************************************************************************************
   Detailed informations needed to rebuild this code.

   MATLAB Version: 8.4.0.150421 (R2014b)
   MATLAB License Number: 819865
 ...
 ***************************************************************************************************
   ...
   ".\docs\coding_guidelines\AGC_MISRA_COMPLIANCE_.rtf in your simulink project"
 ***************************************************************************************************
 */
...
real32_T look1_ifbu16n6lftu16n12DfIf_binlcs(real32_T tmp_, const uint16_T tmp_0[],
  const uint16_T tmp_1[], uint32_T tmp_2)
{
  ...
  if (tmp_ < (((real32_T)tmp_0[0U]) * 0.015625F)) {
    tmp_6 = 0U;
    tmp_4 = 0.0F;
    ...
    while ((tmp_5 - tmp_6) > 1U) {
      ...
      tmp_7 = ((tmp_5 + tmp_6) >> 1U);
    }

    tmp_4 = (tmp_ - (((real32_T)tmp_0[tmp_6]) * 0.015625F)) / (((real32_T)
      ((uint16_T)(((uint32_T)tmp_0[tmp_6 + 1U]) - tmp_0[tmp_6]))) * 0.015625F);
  } else {
    tmp_6 = tmp_2 - 1U;
    tmp_4 = 1.0F;
  }
   ...
   */
  return (((((real32_T)tmp_1[tmp_6 + 1U]) * 0.000244140625F) - (((real32_T)
             tmp_1[tmp_6]) * 0.000244140625F)) * tmp_4) + (((real32_T)
    tmp_1[tmp_6]) * 0.000244140625F);
}
