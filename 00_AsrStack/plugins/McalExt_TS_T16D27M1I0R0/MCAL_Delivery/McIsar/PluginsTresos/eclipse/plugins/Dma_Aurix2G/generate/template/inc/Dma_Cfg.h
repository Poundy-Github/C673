...
[!IF "DmaGeneral/DmaChDeInitApi = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
...
[!IF "DmaGeneral/DmaSuspendApi = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
...
[!IF "DmaGeneral/DmaTriggerApi = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
...
[!IF "DmaGeneral/DmaDataPendingApi = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
...
[!IF "DmaGeneral/DmaBufferSwitchApi = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
...
[!IF "DmaGeneral/DmaGetVersionInfoApi = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
...
DMA_INIT_DEINIT_API_MODE
[/cover] */!][!//
#define DMA_INIT_DEINIT_API_MODE       ([!"node:value(DmaGeneral/DmaInitDeInitApiMode)"!])
...
*/
[!/* [cover parentID={428CFC97-C358-418c-9B21-313FD0BAEE3F}]
DMA_DEINIT_API
[/cover] */!][!//
#define DMA_DEINIT_API                   ([!//
[!IF "DmaGeneral/DmaDeInitApi  = 'true'"!][!//
  STD_ON[!//
[!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
...
*/
[!/* [cover parentID={D750DB5F-1188-4b20-8800-21F4D81FCBCB}]
DMA_SETPATTERN_API
[/cover] */!][!//
#define DMA_SETPATTERN_API             ([!//
[!IF "(num:i(count(./DmaChannelConfig/*[DmaChannelTransactionSet/*[DmaPatternMode != 'Pattern_Detection_Disabled']]))>0)or(num:i(count(./DmaChannelConfig/*[DmaChannelTransactionSet/*[DmaTcsShadowRegisterConfiguration = 'DMA_CONDITIONAL_LINKED_LIST']]))>0)"!][!//
  STD_ON[!//
  [!ELSE!][!//
  STD_OFF[!//
[!ENDIF!][!//
