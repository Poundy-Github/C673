/* $Header: DMC_Soc_Lat_Loop_Gain_Correction.c 1.18 2020/08/20 10:43:34CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_Lat_Loop_Gain_Correction.c
   C source code generated on           : Mon Aug 17 20:48:47 2020
   Filename of Simulink Model           : DMC_Soc_Lat_Loop_Gain_Correction.mdl/.slx
   Revision of Simulink Model           : 1.62
 ***************************************************************************************************
...
#include "DMC_Soc_Lat_Loop_Gain_Correction_private.h"
 ...
 ***************************************************************************************************
   ...
   CALL: DMC_Soc_Lat_Loop_Gain_Correction_step()
   CALL: DMC_Soc_Lat_Loop_Gain_Correction_initialize(0)
   FILE: DMC_Soc_Lat_Loop_Gain_Correction.c
 ***************************************************************************************************
 */

/* Block states (auto storage) */
rtDW_DMC_Soc_Lat_Loop_Gain_Correction_T DMC_Soc_Lat_Loop_Gain_Correction_DWork;

/* Initial conditions for referenced model: 'DMC_Soc_Lat_Loop_Gain_Correction' */
void DMC_Soc_Lat_Loop_Gain_Correction_Init(void)
{
  /* InitializeConditions for UnitDelay: '<S2>/Unit Delay' */
  DMC_Soc_Lat_Loop_Gain_Correction_DWork.UnitDelay_DSTATE = 0.0F;
}

/* Output and update for referenced model: 'DMC_Soc_Lat_Loop_Gain_Correction' */
void DMC_Soc_Lat_Loop_Gain_Correction(const real32_T *rt_erh2I, const real32_T
  *rt_gd42I, const real32_T *rt_cpaoI, const uint16_T *rt_e4hoI, const boolean_T
  *rt_ngfdI, const boolean_T *rt_f3r3I, real32_T *rt_erh2sI, real32_T *rt_gd42sI)
{
  boolean_T rtb_;
  boolean_T rtb_nflb;
  real32_T rtb_atlp;
  ...
  /* Logic: '<Root>/Logical Operator (1)' */
  rtb_ = (boolean_T)((int32_T)(((int32_T)(*rt_f3r3I)) || ((int32_T)(*rt_ngfdI))));

  /* Logic: '<Root>/Logical Operator (2)' incorporates:
   *  Constant: '<S1>/Constant'
   *  RelationalOperator: '<S1>/Compare'
   */
  rtb_nflb = (boolean_T)((int32_T)((((int32_T)(*rt_e4hoI)) != ((int32_T)2)) ||
                          ((int32_T)rtb_)));

  /* Switch: '<Root>/Switch' incorporates:
   *  Constant: '<Root>/Constant'
   *
   * Block description for '<Root>/Constant':
   *  u: degrees
   *
   * Block requirements for '<Root>/Switch':
   *  1. Low Dynamic Control Error Membership
   */
  if ((int32_T)rtb_nflb) {
    rtb_jb0d = 1.0F;
  } else {
  ...
  /* Sum: '<S2>/Sub' incorporates:
   *  UnitDelay: '<S2>/Unit Delay'
   */
  rtb_atlp = rtb_jb0d - DMC_Soc_Lat_Loop_Gain_Correction_DWork.UnitDelay_DSTATE;
   ...
   *  Switch: '<S2>/Switch (1)'
   *
   * Block description for '<S2>/Constant (1)':
   *  u: degrees
   */
  if ((rtb_atlp >= 0.0F) && (0.01F <= rtb_atlp)) {
    rtb_atlp = 0.01F;
  }
  ...
  if ((int32_T)rtb_nflb) {
    rtb_jb0d = rtb_atlp +
      DMC_Soc_Lat_Loop_Gain_Correction_DWork.UnitDelay_DSTATE;
  }
   ...
   *
   * Block description for '<S2>/Constant (2)':
   *  u: level
   */
  if ((int32_T)rtb_) {
    rtb_atlp = 1.0F;
  ...
  /* Product: '<S3>/Product (3)' incorporates:
   *  Constant: '<S3>/Constant (2)'
   *  Constant: '<S3>/Sac_kmc_loop_gain'
   *  Constant: '<S3>/Sac_reduced_kmc_loop_gain'
   *  Product: '<S3>/Product (1)'
   *  Product: '<S3>/Product (2)'
   *  Sum: '<S3>/Add'
   *  Sum: '<S3>/Sub'
   *
   * Block description for '<S3>/Sac_kmc_loop_gain':
   *  u: 1
   *
   * Block description for '<S3>/Sac_reduced_kmc_loop_gain':
   *  u: 1
   */
  rtb_atlp = (rtb_atlp + ((((real32_T)Sac_reduced_kmc_loop_gain) * 0.0009765625F)
    * (1.0F - rtb_atlp))) * (((real32_T)Sac_kmc_loop_gain) * 0.0009765625F);

  /* DataTypeConversion: '<S3>/Data Type Conversion' */
  LAT_Debug7_dbg = (int16_T)((real32_T)floor(rtb_atlp * 1024.0F));

  /* Product: '<Root>/Product (1)' */
  *rt_erh2sI = rtb_atlp * (*rt_erh2I);

  /* Product: '<Root>/Product (2)' */
  *rt_gd42sI = rtb_atlp * (*rt_cpaoI);

  /* Update for UnitDelay: '<S2>/Unit Delay' */
  DMC_Soc_Lat_Loop_Gain_Correction_DWork.UnitDelay_DSTATE = rtb_jb0d;
}

/* Model initialize function */
void DMC_Soc_Lat_Loop_Gain_Correction_initialize(void)
{
  /* Registration code */
