 ...
 *
 * $Id: Os_messagequeue.h 31037 2019-11-12 13:20:38Z sash270423 $
*/
...
#define OS_XC_OP_ActivateTaskAsyn				OS_U(23)
#define OS_XC_OP_SetEventAsyn					OS_U(24)
#define OS_XC_OP_ClearPendingInterrupt          OS_U(25)
#define OS_XC_OP_ControlIdle					OS_U(26)
#define OS_XC_OP_ReturnResult					OS_U(27)
...
#define OS_N_CROSSCORE_HANDLERS					(OS_U(OS_XC_OP_ReturnResult + 6))
...
extern os_errorresult_t OS_SendActivateTaskAsyn(const os_task_t *);
...
extern os_errorresult_t OS_SendSetEventAsyn(os_taskid_t, const os_task_t *, os_eventmask_t);
...
extern os_errorresult_t OS_SendEnableInterruptSource(os_isrid_t, const os_isr_t *, os_boolean_t);
extern os_errorresult_t OS_SendDisableInterruptSource(os_isrid_t, const os_isr_t *);
extern os_errorresult_t OS_SendClearPendingInterrupt(os_isrid_t, const os_isr_t *);
...
extern void OS_RecvClearPendingInterrupt(os_message_t *);
...
extern void OS_RecvControlIdle(os_message_t *);
