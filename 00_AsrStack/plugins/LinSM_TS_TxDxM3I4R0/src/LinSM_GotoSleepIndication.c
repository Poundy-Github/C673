...
/* !LINKSTO LinSM.ASR20-11.SWS_LinSM_00243,1 */
...
/* !LINKSTO LinSM.ASR20-11.SWS_LinSM_91000_EB,1 */
...
)
{
  ...
  {
    /* !LINKSTO LinSM.ASR20-11.SWS_LinSM_00240,1 */
  ...
  else
  {
    ...
    {
      /* !LINKSTO LinSM.ASR20-11.SWS_LinSM_00239,1 */
...
#endif
    {
      ...
      /* !LINKSTO LinSM.ASR20-11.SWS_LinSM_00232,1 */
      if ( currentState == LINSM_FULL_COM )
      {
        /* !LINKSTO LinSM.ASR20-11.SWS_LinSM_00231,1 */
        LinSM_GotoSleep(id);
