/* kern-erruni-ClearPendingInterrupt.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblClearPendingInterrupt[5] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_ClearPendingInterrupt =
{
    OS_errtblClearPendingInterrupt,
