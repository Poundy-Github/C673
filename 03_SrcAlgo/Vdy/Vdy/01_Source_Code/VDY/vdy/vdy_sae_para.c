...
const real32_T vdy_sae_Cr_p = 80000.0F;
const real32_T vdy_sae_I_matrix_p[4] = { 1.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_sae_K_default_p[2] = { 0.0F, 0.0F } ;

const real32_T vdy_sae_P_init_p[4] = { 1.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_sae_Q_add_p[4] = { 0.0F, 0.0F, 0.0F, 0.0F } ;

const real32_T vdy_sae_Q_gain_p[3] = { 1000.0F, 1.0F, 0.2F } ;

const real32_T vdy_sae_Q_sigmas_p[2] = { 0.01F, 0.01F } ;

const real32_T vdy_sae_R_p = 0.001F;
const real32_T vdy_sae_x_init_p[2] = { 0.0001F, 0.001F } ;
