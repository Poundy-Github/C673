/* $Header: DMC_Lat_SAC_Accuracy_Calculation.h 1.23 2020/08/20 10:43:05CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_SAC_Accuracy_Calculation.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_SAC_Accuracy_Calculation_h_
#define RTW_HEADER_DMC_Lat_SAC_Accuracy_Calculation_h_
#include <math.h>
#ifndef DMC_Lat_SAC_Accuracy_Calculation_COMMON_INCLUDES_
# define DMC_Lat_SAC_Accuracy_Calculation_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Lat_SAC_Accuracy_Calculation_COMMON_INCLUDES_ */

#include "DMC_Lat_SAC_Accuracy_Calculation_types.h"
...
/* Block states (auto storage) for model 'DMC_Lat_SAC_Accuracy_Calculation' */
#ifndef DMC_Lat_SAC_Accuracy_Calculation_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T UnitDelay_DSTATE;           /* '<S11>/Unit Delay' */
  real32_T UnitDelay_DSTATE_ghok;      /* '<S16>/Unit Delay' */
  real32_T UnitDelay_DSTATE_nrkb;      /* '<S22>/Unit Delay' */
} rtDW_DMC_Lat_SAC_Accuracy_Calculation_T;

#endif                                 /*DMC_Lat_SAC_Accuracy_Calculation_MDLREF_HIDE_CHILD_*/

extern void DMC_Lat_SAC_Accuracy_Calculation_Init(void);
extern void DMC_Lat_SAC_Accuracy_Calculation(const real32_T *rt_erh2I, const
  real32_T *rt_gd42I, const real32_T *rt_cpaoI, const boolean_T *rt_e4hoI, const
  real32_T *rt_ngfdI, const real32_T *rt_f3r3I, const boolean_T *rt_kkebI, const
  real32_T *rt_hny3I, const real32_T *rt_kwugI, real32_T *rt_erh2sI, real32_T
  *rt_gd42sI, real32_T *rt_cpaomI, real32_T *rt_e4ho4I);

/* Model reference registration function */
extern void DMC_Lat_SAC_Accuracy_Calculation_initialize(void);

#ifndef DMC_Lat_SAC_Accuracy_Calculation_MDLREF_HIDE_CHILD_

/* Block states (auto storage) */
extern rtDW_DMC_Lat_SAC_Accuracy_Calculation_T
  DMC_Lat_SAC_Accuracy_Calculation_DWork;
 ...
 *
 * '<Root>' : 'DMC_Lat_SAC_Accuracy_Calculation'
 * '<S1>'   : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Cmd_Fading_Signal_Computation'
 * '<S2>'   : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Rate_Fading_Signal_Computation'
 * '<S3>'   : 'DMC_Lat_SAC_Accuracy_Calculation/LCO_Comp_Factor_Arbitration'
 * '<S4>'   : 'DMC_Lat_SAC_Accuracy_Calculation/LCO_Compensation_Factor_Fader'
 * '<S5>'   : 'DMC_Lat_SAC_Accuracy_Calculation/LCO_Dos_Limit_Scale_Saturation'
 * '<S6>'   : 'DMC_Lat_SAC_Accuracy_Calculation/LCO_Load_Compensation_Factor'
 * '<S7>'   : 'DMC_Lat_SAC_Accuracy_Calculation/Lateral_Error_Fading_Signal_Computation'
 * '<S8>'   : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Cmd_Fading_Signal_Computation/LCO_Fading_Signal_Selection'
 * '<S9>'   : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Cmd_Fading_Signal_Computation/LCO_Min_Curvature_Command_Filtering'
 * '<S10>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Cmd_Fading_Signal_Computation/LC_Min_Curvature_Command'
 * '<S11>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Cmd_Fading_Signal_Computation/LCO_Min_Curvature_Command_Filtering/LAT_Dual_Slope_Pt1_Filter'
 * '<S12>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Cmd_Fading_Signal_Computation/LCO_Min_Curvature_Command_Filtering/LAT_Dual_Slope_Pt1_Filter/Compare To Zero'
 * '<S13>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Rate_Fading_Signal_Computation/LCO_Fading_Signal_Error_Selection'
 * '<S14>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Rate_Fading_Signal_Computation/LCO_Minimum_Curv_Dot_Enhancement'
 * '<S15>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Rate_Fading_Signal_Computation/LCO_Minimum_Curvature_Dot'
 * '<S16>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Rate_Fading_Signal_Computation/LCO_Minimum_Curv_Dot_Enhancement/LAT_Dual_Slope_Pt1_Filter'
 * '<S17>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Curvature_Rate_Fading_Signal_Computation/LCO_Minimum_Curv_Dot_Enhancement/LAT_Dual_Slope_Pt1_Filter/Compare To Zero'
 * '<S18>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Lateral_Error_Fading_Signal_Computation/LCO_Fading_Signal_Error_Selection'
 * '<S19>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Lateral_Error_Fading_Signal_Computation/LCO_Minimum_Control_Error'
 * '<S20>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Lateral_Error_Fading_Signal_Computation/LCO_Minimum_Error_Enhancement'
 * '<S21>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Lateral_Error_Fading_Signal_Computation/LCO_Minimum_Lateral_Error'
 * '<S22>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Lateral_Error_Fading_Signal_Computation/LCO_Minimum_Error_Enhancement/LAT_Dual_Slope_Pt1_Filter'
 * '<S23>'  : 'DMC_Lat_SAC_Accuracy_Calculation/Lateral_Error_Fading_Signal_Computation/LCO_Minimum_Error_Enhancement/LAT_Dual_Slope_Pt1_Filter/Compare To Zero'
 */

/*-
 * Requirements for '<Root>': DMC_Lat_SAC_Accuracy_Calculation
 */
#endif                                 /* RTW_HEADER_DMC_Lat_SAC_Accuracy_Calculation_h_ */
