...
/* minor version check */
#if (CANTSYN_AR_RELEASE_MINOR_VERSION != 6U )
#error CANTSYN_AR_RELEASE_MINOR_VERSION wrong (!= 6U)
#endif
...
#error CANTSYN_SW_MAJOR_VERSION wrong (!= 3U)
#endif
...
/* patch version check */
#if (CANTSYN_SW_PATCH_VERSION < 0U)
#error CANTSYN_SW_PATCH_VERSION wrong (< 0U)
#endif
...
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00031,1 */
...
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00041,1 */
...
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00094,1 */
...
)
{
  ...
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00088,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00089,1 */
...
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00093,1 */
...
)
{
...
#endif
  {
...
#if(CANTSYN_TX_SYNC_USED == STD_ON)
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00003,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00006,1 */
    /* Deviation TASKING-1 */
    for(PduIdx = 0U; PduIdx < CANTSYN_NUMBER_OF_SYNC_MASTERS; PduIdx++)
    {
      ...
      /* Clear the Sequence Counter */ /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00007,1 */
...
#if((CANTSYN_TX_SYNC_USED == STD_ON) || (CANTSYN_TX_OFFSET_USED == STD_ON))
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00095,1 */
...
)
{
  ...
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00088,1 */ /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00089,1 */
    CANTSYN_DET_REPORT_ERROR(CANTSYN_SID_SETTRANSMISSIONMODE, CANTSYN_E_UNINIT);
  }
  else if((CANTSYN_TX_ON != Mode) && (CANTSYN_TX_OFF != Mode))
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00134,1 */ /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00089,1 */
...
)
{
  ...
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00097.PduInfoPtr.E_NULL_POINTER.RxIndication,1 */
    CANTSYN_DET_REPORT_ERROR(CANTSYN_SID_RXINDICATION, CANTSYN_E_NULL_POINTER);
    RetVal = E_NOT_OK ;
  }
  else if(NULL_PTR == PduInfoPtr->SduDataPtr)
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00097.SduDataPtr.E_NULL_POINTER.RxIndication,1 */
    CANTSYN_DET_REPORT_ERROR(CANTSYN_SID_RXINDICATION, CANTSYN_E_NULL_POINTER);
    RetVal = E_NOT_OK ;
  }
  /* check if received PduId exists */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00086,1 */
  else if( ( (uint8)CANTSYN_NUMBER_OF_SLAVES - (uint8)1U ) < (uint8)RxPduId )
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00097.INVALID_PDUID.RxIndication,1 */
  ...
  /* check the received Pdu Length */
#if(CANTSYN_RX_USE_EXTENDED_MSG == STD_ON)
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00010.DLC.ExtendedMessage,1 */
    ...
    else if( ( CanTSyn_TimeSlaveConfig[RxPduId].IsExtendedMessage == 0U ) && ( (uint8)(PduInfoPtr->SduLength) != CANTSYN_MSG_SIZE)  )
    {
      ...
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00010.DLC.NormalMessage,1 */
...
)
{
  ...
  if( CanTSyn_RxIndication_Validation(RxPduId, PduInfoPtr) == E_OK)
  {
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00073,1 */
    ...
    if(E_OK == CanTSyn_CheckMsgType(rxPduId, RxStatus, sduDataPtr, &CrcValidation))
    {
      ...
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00135,1 */
...
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00099,1 */
...
)
{
...
#endif /* CANTSYN_DEV_ERROR_DETECT == STD_ON */
  {
    ...
    {
#if(CANTSYN_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00100,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00088,1 */ /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00089,1 */
    ...
    else
    {
      ...
      if(TxPduId >= CANTSYN_NUMBER_OF_SYNC_MASTERS)
      {
        ...
        P2CONST(CanTSyn_TimeMasterDomainConfigType, AUTOMATIC, CANTSYN_APPL_CONST) CanTSyn_OfsTimeMasterDomainPtr =
            &CanTSyn_TimeMasterConfig[TxPduId + CANTSYN_NUMBER_OF_SYNC_MASTERS];
        ...
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00042,1 */
        ...
        {
          /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00037,1 */
          ...
          if(result == E_OK)
          {
            ...
            /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00124,1 */
...
#endif /* (CANTSYN_TX_OFFSET_USED == STD_ON) */
      {
        ...
        /* If the time is not expired and the result is E_Ok continue with processing
           the confirmation, else reload the debounce and reset the relevant data */
         /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00033,1 */
        ...
        {
          /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00027,1 */
...
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00102,1 */
FUNC(void, CANTSYN_CODE) CanTSyn_MainFunction(void)
{
  ...
  if(TRUE == CanTSyn_Initialized)
  {
          ...
          PduIndex++)
      {
        ...
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00044,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00043,1 */
      ...
      switch(CanTSyn_SyncSlavePtr->RxStatus)
      {
        ...
        case CANTSYN_FUPMSG_RX_WAIT_TIMEOUT:
        {
          ...
          if(CanTSyn_SyncSlavePtr->TimeRxFollowUpOffset == 0U)
          {
            ...
            /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00063,1 */
      ...
      switch(CanTSyn_OffsetSlavePtr->RxStatus)
      {
        ...
        case CANTSYN_OFNSMSG_RX_WAIT_TIMEOUT:
        {
          ...
          if(CanTSyn_OffsetSlavePtr->TimeRxFollowUpOffset == 0U)
          {
            ...
            /* reset due to timeout */
            /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00071,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00012,1 */ /* User Byte 0 */
  TxDataPtr[CANTSYN_B3_MSG_RESERVED] = CanTSyn_SyncMaster[CanTSynPduIdx].UserByte0;

  /* assemble Bytes 4-7 in Big Endian format */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00008,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00015.NormalMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00017.NormalMessage,1 */
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00015.ExtendedMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00017.ExtendedMessage,1 */
  ...
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00017.NormalMessage,1 */ /* Type with CRC support */
    TxDataPtr[CANTSYN_B0_MSG_TYPE] = CANTSYN_SYNC_WITH_CRC;

    /* add the DataID Value based on the current sequence counter */ /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00054,1 */
    ...
    if(MasterConfigPtr->IsExtendedMessage)
    {
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00085.CRC.ExtendedMessage,1 */
    ...
    {
      /* get the CRC value */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00050,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00085.CRC.NormalMessage,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00049_OFNS_SCUnchanged,1 */
  ...
  /* assemble Bytes 4-7 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00008,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00016.NormalMessage,1 */
...
#if (CANTSYN_TX_USE_EXTENDED_MSG == STD_ON)
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00016.ExtendedMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00018.ExtendedMessage,1 */
  ...
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00018.NormalMessage,1 */ /* Type with CRC support */
    TxDataPtr[CANTSYN_B0_MSG_TYPE] = CANTSYN_FUP_WITH_CRC;

    /* get DataId value based on the current sequence counter */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00054,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00025,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00035,1 */
...
)
{
  ...
  if(CanTSyn_TimeMasterDomainPtr->IsExtendedMessage)
  {
    ...
    {
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00112,1 */
      DataId = CanTSyn_TimeMasterConfig[CanTSynPduIdx+CANTSYN_NUMBER_OF_SYNC_MASTERS].SyncOfsDataIdListPtr[seqCounter];

      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00128,1 */ /* Type with CRC support */
...
#endif /* CANTSYN_TX_CRC_USED == STD_ON */
    {
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00111,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00126,1 */
...
)
{
  ...
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00129,1 */ /* Type with CRC support */
...
#endif /* CANTSYN_TX_CRC_USED == STD_ON */
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00127,1 */
...
)
{
  ...
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00046,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00056,1 */
    ...
    if(E_OK == StbM_GetOffset(CanTSyn_TimeMasterDomainPtr->SyncTimeBaseId, &StbMTimeStamp, &UserData))
    {
      ...
      /* save the user Data */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00011,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00013,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00014,1 */
      ...
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00048,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00049_OFNS_SCUnchanged,1 */
  ...
  if(MessageAccepted == TRUE)
  {
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00136,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00123,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00032,1 */
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00125,1 */
#if(CANTSYN_TX_IMMEDIATE_TRANSMISSION == STD_OFF)
...
#endif
  {
    ...
    if((offsetTimeBaseStatus & CANTSYN_GLOBAL_TIME_BASE_MASK) != 0U)
    {
      ...
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00118,1 */
#if(CANTSYN_TX_IMMEDIATE_TRANSMISSION == STD_ON)
      ...
      if(CanTSyn_TimeMasterDomainPtr->IsImmediateTimeSync == TRUE)
      {
        ...
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00117,1 */
      ...
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00038,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00119,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00121.OFS,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00120.OFS,1 */
...
)
{
  ...
  case CANTSYN_OFSMSG_SEND_WAIT:
  {
    ...
    if(E_OK == CanTSyn_IsTxOFSMessageAwaited(&newOfsTimeBaseCounter, &isImmediateOFSTransmission, ConfirmationHandleId))
    {
      ...
      {
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00036,1 */
  ...
  {
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00124,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00040,1 */
    /* wait until timer will expire */
    CanTSyn_OffsetMasterPtr->DebounceTime--;
    ...
    if(CanTSyn_OffsetMasterPtr->DebounceTime == 0U)
    {
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00039.SameTimeDomain,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00045,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00056,1 */
  ...
  if(E_OK == StbM_BusGetCurrentTime(CanTSyn_TimeMasterDomainPtr->SyncTimeBaseId, &StbMTimeStamp, &T0VLT, &UserData))
  {
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00030.SyncToSubDomain.SGW,1 */
    if((StbMTimeStamp.timeBaseStatus & CANTSYN_SYNC_TO_GATEWAY_MASK) != 0U)
    {
    ...
    {
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00030.SyncToGTM.SGW,1 */
...
#if(CANTSYN_TX_IMMEDIATE_TRANSMISSION == STD_ON)
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00119,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00120.SYNC,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00122,1 */
...
#endif /* (CANTSYN_TX_IMMEDIATE_TRANSMISSION == STD_ON) */
      {
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00028,1 */
...
)
{
  ...
  /* if T4 >= 1s */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00045,1 */ /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00056,1 */
  /* save the seconds portion of Fup T4 into OVS */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00047,1 */
...
)
{
...
#endif
  {
    ...
    if((syncTimeBaseStatus & CANTSYN_GLOBAL_TIME_BASE_MASK) != 0U)
    {
       ...
       * less than zero */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00121.SYNC,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00122,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00028,1 */
...
)
{
  ...
  case CANTSYN_FUPMSG_SEND_WAIT:
  {
    ...
    if(CanTSyn_SyncMasterPtr->DebounceTime == 0U)
    {
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00029.SameTimeDomain,1 */
      ...
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00049.FUP.SCUnchanged,1 */
  ...
  switch(CanTSyn_MasterPtr->TxStatus)
  {
    case CANTSYN_SYNCMSG_WAIT_TXCONF:
    {
      ...
      if(ProcessConfirmation)
      {
        ...
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00026,1 */
        /* FUP message will be sent next */
        CanTSyn_MasterPtr->TxStatus = CANTSYN_FUPMSG_SEND_WAIT;
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00137,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00138,1 */
#if (CANTSYN_MASTER_TIME_DOMAIN_VALIDATION_SUPPORT == STD_ON)
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00141,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00055.CRC.ExtendedMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00055.CRC.NormalMessage,1 */
...
{
  Std_ReturnType RetVal = E_NOT_OK;
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00110.ValidFUPMessage.NoCRC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00110.ValidFUPMessage.CRC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00110.InvalidType.FUPMessage,1 */
#if(CANTSYN_RX_CRC_USED == STD_ON)
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00058.SYNC.ValidType,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00059.SYNC.ValidType,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00109.ValidSYNCMessage.NoCRC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00109.ValidSYNCMessage.CRC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00109.InvalidType.SYNCMessage,1 */
#if(CANTSYN_RX_CRC_USED == STD_ON)
...
)
{
  Std_ReturnType RetVal = E_NOT_OK;
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00114.ValidOFNSMessage.NoCRC,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00114.ValidOFNSMessage.CRC,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00114.InvalidType.OFNSMessage,1 */
#if(CANTSYN_RX_CRC_USED == STD_ON)
  boolean isCrcType = CANTSYN_IS_CRC_VAL_OFNS(SlavePduId, Type);
#endif

/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00070.ValidOFNSMessage,1 */
#if (CANTSYN_RX_CRC_USED == STD_OFF)
  if(
...
)
{
  ...
  /* check the received message type */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00066.Valid.NormalOFSMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00067.Valid.OFSMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00065.Valid.NormalOFSMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00113.ValidOFSMessage.NoCRC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00113.ValidOFSMessage.CRC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00113.InvalidType.OFSMessage,1 */
#if (CANTSYN_RX_CRC_USED == STD_OFF)
  if(
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00079.Startup.NoSCCheck.SYNC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00079.Startup.NoSCCheck.OFS,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00078.TS.IgnoreMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00078.TS.IgnoreMessage0DeltaSC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00078.SYNC.TimeSequenceCounterJumpWidthLimit,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00078.OFS.TimeSequenceCounterJumpWidthLimit,1 */
  ...
  else
  {
     ...
     else
     {
        ...
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00079.DeltaSC.GreaterThan0.TBUpdate.NoSCCheck.SYNC,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00079.DeltaSC.GreaterThan0.TBUpdate.NoSCCheck.OFS,1 */
...
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00130,1 */
/* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00131,1 */
#if(CANTSYN_RX_USE_EXTENDED_MSG == STD_ON)
  if(CanTSyn_TimeSlaveConfig[SlavePduId].IsExtendedMessage)
  {
...
#endif
  {
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00084,1 */
    RetVal = CanTSyn_CheckCRC
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00080,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00057.SYNC.ValidTypeAndCRC,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00060.ValidFUPMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00068.ValidOFNSMessage,1 */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00069.ValidOFNSMessage,1 */
...
)
{
  ...
  if(SlavePduId < CANTSYN_NUMBER_OF_SYNC_SLAVES)
  {
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00109.InvalidCRC.SYNCMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00057.SYNC.InvalidCRC,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00110.InvalidCRC.FUPMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00060.InvalidCRC.FUPMessage,1 */
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00057.SYNC.InvalidType,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00058.SYNC.InvalidType,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00059.SYNC.InvalidType,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00060.InvalidType.FUPMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00061.InvalidType.FUPMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00062.InvalidType.FUPMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00061.InvalidType.FUPMessage,1 */
  ...
  else
  {
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00113.InvalidCRC.OFSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00114.InvalidCRC.OFNSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00065.InvalidCRC.NormalOFSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00068.InvalidCRC.OFNSMessage,1 */
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00065.InvalidType.NormalOFSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00066.InvalidType.NormalOFSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00067.InvalidType.OFSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00068.InvalidType.OFNSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00069.InvalidType.OFNSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00067.InvalidType.OFSMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00070.InvalidType.OFNSMessage,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00115,1 */
  ...
  if(T4Nanoseconds <= CANTSYN_NANOSEC_MAX)
  {
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00075,1 */
    /* T0 + OVS + SyncTimeSec */
    ...
    /* check if the SGW bit */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00133.SyncToSubDomain.SGW,1 */
      /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00133.SyncToGTM.SGW,1 */
    ...
    /* set the global time */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00064,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00135,1 */
    ...
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00139,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00116,1 */
  measureData.pathDelay = 0U;

  /* get the nanoseconds portion from the message */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00074,1 */
  /* disassemble Bytes 4-7 (Big Endian format) */
  /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00008,1 */
  ...
  if(timeStamp.nanoseconds <= CANTSYN_NANOSEC_MAX)
  {
    ...
    /* set the global time */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00072.StbM.ExtendedMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00116,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00135,1 */
...
)
{
  ...
  if(timeStamp.nanoseconds <= CANTSYN_NANOSEC_MAX)
  {
    ...
    /* set the global time */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00072.StbM.NormalMessage,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00116,1 */
    /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00135,1 */
    (void)StbM_BusSetGlobalTime(CanTSyn_TimeSlaveConfig[PduId+CANTSYN_NUMBER_OF_SYNC_SLAVES].SyncTimeBaseId, &timeStamp, &userData, &measureData, &T_VLT);
  }
...
)
{
  ...
  switch(RxStatus)
  {
...
#endif /* (CANTSYN_RX_FOLLOWUP_TIMEOUT_USED == STD_ON) */
    {
      ...
      {
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00061.ValidFUPMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00076.SYNCMatchFUP.SC,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00062.ValidFUPMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00087,1 */
      ...
      else
      {
        ...
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00110.InvalidSC.FUPMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00060.InvalidSC.FUPMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00061.InvalidSC.FUPMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00062.InvalidSC.FUPMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00076.NoMatchSYNC_FUP.SC,1 */
...
#endif /* (CANTSYN_RX_FOLLOWUP_TIMEOUT_USED == STD_ON) */
    {
      ...
      {
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00077.OFSMatchOFNS.SC,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00087,1 */
      ...
      else
      {
        ...
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00077.NoMatchOFS_OFNS.SC,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00114.InvalidSC.OFNSMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00068.InvalidSC.OFNSMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00069.InvalidSC.OFNSMessage,1 */
        /* !LINKSTO CanTSyn.ASR20-11.SWS_CanTSyn_00070.InvalidSC.OFNSMessage,1 */
