/* $Header: DMC_Lat_TDF_Torque_Derating_Function_private.h 1.24 2020/08/20 10:43:18CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_TDF_Torque_Derating_Function_private.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_TDF_Torque_Derating_Function_private_h_
#define RTW_HEADER_DMC_Lat_TDF_Torque_Derating_Function_private_h_
#include "rtwtypes.h"
...
typedef struct {
  /* Expression: Tdf_trq_der_init_corr_y_schedul
   * Referenced by: '<S51>/TDF_Trq_Derating_Init_Corr'
   */
  real32_T TDF_Trq_Derating_Init_Corr_tableData[11];

  /* Expression: Tdf_trq_der_init_corr_x_schedul
   * Referenced by: '<S51>/TDF_Trq_Derating_Init_Corr'
   */
  real32_T TDF_Trq_Derating_Init_Corr_bp01Data[11];

  /* Expression: Tdf_der_thrs_curv_y_scheduling
   * Referenced by: '<S63>/TDF_Derating_Curv_Thrs_Schedul'
   */
  real32_T TDF_Derating_Curv_Thrs_Schedul_tableData[5];

  /* Expression: Tdf_der_thrs_curv_x_scheduling
   * Referenced by: '<S63>/TDF_Derating_Curv_Thrs_Schedul'
   */
  real32_T TDF_Derating_Curv_Thrs_Schedul_bp01Data[5];
} ConstParam_DMC_Lat_TDF_Torque_Derating_Function_T;

/* Constant parameters (auto storage) */
extern const ConstParam_DMC_Lat_TDF_Torque_Derating_Function_T
  DMC_Lat_TDF_Torque_Derating_Function_ConstP;

/* <== Enable QAC again after word size consistence check using limits.h has been done. */
/* PRQA L:LABEL_QAC_PRIVATE */
#endif                                 /* RTW_HEADER_DMC_Lat_TDF_Torque_Derating_Function_private_h_ */
