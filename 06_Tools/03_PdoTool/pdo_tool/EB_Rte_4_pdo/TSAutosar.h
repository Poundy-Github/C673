...
// KK #include <TSAutosar_Cfg.h> /* Non-Autosar platform specific definitions */
 ...
 */
// KK #include <Platforms_TSPlatforms.h>
 ...
 */
// KK #include <Atomics_TSPlatforms.h>
...
// KK #error TS_ARCH_FAMILY must be defined on the commandline
#endif

#if (!defined TS_ARCH_DERIVATE)
// KK #error TS_ARCH_DERIVATE must be defined on the commandline
#endif
