...
const real32_T vdy_yaw_rate_var_tune_p = 0.1F;
const real32_T vdy_ye_I_matrix_yaw_p[4] = { 1.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_ye_K_curve_default_p[4] = { 0.0F, 0.0F, 0.0F, 0.0F } ;

const real32_T vdy_ye_K_yaw_default_p[8] = { 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
  0.0F, 0.0F } ;

const real32_T vdy_ye_P_curve_init_p[4] = { 0.001F, 0.0F, 0.0F, 0.01F } ;

const real32_T vdy_ye_P_init_p[4] = { 1.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_ye_Q_add_p[4] = { 0.0F, 0.0F, 0.0F, 0.0F } ;

const real32_T vdy_ye_Q_curve_gain_p = 1000.0F;
const real32_T vdy_ye_Q_gain_p[4] = { 150000.0F, 2.0F, 0.001F, 0.05F } ;

const real32_T vdy_ye_Q_sigmas_curve_p[2] = { 0.5F, 0.5F } ;

const real32_T vdy_ye_Q_sigmas_p[2] = { 0.1F, 0.1F } ;

const real32_T vdy_ye_Q_sigmas_velo_gain_p[4] = { 1.0F, 1.0F, 0.04F, 10.0F } ;

const real32_T vdy_ye_R_curve_p[3] = { 8.0F, 10000.0F, 5.0F } ;

const real32_T vdy_ye_mahala_para_p[9] = { 2.0F, 0.8F, 0.8F, 0.8F, 0.8F, 0.01F,
  0.01F, 0.01F, 0.01F } ;

const real32_T vdy_ye_x_curve_init_p[2] = { 0.001F, 0.001F } ;

const real32_T vdy_ye_x_init_p[2] = { 0.001F, 0.001F } ;

const uint8_T vdy_ye_yaw_curve_ramp_para_p[2] = { 5U, 10U } ;
