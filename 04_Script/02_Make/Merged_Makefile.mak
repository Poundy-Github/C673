...
# from \common\Include\Platforms_OsSpecific\util\TC38XQ\Merged_Makefile.mak
# don't generate code for Os_Test Os_SingleCore Os_MemoryProtection snippets
TRESOS2_NOGEN_PLUGINS += Os_Test Os_SingleCore Os_MultiCore Os_MemoryProtection
# Multicore OS has the suffix _DPM for board files
BOARD_SUFFIX := _DPM

#################################################################
# DISABLE_MEMMAP_TEST_LOC_FILE
# use specific linker script for Bootloader tests
DISABLE_MEMMAP_TEST_LOC_FILE := true

#################################################################
# PREPROCESSOR_DEFINES
# set the preprocessing variable
