...
#ifndef RTW_HEADER_vdy_gye_private_h_
#define RTW_HEADER_vdy_gye_private_h_
#include "rtwtypes.h"
...
#error The variable for the parameter "VDY_IO_STATE_SUBSTITUE" is not defined
#else
#if (VDY_IO_STATE_SUBSTITUE < 0UL) || (VDY_IO_STATE_SUBSTITUE > 4294967295UL)
#error The value of the variable for the parameter "VDY_IO_STATE_SUBSTITUE" is outside of the range 0UL to 4294967295UL
#endif
#endif
...
/* PRQA S 7012 EOF */
extern void vdy_gye_Get_IO_State1(const uint8_T rtu_state_in[32],
  rtB_Get_IO_State1_vdy_gye *localB, uint32_T rtp_Filter);

#endif                                 /* RTW_HEADER_vdy_gye_private_h_ */
