...
#if(IRQ_GTMTOM0SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM0SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM0SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM0SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM0SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM0SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM0SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM0SR7_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM1SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM1SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM1SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM1SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM1SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM1SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM1SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM1SR7_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM2SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM2SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM2SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM2SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM2SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM2SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM2SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM2SR7_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM3SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM3SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM3SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM3SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM3SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM3SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM3SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM3SR7_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM4SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM4SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM4SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM4SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM4SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM4SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM4SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM4SR7_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM5SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM5SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM5SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM5SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM5SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM5SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM5SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTOM5SR7_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM0SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM0SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM0SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM0SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM1SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM1SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM1SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM1SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM2SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM2SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM2SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM2SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM3SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM3SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM3SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM3SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM4SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM4SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM4SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM4SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM5SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM5SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM5SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM5SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM6SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM6SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM6SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM6SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM7SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM7SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM7SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM7SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM8SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM8SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM8SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM8SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM9SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM9SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM9SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM9SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM10SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM10SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM10SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM10SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM11SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM11SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM11SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMATOM11SR3_EXIST == (STD_ON))
...
/******************** TIM 0 *************************************/
#if(IRQ_GTMTIM0SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM0SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM0SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM0SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM0SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM0SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM0SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM0SR7_EXIST == (STD_ON))
...
/******************** TIM 1 *************************************/
#if(IRQ_GTMTIM1SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM1SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM1SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM1SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM1SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM1SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM1SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM1SR7_EXIST == (STD_ON))
...
/******************** TIM 2 *************************************/
#if(IRQ_GTMTIM2SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM2SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM2SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM2SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM2SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM2SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM2SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM2SR7_EXIST == (STD_ON))
...
/******************** TIM 3 *************************************/
#if(IRQ_GTMTIM3SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM3SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM3SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM3SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM3SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM3SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM3SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM3SR7_EXIST == (STD_ON))
...
/******************** TIM 4 *************************************/
#if(IRQ_GTMTIM4SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM4SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM4SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM4SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM4SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM4SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM4SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM4SR7_EXIST == (STD_ON))
...
/******************** TIM 5 *************************************/
#if(IRQ_GTMTIM5SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM5SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM5SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM5SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM5SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM5SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM5SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM5SR7_EXIST == (STD_ON))
...
/******************** TIM 0 *************************************/
#if(IRQ_GTMTIM6SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM6SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM6SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM6SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM6SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM6SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM6SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM6SR7_EXIST == (STD_ON))
...
/******************** TIM 0 *************************************/
#if(IRQ_GTMTIM7SR0_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM7SR1_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM7SR2_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM7SR3_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM7SR4_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM7SR5_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM7SR6_EXIST == (STD_ON))
...
#if(IRQ_GTMTIM7SR7_EXIST == (STD_ON))
