...
# CHANGES:                   Revision 1.1 2017/06/13 16:06:18CEST Berendes, Ignacius (uid41806) 
# CHANGES:                   Initial revision
...
# CHANGES:                   Revision 1.0 2016/07/01 12:19:58CEST Prajescu, Claudia (uidl9533) 
# CHANGES:                   Initial revision
...
if eve_used:
    ...
    for e in arp32_env_list:
        ...
        if env["variant"] == "release" and not eve_hil_miniapp:		
          execfile(File("#../../../01_Source_Code/algo/" + component_name + "/algo_config.scfg").abspath)
          ...
          if Wrapper == True:	
            ...
            if wrappers_in_ram_rom == True:
                for wrapper_src_file in wrapper_src:
                    for folderName, subfolders, filenames in os.walk(Dir("#../../../01_Source_Code/algo").abspath):
