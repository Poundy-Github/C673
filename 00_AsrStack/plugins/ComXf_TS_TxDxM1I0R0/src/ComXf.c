...
#if (!defined COMXF_VENDOR_ID) /* configuration check */
...
#if (!defined COMXF_AR_RELEASE_MAJOR_VERSION) /* configuration check */
...
#if (!defined COMXF_AR_RELEASE_MINOR_VERSION) /* configuration check */
...
#if (!defined COMXF_AR_RELEASE_REVISION_VERSION) /* configuration check */
...
#if (!defined COMXF_SW_MAJOR_VERSION) /* configuration check */
...
#if (!defined COMXF_SW_MINOR_VERSION) /* configuration check */
...
#if (!defined COMXF_SW_PATCH_VERSION) /* configuration check */
#error COMXF_SW_PATCH_VERSION must be defined
#endif

/* patch version check */
#if (COMXF_SW_PATCH_VERSION < 35U)
#error COMXF_SW_PATCH_VERSION wrong (< 35U)
#endif
