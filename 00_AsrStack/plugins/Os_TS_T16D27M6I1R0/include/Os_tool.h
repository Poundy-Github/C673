 ...
 *
 * $Id: Os_tool.h 35018 2021-08-23 09:29:21Z saga272975 $
*/
...
/* This is not the unused parameter you are looking for. */
extern void* OS_unusedParamVortex;

/* OS_PARAM_UNUSED(p) - mark parameter p as unused parameter (or variable).
 * Usage: Function-like.
 */
#define OS_PARAM_UNUSED(p)	do { OS_unusedParamVortex = (void *) &(p); } while (0)
