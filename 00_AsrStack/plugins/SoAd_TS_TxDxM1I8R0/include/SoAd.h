...
#endif
/** \brief Defines the instance number of this Socket Adaptor.
 **        Because multiple instances of the Socket Adaptor are not supported,
...
#endif
/** \brief Defines the API ID of function SoAd_Init()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_GetVersionInfo()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_IfTransmit()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_TpTransmit()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_CancelTransmit()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_CancelReceive()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_GetSoConId()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_OpenSoCon()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_CloseSoCon()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_RequestIpAddrAssignment()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_ReleaseIpAddrAssignment()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_GetLocalAddr()
 **/
...
#endif
/** \brief Defines the API ID of function  SoAd_GetPhysAddr()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_EnableRouting()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_EnableSpecificRouting()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_DisableRouting()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_DisableSpecificRouting()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_SetRemoteAddr()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_TpChangeParameter()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_TcpIpRxIndication()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_CopyTxData()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_TxConfirmation()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_TcpAccepted()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_TcpConnected()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_TcpIpEvent()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_LocalIpAddrAssignmentChg()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_MainFunction()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_GetRemoteAddr()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_IfRoutingGroupTransmit()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_IfSpecificRoutingGroupTransmit()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_SetUniqueRemoteAddr()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_ReleaseRemoteAddr()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_GetAndResetMeasurementData()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_GetSoConMode()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_ChangeParameter()
 **/
...
#endif
/** \brief Defines the API ID of function SoAd_IsConnectionReady()
 **/
...
#endif
/** \brief Defines the API ID of internal functions
 **/
...
(
 ...
 /** \brief Checks the compatibility of the post-build configuration.
  **
  ** This service checks the compatibility of the post-build configuration
 ...
 ** \retval E_NOT_OK The request was not accepted (e.g. due to a still
 **                  ongoing transmission in the corresponding socket or
 **                  the message to be transmitted is too long).
 **
 ** \ServiceID{0x03}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 ...
 ** Passes the return value of TcpIp to the upper layer.
 **
 ** \param[in] SoConId  Identification of the socket connection
 **
 ...
 ** \retval TCPIP_OK          ARP and IpSec SA exist, data can be sent
 ...
 **
 ** \return Std_ReturnType
 ** \retval E_OK      The request was accepted (but not yet performed).
 ** \retval E_NOT_OK  The request was not accepted (e.g. cancellation not possible).
 **
 ** \ServiceID{0x05}
...
/** \brief Get socket connection ID for given PDU ID
 **
 ** Returns the socket connection index related to the specified transmit PDU ID. In case a
 ** fan-out is configured for TxPduId (i.e. multiple SoAdPduRouteDest specified),
 ** E_NOT_OK shall be returned.
 **
 ** \param[in]  TxPduId     Transmit the PDU ID specifying the SoAd socket connection for
 **                         which the socket connection index shall be returned.
 ** \param[out] SoConIdPtr  Pointer to the memory receiving the socket connection index
 **
 ** \returns Std_ReturnType
 ** \retval E_OK     The request was successful.
 ** \retval E_NOT_OK The request was not successful.
 ...
 **
 ** Returns the socket connection mode related to the specified socket connection.
 **
 ** \param[in]  SoConId     Index of the socket connection for which the mode shall be returned
 ** \param[out] ModePtr     Pointer to the memory where the socket connection mode shall be stored
 **
 ** \returns Std_ReturnType
 ** \retval E_OK     The request was successful.
 ** \retval E_NOT_OK The request was not successful.
 ...
 **
 ** This service opens the socket connection specified by the SoConId.
 **
 ...
 **
 ** This service closes the socket connection specified by the SoConId.
 **
 ** \param[in] SoConId  Socket connection index specifying the socket connection
 **                     to be closed
 ** \param[in] Abort
 **                     - TRUE: Socket connection is immediately terminated.
 **                     - FALSE: Socket connection is terminated if no other upper
 **                              layer uses this socket connection.
 **
 ** \returns Std_ReturnType
 ** \retval E_OK     The request was successful.
 ** \retval E_NOT_OK The request was not successful.
 ...
 **
 ** This API service initiates the local IP address assignment to be used for the socket
 ** connection specified by the SoConId.
 **
 ** \param[in] SoConId  Socket connection index specifying the socket connection for which the IP
 **                     address shall be set
 ** \param[in] Type     Type of IP address assignment that shall be initiated
 ** \param[in] LocalIpAddrPtr  Pointer to the structure containing the IP address that shall be
 **                            assigned to the EthIf controller indirectly specified via the SoConId.
 **                            Note: This parameter is only used if the parameter Type is set to
 ...
 **
 ** This API service releases the local IP address assignment used for the socket connection
 ** specified by the SoConId.
 **
 ...
 ** connection specified by the SoConId, the netmask, and default router.
 **
 ...
 ** \param[out] LocalAddrPtr     Pointer to the struct where the local address (IP address and port)
 **                              is stored
 ** \param[out] NetmaskPtr       Pointer to the memory where the network mask of the IPv4 address or
 **                              address prefix of the IPv6 address in CIDR notation is stored
 ** \param[out] DefaultRouterPtr Pointer to the struct where the IP address of the default router
 ...
 ** socket connection specified by the SoConId.
 **
 ** \param[in]  SoConId      Socket connection index representing the SoAd socket
 ...
 **
 ** Enables the routing of a group of PDUs in the SoAd related to the RoutingGroup specified by
 ** the parameter Id on a specific socket connection specified by the SoConId.
 ** Routing of PDUs can be either forwarding of PDUs from the upper layer to a TCP or UDP
 ** socket of the TCP/IP stack specified by a PduRoute or the other way around specified by a
 ** SocketRoute.
 **
 ...
 **
 ** Disables the routing of a group of PDUs in the SoAd related to the RoutingGroup specified by
 ** the parameter Id.
 ** Routing of PDUs can be either forwarding of PDUs from the upper layer to a TCP or UDP
 ** socket of the TCP/IP stack specified by a PduRoute or the other way around specified by a
 ** SocketRoute.
 ...
 **
 ** This API service sets the remote address (IP address and port) of the specified 
 ** socket connection.
 **
...
/** \brief Change a parameter of the TCP/IP stack
 **
 ** This API service requests the SoAd or TCP/IP stack to change a connection
 ** parameter. For example, the Nagle algorithm may be controlled by this API.
 **
 ** \param[in] Id         Identification of the I-PDU that the parameter change shall affect
 ...
 ** \param[in] ParameterValuePtr  Pointer to the memory containing the new parameter value
 **
 ** \returns Std_ReturnType
 ** \retval E_OK     The request was successful.
 ** \retval E_NOT_OK The request was not successful.
...
/** \brief Read the DHCP host name
 **
 ** By this API service, an upper layer of the SoAd can read the currently configured
 ** host name option in the DHCP submodule of the TCP/IP stack.
 **
 ...
 ** \param[in] Data               Pointer to the provided memory buffer the value is copied to.
 **
 ** \returns Std_ReturnType
 ** \retval E_OK     The request was successful.
 ** \retval E_NOT_OK The request was not successful.
...
/** \brief Write the DHCP host name
 **
 ** By this API service, an upper layer of the SoAd can set the host name option in the
 ...
 **                               This will be overwritten with the length of the actual data.
 ** \param[in] Data               Pointer to the memory containing the new parameter value
 **
 ** \returns Std_ReturnType
 ** \retval E_OK     The request was successful.
 ** \retval E_NOT_OK The request was not successful.
...
/** \brief Main function containing only the transmit part of the SoAd
 **
 ...
 **
 **  This API service releases the remote address (IP address and port) of the specified
 **  socket connection, i.e. it is set back to the configured remote
 **  address setting.
 **
 ...
 * Getting all MeasurementIdx's at once is not supported. SOAD_MEAS_ALL shall only be used to reset
 ...
 * \param[out] MeasurementDataPtr    Pointer to the data buffer where to copy measurement data
 *
 * \returns Std_ReturnType
 * \retval  E_OK     The function was successfully executed.
 * \retval  E_NOT_OK The function was not successfully executed.
 * \ServiceID{0x45}
 * \Reentrancy{Reentrant}
 * \Synchronicity{Synchronous}
 */
