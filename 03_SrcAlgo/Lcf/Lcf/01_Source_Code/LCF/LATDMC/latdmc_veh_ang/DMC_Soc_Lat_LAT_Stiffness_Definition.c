/* $Header: DMC_Soc_Lat_LAT_Stiffness_Definition.c 1.18 2020/08/20 10:43:31CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_Lat_LAT_Stiffness_Definition.c
   C source code generated on           : Mon Aug 17 20:48:40 2020
   Filename of Simulink Model           : DMC_Soc_Lat_LAT_Stiffness_Definition.mdl/.slx
   Revision of Simulink Model           : 1.16
 ***************************************************************************************************
...
#include "DMC_Soc_Lat_LAT_Stiffness_Definition_private.h"
 ...
 ***************************************************************************************************
   ...
   CALL: DMC_Soc_Lat_LAT_Stiffness_Definition_step()
   CALL: DMC_Soc_Lat_LAT_Stiffness_Definition_initialize(0)
   FILE: DMC_Soc_Lat_LAT_Stiffness_Definition.c
 ***************************************************************************************************
 */

/* Output and update for referenced model: 'DMC_Soc_Lat_LAT_Stiffness_Definition' */
void DMC_Soc_Lat_LAT_Stiffness_Definition(const real32_T *rt_erh2I, const
  real32_T *rt_gd42I, const real32_T *rt_cpaoI, uint8_T *rt_erh2sI)
{
  real32_T tmp_;
  real32_T tmp_0;

  /* MinMax: '<Root>/MinMax' incorporates:
   *  Constant: '<Root>/Sac_maximum_stiffness_request'
   */
  tmp_ = ((real32_T)Sac_maximum_stiffness_request) * 0.0009765625F;
  if ((*rt_gd42I) >= tmp_) {
    tmp_ = *rt_gd42I;
  }
  ...
  /* MinMax: '<Root>/MinMax3' incorporates:
   *  Constant: '<Root>/Sac_maximum_accuracy_request'
   */
  tmp_0 = ((real32_T)Sac_maximum_accuracy_request) * 0.0009765625F;
  if ((*rt_cpaoI) >= tmp_0) {
    tmp_0 = *rt_cpaoI;
  }
   ...
   *  MinMax: '<Root>/MinMax2'
   */
  *rt_erh2sI = (uint8_T)((real32_T)(100.0F * tmp_0));
}

/* Model initialize function */
void DMC_Soc_Lat_LAT_Stiffness_Definition_initialize(void)
{
