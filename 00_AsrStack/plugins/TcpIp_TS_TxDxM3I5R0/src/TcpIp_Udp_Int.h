...
/** \brief Read and reset Udp Unit measurement data
 *
 * This function reads and resets dropped datagrams caused by invalid destination UDP-Port, invalid
 * checksum and invalid packet format counters.
 *
 ...
 */
TS_MOD_PRIV_DECL FUNC(void, TCPIP_CODE) TcpIp_Udp_GetAndResetCounter
(
