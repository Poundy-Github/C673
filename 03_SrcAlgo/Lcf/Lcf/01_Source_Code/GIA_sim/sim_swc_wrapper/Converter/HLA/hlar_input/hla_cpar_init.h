/*! \file **********************************************************************
  ...
  CHANGE:                 Revision 1.1 2021/12/13 17:23:30CET Wang, David (Wangd3) 
  CHANGE:                 Initial revision
  CHANGE:                 Member added to project /ADAS/Projects/MFC5xx/MFC5J3/06_Algorithm/DPU/04_Engineering/01_Source_Code/GIA_sim/sim_swc_wrapper/Converter/HLA/hlar_input/project.pj
  CHANGE:                 Revision 1.0 2017/03/03 10:35:01CET Sorge, Sven (uidg3181) 
  CHANGE:                 Initial revision
  CHANGE:                 Member added to project /ADAS/SW/Integration/06_Simulation_Components/GIA_GenericInterfaceAdapter/04_Engineering/03_Workspace/Component_Workspace/GIA_sim/sim_swc_wrapper/Converter/HLA/hlar_input/project.pj
  CHANGE:                 Revision 1.17 2014/05/16 12:35:18CEST Sorge, Sven (uidg3181) 
  CHANGE:                 Inlined functions
  CHANGE:                 - Added comments -  uidg3181 [May 16, 2014 12:35:18 PM CEST]
  CHANGE:                 Change Package : 199693:5 http://mks-psad:7002/im/viewissue?selection=199693
...
#ifndef PC_SIM
inline int CParInit_HlaPar(CPAR_HLA_Parameter_t *pCPar_HlaPar)
{
  sint32 ret_val = 0;
...
inline int CParInit_HlarPar(CPAR_HLAR_Parameter_t *pCPar_HlarPar)
{
  sint32 ret_val = 0;
...
inline int CParInit_HlafPar(CPAR_HLAF_Parameter_t *pCPar_HlafPar)
{
  sint32 ret_val = 0;
