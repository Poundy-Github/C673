...
#if (SENT_AR_RELEASE_MINOR_VERSION != MCAL_AR_RELEASE_MINOR_VERSION)
#error "SENT_AR_RELEASE_MINOR_VERSION does not match."
#endif
...
#if (SENT_AR_RELEASE_REVISION_VERSION != MCAL_AR_RELEASE_REVISION_VERSION)
#error "SENT_AR_RELEASE_REVISION_VERSION does not match."
#endif
...
#if ( SENT_SW_MAJOR_VERSION != 20U )
#error "SENT_SW_MAJOR_VERSION does not match. "
#endif
#if ( SENT_SW_MINOR_VERSION != 0U )
...
void Sent_Init(const Sent_ConfigType * const ConfigPtr)
{
  uint8 CoreId;
  uint32 TempVal;
  #if ((SENT_DEV_ERROR_DETECT == STD_ON) || (SENT_RESET_SFR_AT_INIT == STD_ON))
