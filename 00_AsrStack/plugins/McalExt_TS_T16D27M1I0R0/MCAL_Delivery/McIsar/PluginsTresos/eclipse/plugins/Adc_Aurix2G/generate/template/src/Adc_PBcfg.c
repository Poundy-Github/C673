...
[!NOCODE!]
[!VAR "AdcEmuxEnable" = "AdcGeneral/AdcEmuxEnable"!][!//
[!VAR "AdcEmuxGroupInterface0" = "num:i(text:split(AdcGeneral/AdcEmuxGroupInterface0,'_ADC')[2])"!][!//
[!VAR "AdcEmuxGroupInterface1" = "num:i(text:split(AdcGeneral/AdcEmuxGroupInterface1,'_ADC')[2])"!][!//
[!ENDNOCODE!]
...
[!//
[!VAR "AdcChannelCount" = "num:i(count(AdcGroupDefinition/*))"!][!//
[!VAR "AdcGrpAnChDiagData" = "num:i(0)"!][!//
[!VAR "ChannelIdx" = "num:i(0)"!][!//
[!FOR "ChannelIdx" ="num:i(1)" TO "num:i($AdcChannelCount)"!][!//
  ...
  [!LOOP "../../AdcChannel/*"!][!//
    [!IF "@name = $TempNodeName"!][!//
      ...
      [!CALL "Adc_ConfigChDiagnosticsVal","PullDownDiagEnable"= "AdcPullDownDiagnosticEnable","MultiplexerDiagEnable" = "AdcMultiplexerDiagnosticEnable","MultiplexerDiagLevel"= "AdcMultiplexerDiagnosticLevel",
      "ConverterDiagEnable"= "AdcConverterDiagnosticEnable","ConverterDiagLevel"= "AdcConverterDiagnosticsLevel","AdcGrpAnChDiagData"= "$AdcGrpAnChDiagData"!][!//
    [!ENDIF!][!//
  [!ENDLOOP!][!//
  [!WS"2"!]{  [!"$AdcGrpAsChNum"!]U,                   [!"$AdcGrpAnChNum"!]U,                [!"AdcResRegDefinition/*[num:i($ChannelIdx)]"!]U,                [!"num:inttohex($AdcGrpAnChDiagData,8)"!]U}[!IF "$ChannelIdx != num:i($AdcChannelCount)"!],[!ENDIF!][!//
...
[!VAR "AdcGrpEmuxCfg" = "num:i(0)"!][!//
[!VAR "AdcConverterDiagChannelConfigured" = "num:i(0)"!][!//
[!VAR "AdcConverterDiagChannel" = "num:i(0)"!][!//
[!VAR "AdcDiagnosticChGrp" = "num:i(0)"!][!//
...
[!FOR "ChannelIdx" ="num:i(1)" TO "num:i($AdcChannelCount)"!][!//
  ...
  [!LOOP "../../AdcChannel/*"!][!//
    ...
    [!IF "@name = $TempNodeName"!][!//
      ...
      [!ENDIF!][!//
      [!IF "AdcPullDownDiagnosticEnable = 'true' or AdcMultiplexerDiagnosticEnable = 'true' or AdcConverterDiagnosticEnable = 'true'"!][!//
        [!VAR "AdcDiagnosticChGrp" = "num:i(1)"!][!//
        [!IF "AdcConverterDiagnosticEnable = 'true'"!][!//
          [!VAR "AdcConverterDiagChannelConfigured" = "num:i(1)"!][!//
          [!IF "$AdcGrpAnChNum = num:i(0)"!][!//
            [!VAR "AdcConverterDiagChannel" = "num:i(0)"!][!//
          [!ELSEIF "$AdcGrpAnChNum = num:i(1)"!][!//
            [!VAR "AdcConverterDiagChannel" = "num:i(1)"!][!//
          [!ENDIF!][!//
        [!ENDIF!][!//
      [!ENDIF!][!//
    [!ENDIF!][!//
...
[!FOR "ChannelIdx" ="num:i(1)" TO "num:i($AdcChannelCount)"!][!//
  [!IF "node:exists(node:ref(AdcGroupDefinition/*[num:i($ChannelIdx)])/AdcChannelLimitCheck/*[1])"!][!//
    [!IF "node:ref(AdcGroupDefinition/*[num:i($ChannelIdx)])/AdcChannelLimitCheck/*[1] = 'true'"!][!//
      ...
      [!IF "AdcEmuxChGroup = 'true'"!][!//
        [!ERROR!][!//
          ADC Code Generator: A EMUX Group does not support the Limit checking feature. [!"node:path(.)"!] contains limit checking channel in AdcGroupDefinition.
        [!ENDERROR!][!//
      [!ENDIF!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
...
[!ELSEIF "../../../../../AdcGeneral/AdcPriorityImplementation = 'ADC_PRIORITY_HW'"!]
  ...
  [!ELSE!]
    [!VAR "AdcPriotityLevel" = "num:i(0)"!][!// 
  [!ENDIF!]
  [!IF "./AdcGroupPriority/*[1] != num:i(255) and $AdcDiagnosticChGrp = num:i(1)"!]
    [!ERROR!][!//
      ADC Code Generator: Group having the Diagnostic channels [!"node:path(.)"!] is not configured with priority level of 255 in AdcGroupPriority.
    [!ENDERROR!][!//
  [!ENDIF!][!//
...
[!IF "$AdcConverterDiagChannelConfigured = num:i(1)"!]
  [!IF "AdcChannel0Alias != num:i(24) and $AdcConverterDiagChannel = num:i(0)"!]
    [!ERROR!][!//
      ADC Code Generator: Group having converter Diagnostic channel in [!"node:path(.)"!] does not configured with a dummy channel 24 in AdcChannel0Alias.
    [!ENDERROR!][!//
  [!ELSEIF "AdcChannel1Alias != num:i(24) and $AdcConverterDiagChannel = num:i(1)"!]
    [!ERROR!][!//
      ADC Code Generator: Group having converter Diagnostic channel in [!"node:path(.)"!] does not configured with a dummy channel 24 in AdcChannel1Alias.
    [!ENDERROR!][!//
  [!ENDIF!]
[!ENDIF!]
[!IF "AdcEmuxChGroup = 'true'"!][!//
  [!VAR "AdcGrpEmuxCfg" = "num:i(1)"!][!//
  [!VAR "AdcGrpEmuxCfg" = "bit:or($AdcGrpEmuxCfg,bit:shl(AdcEmuxStartSelection,1))"!][!//
[!ENDIF!]
[!ENDNOCODE!][!//
[!//
[!VAR "GroupIdx" = "$GroupIdx + num:i(1)"!][!//
  {/*Group Configuration structure for [!"@name"!] - ID[!"./AdcGroupId"!]*/
    ...
    */
    ...
    [!"num:inttohex($AdcGrpEmuxCfg,2)"!]U, /* EMUX configuration of the Group */
    [!"$AdcDiagnosticChGrp"!]U /* Diagnostic channels configured for the Group */
...
[!VAR "AdcEmuxEnabledHw" = "num:i(0)"!][!//
[!IF "(($AdcHwId = $AdcEmuxGroupInterface0) or ($AdcHwId = $AdcEmuxGroupInterface1))"!][!//
  [!VAR "AdcEmuxEnabledHw" = "num:i(1)"!][!//
[!ENDIF!]
[!CALL "Adc_ConfigIClassVal","ChSampleTime" ="AdcHwUnitInputClass/*[1]/AdcChSampleTime","ChPreChargeClkCycles"= "AdcHwUnitInputClass/*[1]/AdcChPreChargeClkCycles",
"ChConvMode"="AdcHwUnitInputClass/*[1]/AdcChConvMode", "ChSESPSEnable"="AdcHwUnitInputClass/*[1]/AdcChSESPSEnable",
"EmuxEnable"= "$AdcEmuxEnabledHw","EmuxChSampleTime" ="AdcHwUnitInputClass/*[1]/AdcEmuxChSampleTime", "EmuxChPreChargeClkCycles"= "AdcHwUnitInputClass/*[1]/AdcEmuxChPreChargeClkCycles",
"EmuxChConvMode"="AdcHwUnitInputClass/*[1]/AdcEmuxChConvMode", "EmuxChSESPSEnable"="AdcHwUnitInputClass/*[1]/AdcEmuxChSESPSEnable",
"AdcChClassVal"="$AdcChClassVal"!][!//
[!VAR "AdcHwUnitIClass0Val" = "num:i($AdcChClassVal)"!][!//
[!VAR "AdcChClassVal" = "num:i(0)"!][!//
[!CALL "Adc_ConfigIClassVal","ChSampleTime" ="AdcHwUnitInputClass/*[2]/AdcChSampleTime","ChPreChargeClkCycles"= "AdcHwUnitInputClass/*[2]/AdcChPreChargeClkCycles",
"ChConvMode"="AdcHwUnitInputClass/*[2]/AdcChConvMode","ChSESPSEnable"="AdcHwUnitInputClass/*[2]/AdcChSESPSEnable",
"EmuxEnable"= "$AdcEmuxEnabledHw","EmuxChSampleTime" ="AdcHwUnitInputClass/*[1]/AdcEmuxChSampleTime", "EmuxChPreChargeClkCycles"= "AdcHwUnitInputClass/*[1]/AdcEmuxChPreChargeClkCycles",
"EmuxChConvMode"="AdcHwUnitInputClass/*[1]/AdcEmuxChConvMode", "EmuxChSESPSEnable"="AdcHwUnitInputClass/*[1]/AdcEmuxChSESPSEnable",
"AdcChClassVal"="$AdcChClassVal"!][!//
...
[!VAR "AdcChClassVal" = "num:i(0)"!][!//
[!CALL "Adc_ConfigIClassVal","ChSampleTime" ="AdcChSampleTime", "ChPreChargeClkCycles"= "AdcChPreChargeClkCycles","ChConvMode"="AdcChConvMode", "ChSESPSEnable"="AdcChSESPSEnable",
"EmuxEnable"= "$AdcEmuxEnable", "EmuxChSampleTime" ="AdcEmuxChSampleTime", "EmuxChPreChargeClkCycles"= "AdcEmuxChPreChargeClkCycles",
"EmuxChConvMode"="AdcEmuxChConvMode", "EmuxChSESPSEnable"="AdcEmuxChSESPSEnable",
"AdcChClassVal"="$AdcChClassVal"!][!//
...
[!ENDSELECT!][!//
[!SELECT "AdcConfigSet"!][!//
[!VAR "AdcGlobEmuxGrpInterfaceCfg" = "num:i(0)"!][!//
[!IF " $AdcEmuxEnable = 'true'"!][!//
[!CALL "Adc_ConfigGlobEmuxGrpInterfaceCfgVal","EmuxGrpInterface0"="$AdcEmuxGroupInterface0",
"EmuxGrpInterface1"="$AdcEmuxGroupInterface1","AdcGlobEmuxGrpInterfaceCfg"="$AdcGlobEmuxGrpInterfaceCfg"!][!//
[!ENDIF!]
[!ENDSELECT!]
[!//
  ...
  [!"num:inttohex($AdcGlobEmuxGrpInterfaceCfg,8)"!]U /*Configuration value for EMUXSEL register */
};
/* MISRA2012_RULE_5_1_JUSTIFICATION: Memmap macros are defined as per Autosar
   naming convention, hence it goes beyond 32 characters.*/
/* MISRA2012_RULE_5_2_JUSTIFICATION: Memmap macros are defined as per Autosar
