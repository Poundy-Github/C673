/* $Header: DMC_Soc_Lat_SAC_Proportional_Factor_Derating.h 1.16 2020/08/20 10:43:45CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_Lat_SAC_Proportional_Factor_Derating.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Soc_Lat_SAC_Proportional_Factor_Derating_h_
#define RTW_HEADER_DMC_Soc_Lat_SAC_Proportional_Factor_Derating_h_
#include <math.h>
#ifndef DMC_Soc_Lat_SAC_Proportional_Factor_Derating_COMMON_INCLUDES_
# define DMC_Soc_Lat_SAC_Proportional_Factor_Derating_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Soc_Lat_SAC_Proportional_Factor_Derating_COMMON_INCLUDES_ */

#include "DMC_Soc_Lat_SAC_Proportional_Factor_Derating_types.h"
...
/* Block states (auto storage) for model 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating' */
#ifndef DMC_Soc_Lat_SAC_Proportional_Factor_Derating_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T UnitDelay_DSTATE;           /* '<S1>/Unit Delay' */
  real32_T UnitDelay_DSTATE_jjbb;      /* '<S5>/Unit Delay' */
} rtDW_DMC_Soc_Lat_SAC_Proportional_Factor_Derating_T;

#endif                                 /*DMC_Soc_Lat_SAC_Proportional_Factor_Derating_MDLREF_HIDE_CHILD_*/

extern void DMC_Soc_Lat_SAC_Proportional_Factor_Derating_Init(void);
extern void DMC_Soc_Lat_SAC_Proportional_Factor_Derating(const real32_T
  *rt_erh2I, const real32_T *rt_gd42I, real32_T *rt_erh2sI, real32_T *rt_gd42sI,
  boolean_T *rt_cpaoI, real32_T *rt_e4hoI);

/* Model reference registration function */
extern void DMC_Soc_Lat_SAC_Proportional_Factor_Derating_initialize(void);

#ifndef DMC_Soc_Lat_SAC_Proportional_Factor_Derating_MDLREF_HIDE_CHILD_

/* Block states (auto storage) */
extern rtDW_DMC_Soc_Lat_SAC_Proportional_Factor_Derating_T
 ...
 *
 * Block '<Root>/Display (1)' : Unused code path elimination
 * Block '<S1>/Display (1)' : Unused code path elimination
 * Block '<S1>/Display (2)' : Unused code path elimination
 ...
 * Block '<Root>/Scope (3)' : Unused code path elimination
 * Block '<Root>/Scope (4)' : Unused code path elimination
 * Block '<Root>/Scope (5)' : Unused code path elimination
 */
 ...
 *
 * '<Root>' : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating'
 * '<S1>'   : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating/SAC_Control_Error_Filtering'
 * '<S2>'   : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating/SAC_Control_Error_Saturation'
 * '<S3>'   : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating/SAC_Debug_Signal (1)'
 * '<S4>'   : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating/SAC_Debug_Signal (2)'
 * '<S5>'   : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating/SAC_Low_Dyn_Control_Error_Filtering'
 * '<S6>'   : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating/SAC_Control_Error_Filtering/Compare To Zero'
 * '<S7>'   : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating/SAC_Control_Error_Saturation/System Requirements'
 * '<S8>'   : 'DMC_Soc_Lat_SAC_Proportional_Factor_Derating/SAC_Low_Dyn_Control_Error_Filtering/Compare To Zero'
 */

/*-
 * Requirements for '<Root>': DMC_Soc_Lat_SAC_Proportional_Factor_Derating
 */
#endif                                 /* RTW_HEADER_DMC_Soc_Lat_SAC_Proportional_Factor_Derating_h_ */
