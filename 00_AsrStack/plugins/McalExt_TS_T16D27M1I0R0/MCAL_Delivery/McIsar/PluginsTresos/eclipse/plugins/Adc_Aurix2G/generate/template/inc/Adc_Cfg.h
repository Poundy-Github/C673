...
*/
[!/* [cover parentID={A673698D-999D-467c-BAA6-5E436AE94468}]ADC_RUNTIME_ERROR_DETECT[/cover] */!][!//
#define ADC_RUNTIME_ERROR_DETECT  [!//
[!IF "(node:exists(AdcGeneral/AdcRunTimeErrorDetect))"!][!//
[!CALL "Adc_ConfigPreCompileSwitch","NodeVal" = "AdcGeneral/AdcRunTimeErrorDetect"!][!//
[!ELSE!][!//
(STD_OFF)[!//
[!ENDIF!][!//
...
*/
[!/* [cover parentID={E2E15C08-9FF6-479a-A00F-FDBEE6A2AAE3}]ADC_EMUX_ENABLE[/cover] */!][!//
#define ADC_EMUX_ENABLE  [!//
[!CALL "Adc_ConfigPreCompileSwitch","NodeVal" = "AdcGeneral/AdcEmuxEnable"!][!//
