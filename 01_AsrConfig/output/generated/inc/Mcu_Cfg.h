...
#define MCU_E_OSC_FAILURE               \
           (DemConf_DemEventParameter_MCU_E_OSC_FAILURE)
...
#define MCU_E_SYSTEM_PLL_TIMEOUT_ERR                \
           (DemConf_DemEventParameter_MCU_E_SYSTEM_PLL_TIMEOUT_ERR)
...
#define MCU_E_PERIPHERAL_PLL_TIMEOUT_ERR                \
           (DemConf_DemEventParameter_MCU_E_PERIPHERAL_PLL_TIMEOUT_ERR)
...
#define MCU_E_SYSTEM_PLL_LOCK_LOSS                \
           (DemConf_DemEventParameter_MCU_E_SYSTEM_PLL_LOCK_LOSS)
...
#define MCU_E_PERIPHERAL_PLL_LOCK_LOSS                \
           (DemConf_DemEventParameter_MCU_E_PERIPHERAL_PLL_LOCK_LOSS)
...
#define MCU_E_GTM_CLC_ENABLE_ERR                \
           (DemConf_DemEventParameter_MCU_E_GTM_CLC_ENABLE_ERR)
...
#define MCU_E_GTM_CLC_DISABLE_ERR                \
            (DemConf_DemEventParameter_MCU_E_GTM_CLC_DISABLE_ERR)
...
#define MCU_E_CONVCTRL_CLC_ENABLE_ERR                \
            (DemConf_DemEventParameter_MCU_E_CONVCTRL_CLC_ENABLE_ERR)
...
#define MCU_E_CONVCTRL_CLC_DISABLE_ERR                \
            (DemConf_DemEventParameter_MCU_E_CONVCTRL_CLC_DISABLE_ERR)
...
#define MCU_E_CCUCON_UPDATE_ERR                \
            (DemConf_DemEventParameter_MCU_E_CCUCON_UPDATE_ERR)
...
#define MCU_E_CCU6_CLC_ENABLE_ERR                \
            (DemConf_DemEventParameter_MCU_E_CCU6_CLC_ENABLE_ERR)
...
#define MCU_E_CCU6_CLC_DISABLE_ERR                \
            (DemConf_DemEventParameter_MCU_E_CCU6_CLC_DISABLE_ERR)
...
#define MCU_E_GPT12_CLC_ENABLE_ERR                \
            (DemConf_DemEventParameter_MCU_E_GPT12_CLC_ENABLE_ERR)
...
#define MCU_E_GPT12_CLC_DISABLE_ERR                \
            (DemConf_DemEventParameter_MCU_E_GPT12_CLC_DISABLE_ERR)
...
#define MCU_E_PMSWCR_UPDATE_ERR                \
            (DemConf_DemEventParameter_MCU_E_PMSWCR_UPDATE_ERR)
