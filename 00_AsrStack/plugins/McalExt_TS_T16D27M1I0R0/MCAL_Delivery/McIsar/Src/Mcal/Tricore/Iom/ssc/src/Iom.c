...
#ifndef IOM_AR_RELEASE_MAJOR_VERSION
#error "IOM_AR_RELEASE_MAJOR_VERSION is not defined. "
#endif

#ifndef IOM_AR_RELEASE_MINOR_VERSION
#error "IOM_AR_RELEASE_MINOR_VERSION is not defined. "
#endif

#ifndef IOM_AR_RELEASE_REVISION_VERSION
#error "IOM_AR_RELEASE_REVISION_VERSION is not defined. "
#endif
...
#if ( IOM_SW_MAJOR_VERSION != 20U )
#error "IOM_SW_MAJOR_VERSION does not match. "
#endif

#if ( IOM_SW_MINOR_VERSION != 0U )
...
#if ( IOM_AR_RELEASE_MAJOR_VERSION != MCAL_AR_RELEASE_MAJOR_VERSION )
#error "IOM_AR_RELEASE_MAJOR_VERSION does not match. "
#endif

#if ( IOM_AR_RELEASE_MINOR_VERSION != MCAL_AR_RELEASE_MINOR_VERSION )
#error "IOM_AR_RELEASE_MINOR_VERSION does not match. "
#endif

#if ( IOM_AR_RELEASE_REVISION_VERSION != MCAL_AR_RELEASE_REVISION_VERSION )
#error "IOM_AR_RELEASE_REVISION_VERSION does not match. "
#endif
...
#if(IOM_E_CLC_ENABLE_ERR_DEM_REPORT == IOM_ENABLE_DEM_REPORT)
static void Iom_lReportDemError(const Dem_EventIdType EventId, 
...
void Iom_Init(const Iom_ConfigType *const ConfigPtr)
{
  ...
  {
    (void)Det_ReportError((uint16)IOM_MODULE_ID,
                    IOM_INSTANCE_ID,
                    IOM_SID_INIT,
                    IOM_E_PARAM_CONFIG);
...

  {
        ...
        IOM_CLC_DISS_BITPOS) == 0U)
    {
      ...
      Iom_lReportDemError(IOM_E_CLC_ENABLE_ERR, \
...
** Traceability     :                                                         **
**                                                                            **
** Syntax           : static void Iom_lReportDemError(const Dem_EventIdType   **
