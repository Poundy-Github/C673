  ...
  */!][!//
  ...
  [!SELECT "as:modconf('Eth')[1]"!][!//
    ...
    */!][!//
    ...
    [!/*
    [cover parentID={57738CFA-118C-490c-9BDB-553E7520EA01}][/cover]
    */!][!//
    ...
    [!/*
    [cover parentID={982786D6-4256-469b-B522-D47E85A2AD42}][/cover]
    */!][!//
    ...
    [!/*
    [cover parentID={366C1437-79A2-4482-924A-7B0F6576F604}][/cover]
    */!][!//
    /* Number of fSPB cycles to wait after a DMA software reset */
    #define ETH_17_GETHMAC_DMA_RESET_WAITCYCLE      ([!"EthGeneral/EthDmaSwResetWaitCycle"!]U)
