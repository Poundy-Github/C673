 ...
 *
 * $Id: kern-erroraction.c 34824 2021-08-05 13:57:39Z ache271795 $
*/
 ...
 *
 * Reason:
 * Functions OS_ErrorActionTask, OS_ErrorActionCat2, OS_ErrorActionStartupHook
 * and OS_ErrorActionErrorHook are called indirectly by OS_Error and
 * OS_ErrorAction.
...
const os_uint8_t OS_dummy_kern_erroraction_c = 0xeb;
