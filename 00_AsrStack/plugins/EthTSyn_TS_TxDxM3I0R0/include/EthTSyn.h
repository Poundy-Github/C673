...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00035.ServiceId, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00036.ServiceId, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00039.ServiceId, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00044.ServiceId, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00040.ServiceId, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00042.ServiceId, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00043.ServiceId, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_91001.ServiceId, 1 */
#if (defined ETHTSYN_SID_SETPROTOCOLPARAM)
#error ETHTSYN_SID_SETPROTOCOLPARAM is already defined
#endif
/** \brief Defines API id of function EthTSyn_SetProtocolParam(). */
#define ETHTSYN_SID_SETPROTOCOLPARAM 0xAU

/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_91002.ServiceId, 1 */
#if (defined ETHTSYN_SID_GETPROTOCOLPARAM)
#error ETHTSYN_SID_GETPROTOCOLPARAM is already defined
#endif
/** \brief Defines API id of function EthTSyn_GetProtocolParam(). */
#define ETHTSYN_SID_GETPROTOCOLPARAM 0xBU

/* === Module Det error codes === */
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00030_ValueCheck_UNINIT, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00030_ValueCheck_CTRL_IDX, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00030_ValueCheck_PARAM_POINTER, 1 */
...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00030_ValueCheck_PARAM, 1 */
 ...
 * \return void
 *
 * \param[in] EthIfCtrlIdx - Index of the controller within the context of the EthIf.
...
/**
 * \brief By this API service the EthTSyn gets an indication and the data of a received frame from EthSwt.
 *
 * \return boolean - True - if received frame was processed succefully and a new TimeStamp is required.
 *                 - False - frame processing failed and no new TimeStamp is required.
 *
 * \param[in] MgmtInfoPtr - Pointer that holds the switch info: SwitchIdx and SwitchPortIdx
 * \param[in] IngressTimeStampPtr - Pointer that holds the IngressTimeStamp of the received frame.
...
/**
 * \brief EthTSyn_SetProtocolParam function.
 *  This API is used to set FollowUp information TLV parameters of a Follow_Up
 *  message prior transmission.
 *
 ...
 *         E_NOT_OK: failed
 */
extern FUNC(Std_ReturnType, ETHTSYN_CODE) EthTSyn_SetProtocolParam
(
...
/**
 * \brief EthTSyn_GetProtocolParam function.
 *  This API is used to read FollowUp information TLV parameters from received
 *  Follow_Up message.
 *
 * \param[in] timeBaseId - ID of the synchronized time base
 ...
 *         E_NOT_OK: failed
 */
extern FUNC(Std_ReturnType, ETHTSYN_CODE) EthTSyn_GetProtocolParam
(
  StbM_SynchronizedTimeBaseType timeBaseId,
