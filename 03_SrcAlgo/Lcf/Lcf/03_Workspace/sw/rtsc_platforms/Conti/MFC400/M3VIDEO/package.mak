...
override PKGDIR = Conti/MFC400/M3VIDEO
...
package/%.xdc.inc package/%_Conti.MFC400.M3VIDEO.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package Conti.MFC400.M3VIDEO" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedConti/MFC400/M3VIDEOpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js Conti.MFC400.M3VIDEO $@
...
.PHONY: release,Conti_MFC400_M3VIDEO
Conti_MFC400_M3VIDEO.zip: package/package.bld.xml
Conti_MFC400_M3VIDEO.zip: package/build.cfg
Conti_MFC400_M3VIDEO.zip: package/package.xdc.inc
Conti_MFC400_M3VIDEO.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/Conti_MFC400_M3VIDEO.zip.dep
endif
package/rel/Conti_MFC400_M3VIDEO/Conti/MFC400/M3VIDEO/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

Conti_MFC400_M3VIDEO.zip: package/rel/Conti_MFC400_M3VIDEO.xdc.inc package/rel/Conti_MFC400_M3VIDEO/Conti/MFC400/M3VIDEO/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/Conti_MFC400_M3VIDEO.xdc.inc,package/rel/Conti_MFC400_M3VIDEO.zip.dep)


release release,Conti_MFC400_M3VIDEO: all Conti_MFC400_M3VIDEO.zip
clean:: .clean
	-$(RM) Conti_MFC400_M3VIDEO.zip
	-$(RM) package/rel/Conti_MFC400_M3VIDEO.xdc.inc
	-$(RM) package/rel/Conti_MFC400_M3VIDEO.zip.dep
