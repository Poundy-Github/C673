...
[!INDENT "0"!]
  [!SELECT "as:modconf('Uart')[1]"!][!//
    ...
    */
    ...
    [!VAR "UartRxIntpMode" = "'false'"!][!//
    [!VAR "UartRxPollMode" = "'false'"!][!//
    [!LOOP "UartConfigSet/UartChannel/*"!][!//
      [!IF "contains(UartRxChannelMode,'INTERRUPT') = 'true'"!][!//
        [!VAR "UartRxIntpMode" = "'true'"!][!//
      [!ELSE!][!//
        [!VAR "UartRxPollMode" = "'true'"!][!//
      [!ENDIF!][!//
    [!ENDLOOP!][!//
    ...
    */
    #define UART_RX_MODE  ([!//
    [!IF "$UartRxIntpMode = 'true' and $UartRxPollMode = 'true'"!][!//
      UART_MIXED_MODE[!//
    [!ELSEIF "$UartRxIntpMode = 'true'"!][!//
      UART_INTERRUPT_MODE[!//
    [!ELSE!][!//
      UART_POLLING_MODE[!//
    [!ENDIF!][!//
    ...
    [/cover] */
    [!VAR "UartTxIntpMode" = "'false'"!][!//
    [!VAR "UartTxPollMode" = "'false'"!][!//
    [!LOOP "UartConfigSet/UartChannel/*"!][!//
      [!IF "contains(UartTxChannelMode,'INTERRUPT') = 'true'"!][!//
        [!VAR "UartTxIntpMode" = "'true'"!][!//
      [!ELSE!][!//
        [!VAR "UartTxPollMode" = "'true'"!][!//
      [!ENDIF!][!//
    [!ENDLOOP!][!//
    /*
    ...
    */
    #define UART_TX_MODE  ([!//
    [!IF "$UartTxIntpMode = 'true' and $UartTxPollMode = 'true'"!][!//
      UART_MIXED_MODE[!//
    [!ELSEIF "$UartTxIntpMode = 'true'"!][!//
      UART_INTERRUPT_MODE[!//
    [!ELSE!][!//
      UART_POLLING_MODE[!//
    [!ENDIF!][!//
    ...
    */
    ...
    [!VAR "MaxAscLinMod"= "ecu:get('AscLin.LastIndexOfAscLinModules')+1"!][!//
    #define UART_MAX_HW_UNIT ([!"num:i($MaxAscLinMod)"!]U)
    ...
    [!INDENT "4"!][!//
      ...
      [!VAR "TempAscLin" = "concat('ASCLIN',$Hwnumber)"!][!//
        ...
        [!ENDIF!][!//
        [!NOCODE!]
        /* [cover parentID={A7995084-3ECF-4aac-9140-2C72BCF79553}]
        Is current hardware kernal available
        [/cover] */
        [!ENDNOCODE!]
