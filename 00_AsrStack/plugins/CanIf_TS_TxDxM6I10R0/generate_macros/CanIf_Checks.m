   ...
   */!][!IF "as:modconf('CanIf')[1]/CanIfPublicCfg/CanIfMultiCoreSupport = 'true'"!][!/*
     */!][!IF "node:exists(as:ref(as:ref(as:ref(as:ref(CanIfTxPduBufferRef)/CanIfBufferHthRef/*[1])/CanIfHthCanCtrlIdRef)/CanIfCtrlCanCtrlRef)/CanControllerEcucPartitionRef)"!][!/*
       ...
       */!][!ASSERT "node:exists(as:ref(CanIfTxPduRef)/EcucPduDedicatedPartition/*[as:name(as:ref(./EcucPduDedicatedPartitionBswModuleRef)) = 'CanIf']) or
       ...
       Controller [!"name(as:ref(as:ref(as:ref(as:ref(CanIfTxPduBufferRef)/CanIfBufferHthRef/*[1])/CanIfHthCanCtrlIdRef)/CanIfCtrlCanCtrlRef))"!] refers an EcucPartition (via CanControllerEcucPartitionRef), Tx-PDU [!"name(.)"!] must refer the same EcucPartition using EcucPduDedicatedPartition or EcucPduDefaultPartitionRef.[!ENDASSERT!][!/*
       ...
       */!][!IF "node:exists(as:ref(CanIfTxPduRef)/EcucPduDedicatedPartition/*[as:name(as:ref(./EcucPduDedicatedPartitionBswModuleRef)) = 'CanIf'])"!][!/*
         ...
         */!][!ASSERT "as:path(as:ref(as:ref(CanIfTxPduRef)/EcucPduDedicatedPartition/*[as:name(as:ref(./EcucPduDedicatedPartitionBswModuleRef)) = 'CanIf']/EcucPduDedicatedPartitionRef)) = 
         ...
         Tx-PDU [!"name(.)"!] must refer the same EcucPartition (via EcucPduDedicatedPartitionRef) as its corresponding controller [!"name(as:ref(as:ref(as:ref(as:ref(CanIfTxPduBufferRef)/CanIfBufferHthRef/*[1])/CanIfHthCanCtrlIdRef)/CanIfCtrlCanCtrlRef))"!].[!ENDASSERT!][!/*
       */!][!ELSE!][!/*
        ...
        */!][!ASSERT "as:path(as:ref(as:ref(CanIfTxPduRef)/EcucPduDefaultPartitionRef)) = 
                      as:path(as:ref(as:ref(as:ref(as:ref(as:ref(CanIfTxPduBufferRef)/CanIfBufferHthRef/*[1])/CanIfHthCanCtrlIdRef)/CanIfCtrlCanCtrlRef)/CanControllerEcucPartitionRef))"!]
        Tx-PDU [!"name(.)"!] must refer the same EcucPartition (via EcucPduDefaultPartitionRef or EcucPduDedicatedPartitionRef) as its corresponding controller [!"name(as:ref(as:ref(as:ref(as:ref(CanIfTxPduBufferRef)/CanIfBufferHthRef/*[1])/CanIfHthCanCtrlIdRef)/CanIfCtrlCanCtrlRef))"!].[!ENDASSERT!][!/*
       */!][!ENDIF!][!/*
       ...
       */!][!IF "node:exists(as:modconf('J1939Nm')[1]/J1939NmConfigSet/*[1]/J1939NmChannel/*[J1939NmTxPdu/J1939NmTxPduRef = node:current()/CanIfTxPduRef])"!][!/*
         ...
         */!][!ASSERT "node:exists(as:ref(CanIfTxPduRef)/EcucPduDedicatedPartition/*[as:name(node:ref(./EcucPduDedicatedPartitionBswModuleRef)) = 'J1939Nm']) or
                       node:exists(as:ref(CanIfTxPduRef)/EcucPduDefaultPartitionRef)"!]
         If CanIfMultiCoreSupport is enabled, Tx J1939Nm PDU [!"name(as:modconf('J1939Nm')[1]/J1939NmConfigSet/*[1]/J1939NmChannel/*[J1939NmTxPdu/J1939NmTxPduRef = node:current()/CanIfTxPduRef]/J1939NmTxPdu)"!] must refer an EcucPartition (via EcucPduDedicatedPartition or EcucPduDefaultPartitionRef).[!ENDASSERT!][!/*
         ...
         */!][!ELSE!][!/*
           ...
           */!][!ELSE!][!/*
             ...
             */!][!ASSERT "$TxPduPartition = as:ref(as:ref(CanIfTxPduRef)/EcucPduDefaultPartitionRef)"!]
             All J1939Nm PDUs must refer the same partition as the entire J1939 stack.[!ENDASSERT!][!/*
           */!][!ENDIF!][!/*
         */!][!ENDIF!][!/*
       ...
       */!][!ENDIF!][!/*
         ...
         */!][!LOOP "CanIfRxPduHrhIdRef/*"!][!/*
           */!][!IF "node:exists(as:ref(as:ref(as:ref(.)/CanIfHrhCanCtrlIdRef)/CanIfCtrlCanCtrlRef)/CanControllerEcucPartitionRef)"!][!/*
             ...
             <!-- !LINKSTO CanIf.EB.Multicore.CtrlDefaultPartitionRef,1 -->
             */!][!ASSERT "$pduPartition != ''"!]
             Controller [!"name(as:ref(as:ref(as:ref(.)/CanIfHrhCanCtrlIdRef)/CanIfCtrlCanCtrlRef))"!] refers an EcucPartition (via CanControllerEcucPartitionRef), Rx-PDU [!"$currentRxPduName"!] must refer the same EcucPartition using EcucPduDedicatedPartition or EcucPduDefaultPartitionRef.[!ENDASSERT!][!/*
             ...
             */!][!ASSERT "$pduPartition = as:path(as:ref(as:ref(as:ref(as:ref(.)/CanIfHrhCanCtrlIdRef)/CanIfCtrlCanCtrlRef)/CanControllerEcucPartitionRef))"!]
             Rx-PDU [!"$currentRxPduName"!] must refer the same EcucPartition (via EcucPduDefaultPartitionRef or EcucPduDedicatedPartitionRef) as its corresponding controller [!"name(as:ref(as:ref(as:ref(.)/CanIfHrhCanCtrlIdRef)/CanIfCtrlCanCtrlRef))"!].[!ENDASSERT!][!/*
           */!][!ENDIF!][!/*
         */!][!ENDLOOP!][!/*
   ...
   */!][!IF "as:modconf('CanIf')[1]/CanIfPublicCfg/CanIfDecoupledProcessingSupport = 'true'"!][!/*
     ...
     */!][!LOOP "as:modconf('CanIf')[1]/CanIfPublicCfg/CanIfRxProcessing/*"!][!/*
       */!][!LOOP "CanIfRxPduProcessingRef/*"!][!/*
         ...
         */!][!ASSERT "$PduPartition = as:path(as:ref(../../CanIfPartitionRef))"!]
         Rx PDU [!"name(as:ref(.))"!] must refer the same partition as the CanIfPartitionRef of [!"name(../..)"!].[!ENDASSERT!][!/*
       */!][!ENDLOOP!][!/*
     */!][!ENDLOOP!][!/*
     ...
     */!][!LOOP "as:modconf('CanIf')[1]/CanIfPublicCfg/CanIfTxProcessing/*"!][!/*
       */!][!LOOP "CanIfTxPduProcessingRef/*"!][!/*
         ...
         */!][!ASSERT "$PduPartition = as:path(as:ref(../../CanIfPartitionRef))"!]
         Tx PDU [!"name(as:ref(.))"!] must refer the same partition as the CanIfPartitionRef of [!"name(../..)"!].[!ENDASSERT!][!/*
       */!][!ENDLOOP!][!/*
     */!][!ENDLOOP!][!/*
