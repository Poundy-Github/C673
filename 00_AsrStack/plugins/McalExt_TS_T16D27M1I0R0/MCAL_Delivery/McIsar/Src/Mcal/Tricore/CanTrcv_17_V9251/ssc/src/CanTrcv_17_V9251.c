...
#if ( CANTRCV_17_V9251_SW_MINOR_VERSION != 0U )
#error "CANTRCV_17_V9251_SW_MINOR_VERSION does not match. "
#endif

#if ( CANTRCV_17_V9251_SW_PATCH_VERSION != 1U )
...
/* Bit Postion */
#define CANTRCV_17_V9251_BIT_POS_ZERO                     (0)

/* Bit Length */
#define CANTRCV_17_V9251_BIT_LEN_THIRTY_ONE               (31)
  ...
  if (ReturnValue == E_OK)
  {
    ...
    if (CurrentMode != OpMode)
    {
      ...
      if (OpMode == CANTRCV_TRCVMODE_NORMAL)
      {
        ...
        Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
        Cantrcv_17_V9251_WuReason[Transceiver]),
        CANTRCV_17_V9251_BIT_POS_ZERO,
        CANTRCV_17_V9251_BIT_LEN_THIRTY_ONE,
      ...
      Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
      Cantrcv_17_V9251_CurrentMode[Transceiver]),
      CANTRCV_17_V9251_BIT_POS_ZERO,
      CANTRCV_17_V9251_BIT_LEN_THIRTY_ONE,
...
static void CanTrcv_17_V9251_lSetInitMode(const uint8 Channel)
{
  ...
  /* [cover parentID={D4AE1E11-F60A-4095-BC1C-3A518D899821}]
     Put the CanTrcv into configured Mode [/cover] */
   Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
   Cantrcv_17_V9251_CurrentMode[TrcvChannelId]),
   CANTRCV_17_V9251_BIT_POS_ZERO,
   CANTRCV_17_V9251_BIT_LEN_THIRTY_ONE,
   TrcvNwMode);
   ...
   Mcal_SetBitAtomic(&(CanTrcv_17_V9251_Channelstatus.
   Cantrcv_17_V9251_WuReason[TrcvChannelId]),
   CANTRCV_17_V9251_BIT_POS_ZERO,
   CANTRCV_17_V9251_BIT_LEN_THIRTY_ONE,
   CANTRCV_WU_POWER_ON);
