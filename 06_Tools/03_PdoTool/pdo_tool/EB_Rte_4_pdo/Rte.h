 ...
 */
  ...
  * on Wed Nov 07 13:37:44 CET 2018. !!!IGNORE-LINE!!!
  */
...
/* minor version check */
#if (RTE_SW_MINOR_VERSION < 2U)
#error RTE_SW_MINOR_VERSION wrong (< 2U)
#endif
...
/* patch version check */
#if (RTE_SW_PATCH_VERSION < 15U)
#error RTE_SW_PATCH_VERSION wrong (< 15U)
#endif

/*------------------[RTE Constants ]----------------------------------------*/

#if (defined RTE_TRANSFORMER_UNSPECIFIED) /* to prevent double declaration */
#error RTE_TRANSFORMER_UNSPECIFIED already defined
#endif /* if (defined RTE_TRANSFORMER_UNSPECIFIED) */

/** \brief Transformer of a unspecified transformer class. */
#define RTE_TRANSFORMER_UNSPECIFIED 0x00U

#if (defined RTE_TRANSFORMER_SERIALIZER) /* to prevent double declaration */
#error RTE_TRANSFORMER_SERIALIZER already defined
#endif /* if (defined RTE_TRANSFORMER_SERIALIZER) */

/** \brief Transformer of a serializer class. */
#define RTE_TRANSFORMER_SERIALIZER 0x01U

#if (defined RTE_TRANSFORMER_SAFETY) /* to prevent double declaration */
#error RTE_TRANSFORMER_SAFETY already defined
#endif /* if (defined RTE_TRANSFORMER_SAFETY) */

/** \brief Transformer of a safety class. */
#define RTE_TRANSFORMER_SAFETY 0x02U

#if (defined RTE_TRANSFORMER_SECURITY) /* to prevent double declaration */
#error RTE_TRANSFORMER_SECURITY already defined
#endif /* if (defined RTE_TRANSFORMER_SECURITY) */

/** \brief  Transformer of a security class. */
#define RTE_TRANSFORMER_SECURITY 0x03U

#if (defined RTE_TRANSFORMER_CUSTOM) /* to prevent double declaration */
#error RTE_TRANSFORMER_CUSTOM already defined
#endif /* if (defined RTE_TRANSFORMER_CUSTOM) */
...
#if (defined RTE_E_HARD_TRANSFORMER_ERROR) /* to prevent double declaration */
#error RTE_E_HARD_TRANSFORMER_ERROR already defined
#endif /* if (defined RTE_E_HARD_TRANSFORMER_ERROR) */

/** \brief An error during transformation occurred.*/
#define RTE_E_HARD_TRANSFORMER_ERROR 138U

#if (defined RTE_E_TRANSFORMER_LIMIT) /* to prevent double declaration */
#error RTE_E_TRANSFORMER_LIMIT already defined
#endif /* if (defined RTE_E_TRANSFORMER_LIMIT) */

/** \brief Buffer for transformation operation could not be created.*/
#define RTE_E_TRANSFORMER_LIMIT 139U

#if (defined RTE_E_SOFT_TRANSFORMER_ERROR) /* to prevent double declaration */
#error RTE_E_SOFT_TRANSFORMER_ERROR already defined
#endif /* if (defined RTE_E_SOFT_TRANSFORMER_ERROR) */
