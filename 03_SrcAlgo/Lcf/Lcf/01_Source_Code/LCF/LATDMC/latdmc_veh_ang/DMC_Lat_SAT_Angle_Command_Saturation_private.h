/* $Header: DMC_Lat_SAT_Angle_Command_Saturation_private.h 1.27 2020/08/20 10:43:15CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_SAT_Angle_Command_Saturation_private.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_SAT_Angle_Command_Saturation_private_h_
#define RTW_HEADER_DMC_Lat_SAT_Angle_Command_Saturation_private_h_
#include "rtwtypes.h"
...
typedef struct {
  /* Expression: SAT_Max_Angle_Y_Scheduling
   * Referenced by: '<S7>/SAT_Max_Angle_Scheduling'
   */
  real32_T SAT_Max_Angle_Scheduling_tableData[4];

  /* Expression: SAT_Max_Angle_X_Scheduling
   * Referenced by: '<S7>/SAT_Max_Angle_Scheduling'
   */
  real32_T SAT_Max_Angle_Scheduling_bp01Data[4];

  /* Expression: Sat_max_angle_low_bound_y_sched
   * Referenced by: '<S7>/Sat_max_angle_low_bound_sched'
   */
  real32_T Sat_max_angle_low_bound_sched_tableData[3];

  /* Expression: Sat_max_angle_low_bound_x_sched
   * Referenced by: '<S7>/Sat_max_angle_low_bound_sched'
   */
  real32_T Sat_max_angle_low_bound_sched_bp01Data[3];
} ConstParam_DMC_Lat_SAT_Angle_Command_Saturation_T;

/* Constant parameters (auto storage) */
extern const ConstParam_DMC_Lat_SAT_Angle_Command_Saturation_T
  DMC_Lat_SAT_Angle_Command_Saturation_ConstP;

/* <== Enable QAC again after word size consistence check using limits.h has been done. */
/* PRQA L:LABEL_QAC_PRIVATE */
#endif                                 /* RTW_HEADER_DMC_Lat_SAT_Angle_Command_Saturation_private_h_ */
