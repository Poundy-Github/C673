 ...
 *
 * $Id: kern-simtimer.c 34824 2021-08-05 13:57:39Z ache271795 $
*/
...
os_simtimer_t
	...
	OS_BSS_SECTION_ATTRIB_POST(.bss.shared.os.OS_simTimer);
/* CHECK: PARSE */
...
const os_uint8_t OS_dummy_kern_simtimer_c = 0xeb;
