...
sim_variant_list = []
#-------------------------
# call sim_swc_vis_disparity SConscript-simenv
#-------------------------
sim_algo_pc_lib = SConscript("SConscript_algo_pc_lib.py", 
           exports = {"component_name" : component_name, "env" : pc_env, "algo_name" : component_name})
       
#-------------------------
# call sim_swc_cut_roi SConscript-simenv
#-------------------------
sim_swc_cut_roi_ide = SConscript("sim_swc_cut_roi/SConscript_simenv.py", 
           exports = {"component_name" : component_name, "env" : pc_env, "algo_name" : component_name})
if not skip_ide_generation:
    sim_variant_list.extend(sim_swc_cut_roi_ide[1])
       
#-------------------------
# call sim_swc_vis_image SConscript-simenv
#-------------------------
sim_swc_vis_image_ide = SConscript("sim_swc_vis_image/SConscript_simenv.py", 
           exports = {"component_name" : component_name, "env" : pc_env, "algo_name" : component_name})
if not skip_ide_generation:
    sim_variant_list.extend(sim_swc_vis_image_ide[1])
    
#-------------------------
# call sim_swc_vis_perspectives SConscript-simenv
#-------------------------
sim_swc_vis_perspectives_ide = SConscript("sim_swc_vis_perspectives/SConscript_simenv.py", 
           exports = {"component_name" : component_name, "env" : pc_env, "algo_name" : component_name})
if not skip_ide_generation:
    sim_variant_list.extend(sim_swc_vis_perspectives_ide[1])

#-------------------------
# call sim_swc_rt_range SConscript-simenv
#-------------------------
sim_swc_vis_rt_range_ide = SConscript("sim_swc_vis_rt_range/SConscript_simenv.py", 
           exports = {"component_name" : component_name, "env" : pc_env, "algo_name" : component_name})
if not skip_ide_generation:
    sim_variant_list.extend(sim_swc_vis_rt_range_ide[1])
    
#-------------------------
# call sim_swc_vis_velodyne SConscript-simenv
#-------------------------
sim_swc_vis_velodyne_ide = SConscript("sim_swc_vis_velodyne/SConscript_simenv.py", 
           exports = {"component_name" : component_name, "env" : pc_env, "algo_name" : component_name})
if not skip_ide_generation:
    sim_variant_list.extend(sim_swc_vis_velodyne_ide[1])


#-------------------------
# call sim_swc_hil_client SConscript-simenv
#-------------------------
sim_swc_hil_client_ide = SConscript("sim_swc_hil_client/SConscript_simenv.py", 
           exports = {"component_name" : component_name, "env" : pc_env, "algo_name" : component_name})
if not skip_ide_generation:
    sim_variant_list.extend(sim_swc_hil_client_ide[1])
...
if not skip_ide_generation:
    ...
    sim_sln = pc_env.MSVSSolution(# solution name
                 ...
                 projects = [sim_swc_cut_roi_ide[0], sim_swc_vis_perspectives_ide[0], sim_swc_hil_client_ide[0], sim_swc_vis_image_ide[0], sim_swc_vis_rt_range_ide[0], sim_swc_vis_velodyne_ide[0]], 
                 # build variant
