/*! \file **********************************************************************
   ...
   File: vdy_matrix_inversion_4x4.h
...
#ifndef RTW_HEADER_vdy_matrix_inversion_4x4_h_
#define RTW_HEADER_vdy_matrix_inversion_4x4_h_
...
/* Block signals for system '<S70>/Matrix_Inversion_4x4' */
typedef struct {
  real32_T HPHt_R_inv[16];             /* '<S70>/Matrix_Inversion_4x4' */
  boolean_T det_flag;                  /* '<S70>/Matrix_Inversion_4x4' */
} rtB_vdy_matrix_inversion_4x4;

extern void vdy_matrix_inversion_4x4(const real32_T rtu_HPHt[16], const real32_T
  rtu_R[16], rtB_vdy_matrix_inversion_4x4 *localB);

#endif                                 /* RTW_HEADER_vdy_matrix_inversion_4x4_h_ */
