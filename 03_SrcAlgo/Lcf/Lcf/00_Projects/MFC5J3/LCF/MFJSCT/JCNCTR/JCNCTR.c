...
$Log: $
File          : JCNCTR
Generated on  : Wed 28.06.2023 at 21:13:40 (UTC+01:00)
MD5           : [2595182074  1203954842   829391977  1382368454 0](JCNCTR)
...
/* General includes */
#include "JCNCTR_private.h"  //MFC5J3
#include "LCFPRM/LCFPRM_data.h"  //MFC5J3
#include "JCNCTR.h"
/* Specific Includes */
...
void JCNCTR_SenProcess(void)
{
    ...
    if (GET_P_JCNCTR_LKAYawRateSupDur_sec() <= rtb_Switch) {
        ...
        /* Switch: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/SubSystem10/SRFLIPFLOP/Functionality'/Switch1' incorporates:
                 ...
                 */
        rtb_DataTypeConversion_d = 0U;
    } else {
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_h;
    }
    ...
    if (GET_P_JCNCTR_LKACurvatureSupDur_sec() <= rtb_Switch_iy) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_c;
    }
    ...
    if (GET_P_JCNCTR_LKACurvatureSupDur_sec() <= rtb_Switch_ps) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_k;
    }
    ...
    if (GET_P_JCNCTR_LKAManualTrqSupDur_sec() <= rtb_Switch_k2) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_b;
    }
    ...
    if (GET_P_JCNCTR_LKABothLaneInvalidSupDur_sec() <= rtb_Switch_d3) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_fk;
    }
    ...
    if (GET_P_JCNCTR_LKAActiveStCtrSupTime_sec() <= rtb_Switch_bh) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_m;
    }
    ...
    if (GET_P_JCNCTR_LKAMainCylPresSupDur_sec() <= rtb_Switch_k) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_lx;
    }
    ...
    /* DataTypeConversion: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/OR4/Functionality'/Data Type Conversion' incorporates:
         *  Constant: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/from_data_definition31'/state_source'
         *  Constant: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/from_data_definition32'/state_source'
         *  Inport: '<Root>/S_LCFRCV_SysStateIACC_nu'
         *  Logic: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/OR4/Functionality'/OR'
         *  RelationalOperator: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/EQ32/Functionality'/EQ'
         *  RelationalOperator: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/EQ7/Functionality'/EQ'
         */
    rtb_VectorConcatenate1[11] = (uint8)((((sint32)GET_S_LCFRCV_SysStateIACC_nu()) == ((sint32)((uint8)E_HMOS202_SysStateType_E_HMOS202_SYSSTATE_ACTIVE))) || (((sint32)GET_S_LCFRCV_SysStateIACC_nu()) == ((sint32)((uint8) E_HMOS202_SysStateType_E_HMOS202_SYSSTATE_SUSPEND))));
    ...
    if (GET_P_JCNCTR_BrakePedalPostionSupDur_sec() <= rtb_Switch_pm) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_ba;
    }
    ...
    if (GET_P_JCNCTR_ELKYawRateSupDur_sec() <= rtb_Switch_ko) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_it;
    }
    ...
    if (GET_P_JCNCTR_ELKCurvatureSupDur_sec() <= rtb_Switch_fv) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_j;
    }
    ...
    if (GET_P_JCNCTR_ELKCurvatureSupDur_sec() <= rtb_Switch_gw) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_bw;
    }
    ...
    if (GET_P_JCNCTR_ELKManualTrqSupDur_sec() <= rtb_Switch_g1) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_dl;
    }
    ...
    if (GET_P_JCNCTR_ELKAccPedalPosSupDur_sec() <= rtb_Switch_ci) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_g;
    }
    ...
    if (GET_P_JCNCTR_ELKBothLaneInvalidSupDur_sec() <= rtb_Switch_j) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_bj;
    }
    ...
    if (GET_P_JCNCTR_ELKActiveStCtrSupTime_sec() <= rtb_Switch_ng) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_dy;
    }
    ...
    if (GET_P_JCNCTR_ELKMainCylPresSupDur_sec() <= rtb_Switch_po) {
        ...
        rtb_DataTypeConversion_d = DW_jcnctr_Unit_Delay2_DSTATE_e;
    }
    ...
    /* SignalConversion: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM'/ConcatBufferAtVector Concatenate2In10' incorporates:
         ...
         */
    rtb_VectorConcatenate2[9] = rtb_DataTypeConversion_d;
    ...
    if (GET_P_JCNCTR_LDWYawRateSupDur_sec() <= rtb_Switch_kx) {
        ...
        rtb_DataTypeConversion_h = DW_jcnctr_Unit_Delay2_DSTATE_g5;
    }
    ...
    if (GET_P_JCNCTR_LDWCurvatureSupDur_sec() <= rtb_Switch_fs) {
        ...
        rtb_DataTypeConversion_h = DW_jcnctr_Unit_Delay2_DSTATE_bv;
    }
    ...
    if (GET_P_JCNCTR_LDWCurvatureSupDur_sec() <= rtb_Switch_e) {
        ...
        rtb_DataTypeConversion_h = DW_jcnctr_Unit_Delay2_DSTATE_ck;
    }
    ...
    if (GET_P_JCNCTR_LDWManualTrqSupDur_sec() <= rtb_Switch_p) {
        ...
        rtb_DataTypeConversion_h = DW_jcnctr_Unit_Delay2_DSTATE_dn;
    }
    ...
    if (GET_P_JCNCTR_LDWBothLaneInvalidSupDur_sec() <= rtb_Switch_g5) {
        ...
        rtb_DataTypeConversion_h = DW_jcnctr_Unit_Delay2_DSTATE_gn;
    }
    ...
    if (GET_P_JCNCTR_LDWActiveStCtrSupTime_sec() <= rtb_Switch_o) {
        ...
        rtb_DataTypeConversion_h = DW_jcnctr_Unit_Delay2_DSTATE_me;
    }
    ...
    if (GET_P_JCNCTR_LDWMainCylPresSupDur_sec() <= rtb_Switch_gi) {
        ...
        rtb_DataTypeConversion_h = DW_jcnctr_Unit_Delay2_DSTATE_pb;
    }
    ...
    /* SignalConversion: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM'/ConcatBufferAtVector ConcatenateIn10' incorporates:
         ...
         */
    rtb_VectorConcatenate[9] = rtb_DataTypeConversion_h;
    ...
    /* Update for UnitDelay: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/SubSystem29'/Unit_Delay2' incorporates:
         *  SignalConversion: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/SubSystem29/SRFLIPFLOP/Functionality'/Signal Conversion'
         */
    DW_jcnctr_Unit_Delay2_DSTATE_e = rtb_DataTypeConversion_d;
    ...
    /* Update for UnitDelay: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/SubSystem9'/Unit_Delay2' incorporates:
         *  SignalConversion: 'sda:JCNCTR/JCNCTR/JCNCTR_SenProcess/OPM/SubSystem9/SRFLIPFLOP/Functionality'/Signal Conversion'
         */
    DW_jcnctr_Unit_Delay2_DSTATE_pb = rtb_DataTypeConversion_h;
}
#include "Pse_JCNCTR.h"
