/* $Header: DMC_Lat_LAT_Ldp_States.h 1.9 2020/08/20 10:43:02CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_LAT_Ldp_States.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_LAT_Ldp_States_h_
#define RTW_HEADER_DMC_Lat_LAT_Ldp_States_h_
#ifndef DMC_Lat_LAT_Ldp_States_COMMON_INCLUDES_
# define DMC_Lat_LAT_Ldp_States_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Lat_LAT_Ldp_States_COMMON_INCLUDES_ */

#include "DMC_Lat_LAT_Ldp_States_types.h"
...
/* Block states (auto storage) for model 'DMC_Lat_LAT_Ldp_States' */
typedef struct {
  real32_T UnitDelay_DSTATE;           /* '<S4>/Unit Delay' */
  boolean_T UnitDelay1_DSTATE;         /* '<S5>/Unit Delay (1)' */
  boolean_T UnitDelay2_DSTATE;         /* '<S5>/Unit Delay (2)' */
} rtDW_DMC_Lat_LAT_Ldp_States_T;

typedef struct {
  rtDW_DMC_Lat_LAT_Ldp_States_T rtdw;
} rtMdlrefDWork_DMC_Lat_LAT_Ldp_States_T;

/* Model reference registration function */
extern void DMC_Lat_LAT_Ldp_States_initialize(rtDW_DMC_Lat_LAT_Ldp_States_T
  *localDW);
extern void DMC_Lat_LAT_Ldp_States_Init(rtDW_DMC_Lat_LAT_Ldp_States_T *localDW);
extern void DMC_Lat_LAT_Ldp_States(const int16_T *rt_erh2I, const boolean_T
  *rt_gd42I, boolean_T *rt_erh2sI, boolean_T *rt_gd42sI, boolean_T *rt_cpaoI,
  boolean_T *rt_e4hoI, boolean_T *rt_ngfdI, uint16_T *rt_f3r3I,
 ...
 *
 * '<Root>' : 'DMC_Lat_LAT_Ldp_States'
 * '<S1>'   : 'DMC_Lat_LAT_Ldp_States/Encoder'
 * '<S2>'   : 'DMC_Lat_LAT_Ldp_States/LAT_Lane_Status_Evaluation'
 * '<S3>'   : 'DMC_Lat_LAT_Ldp_States/LAT_Lane_Status_Selection'
 * '<S4>'   : 'DMC_Lat_LAT_Ldp_States/LAT_Startup_Flag'
 * '<S5>'   : 'DMC_Lat_LAT_Ldp_States/LAT_Trigger_Flag'
 */

/*-
 * Requirements for '<Root>': DMC_Lat_LAT_Ldp_States
 */
#endif                                 /* RTW_HEADER_DMC_Lat_LAT_Ldp_States_h_ */
