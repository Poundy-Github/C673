...
#ifndef RTW_HEADER_vdy_ye_private_h_
#define RTW_HEADER_vdy_ye_private_h_
#include "rtwtypes.h"
...
/* PRQA S 7012 EOF */
extern void vdy_ye_Get_IO_State1(const uint8_T rtu_state_in[32],
  rtB_Get_IO_State1_vdy_ye *localB, uint32_T rtp_Filter);
extern void vdy_ye_diag_variance(const real32_T rtu_u[16],
  rtB_diag_variance_vdy_ye *localB);
extern void vdy_ye_At(const real32_T rtu_u[4], rtB_At_vdy_ye *localB);
extern void vdy_ye_diag_curve_variance(const real32_T rtu_u[4],
  rtB_diag_curve_variance_vdy_ye *localB);
extern void vdy_ye_make_A_matrix(real32_T rtu_CycleTime,
  rtB_make_A_matrix_vdy_ye *localB);

#endif                                 /* RTW_HEADER_vdy_ye_private_h_ */
