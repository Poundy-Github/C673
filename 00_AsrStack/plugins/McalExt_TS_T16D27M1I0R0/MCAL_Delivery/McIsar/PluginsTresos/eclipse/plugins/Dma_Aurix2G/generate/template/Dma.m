...
**                                                                            **
*****************************************************************************/!]
[!MACRO "Dma_ChcfgrConfig", "DataWidth"="", "PatternMode"="","BlockMode"="","TransactionLenght"="", "DmaTransferReqState"="","HwMode"="", "PeripheralSelect"="","Priority"="","CrcSwapOrder"="","DmaChcfgrControl"=""!][!//
[!NOCODE!]
  ...
  [!IF "(./DmaPatternMode != 'Pattern_Detection_Disabled') and (./DmaTcsShadowRegisterConfiguration != 'DMA_CONDITIONAL_LINKED_LIST')"!][!//        
    [!IF "$PatternMode='Pattern_Mode_1'"!][!//
      [!VAR "DmaChcfgrControl" = "bit:or($DmaChcfgrControl, bit:shl(1,24))"!][!//
    [!ELSEIF "$PatternMode='Pattern_Mode_2'"!][!//
      [!VAR "DmaChcfgrControl" = "bit:or($DmaChcfgrControl, bit:shl(2,24))"!][!//
    [!ELSEIF "$PatternMode='Pattern_Mode_3'"!][!//
      [!VAR "DmaChcfgrControl" = "bit:or($DmaChcfgrControl, bit:shl(3,24))"!][!//
    [!ELSEIF "$PatternMode='Pattern_Mode_5'"!][!//
      [!VAR "DmaChcfgrControl" = "bit:or($DmaChcfgrControl, bit:shl(5,24))"!][!//
    [!ELSEIF "$PatternMode='Pattern_Mode_6'"!][!//
      [!VAR "DmaChcfgrControl" = "bit:or($DmaChcfgrControl, bit:shl(6,24))"!][!//
    [!ELSEIF "$PatternMode='Pattern_Mode_7'"!][!//
      [!VAR "DmaChcfgrControl" = "bit:or($DmaChcfgrControl, bit:shl(7,24))"!][!//    
    [!ENDIF!][!//   
  [!ENDIF!][!//
...
/*******************************************************************************
** Name             : Dma_ConfigchannelUserData                               **
**                                                                            **
** Description      : Macro to generate the user data for the DMA             **
**                    channels                                                **
*******************************************************************************/
[!MACRO "Dma_ConfigchannelUserData","DmaChUser"= "","Dmach"= ""!][!//
  [!NOCODE!][!//  
    [!/* Dma channel Verification and UserInfo Construction */!]   
    [!IF "$DmaChUser = 'CRC'"!][!//
      [!VAR "flag" = "num:i(0)"!][!//
      [!SELECT "as:modconf('Crc')[1]/CrcChannelConfig/*"!][!//  
        [!VAR "CrcDmaChn" = "CrcDmaChannel"!][!//
        [!VAR "CrcDmaChn" = "substring-after($CrcDmaChn,'Dma/Dma/')"!][!//
        [!IF "$CrcDmaChn = $Dmach"!][!//
          [!VAR "flag" = "num:i(1)"!][!//
        [!ENDIF!][!//
      [!ENDSELECT!][!//
      [!IF "$flag = num:i(0)"!]
        [!ERROR!][!//
          ERROR: Dma channel configuration inside CRC module does not match with [!"$Dmach"!], Please configure properly.
        [!ENDERROR!][!//      
      [!ENDIF!][!//
    [!ELSEIF "$DmaChUser = 'SPI'"!][!//
      [!IF "node:exists(as:modconf('Spi')[1]/SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*/SpiHwDmaConfigurationQspi/*)"!][!//
        [!VAR "flag" = "num:i(0)"!][!//    
        [!SELECT "as:modconf('Spi')[1]/SpiHwConfiguration/*[1]/SpiHwConfigurationQspi/*/SpiHwDmaConfigurationQspi/*"!][!//  
          [!VAR "SpiDmaRec" = "SpiHwDmaChannelReceptionRef"!][!//
          [!VAR "SpiDmaTrans" = "SpiHwDmaChannelTransmissionRef"!][!//
          [!VAR "SpiDmaRec" = "substring-after($SpiDmaRec,'Dma/Dma/')"!][!//
          [!VAR "SpiDmaTrans" = "substring-after($SpiDmaTrans,'Dma/Dma/')"!][!//        
          [!IF "($SpiDmaRec = $Dmach) or ($SpiDmaTrans = $Dmach)"!][!//
            [!VAR "flag" = "num:i(1)"!][!//
          [!ENDIF!][!//      
        [!ENDSELECT!][!//
        [!IF "$flag = num:i(0)"!]
          [!ERROR!][!//
            ERROR: Dma channel configuration for reception/transmission channel of SPI module does not match with [!"$Dmach"!], Please configure properly.
          [!ENDERROR!][!//
        [!ENDIF!][!//
      [!ENDIF!][!//      
    [!ELSEIF "$DmaChUser = 'HSSL'"!][!//
     [!VAR "flag" = "num:i(0)"!][!//
     [!SELECT "as:modconf('Hssl')[1]/HsslConfig/*"!][!//  
       [!VAR "HsslWrCh" = "HsslDmaMultiWriteChannelRef"!][!//
       [!VAR "HsslRdTxCh" = "HsslDmaMultiReadTxChannelRef"!][!//
       [!VAR "HsslRdRxCh" = "HsslDmaMultiReadRxChannelRef "!][!//
       [!VAR "HsslWrCh" = "substring-after($HsslWrCh,'Dma/Dma/')"!][!//
       [!VAR "HsslRdTxCh" = "substring-after($HsslRdTxCh,'Dma/Dma/')"!][!//
       [!VAR "HsslRdRxCh" = "substring-after($HsslRdRxCh,'Dma/Dma/')"!][!//                      
       [!IF "($HsslWrCh = $Dmach) or ($HsslRdTxCh = $Dmach) or ($HsslRdRxCh = $Dmach)"!][!//
         [!VAR "flag" = "num:i(1)"!][!//
       [!ENDIF!][!//        
     [!ENDSELECT!][!//
     [!IF "$flag = num:i(0)"!]
      [!ERROR!][!//
        ERROR: Dma channel configuration for MultiWriteChannelRef or MultiReadTxChannelRef or MultiReadRxChannelRef of HSSL module does not match with [!"$Dmach"!], Please configure properly.
      [!ENDERROR!][!//
     [!ENDIF!][!//     
   [!ENDIF!][!//
 [!ENDNOCODE!][!//
