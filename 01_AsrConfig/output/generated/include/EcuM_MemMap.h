...
/* Memory section macros for EcuM */
    ...
    #error Tried to open section ECUM_START_SEC_CODE within an already open section.
  #else
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_CODE without prior opening ECUM_START_SEC_CODE.
  #endif

#elif (defined ECUM_START_SEC_CONFIG_DATA_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_CONFIG_DATA_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_CONFIG_DATA_UNSPECIFIED without prior opening ECUM_START_SEC_CONFIG_DATA_UNSPECIFIED.
  #endif

#elif (defined ECUM_START_CONFIG_DATA_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_CONFIG_DATA_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_CONFIG_DATA_UNSPECIFIED without prior opening ECUM_START_CONFIG_DATA_UNSPECIFIED.
  #endif

#elif (defined ECUM_START_SEC_CONST_16)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_CONST_16 within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_CONST_16 without prior opening ECUM_START_SEC_CONST_16.
  #endif

#elif (defined ECUM_START_SEC_CONST_32)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_CONST_32 within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_CONST_32 without prior opening ECUM_START_SEC_CONST_32.
  #endif

#elif (defined ECUM_START_SEC_CONST_8)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_CONST_8 within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_CONST_8 without prior opening ECUM_START_SEC_CONST_8.
  #endif

#elif (defined ECUM_START_SEC_CONST_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_CONST_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_CONST_UNSPECIFIED without prior opening ECUM_START_SEC_CONST_UNSPECIFIED.
  #endif

#elif (defined ECUM_START_SEC_INTERNAL_VAR_POWER_ON_INIT_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_INTERNAL_VAR_POWER_ON_INIT_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_INTERNAL_VAR_POWER_ON_INIT_UNSPECIFIED without prior opening ECUM_START_SEC_INTERNAL_VAR_POWER_ON_INIT_UNSPECIFIED.
  #endif

#elif (defined ECUM_START_SEC_VAR_CLEARED_16)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_VAR_CLEARED_16 within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_VAR_CLEARED_16 without prior opening ECUM_START_SEC_VAR_CLEARED_16.
  #endif

#elif (defined ECUM_START_SEC_VAR_CLEARED_8)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_VAR_CLEARED_8 within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_VAR_CLEARED_8 without prior opening ECUM_START_SEC_VAR_CLEARED_8.
  #endif

#elif (defined ECUM_START_SEC_VAR_CLEARED_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_VAR_CLEARED_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_VAR_CLEARED_UNSPECIFIED without prior opening ECUM_START_SEC_VAR_CLEARED_UNSPECIFIED.
  #endif

#elif (defined ECUM_START_SEC_VAR_INIT_8)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_VAR_INIT_8 within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_VAR_INIT_8 without prior opening ECUM_START_SEC_VAR_INIT_8.
  #endif

#elif (defined ECUM_START_SEC_VAR_INIT_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_VAR_INIT_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_VAR_INIT_UNSPECIFIED without prior opening ECUM_START_SEC_VAR_INIT_UNSPECIFIED.
  #endif

#elif (defined ECUM_START_SEC_VAR_POWER_ON_INIT_8)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_ECUM
    #error Tried to open section ECUM_START_SEC_VAR_POWER_ON_INIT_8 within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_ECUM
    #error Tried to close section ECUM_STOP_SEC_VAR_POWER_ON_INIT_8 without prior opening ECUM_START_SEC_VAR_POWER_ON_INIT_8.
  #endif
  ...
  #undef MEMMAP_ERROR_ECUM
  #error MEMMAP_ERROR_ECUM the included memory section was not defined within the BSW-IMPLEMENTATION or SWC-IMPLEMENTATION of EcuM.
#endif
