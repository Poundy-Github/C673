/* $Header: look1_is16lfts16n10DfIf_binlcr.c 1.1 2018/01/24 16:29:58CET Asong, Wedndah Asaha (uidj2187) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : look1_is16lfts16n10DfIf_binlcr.c
   C source code generated on           : Thu Sep 01 23:29:42 2016
   Filename of Simulink Model           : DMC.mdl/.slx
   Revision of Simulink Model           : 1.2622
 ***************************************************************************************************
...
real32_T look1_is16lfts16n10DfIf_binlcr(int16_T tmp_, const int16_T tmp_0[],
  const int16_T tmp_1[], uint32_T tmp_2)
{
  real32_T tmp_4;
  uint32_T tmp_5;
  uint32_T tmp_6;
  ...
  if (tmp_ <= tmp_0[(uint8_T)0U]) {
    ...
    tmp_4 = ((real32_T)((uint16_T)(((uint32_T)tmp_) - ((uint32_T)tmp_0[tmp_6]))))
      / ((real32_T)((uint16_T)((int32_T)(((int32_T)tmp_0[tmp_6 + ((uint32_T)1U)])
            - tmp_0[tmp_6]))));
  } else {
   ...
   */
  return (((((real32_T)tmp_1[tmp_6 + ((uint32_T)1U)]) * 0.0009765625F) -
           (((real32_T)tmp_1[tmp_6]) * 0.0009765625F)) * tmp_4) + (((real32_T)
    tmp_1[tmp_6]) * 0.0009765625F);
}
