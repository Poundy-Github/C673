...
REM  FILE NAME: batch\scons_qac_ti_c674x_analyze_file.bat
...
REM #############################################################################
REM  CHANGES:                   $Log: scons_qac_ti_c674x_analyze_file.bat  $
...
REM  CHANGES:                   Revision 1.2 2015/06/26 13:30:33CEST uidr0826 
REM  CHANGES:                   Add revision label with module description for all GSCons files (Issue 320651)
REM  CHANGES:                   - Added comments -  uidr0826 [Jun 26, 2015 1:30:33 PM CEST]
...
call scons.bat build_from_ide=1 %component%_qac_ti_c674x qac_source=%2
popd