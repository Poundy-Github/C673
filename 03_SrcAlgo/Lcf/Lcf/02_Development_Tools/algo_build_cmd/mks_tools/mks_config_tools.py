...
# :org:           Continental AG
# :author:        Jochen Spruck and Ilja Hotjakov
# :version:       $Revision: 1.1 $
# :date:          $Date: 2021/12/13 17:52:36CET $
...
class mks_obj(logging_obj, xml_obj):
        ...
        for line in stdout_str_lines:
            if (len(line) > 1):
                ...
                if (len(argu) > 1):
                    ...
                    retGetAllLabelsDict[argu[0]] = argu[1]
    ...
    def CheckpointProject(self, ProjectType, ProjectPath, ActDevPath, Description, LabelMembers, Label):
        ...
        if ((LabelMembers == True) and ((ProjectType == "sandbox") or (ProjectType == "project"))):
        ...
        elif ((LabelMembers == False) and ((ProjectType == "sandbox") or (ProjectType == "project"))):
            self.Log("Info",
                     "Start Labeling members. This may take some time and you cannot see any progress in output.")
            self.AddMemberLabel(ProjectType, ProjectPath, ActDevPath, Label, Recurse=False)
            self.Log("Info", "Finished Labeling members.")
        return 0
        ...
        if ((ConfigNumber == 1) or (ConfigNumber == 3) or (ConfigNumber == 5) or (ConfigNumber == 7)):
            if (len(Label) > 0):
                ...
                if (ConfigType == "CustomV2"):
                    ...
                    if Label in self.SharedProjectLabelsDevPathInfo[SharedPath]["Build"]:
                        BuildRevision = self.SharedProjectLabelsDevPathInfo[SharedPath]["Build"][Label]
                        # print SharedPath
                        # print Label
                        # print BuildRevision
                        if (BuildRevision == 0):
...
CHANGE LOG:
-----------
$Log: mks_config_tools.py  $
Revision 1.1 2021/12/13 17:52:36CET Wang, David (Wangd3) 
Initial revision
Member added to project /ADAS/Projects/MFC5xx/MFC5J3/06_Algorithm/DPU/04_Engineering/02_Development_Tools/algo_build_cmd/mks_tools/project.pj
Revision 1.136 2017/11/17 14:01:25CET Arndt, Bosse (uidq5253) 
Hotfix: SINT-2274
Revision 1.135 2017/11/07 16:59:56CET Arndt, Bosse (uidq5253) 
Hotfix from master branch [92b4a0f]
Revision 1.134 2017/11/07 16:39:46CET Arndt, Bosse (uidq5253) 
Hotfix from master branch [92b4a0f]
Revision 1.127 2017/04/21 14:34:20CEST Azam, Saad (uidg4889)
hotfix: to be able to configure GA in the project
Revision 1.126 2017/04/21 14:08:56CEST Azam, Saad (uidg4889)
hotfix to be able to configure GA
Revision 1.125 2017/03/21 15:51:07CET Azam, Saad (uidg4889)
Just some logging info updates
Revision 1.124 2017/03/20 14:02:53CET Azam, Saad (uidg4889)
- GetProjectView updated to retrun view for 'normal' subprojects
- Bugfix for function AddSharedSubProject
Revision 1.123 2017/03/20 08:54:33CET Azam, Saad (uidg4889)
Adapted GetProjectView function to be able to verify devpath enteries
Revision 1.122 2017/03/16 18:00:15CET Azam, Saad (uidg4889)
Improved error handeling for DropSubproject and AddSharedSubproject functions
Revision 1.121 2017/03/16 15:41:14CET Azam, Saad (uidg4889)
Updated Dropsubproject and ADDSharedSubproject functions for better error handeling
Revision 1.120 2017/03/16 10:21:45CET Azam, Saad (uidg4889)
Drop subproject function added to mks_obj() class
Revision 1.119 2017/02/09 18:00:12CET Azam, Saad (uidg4889)
Adapted for GA repostory locations
Revision 1.118 2017/01/27 10:38:07CET Azam, Saad (uidg4889)
Base component paths updated for GA, and new common components from Mainstream common RTE
Revision 1.117 2016/11/24 10:39:50CET Mali, Sangram (uidp6760)
Added new Project Path path Global Architecture
Revision 1.116 2016/09/16 16:26:42CEST Azam, Saad (uidg4889)
Fixes related to mks_restore_from_project script
Revision 1.115 2016/09/09 12:41:21CEST Sinnwell-EXT, Wolfgang (uidj6607)
fixed error return handling of UpdateConfig on xml file read errors
Revision 1.114 2016/09/09 10:27:03CEST Sinnwell-EXT, Wolfgang (uidj6607)
added print LabelType on missed component for better identification
Revision 1.113 2016/08/31 11:20:05CEST Azam, Saad (uidg4889)
bugfix for 1.111 in CompName recognition
Revision 1.112 2016/08/30 15:17:14CEST Azam, Saad (uidg4889)
Updated CompName path for SW common RTE
Revision 1.111 2016/08/08 17:41:31CEST Azam, Saad (uidg4889)
another crazy indentation update
Revision 1.109 2016/08/08 16:18:33CEST Azam, Saad (uidg4889)
Improved error processing of SetSharedProjectsToConfig() calls introduced in revision 1.101
Revision 1.108 2016/08/05 17:01:15CEST Azam, Saad (uidg4889)
path added for /nfs/projekte1/SW/SW_ARS4xx subproject for common RTE configuration
Revision 1.107 2016/07/26 15:32:41CEST Azam, Saad (uidg4889)
Added path for project component EUNCAP18 so that Run Config can recognise shares from ncap18 project using CompName "EUNCAP18"
Revision 1.106 2016/06/02 14:30:12CEST Azam, Saad (uidg4889)
Base path for new component added: '/nfs/projekte1/REPOSITORY/Tools/Validation_Tools/Lib_Libraries/'
Revision 1.105 2016/05/20 11:59:30CEST Azam, Saad (uidg4889)
GetNotSharedProjectsRecGeneric added
Revision 1.104 2016/05/18 10:35:06CEST Azam, Saad (uidg4889)
Updated the function "GetProjectsRecGeneric", added following functions "GetListOfNonSharedSubprojectsFromSandbox", "ValidateSubProjectPath", "CreateSubproject"
Revision 1.103 2016/04/18 16:31:40CEST Azam, Saad (uidg4889)
Updated 'CheckIn' function for additional return, for better checkin condition handeling
Revision 1.102 2016/03/30 16:24:13CEST Sinnwell-EXT, Wolfgang (uidj6607)
fixed missed user/pw in "si addlabel" command
fixed logging output (minor)
Revision 1.101 2016/03/04 12:35:24CET Sinnwell-EXT, Wolfgang (uidj6607)
added error processing of SetSharedProjectsToConfig() calls
Revision 1.100 2016/02/04 13:29:21CET Sinnwell-EXT, Wolfgang (uidj6607)
added ReadConfigXMLFileDict2CompDict(), CheckConfigXML2PostConfig
updated descriptions and error handling
Revision 1.99 2016/02/02 13:22:28CET Sinnwell-EXT, Wolfgang (uidj6607)
added CheckPostConfig()
Revision 1.98 2016/01/25 13:57:34CET Sinnwell-EXT, Wolfgang (uidj6607)
fixed error return of ReadAndUpdateConfig() in ConfigSharedSubProjects()
Revision 1.97 2016/01/21 17:46:05CET Sinnwell-EXT, Wolfgang (uidj6607)
added user/password to critical commands for Jenkins multiuser processing
Revision 1.96 2016/01/15 18:07:23CET Sinnwell-EXT, Wolfgang (uidj6607)
added user/password parameter handling to run with different user account under in Jenkins
Revision 1.95 2015/12/09 13:38:38CET Sinnwell-EXT, Wolfgang (uidj6607)
added sorted output to GetCompList()
Revision 1.94 2015/11/30 11:56:31CET Azam, Saad (uidg4889)
Following strings parsed by the script are replaced due the changes in project info command in Integrity client 10.6:

# Integrity 10.6: "Shared From: "  ==> "Repository Location: "
# Integrity 10.6: "Revision:"  ==> "Last Checkpoint:"
Revision 1.93 2015/11/25 14:38:49CET Sinnwell-EXT, Wolfgang (uidj6607)
added error handling for  ConfigureSharedSubproject(), SetSharedProjectsToConfig(),CreateSharedProjectXML()
added more verbose error messages with location info
--- Added comments ---  uidj6607 [Nov 25, 2015 2:38:52 PM CET]
Change Package : 269733:2 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.92 2015/11/02 16:54:56CET Sinnwell-EXT, Wolfgang (uidj6607)
added print revision info
--- Added comments ---  uidj6607 [Nov 2, 2015 4:54:57 PM CET]
Change Package : 269733:2 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.91 2015/10/28 10:37:54CET Azam, Saad (uidg4889)
- Improved error handeling of checkifallbuild (which creates the checkpoint and label members)
- Added port and host input for IsChangePackageValid(), LockMemberSandbox(), CheckIn() and UpdateWorkingToMember()
--- Added comments ---  uidg4889 [Oct 28, 2015 10:37:55 AM CET]
Change Package : 279146:2 http://mks-psad:7002/im/viewissue?selection=279146
Revision 1.90 2015/10/14 12:20:29CEST Sinnwell-EXT, Wolfgang (uidj6607)
added print of modified _mod.xml with new Modified flag set
--- Added comments ---  uidj6607 [Oct 14, 2015 12:20:30 PM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.89 2015/10/06 16:54:05CEST Sinnwell-EXT, Wolfgang (uidj6607)
merged 1.88.1.1
fixed error handling in CheckpointProject()
--- Added comments ---  uidj6607 [Oct 6, 2015 4:54:06 PM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.88.1.1 2015/10/06 12:19:05CEST Azam, Saad (uidg4889)
- Better error handeling and labeling during checkifallbuild (checkpointing)
--- Added comments ---  uidg4889 [Oct 6, 2015 12:19:06 PM CEST]
Change Package : 382631:1 http://mks-psad:7002/im/viewissue?selection=382631
Revision 1.88 2015/08/25 17:00:18CEST Sinnwell-EXT, Wolfgang (uidj6607)
fixed exception on XML read error
--- Added comments ---  uidj6607 [Aug 25, 2015 5:00:19 PM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.87 2015/08/25 14:53:28CEST Sinnwell-EXT, Wolfgang (uidj6607)
merged v1.79.1. branch with trunk
--- Added comments ---  uidj6607 [Aug 25, 2015 2:53:29 PM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.79.1.13 2015/08/14 10:43:48CEST Sinnwell-EXT, Wolfgang (uidj6607)
added new Validation_Tools & SW_MFC411 path in ParseForSharedSandboxProject()
--- Added comments ---  uidj6607 [Aug 14, 2015 10:43:49 AM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.84 2015/08/14 10:37:19CEST Sinnwell-EXT, Wolfgang (uidj6607)
added new Validation_Tools & SW_MFC411 path in ParseForSharedSandboxProject()
--- Added comments ---  uidj6607 [Aug 14, 2015 10:37:20 AM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.79.1.12 2015/08/13 18:15:05CEST Azam, Saad (uidg4889)
Fixed, wrong checkin condition check for unlock
--- Added comments ---  uidg4889 [Aug 13, 2015 6:15:06 PM CEST]
Change Package : 279146:1 http://mks-psad:7002/im/viewissue?selection=279146
Revision 1.79.1.11 2015/08/13 10:21:44CEST Azam, Saad (uidg4889)
Fix for the issue --> Label members before Checkpoint
Solution: Checkpoint before start labelling
--- Added comments ---  uidg4889 [Aug 13, 2015 10:21:45 AM CEST]
Change Package : 224745:1 http://mks-psad:7002/im/viewissue?selection=224745
Revision 1.79.1.10 2015/08/11 13:15:30CEST Azam, Saad (uidg4889)
- Added unlock member, if checkin fails during automated integration, unlock is executed for the failed member
- clean up for redundant 'return' statements
- labelling enabled in case a label is entered using cmdline arguments for checkpointing
- return False and True switched for CheckForBuild function, False returns is no error else a True/1 is returned, this is done
  to be consistent with rest of the automation to be done using Jenkins
--- Added comments ---  uidg4889 [Aug 11, 2015 1:15:31 PM CEST]
Change Package : 224745:1 http://mks-psad:7002/im/viewissue?selection=224745
Revision 1.79.1.9 2015/08/10 17:31:52CEST Sinnwell-EXT, Wolfgang (uidj6607)
fixed path construction
tested under Jenkins environment
--- Added comments ---  uidj6607 [Aug 10, 2015 5:31:53 PM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.79.1.8 2015/08/04 19:09:17CEST Azam, Saad (uidg4889)
Description string added to be updated via command line options
--- Added comments ---  uidg4889 [Aug 4, 2015 7:09:18 PM CEST]
Change Package : 279146:1 http://mks-psad:7002/im/viewissue?selection=279146
Revision 1.79.1.7 2015/07/28 10:50:02CEST Azam, Saad (uidg4889)
Restructuring and naming of the class CheckInMembers, some member functions more relavent moved to mks_obj
--- Added comments ---  uidg4889 [Jul 28, 2015 10:50:03 AM CEST]
Change Package : 279146:1 http://mks-psad:7002/im/viewissue?selection=279146
Revision 1.79.1.6 2015/07/20 16:41:15CEST Azam, Saad (uidg4889)
checkin_members moved to a seperate class
more robust error handeling introduced inside checkin_members class
--- Added comments ---  uidg4889 [Jul 20, 2015 4:41:16 PM CEST]
Revision 1.79.1.5 2015/07/06 19:10:13CEST Azam, Saad (uidg4889)
Minor fix to 1.79.1.4
--- Added comments ---  uidg4889 [Jul 6, 2015 7:10:14 PM CEST]
Change Package : 279146:1 http://mks-psad:7002/im/viewissue?selection=279146
Revision 1.79.1.4 2015/07/06 18:27:08CEST Azam, Saad (uidg4889)
Automatic description and labelling added
--- Added comments ---  uidg4889 [Jul 6, 2015 6:27:09 PM CEST]
Change Package : 224745:1 http://mks-psad:7002/im/viewissue?selection=224745
Revision 1.79.1.3 2015/06/29 12:21:22CEST Azam, Saad (uidg4889)
Locked Members can be checked in only if pre existing lock cp id matched the input change package id
--- Added comments ---  uidg4889 [Jun 29, 2015 12:21:23 PM CEST]
Change Package : 224745:1 http://mks-psad:7002/im/viewissue?selection=224745
Revision 1.79.1.2 2015/06/22 10:39:52CEST Azam, Saad (uidg4889)
Bugfix in CheckinMembers function
--- Added comments ---  uidg4889 [Jun 22, 2015 10:39:53 AM CEST]
Change Package : 224745:1 http://mks-psad:7002/im/viewissue?selection=224745
Revision 1.79.1.1 2015/06/15 13:47:21CEST Azam, Saad (uidg4889)
1st version: New functions added for automated checkIn
--- Added comments ---  uidg4889 [Jun 15, 2015 1:47:21 PM CEST]
Change Package : 224745:1 http://mks-psad:7002/im/viewissue?selection=224745
Revision 1.79 2015/04/27 18:09:16CEST Azam, Saad (uidg4889)
Bug Fix for Rev. 1.78,
Fixed labelling twice after '-m' (labelallmembers) enabled
--- Added comments ---  uidg4889 [Apr 27, 2015 6:09:17 PM CEST]
Change Package : 279146:1 http://mks-psad:7002/im/viewissue?selection=279146
Revision 1.78 2015/04/23 11:19:21CEST Azam, Saad (uidg4889)
Updated function 'CheckIfAllBuild', added new option '-m' for AddLabelToAllMembers, to choose if all members should be labelled in the checkpoint(for ARS) or selected ones(for MFL/MFC/SMFC),
-m =  AddLabelToAllMembers, otherwise add label to only members from not shared subprojects
--- Added comments ---  uidg4889 [Apr 23, 2015 11:19:22 AM CEST]
Change Package : 279146:1 http://mks-psad:7002/im/viewissue?selection=279146
Revision 1.77 2015/04/09 19:28:28CEST Sinnwell-EXT, Wolfgang (uidj6607)
added comments in UpdateConfig()
--- Added comments ---  uidj6607 [Apr 9, 2015 7:28:28 PM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.76 2015/04/09 16:54:42CEST Sinnwell-EXT, Wolfgang (uidj6607)
added comments in  UpdateConfig()
fixed missed SharedProjects entries for CustomV2
--- Added comments ---  uidj6607 [Apr 9, 2015 4:54:42 PM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.75 2015/03/30 18:41:32CEST Sinnwell-EXT, Wolfgang (uidj6607)
added option --baselist to UpdateConfig()
--- Added comments ---  uidj6607 [Mar 30, 2015 6:41:33 PM CEST]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.74 2015/03/18 14:45:13CET Sinnwell-EXT, Wolfgang (uidj6607)
added dryrun flag for
added logging to custom type on console
added option Build for CreateSandbox()
added functions:
dict_diff()
GetPreConfigSharesProjects()
ReadConfigSharedProjectsXML2Dict()
GetConfigFileXMLDocs()
SaveConfigXML()
FindReplaceCPlabel()
UpdateConfig()
--- Added comments ---  uidj6607 [Mar 18, 2015 2:45:14 PM CET]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.73 2015/03/06 21:37:14CET Friebertshaeuser, Markus (uidt0551)
- avoid configuring unnecessary paths that are determined by CustomV3 config
--- Added comments ---  uidt0551 [Mar 6, 2015 9:37:18 PM CET]
Change Package : 199714:3 http://mks-psad:7002/im/viewissue?selection=199714
Revision 1.72 2015/03/06 14:48:26CET Friebertshaeuser, Markus (uidt0551)
- bugfix in ConfigureSubprojects for shared subprojects not shared as 'project.pj'
- import warnings removed
--- Added comments ---  uidt0551 [Mar 6, 2015 2:48:30 PM CET]
Change Package : 199714:3 http://mks-psad:7002/im/viewissue?selection=199714
Revision 1.71 2015/01/13 13:51:00CET Hussain-Ext, Medhat (uidg3180)
bugfix
--- Added comments ---  uidg3180 [Jan 13, 2015 1:51:01 PM CET]
Change Package : 280292:1 http://mks-psad:7002/im/viewissue?selection=280292
Revision 1.70 2014/11/07 16:08:26CET Sinnwell-EXT, Wolfgang (uidj6607)
fixed typos
--- Added comments ---  uidj6607 [Nov 7, 2014 4:08:27 PM CET]
Change Package : 269733:1 http://mks-psad:7002/im/viewissue?selection=269733
Revision 1.69 2014/09/30 12:15:11CEST Spruck, Jochen (spruckj)
Performanc optimization related to local database
--- Added comments ---  spruckj [Sep 30, 2014 12:15:11 PM CEST]
Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
Revision 1.68 2014/09/29 11:38:34CEST Spruck, Jochen (spruckj)
Performanc optimzation of config skript
--- Added comments ---  spruckj [Sep 29, 2014 11:38:35 AM CEST]
Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
Revision 1.67 2014/09/11 09:01:23CEST Spruck, Jochen (spruckj)
Remove instrumentation and add small performance optimization
--- Added comments ---  spruckj [Sep 11, 2014 9:01:25 AM CEST]
Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
Revision 1.66 2014/09/10 17:45:12CEST Spruck, Jochen (spruckj)
Some small bug fixes regarding shared sub project config with database
--- Added comments ---  spruckj [Sep 10, 2014 5:45:13 PM CEST]
Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
Revision 1.65 2014/09/09 12:41:47CEST Spruck, Jochen (spruckj)
First version with database support for shared sub project configuration
--- Added comments ---  spruckj [Sep 9, 2014 12:41:48 PM CEST]
Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
Revision 1.63 2014/06/16 15:09:34CEST Spruck, Jochen (spruckj)
Small bug fix regarding resync sandbox
--- Added comments ---  spruckj [Jun 16, 2014 3:09:34 PM CEST]
Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
Revision 1.62 2014/06/02 09:23:32CEST Berndt, Thomas01 (berndtt1)
+ Create Sandbox with "Configuration Path"
--- Added comments ---  berndtt1 [Jun 2, 2014 9:25:40 AM CEST]
Change Package : 240292:1 http://mks-psad:7002/im/viewissue?selection=240292
Revision 1.61 2014/05/22 15:12:01CEST Spruck, Jochen (spruckj)
- Add resync mks kommand
- create first version of mks config database
- add hash to the configuration pre and post xml
--- Added comments ---  spruckj [May 22, 2014 3:12:02 PM CEST]
Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
Revision 1.60 2014/02/25 15:00:43CET Gressmann, Markus (uidw1565)
added CheckoutSubProjectByLabel and RetargetAndResynchSbx
--- Added comments ---  uidw1565 [Feb 25, 2014 3:00:44 PM CET]
Change Package : 188681:2 http://mks-psad:7002/im/viewissue?selection=188681
Revision 1.59 2014/01/09 12:01:38CET Spruck, Jochen (spruckj)
Delete sandbox folder if sandbox is already dropped from mks
--- Added comments ---  spruckj [Jan 9, 2014 12:01:39 PM CET]
Change Package : 196584:4 http://mks-psad:7002/im/viewissue?selection=196584
Revision 1.58 2013/09/25 16:12:34CEST Spruck, Jochen (spruckj)
Small Bug fix
--- Added comments ---  spruckj [Sep 25, 2013 4:12:34 PM CEST]
Change Package : 196584:1 http://mks-psad:7002/im/viewissue?selection=196584
Revision 1.57 2013/09/23 16:20:03CEST Spruck, Jochen (spruckj)
Update check for build and checkpoint skripting.
-> Should be much faster!!!
--- Added comments ---  spruckj [Sep 23, 2013 4:20:03 PM CEST]
Change Package : 196584:1 http://mks-psad:7002/im/viewissue?selection=196584
Revision 1.56 2013/09/23 14:40:18CEST Spruck, Jochen (spruckj)
Extend intergrity command (update issue)
Do some performance optimizations regarding shared sub project configuration skripting
--- Added comments ---  spruckj [Sep 23, 2013 2:40:19 PM CEST]
Change Package : 196584:1 http://mks-psad:7002/im/viewissue?selection=196584
Revision 1.55 2013/09/10 16:22:36CEST Friebertshaeuser, Markus (uidt0551)
Add option to label only relevant members while checkpointing
--- Added comments ---  uidt0551 [Sep 10, 2013 4:22:37 PM CEST]
Change Package : 162889:10 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.54 2013/09/05 13:40:09CEST Spruck, Jochen (spruckj)
Add skripting to create issues for multiple components
--- Added comments ---  spruckj [Sep 5, 2013 1:40:09 PM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.53 2013/08/22 10:12:07CEST Konarski-EXT, Witek (uidt8403)
Fixed the problem of labelling members when not needed by add pre int checkpoint.
--- Added comments ---  uidt8403 [Aug 22, 2013 10:12:07 AM CEST]
Change Package : 193972:1 http://mks-psad:7002/im/viewissue?selection=193972
Revision 1.52 2013/08/09 11:10:54CEST Spruck, Jochen (spruckj)
- Update function GetAllDevPathes to set the starting path of search
- bug fix sync dev pathes script, input from adrian
--- Added comments ---  spruckj [Aug 9, 2013 11:10:55 AM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.51 2013/07/10 14:58:10CEST Konarski-EXT, Witek (uidt8403)
- Added AddMemberLabel() for auromatic labelling after checkpoint has been executed.
- Corrected typos
--- Added comments ---  uidt8403 [Jul 10, 2013 2:58:10 PM CEST]
Change Package : 179669:17 http://mks-psad:7002/im/viewissue?selection=179669
Revision 1.50 2013/07/03 16:57:29CEST Friebertshaeuser, Markus (uidt0551)
Added class to add a project label recursively with given checkpoint root-revision
--- Added comments ---  uidt0551 [Jul 3, 2013 4:57:29 PM CEST]
Change Package : 162889:10 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.49 2013/06/10 12:35:49CEST Paulig, Ralf (uidt3509)
Report error if config uses CustomV2 but is called with type "normal".
--- Added comments ---  uidt3509 [Jun 10, 2013 12:35:49 PM CEST]
Change Package : 175257:4 http://mks-psad:7002/im/viewissue?selection=175257
Revision 1.48 2013/06/06 20:11:27CEST Spruck, Jochen (spruckj)
- Bug fix, extracting internal cross shares
--- Added comments ---  spruckj [Jun 6, 2013 8:11:27 PM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.47 2013/06/06 19:21:22CEST Spruck, Jochen (spruckj)
- Bug fix merging additional files including other custom configs
- Bug fix adding internal share of a project
--- Added comments ---  spruckj [Jun 6, 2013 7:21:23 PM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.46 2013/06/06 10:36:40CEST Spruck, Jochen (spruckj)
- Update some sw shares filters (comp name extreaction),
- Bug fix options for check for build and checkpoint
--- Added comments ---  spruckj [Jun 6, 2013 10:36:40 AM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.45 2013/06/05 12:22:40CEST Spruck, Jochen (spruckj)
Small bug fix regarding the Custom V2 extension
--- Added comments ---  spruckj [Jun 5, 2013 12:22:40 PM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.44 2013/06/04 18:26:09CEST Spruck, Jochen (spruckj)
add option for adding label to all members in case of checkpointing
--- Added comments ---  spruckj [Jun 4, 2013 6:26:09 PM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.43 2013/05/27 10:25:43CEST Spruck, Jochen (spruckj)
Bug fix Config V2 new feature should be only available if Devpathname is set in the config xml
--- Added comments ---  spruckj [May 27, 2013 10:25:44 AM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.42 2013/05/26 18:22:28CEST Spruck, Jochen (spruckj)
Add new feature to CustomConfigV2
         <SharedProject CompName="MTS_Application" DevPathName="MTS_Application_2011_CW19_MFC300_UNICODE" >
now also the desired DevPathName could be specified for which the config is valid.
the config is valid if the share is actually configured to a checkpoint of this variant
--- Added comments ---  spruckj [May 26, 2013 6:22:28 PM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.41 2013/04/04 08:56:59CEST Spruck, Jochen (spruckj)
Add some addition component rules
--- Added comments ---  spruckj [Apr 4, 2013 8:57:00 AM CEST]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.40 2013/03/20 10:15:30CET Ruland, Thomas (uidw0251)
- added forwarding of xml-parser-error-message in case of parser errors
--- Added comments ---  uidw0251 [Mar 20, 2013 10:15:33 AM CET]
Change Package : 173649:1 http://mks-psad:7002/im/viewissue?selection=173649
Revision 1.39 2013/03/13 08:37:37CET Spruck, Jochen (spruckj)
Bug fix extraction of SW_XXX_PR component projects
--- Added comments ---  spruckj [Mar 13, 2013 8:37:37 AM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.38 2013/03/12 17:59:04CET Spruck, Jochen (spruckj)
update script using common folder from sw
--- Added comments ---  spruckj [Mar 12, 2013 5:59:05 PM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.37 2013/02/06 16:05:28CET Spruck, Jochen (spruckj)
remove comment
--- Added comments ---  spruckj [Feb 6, 2013 4:05:29 PM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.36 2013/02/06 16:00:53CET Spruck, Jochen (spruckj)
Add component extraction for ti compiler in sw
--- Added comments ---  spruckj [Feb 6, 2013 4:00:53 PM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.35 2013/02/06 15:42:57CET Spruck, Jochen (spruckj)
do not use relpath because movpy does not have this feature
--- Added comments ---  spruckj [Feb 6, 2013 3:42:59 PM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.34 2013/02/06 13:40:32CET Spruck, Jochen (spruckj)
improve sync of dev pathes
--- Added comments ---  spruckj [Feb 6, 2013 1:40:33 PM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.33 2013/02/05 13:53:46CET Spruck, Jochen (spruckj)
Add missing shares only if share is missing
--- Added comments ---  spruckj [Feb 5, 2013 1:53:46 PM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.32 2013/02/05 12:21:38CET Spruck, Jochen (spruckj)
remove debug print
--- Added comments ---  spruckj [Feb 5, 2013 12:21:39 PM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.31 2013/02/05 09:17:20CET Spruck, Jochen (spruckj)
Add SyncMksPathes
--- Added comments ---  spruckj [Feb 5, 2013 9:17:20 AM CET]
Change Package : 162889:25 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.30 2013/02/04 09:21:17CET Spruck, Jochen (spruckj)
bug fix missing s for string print if exclude file is used
--- Added comments ---  spruckj [Feb 4, 2013 9:21:18 AM CET]
Change Package : 162889:2 http://mks-psad:7002/im/viewissue?selection=162889
Revision 1.29 2013/01/22 16:01:49CET Spruck, Jochen (spruckj)
Update drop sandbox function
--- Added comments ---  spruckj [Jan 22, 2013 4:01:49 PM CET]
Change Package : 46866:19 http://mks-psad:7002/im/viewissue?selection=46866
Revision 1.28 2012/08/13 15:53:13CEST Friebertshaeuser, Markus (uidt0551)
Added possibility to specify separate checkpoint description
--- Added comments ---  uidt0551 [Aug 13, 2012 3:53:14 PM CEST]
Change Package : 78383:2 http://mks-psad:7002/im/viewissue?selection=78383
Revision 1.27 2012/05/03 07:52:00CEST Hotjakov-EXT, Ilja (uidt9433)
Updated:
     ConfigureSharedProjects()
           Print lines added
     RestorePreIntCheckpointFromXML(self,argu)
           Renaming of pre_config_shared_projects_preint.xml removed
--- Added comments ---  uidt9433 [May 3, 2012 7:52:01 AM CEST]
Change Package : 89102:1 http://mks-psad:7002/im/viewissue?selection=89102
Revision 1.26 2012/04/27 13:01:42CEST Hotjakov-EXT, Ilja (uidt9433)
Removed:

    ParseForSharedProject()
        New faster function added: ParseForSharedSandboxProject()
    GetAllLabelsForAllDevPathes()
        New function name is GetAllLabelsForSharedProject()

Added:

    Import copy, stat and time
    In all si command functions:
        --batch added to every si command now it dont wait for mks inputs
    Functions:
        GetLabelForRevisionWithAllLabelsDict()
            Get the label corresponding to a revision and save all labels with revision to global Dictionary(e.g. self.retGetAllLabelsDict)
        GetRevisionSharedAndPathFromSandboxPath()
            Get the revision, projectpath and path from where the shared project in SandboxPath is shared
        IsSharedProjectAlreadyConfigured()
            Check if the SharedProject already configured
        GetProjectTypeDict()
            Save the configuration information of SubProjects type, revision and development path (if type variant or label) and path (full path) in dictionary of the project.pj from server
        GetNoBuildSharedSubSandboxList()
            Save the no build shared sandbox paths to list starting from given SandboxPath
        GetAllLabelsForSharedProject()
            Get all the label of the shared projects
        IsBaseConfigAlreadyInCustomV2()
            Check if the SharedProject is already in costomV2 configuration XML file
        ParseForSharedSandboxProject()
            Parse for all shared projects in project or the sandbox which are found in InputFileName e.g. pre_config_shared_projects.xml and add it to an xml stuct with all shared subpojects (normal/variant/build) This xml includes the project path and the shared project path the revision and the corresponding label, and the type(normal/variant/build)
        ParseForSharedProjectfromDict()
            Parse for all shared projects in project or the sandbox which are found in InputFileName e.g. pre_config_shared_projects.xml and add it to an xml stuct with all shared subpojects (normal/variant/build) This xml includes the project path and the shared project path the revision and the corresponding label, and the type(normal/variant/build) which is read from in InputDictName
        ParseForSharedProjectfromFile()
            Parse for all shared projects in project or the sandbox which are found in InputFileName e.g. pre_config_shared_projects.xml and add it to an xml stuct with all shared subpojects (normal/variant/build). This xml includes the project path and the shared project path the revision and the corresponding label, and the type(normal/variant/build). This function work only with projectpath, be sure that the normal in MKS has all the sub-projects that the branch of this project includes, else you get an error
        CreateSharedProjectXMLfromFile()
            Create a xml file of all shared sub projects, first try from dictionary if fails then from MKS
        IsSharedSubSubsandboxBuild()
            Check are all shared sub project of the sandbox build

Updated:

    GetCurrentDevPath():
        If no development path found, return "0"
    GetRevisionForLabelExt() and GetRevisionForLabel()
        Can handle non Unicode ASCI now
    GetLabelForRevision()
        ActDevPath input removed,
        Returns 1 if some error occur
        Speed optimized
    GetSharedFromPath()
        Returns 1 if some error occur
    ConfigureSharedSubproject()
        Error detection improved
        Return 0 if config was successful and 1 if configuration fails and 2 if the Error Massage "Please try again later" occur
    GetProjectType()
        Can handle project path too
    CheckIfPathShouldBeExcluded()
        Return code changed: return true if the Project should be excluded otherwise false
    CreateSharedProjectXML()
        Input added: GenPreConfigSharedProjectDict ->
        Generate a dictionary with label, revision, sharedpath, projectpath and type
    CheckSetProjectCfg()
        If root "CompName" (e.g. ARS301, SMR200, ARS400) not in configuration.xml file, this component will not added to configuration.xml and no exception occur
    CheckSharedProjectCompName()
        Root "CompName" (e.g. ARS301, SMR200, ARS400) checking added
    ReadAndUpdateConfig()
        If file configuration.xml write protected, write protection will be removed
    ConfigureSharedProjects()
        Speed optimized, only if the component not already configured the configuration will be done
    ConfigSharedSubProjects(argu)
        Input option -quiet added, quiet(on/off), prompt for Development Path confirmation
        CreateSharedProjectXMLfromFile used for PostConfigFileName.xml creation
    ScanForNonBuildSharedProject()
        Return code updated, return 2 if an error occur
        Speed improved if input is sandbox path
    MakeCheckPoint()
        New function GetAllLabelsForSharedProject() used instead of GetAllLabelsForAllDevPathes()
    CheckIfAllBuild(argu)
        Development path will be displayed now
        ScanForNonBuildSharedProject() error detection added
    RestoreConfig()
        Speed optimized
    CheckProjectType()
        Input v/b/n removed only normal/variant/build allowed
--- Added comments ---  uidt9433 [Apr 27, 2012 1:01:56 PM CEST]
Change Package : 105676:2 http://mks-psad:7002/im/viewissue?selection=105676
Revision 1.25 2012/03/29 08:35:49CEST Hotjakov-EXT, Ilja (uidt9433)
Updated:
    Functions in mks_obj class:
        GetCurrentDevPath()
            If normal, empty string will be returned
    Functions in ConfigSharedSubProjets_obj class:
        ParseForSharedProject()
            Speed optimized
            Log type changed: If Component name for subproject: not found: Error -> Info
    Functions in ConfigSharedSubProjets_obj class:
        ConfigSharedSubProjects(argu)
            Normal can be handled now
    Functions in CheckIfAllBuild_obj class:
        CheckIfAllBuild(argu)
            ynInputCheck(checkpoint,100) error code can be handled now
    Functions in RenameAllCheckpointLabels_obj class:
        RenameAllCheckpointLabels(argu)
            Normal can be handled now
            ynInputCheck(checkpoint,100) error code can be handled now
    Functions in AddPreIntCheckpoint_obj class:
        AddPreIntCheckpoint(argu)
            Normal can be handled now
            ynInputCheck(checkpoint,100) error code can be handled now
        RestoreConfig()
            ynInputCheck(checkpoint,100) error code can be handled now
        RestorePreIntCheckpointFromXML(argu)
            Normal can be handled now
            ynInputCheck(checkpoint,100) error code can be handled now
--- Added comments ---  uidt9433 [Mar 29, 2012 8:35:56 AM CEST]
Change Package : 103429:1 http://mks-psad:7002/im/viewissue?selection=103429
Revision 1.24 2012/03/22 09:45:07CET Hotjakov-EXT, Ilja (uidt9433)
Updated:
    Functions in mks_obj class:
        GetCurrentDevPath()
            MKS errors can be handled now
        RenameCheckpoint()
            Speed is optimized if new label is blank
    Functions in ConfigSharedSubProjets_obj class:
        ConfigSharedSubProjects(argu)
            If sandbox is used no more development path must be entered only if you use the project path as input, you should enter the development path
    Functions in ConfigSharedSubProjets_obj class:
        CheckIfAllBuild_obj(argu)
            If sandbox is used no more development path must be entered only if you use the project path as input, you should enter the development path
    Functions in RenameAllCheckpointLabels_obj class:
        RenameAllCheckpointLabels(argu)
            If sandbox is used no more development path must be entered only if you use the project path as input, you should enter the development path
    Functions in AddPreIntCheckpoint_obj class:
        ...
        RestorePreIntCheckpointFromXML(argu)
            If sandbox is used no more development path must be entered only if you use the project path as input, you should enter the development path
Fixed:
    Functions in CHeckAlgoIntegration_obj class:
        CheckDLLVersionWithXmlLabel(argu)
            Print issue fixed
--- Added comments ---  uidt9433 [Mar 22, 2012 9:45:16 AM CET]
Change Package : 103429:1 http://mks-psad:7002/im/viewissue?selection=103429
Revision 1.23 2012/03/19 13:32:36CET Hotjakov-EXT, Ilja (uidt9433)
New:
    Functions in mks_obj class:
        RenameFileAndAddDateTime()
            Add to an existing file the date and time  e.g. Filename_19.03.2012_10:25:34.xml
Updated:
    Functions in AddPreIntCheckpoint_obj class:
        AddPreIntCheckpoint(argu)
            backup old config files if exist
    ...
    Functions in ConfigSharedSubProjets_obj class:
        ConfigSharedSubProjects(self,argu)
            backup old config files if exist
--- Added comments ---  uidt9433 [Mar 19, 2012 1:32:41 PM CET]
Change Package : 97470:1 http://mks-psad:7002/im/viewissue?selection=97470
Revision 1.22 2012/03/19 09:48:00CET Hotjakov-EXT, Ilja (uidt9433)
Fixed: Input correction in:
    Functions in AddPreIntCheckpoint_obj class:
        RestoreConfig()
        AddPreIntCheckpoint(argu)
    Functions in CHeckAlgoIntegration_obj class:
        ...
        CheckDLLVersionWithXmlLabel(self,argu)
        CheckIfSharedSubSubsandboxBuild(self,argu)
        CompareDLLVersion(self,argu)
--- Added comments ---  uidt9433 [Mar 19, 2012 9:48:06 AM CET]
Change Package : 103429:1 http://mks-psad:7002/im/viewissue?selection=103429
Revision 1.21 2012/03/16 09:19:55CET Hotjakov-EXT, Ilja (uidt9433)
Fixed:
    Functions in AddPreIntCheckpoint_obj class:
        RestoreConfig()
    Functions in ConfigSharedSubProjects_obj class:
        ParseForSharedProject()
--- Added comments ---  uidt9433 [Mar 16, 2012 9:19:55 AM CET]
Change Package : 97470:1 http://mks-psad:7002/im/viewissue?selection=97470
Revision 1.20 2012/03/16 08:59:17CET Hotjakov-EXT, Ilja (uidt9433)
New:
    Functions in AddPreIntCheckpoint_obj class:
        RestorePreIntCheckpointFromXML(self,argu)
            If AddPreIntCheckpoint fails you can restore the old                 configuration from pre_config_shared_project_preint.xml now
        ReadConfigSharedProjectsPreintXML2Dict()
            Read the Xml file to self.RestoreTo dictionary

Updated:
    All Functions:
        Comments updated e.g. Port 7001, Server mks-psad
    Functions in AddPreIntCheckpoint_obj class:
        RestoreConfig()
            Input correction included
    Functions in ConfigSharedSubProjects_obj class:
        ParseForSharedProject()
            time-aligned
--- Added comments ---  uidt9433 [Mar 16, 2012 8:59:29 AM CET]
Change Package : 97470:1 http://mks-psad:7002/im/viewissue?selection=97470
Revision 1.19 2012/03/13 14:17:09CET Hotjakov-EXT, Ilja (uidt9433)
Fixed:
    CheckAlgoIntegration_obj.IsSharedSubSubsandboxBuild(self,abspath):
        Internal share will be dropped now
--- Added comments ---  uidt9433 [Mar 13, 2012 2:17:15 PM CET]
Change Package : 97470:1 http://mks-psad:7002/im/viewissue?selection=97470
Revision 1.18 2012/03/13 11:12:43CET Hotjakov-EXT, Ilja (uidt9433)
Comments corrected
--- Added comments ---  uidt9433 [Mar 13, 2012 11:12:48 AM CET]
Change Package : 97470:1 http://mks-psad:7002/im/viewissue?selection=97470
Revision 1.17 2012/03/13 10:59:38CET Hotjakov-EXT, Ilja (uidt9433)
Updated:
    All Functions:
        Print output include now date and time
        Argv parameter input check improved

    GetAttributeFromXML():
        Return "0" if CompLabelName not found
    IsFileContentEqual():
        Can handle file open errors now
    IsStrVersionEqual():
        Abort if not equal number found
    CompareDLLVersion(self,argu):
        Corrected
--- Added comments ---  uidt9433 [Mar 13, 2012 10:59:43 AM CET]
Change Package : 97470:1 http://mks-psad:7002/im/viewissue?selection=97470
Revision 1.15 2012/02/09 13:11:01CET Spruck, Jochen (spruckj)
Add new mks si / im script to if all tasks with working packages are assigned to releases
--- Added comments ---  spruckj [Feb 9, 2012 1:11:02 PM CET]
Change Package : 46866:11 http://mks-psad:7002/im/viewissue?selection=46866
Revision 1.14 2012/01/17 13:15:53CET Hotjakov-EXT, Ilja (uidt9433)
Added:     ynInputCheck(input, numberOfTry)
Modified:    AddPreIntCheckpoint(self, argu)
        -y/n input will be checked now
--- Added comments ---  uidt9433 [Jan 17, 2012 1:15:54 PM CET]
Change Package : 90849:1 http://mks-psad:7002/im/viewissue?selection=90849
Revision 1.13 2011/12/08 14:21:50CET Hotjakov-EXT, Ilja (uidt9433)
RenameCheckpoint() updated "" can be handled now
--- Added comments ---  uidt9433 [Dec 8, 2011 2:21:59 PM CET]
Change Package : 89601:1 http://mks-psad:7002/im/viewissue?selection=89601
Revision 1.12 2011/10/28 15:12:51CEST Spruck, Jochen (spruckj)
add exclude file option to exclude pathes from the configuration
--- Added comments ---  spruckj [Oct 28, 2011 3:12:51 PM CEST]
Change Package : 46866:11 http://mks-psad:7002/im/viewissue?selection=46866
Revision 1.11 2011/10/13 08:15:37CEST Spruck Jochen (spruckj) (spruckj)
- Add functionality to Split config files
- Add CustomConfigV3 config file section to assign to a target path an shared project configuration
--- Added comments ---  spruckj [Oct 13, 2011 8:15:43 AM CEST]
Change Package : 46866:17 http://mks-psad:7002/im/viewissue?selection=46866
Revision 1.10 2011/09/02 13:19:53CEST Hotjakov Ilja (uidt9433) (uidt9433)
self.Log "Info" marker added
--- Added comments ---  uidt9433 [Sep 2, 2011 1:19:56 PM CEST]
Change Package : 76882:1 http://mks-psad:7002/im/viewissue?selection=76882
Revision 1.9 2011/08/11 09:31:06CEST Hotjakov Ilja (uidt9433) (uidt9433)
fehelr behoben in SMR200 Zweige optimiert
--- Added comments ---  uidt9433 [Aug 11, 2011 9:31:07 AM CEST]
Change Package : 74797:1 http://mks-psad:7002/im/viewissue?selection=74797
Revision 1.8 2011/05/11 09:05:27CEST Spruck Jochen (spruckj) (spruckj)
Update/add some integrity mks funktions
--- Added comments ---  spruckj [May 11, 2011 9:05:28 AM CEST]
Change Package : 46866:6 http://mks-psad:7002/im/viewissue?selection=46866
Revision 1.7 2011/04/28 12:28:16CEST Spruck Jochen (spruckj) (spruckj)
Add check if label already exist for the CheckIfAllBuild and checkpoint scrip
--- Added comments ---  spruckj [Apr 28, 2011 12:28:16 PM CEST]
Change Package : 65146:1 http://mks-psad:7002/im/viewissue?selection=65146
Revision 1.6 2011/04/26 13:57:45CEST Spruck Jochen (spruckj) (spruckj)
Introduce skt as sub componenent project.
Runtime improvement
--- Added comments ---  spruckj [Apr 26, 2011 1:57:45 PM CEST]
Change Package : 65146:1 http://mks-psad:7002/im/viewissue?selection=65146
Revision 1.5 2011/04/13 17:03:59CEST Spruck Jochen (spruckj) (spruckj)
Add option for check for build and checkpoint to give script the checkpoint label
--- Added comments ---  spruckj [Apr 13, 2011 5:03:59 PM CEST]
Change Package : 46866:6 http://mks-psad:7002/im/viewissue?selection=46866
Revision 1.3 2011/01/18 13:02:08CET Jochen Spruck (spruckj)
MKS project in now configurable for the checkforbuild before checkpoint
--- Added comments ---  spruckj [Jan 18, 2011 1:02:08 PM CET]
Change Package : 46866:1 http://mks-psad:7002/im/viewissue?selection=46866
Revision 1.6 2010/03/30 13:48:39CEST Jochen Spruck (jspruck)
bug fix of check for build shared subproject look at type not at project type return value
--- Added comments ---  jspruck [2010/03/30 11:48:39Z]
Change Package : 31184:2 http://LISS014:6001/im/viewissue?selection=31184
Revision 1.5 2010/03/30 12:10:07CEST Jochen Spruck (jspruck)
Use communicate for subprocces to get the stdout and stderr information
--- Added comments ---  jspruck [2010/03/30 10:10:07Z]
Change Package : 31184:2 http://LISS014:6001/im/viewissue?selection=31184
Revision 1.4 2010/03/29 18:14:32CEST Jochen Spruck (jspruck)
Append script
- no it is possible to check projects if all shared sub projects are configured to build
- checkpoint the project after the test was successful
--- Added comments ---  jspruck [2010/03/29 16:14:32Z]
Change Package : 40051:1 http://LISS014:6001/im/viewissue?selection=40051
Revision 1.3 2010/03/23 13:15:58CET Jochen Spruck (jspruck)
Update mks_config
-> prompt for config type
-> bug fix alternative config if not set or not found
--- Added comments ---  jspruck [2010/03/23 12:15:59Z]
Change Package : 33263:4 http://LISS014:6001/im/viewissue?selection=33263
Revision 1.2 2010/03/23 10:54:16CET Jochen Spruck (jspruck)
Add prompt for change package
--- Added comments ---  jspruck [2010/03/23 09:54:16Z]
Change Package : 31184:2 http://LISS014:6001/im/viewissue?selection=31184
Revision 1.1 2010/03/22 10:09:21CET dkubera
Initial revision
