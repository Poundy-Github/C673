/*! \file **********************************************************************
   ...
   File: vdy_matrix_inversion_1x1.h
...
#ifndef RTW_HEADER_vdy_matrix_inversion_1x1_h_
#define RTW_HEADER_vdy_matrix_inversion_1x1_h_
...
/* Block signals for system '<S12>/Matrix_Inversion_1x1' */
typedef struct {
  real32_T HPHt_R_inv;                 /* '<S12>/Matrix_Inversion_1x1' */
  boolean_T det_flag;                  /* '<S12>/Matrix_Inversion_1x1' */
} rtB_vdy_matrix_inversion_1x1;

extern void vdy_matrix_inversion_1x1(real32_T rtu_HPHt_R,
  rtB_vdy_matrix_inversion_1x1 *localB);

#endif                                 /* RTW_HEADER_vdy_matrix_inversion_1x1_h_ */
