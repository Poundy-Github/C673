"""
Filename                  : scons_common_scripts\sim\sim_lib\SConscript.py
Description               : SConscript to build sim adapter Static library (LIB). 
"""
#***************************************************************************************************
...
#
# MODULE NAME: sim\sim_lib\SConscript.py
#
# DESCRIPTION: SConscript to build sim adapter Static library (LIB). 
#
...
#
# LAST CHANGE:      $Date: 2021/12/13 19:06:49CET $
#                   $Author: Wang, David (Wangd3) $
#
# CURRENT VERSION:  $Revision: 1.1 $
#############################################################################
# CHANGES:                   $Log: SConscript.py  $
# CHANGES:                   Revision 1.1 2021/12/13 19:06:49CET Wang, David (Wangd3) 
# CHANGES:                   Initial revision
# CHANGES:                   Member added to project /ADAS/Projects/MFC5xx/MFC5J3/06_Algorithm/DPU/04_Engineering/02_Development_Tools/scons_tools/scons_common_scripts/sim/sim_lib/project.pj
# CHANGES:                   Revision 1.7 2017/05/30 14:01:06CEST Bhagawati, Tridip (uidr2134) 
# CHANGES:                   GSCons update for Mainstream
# CHANGES:                   Revision 1.6 2017/04/27 16:06:25CEST Bhagawati, Tridip (uidr2134) 
# CHANGES:                   Support Mainstream adaptation
# CHANGES:                   Revision 1.5 2016/07/01 06:44:55CEST Annashamachar, Shwetha (uidj8746) 
# CHANGES:                   File header added
# CHANGES:                   Revision 1.4 2015/06/26 08:34:47CEST Palanisamy-EXT, Lenin (uidr0826) 
...
# SConscript to build sim adapter LIB
# remark: this is a non-generic script!
...
# build LIB
#-------------------------
lib = local_env.StaticLibrary(target, src)
