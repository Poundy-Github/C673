/* $Header: DMC_Long.h 1.8 2020/02/27 20:25:44CET Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Long.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Long_h_
#define RTW_HEADER_DMC_Long_h_
#include <math.h>
#ifndef DMC_Long_COMMON_INCLUDES_
# define DMC_Long_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Long_COMMON_INCLUDES_ */

#include "DMC_Long_types.h"
...
extern void DMC_Long(const real32_T *rt_erh2I, const int16_T *rt_gd42I, const
                     int16_T *rt_cpaoI, const int16_T rt_e4hoI[4], real32_T
                     *rt_erh2sI, real32_T *rt_gd42sI);

/* Model reference registration function */
extern void DMC_Long_initialize(void);
...
/*-
 * Requirements for '<Root>': DMC_Long
 */
#endif                                 /* RTW_HEADER_DMC_Long_h_ */
