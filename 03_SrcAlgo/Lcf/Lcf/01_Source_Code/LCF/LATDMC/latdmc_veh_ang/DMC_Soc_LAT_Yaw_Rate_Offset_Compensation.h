/* $Header: DMC_Soc_LAT_Yaw_Rate_Offset_Compensation.h 1.18 2020/08/20 10:43:52CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Soc_LAT_Yaw_Rate_Offset_Compensation.h
   C source code generated on           : Mon Aug 17 20:48:24 2020
   Filename of Simulink Model           : DMC_Soc_LAT_Yaw_Rate_Offset_Compensation.mdl/.slx
   Revision of Simulink Model           : 1.13
 ***************************************************************************************************
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_h_
#define RTW_HEADER_DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_h_
#include <math.h>
#ifndef DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_COMMON_INCLUDES_
# define DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_COMMON_INCLUDES_ */

#include "DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_types.h"
...
extern void DMC_Soc_LAT_Yaw_Rate_Offset_Compensation(const real32_T *rt_erh2I,
  const real32_T *rt_gd42I, const int16_T *rt_cpaoI, real32_T *rt_erh2sI);

/* Model reference registration function */
extern void DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_initialize(void);
 ...
 *
 * '<Root>' : 'DMC_Soc_LAT_Yaw_Rate_Offset_Compensation'
 * '<S1>'   : 'DMC_Soc_LAT_Yaw_Rate_Offset_Compensation/VEH_Yaw_Rate_Offset_Sel'
 * '<S2>'   : 'DMC_Soc_LAT_Yaw_Rate_Offset_Compensation/VEH_Yaw_Rate_Offset_State_Sel'
 * '<S3>'   : 'DMC_Soc_LAT_Yaw_Rate_Offset_Compensation/VEH_Yaw_Rate_Offset_Sel/Compare To Constant'
 */

/*-
 * Requirements for '<Root>': DMC_Soc_LAT_Yaw_Rate_Offset_Compensation
 */
#endif                                 /* RTW_HEADER_DMC_Soc_LAT_Yaw_Rate_Offset_Compensation_h_ */
