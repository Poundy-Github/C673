/* $Header: DMC_Lat_SAC_Angle_Command_Fading.h 1.37 2020/08/20 10:43:07CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_SAC_Angle_Command_Fading.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_DMC_Lat_SAC_Angle_Command_Fading_h_
#define RTW_HEADER_DMC_Lat_SAC_Angle_Command_Fading_h_
#include <math.h>
#ifndef DMC_Lat_SAC_Angle_Command_Fading_COMMON_INCLUDES_
# define DMC_Lat_SAC_Angle_Command_Fading_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* DMC_Lat_SAC_Angle_Command_Fading_COMMON_INCLUDES_ */

#include "DMC_Lat_SAC_Angle_Command_Fading_types.h"
...
/* Block states (auto storage) for model 'DMC_Lat_SAC_Angle_Command_Fading' */
#ifndef DMC_Lat_SAC_Angle_Command_Fading_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T UnitDelay1_DSTATE;          /* '<S47>/Unit Delay1' */
  real32_T Delay1_DSTATE;              /* '<S39>/Delay1' */
  real32_T Delay_DSTATE;               /* '<S40>/Delay' */
  real32_T Delay_DSTATE_mlby;          /* '<S37>/Delay' */
  real32_T UnitDelay1_DSTATE_okxo;     /* '<S48>/Unit Delay1' */
  real32_T Delay_DSTATE_gxyd;          /* '<S36>/Delay' */
  real32_T UnitDelay2_DSTATE;          /* '<S24>/Unit Delay2' */
  real32_T UnitDelay2_DSTATE_jn4g;     /* '<S14>/Unit Delay2' */
  real32_T UnitDelay3_DSTATE;          /* '<S14>/Unit Delay3' */
  real32_T UnitDelay_DSTATE;           /* '<S5>/Unit Delay' */
  real32_T UnitDelay1_DSTATE_huhv;     /* '<S14>/Unit Delay1' */
  real32_T UnitDelay5_DSTATE;          /* '<S9>/Unit Delay5' */
  real32_T UnitDelay2_DSTATE_pr3g;     /* '<S9>/Unit Delay2' */
  real32_T UnitDelay5_DSTATE_k0cr;     /* '<S15>/Unit Delay5' */
  real32_T UnitDelay1_DSTATE_kujk;     /* '<S33>/Unit Delay1' */
  real32_T UnitDelay2_DSTATE_npeh;     /* '<S20>/Unit Delay2' */
  real32_T UnitDelay3_DSTATE_dklm;     /* '<S20>/Unit Delay3' */
  real32_T UnitDelay4_DSTATE;          /* '<S20>/Unit Delay4' */
  real32_T UnitDelay2_DSTATE_e30m;     /* '<S16>/Unit Delay2' */
  real32_T UnitDelay1_DSTATE_cjrr;     /* '<S16>/Unit Delay1' */
  real32_T Delay_DSTATE_b5gf;          /* '<S34>/Delay' */
  boolean_T Delay2_DSTATE;             /* '<S42>/Delay2' */
  boolean_T UnitDelay1_DSTATE_bsyw;    /* '<S5>/Unit Delay1' */
  boolean_T UnitDelay1_DSTATE_m1ek;    /* '<S9>/Unit Delay1' */
  boolean_T UnitDelay4_DSTATE_hg2d;    /* '<S9>/Unit Delay4' */
  boolean_T UnitDelay_DSTATE_l3th;     /* '<S46>/Unit Delay' */
} rtDW_DMC_Lat_SAC_Angle_Command_Fading_T;

#endif                                 /*DMC_Lat_SAC_Angle_Command_Fading_MDLREF_HIDE_CHILD_*/

extern void DMC_Lat_SAC_Angle_Command_Fading_Init(void);
extern void DMC_Lat_SAC_Angle_Command_Fading(const real32_T *rt_erh2I, const
  boolean_T *rt_gd42I, const real32_T *rt_cpaoI, const real32_T *rt_e4hoI, const
  real32_T *rt_ngfdI, const boolean_T *rt_hny3I, const boolean_T *rt_kwugI,
  const real32_T *rt_kafvI, const boolean_T *rt_kaadI, const real32_T *rt_eltpI,
  const real32_T *rt_cjpeI, const real32_T *rt_ezusI, const boolean_T *rt_orb0I,
  const int16_T *rt_pdp2I, const real32_T *rt_dxdkI, const real32_T *rt_dmmuI,
  const uint8_T *rt_gyqsI, const uint16_T *rt_m2jwI, const real32_T *rt_pdncI,
  const boolean_T *rt_id5lI, const boolean_T *rt_prezI, const real32_T *rt_pehlI,
...
extern void DMC_Lat_SAC_Angle_Command_Fading_initialize(void);

#ifndef DMC_Lat_SAC_Angle_Command_Fading_MDLREF_HIDE_CHILD_

/* Block states (auto storage) */
extern rtDW_DMC_Lat_SAC_Angle_Command_Fading_T
  DMC_Lat_SAC_Angle_Command_Fading_DWork;
 ...
 * Block '<S13>/Const' : Unused code path elimination
 ...
 * Block '<S25>/Display9' : Unused code path elimination
 ...
 * Block '<S14>/Lat_startup_timer' : Unused code path elimination
 * Block '<S14>/SAC_Angle_Rate_Limiter_Res' : Unused code path elimination
 ...
 * Block '<S43>/tst2' : Unused code path elimination
 * Block '<S35>/tst1' : Unused code path elimination
 ...
 * Block '<S46>/Signal Conversion' : Eliminate redundant signal conversion block
 */
 ...
 *
 * '<Root>' : 'DMC_Lat_SAC_Angle_Command_Fading'
 * '<S1>'   : 'DMC_Lat_SAC_Angle_Command_Fading/Compare To Constant'
 * '<S2>'   : 'DMC_Lat_SAC_Angle_Command_Fading/DocBlock'
 * '<S3>'   : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter'
 * '<S4>'   : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading'
 * '<S5>'   : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter'
 * '<S6>'   : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Rate_Control'
 * '<S7>'   : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/Compare To Zero'
 * '<S8>'   : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/Compare To Zero1'
 * '<S9>'   : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Angle_Fading_Request1'
 * '<S10>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Delta_F_Cmd_Parity_Def'
 * '<S11>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Delta_F_Filter'
 * '<S12>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Delta_F_Grad_Arbitration'
 * '<S13>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection'
 * '<S14>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Initial_Activation_Condition'
 * '<S15>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Low_Gradient_Req_Definition'
 * '<S16>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Ramp_Enable'
 * '<S17>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAT_Angle_Fading_Max_Cmd'
 * '<S18>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAT_Angle_Saturation'
 * '<S19>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Delta_F_Filter/LAT_Cut_Delta_Sample1'
 * '<S20>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Delta_F_Filter/LAT_Delta_F_Sample'
 * '<S21>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Delta_F_Filter/LAT_Saturate_Delta_Sample1'
 * '<S22>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/Compare To Constant'
 * '<S23>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Gradient_Od_Depending'
 * '<S24>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Jerk_Gradient'
 * '<S25>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Straight_Gradient'
 * '<S26>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Gradient_Od_Depending/Compare To Zero1'
 * '<S27>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Gradient_Od_Depending/Compare To Zero2'
 * '<S28>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Gradient_Od_Depending/SAC_Gradient_Od_Depending1'
 * '<S29>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Gradient_Od_Depending/SAC_Gradient_Od_Depending1/Compare To Zero1'
 * '<S30>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Gradient_Od_Depending/SAC_Gradient_Od_Depending1/Compare To Zero2'
 * '<S31>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Gradient_Selection/SAC_Jerk_Gradient/SAC_Jerk_Gradient1'
 * '<S32>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Low_Gradient_Req_Definition/Compare To Constant'
 * '<S33>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Angle_Rate_Limiter/SAC_Angle_Command_Rate_Limiter/SAC_Low_Gradient_Req_Definition/SAC_Low_Grad_Dys_Monoflop'
 * '<S34>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Exp'
 * '<S35>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin'
 * '<S36>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_LinExp'
 * '<S37>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Progr'
 * '<S38>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Zero'
 * '<S39>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fad_Spike_Detection'
 * '<S40>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fading'
 * '<S41>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fading_Offset_Calc'
 * '<S42>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fading_Trigger'
 * '<S43>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fading_Trigger_Logic'
 * '<S44>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fading_Offset_Calc/SAC_Lin_Fading_Offset_Reduction'
 * '<S45>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fading_Trigger/S-R_Flip_Flop'
 * '<S46>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fading_Trigger/S-R_Flip_Flop/Atomic Subsystem'
 * '<S47>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Lin/SAC_Lin_Fading_Trigger_Logic/DMC_Integrator1'
 * '<S48>'  : 'DMC_Lat_SAC_Angle_Command_Fading/SAC_Offset_Fading/Ref_Steer_Angle_Offset_Progr/DMC_Integrator1'
 */

/*-
 * Requirements for '<Root>': DMC_Lat_SAC_Angle_Command_Fading
 */
#endif                                 /* RTW_HEADER_DMC_Lat_SAC_Angle_Command_Fading_h_ */
