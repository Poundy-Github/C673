...
#if (LINIF_SLAVE_SUPPORTED == STD_ON)
#if (LINIF_MASTER_SUPPORTED == STD_ON)
        if(LINIF_CH_IS_SLAVE == (LINIF_CFG_GET_CHANNEL[currentChannel].CfgFlags & LINIF_NODETYPE_MASK))
#endif /* LINIF_MASTER_SUPPORTED == STD_ON */
        {
...
#else
#if(LINIF_MASTER_SUPPORTED == STD_ON)
          const uint8 NAD = (LINIF_CH_IS_MASTER == (LINIF_CFG_GET_CHANNEL[currentChannel].CfgFlags & LINIF_NODETYPE_MASK)) ? pTpTxConfig->LinTpTxNSduNad : LinTp_GetConfNad(currentChannel);
#else
...
#if (LINIF_SLAVE_SUPPORTED == STD_ON)
                if(LINIF_CH_IS_MASTER == (LINIF_CFG_GET_CHANNEL[currentChannel].CfgFlags & LINIF_NODETYPE_MASK))
#endif /* LINIF_SLAVE_SUPPORTED == STD_ON */
                {
                  LinTp_StopTimerCS(pPhysData);
                  LinTp_StartTimerAS(pTpTxConfig, pPhysData);
...
#else
        const uint8 expectedNAD = (LINIF_CH_IS_MASTER == (LINIF_CFG_GET_CHANNEL[currentChannel].CfgFlags & LINIF_NODETYPE_MASK)) ? pPhysData->NAD : LinTp_GetConfNad(currentChannel);
...
#else
        const LinTp_Response_Type responseType = (LINIF_CH_IS_MASTER == (LINIF_CFG_GET_CHANNEL[currentChannel].CfgFlags & LINIF_NODETYPE_MASK)) ?
...
#else
              const uint8 lastNAD = (LINIF_CH_IS_MASTER == (LINIF_CFG_GET_CHANNEL[currentChannel].CfgFlags & LINIF_NODETYPE_MASK)) ? pPhysData->NAD : LinTp_GetConfNad(currentChannel);
#endif /* LINIF_SLAVE_SUPPORTED == STD_OFF */
...
#if (LINIF_SLAVE_SUPPORTED == STD_ON)
#if (LINIF_MASTER_SUPPORTED == STD_ON)
    const uint8 lookupNad = (LINIF_CH_IS_MASTER == (LINIF_CFG_GET_CHANNEL[currentChannel].CfgFlags & LINIF_NODETYPE_MASK)) ? NAD : 0U;
#else
    TS_PARAM_UNUSED(NAD);
#endif /* LINIF_MASTER_SUPPORTED == STD_ON */
#endif /* LINIF_SLAVE_SUPPORTED == STD_ON */
