/* TRICORE-trap1handler.c
 *
 * This file contains the OS_Trap1Handler function.
 *
 ...
 *
 * $Id: TRICORE-trap1handler.c 34824 2021-08-05 13:57:39Z ache271795 $
*/
 ...
 * OS_Trap1Handler()
 *
 * This function handles TRICORE class 1 traps.
 *
 * Class 1 traps are caused when to code attempts to do something
 * that is is not permitted to do by the current protection settings.
 *
...
const os_uint8_t OS_dummy_TRICORE_trap1handler_c = 0xeb;
