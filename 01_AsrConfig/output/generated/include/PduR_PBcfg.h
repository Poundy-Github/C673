...
typedef struct /* PduR_ConfigLayoutType */ {
    ...
    VAR( PduR_RTabLoIfType, TYPEDEF ) PduR_RTabLoIfRx[47];
    VAR( PduR_RTabLoIfType, TYPEDEF ) PduR_RTabLoIfTx[47];
    VAR( PduR_RTabUpIfTxType, TYPEDEF ) PduR_RTabUpIfTx[47];
    VAR( PduR_RTabLoTpType, TYPEDEF ) PduR_RTabLoTpRx[4];
    VAR( PduR_RTabLoTpType, TYPEDEF ) PduR_RTabLoTpTx[2];
    VAR( PduR_RTabUpTpType, TYPEDEF ) PduR_RTabUpTpTx[2];
    VAR( PduR_RTabUpTpType, TYPEDEF ) PduR_RTabUpTpRx[4];
