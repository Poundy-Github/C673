...
[!ENDMACRO!][!//
[!/*****************************************************************************
[!/*[cover parentID={0C0040C0-D67D-4e5c-A7C5-5878D06ED69F}][/cover]*/!][!//
[!MACRO "Port_Port14LVDSPinPair9_10Available"!][!//
[!SELECT "as:modconf('Port')[1]"!][!//
[!LOOP "node:order(PortConfigSet/PortContainer/*,'node:value(./PortNumber)')"!][!//
[!IF "(./PortNumber = num:i(14))"!]
[!VAR "Holder" = "@name"!]
[!LOOP "as:modconf('Port')[1]/PortConfigSet/PortContainer/*[@name = $Holder]/PortLVDS/*[PortLVDSPinPair] "!][!//[!//
    [!IF "./PortLVDSRxPathEnable = 'true' "!]
       [!VAR "Port14LvdsRxEnable" = "num:i(1)"!]
       [!BREAK!]
    [!ENDIF!]
 [!ENDLOOP!]
[!ENDIF!]
