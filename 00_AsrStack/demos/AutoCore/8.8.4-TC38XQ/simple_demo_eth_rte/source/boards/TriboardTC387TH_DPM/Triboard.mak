...
CC_FILES_TO_BUILD    += $(OS_BOARD_DIR)\board_initcdata.c
CC_FILES_TO_BUILD    += $(OS_BOARD_DIR)\board_initpll.c
CC_FILES_TO_BUILD    += $(OS_BOARD_DIR)\board_tool_diab.c
...
OS_GENLD_OPT += -include $(OS_BOARD_DIR)\$(DERIVATE)-tasking.ldscript
...
$(LOC_FILE): $(OS_GENLD) $(wildcard $(AutosarOS_CORE_PATH)/bin/Genld*.pm)
	$(PERL_EXE) $(OS_GENLD) -o $@ $(OS_GENLD_OPT) $(OS_APP_SPECS) -numcores $(OS_N_CORES_MAX) -corecsas $(OS_TRICORE_NCSA_LIST)
