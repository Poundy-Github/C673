 ...
 *
 * $Id: Os_configuration_decls_cx.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
...
#if (THIS_CORE_INDEX == OS_SHAREDHWCOUNTERTIMESTAMP_COREID)
#define OS_NSHAREDHWCOUNTERTIMESTAMP_COREX 1
#else
#define OS_NSHAREDHWCOUNTERTIMESTAMP_COREX 0
#endif

#define OS_TOTALALARMS_COREX (OS_NALARMS_COREX + OS_NSCHEDULES_COREX + OS_NSHAREDHWCOUNTERTIMESTAMP_COREX)
