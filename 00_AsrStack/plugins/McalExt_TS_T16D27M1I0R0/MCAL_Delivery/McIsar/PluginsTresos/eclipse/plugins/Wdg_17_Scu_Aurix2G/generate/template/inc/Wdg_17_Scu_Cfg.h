...
*******************************************************************************/
[!VAR "ArMajorVersion" = "text:split($moduleReleaseVer, '.')[position()-1 = 0]"!][!//
[!VAR "ArMinorVersion" = "text:split($moduleReleaseVer, '.')[position()-1 = 1]"!][!//
[!VAR "ArRevisionVersion" = "text:split($moduleReleaseVer, '.')[position()-1 = 2]"!][!//

/* AUTOSAR specification version numbers */

#define WDG_17_SCU_AR_RELEASE_MAJOR_VERSION     ([!"$ArMajorVersion"!]U)
#define WDG_17_SCU_AR_RELEASE_MINOR_VERSION     ([!"$ArMinorVersion"!]U)
#define WDG_17_SCU_AR_RELEASE_REVISION_VERSION  ([!"$ArRevisionVersion"!]U)
