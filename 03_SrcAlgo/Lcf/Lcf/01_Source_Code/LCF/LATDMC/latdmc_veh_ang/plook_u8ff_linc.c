/* $Header: plook_u8ff_linc.c 1.1 2018/04/19 09:35:39CEST Grosu, George (uidl9584) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : plook_u8ff_linc.c
   C source code generated on           : Fri Mar 16 16:54:45 2018
   Filename of Simulink Model           : DMC_Soc_Lat.mdl/.slx
   Revision of Simulink Model           : 1.3226
 ***************************************************************************************************
...
/* --- Includes --- */
#include "rtwtypes.h"
#include "linsearch_u8f.h"
#include "plook_u8ff_linc.h"

uint8_T plook_u8ff_linc(real32_T tmp_, const real32_T tmp_0[], uint32_T tmp_1,
  real32_T *tmp_2)
{
  uint8_T tmp_3;
  ...
  if (tmp_ <= tmp_0[(uint8_T)0U]) {
    tmp_3 = 0U;
    *tmp_2 = 0.0F;
  } else if (tmp_ < tmp_0[tmp_1]) {
    tmp_3 = linsearch_u8f(tmp_, tmp_0, tmp_1 >> ((uint8_T)1U));
    *tmp_2 = (tmp_ - tmp_0[(uint32_T)tmp_3]) / (tmp_0[tmp_3 + ((uint8_T)1U)] -
      tmp_0[(uint32_T)tmp_3]);
  } else {
    tmp_3 = (uint8_T)(tmp_1 - ((uint32_T)1U));
    *tmp_2 = 1.0F;
  }
