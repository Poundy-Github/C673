...
COPYRIGHT (C) $Date: 2019/07/03 13:44:16CEST $
...
$Log: bitop.c  $
Revision 1.1 2019/07/03 13:44:16CEST Nastasa, Elena (uidt4846)
Initial revision
...
Revision 1.1 2018/07/24 16:48:48CEST Ammermueller Martin (uidv5342) (uidv5342)
Initial revision
...
//#define BITOP_H
#include "Std_Types.h"
#include "Bitop.h" // 2021.11.12
#include "iopt_memmap.h" //20211119
/*~A*/
/*~+:LINT Supressions*/
/*lint --e{9033} */
/*lint --e{9034} */
...
#define READ_BIT_OF_LF_UX(LF,POSITION,UX)                GET_BIT_OF_LF_UX(LF,POSITION,UX) /**< Get specific LF Bit position
...
@param position  : 0..7 (for u8 lf), 0..15 (for u16 lf), 0..31 (for u32 lf), 0..63 (for u64 lf)
@param ux  : u8, u16, u32, u64 */
#define WRITE_BIT_OF_LF_UX(L,P,T)                        SET_BIT_OF_LF_UX(L,P,T)  /**< This macro shall set the specific LF Bit position */
...
uint8 u8_cntlz_u8(uint8 val);
uint8 u8_cntlz_u16(uint16 val);
uint8 u8_cntlz_u32(uint32 val);
 uint8 u8_msbpos_u8(uint8 val);
 uint8 u8_msbpos_u16(uint16 val);
 uint8 u8_msbpos_u32(uint32 val);
 boolean flag_get_u8_u8(uint8 val, uint8 cnt);
 boolean flag_get_u16_u8(uint16 val, uint8 cnt);
 boolean flag_get_u32_u8(uint32 val, uint8 cnt);
 boolean flag_get_u64_u8(uint64 val, uint8 cnt);
 uint8 u8_get_u16_u8(uint16 val, uint8 cnt);
 uint8 u8_get_u32_u8(uint32 val, uint8 cnt);
 uint8 u8_get_u64_u8(uint64 val, uint8 cnt);
 uint16 u16_get_u32_u8(uint32 val, uint8 cnt);
 uint16 u16_get_u64_u8(uint64 val, uint8 cnt);
 uint32 u32_get_u64_u8(uint64 val, uint8 cnt);
 uint16 u16_make_u8_u8(uint8 high, uint8 low);
 uint32 u32_make_u16_u16(uint16 high, uint16 low);
 uint64 u64_make_u32_u32(uint32 high, uint32 low);
 uint8 u8_lsl_u8_u8(uint8 val, uint8 cnt);
 uint16 u16_lsl_u16_u8(uint16 val, uint8 cnt);
 uint32 u32_lsl_u32_u8(uint32 val, uint8 cnt);
 uint64 u64_lsl_u64_u8(uint64 val, uint8 cnt);
 uint8 u8_lsr_u8_u8(uint8 val, uint8 cnt);
 uint16 u16_lsr_u16_u8(uint16 val, uint8 cnt);
 uint32 u32_lsr_u32_u8(uint32 val, uint8 cnt);
 uint64 u64_lsr_u64_u8(uint64 val, uint8 cnt);
 uint8 u8_inv_u8(uint8 val);
 uint16 u16_inv_u16(uint16 val);
 uint32 u32_inv_u32(uint32 val);
 uint64 u64_inv_u64(uint64 val);
 uint8 u8_bit_u8(uint8 cnt);
 uint16 u16_bit_u8(uint8 cnt);
 uint32 u32_bit_u8(uint8 cnt);
 uint64 u64_bit_u8(uint8 cnt);
 uint8 u8_set_flag_u8(uint8 val, uint8 cnt);
 uint16 u16_set_flag_u8(uint16 val, uint8 cnt);
 uint32 u32_set_flag_u8(uint32 val, uint8 cnt);
 uint64 u64_set_flag_u8(uint64 val, uint8 cnt);
 uint8 u8_clear_flag_u8(uint8 val, uint8 cnt);
 uint16 u16_clear_flag_u8(uint16 val, uint8 cnt);
 uint32 u32_clear_flag_u8(uint32 val, uint8 cnt);
 uint64 u64_clear_flag_u8(uint64 val, uint8 cnt);
 boolean flag_sr_ff_flag_flag_flag(boolean lv_in, boolean lv_set, boolean lv_rst);
 boolean flag_rs_ff_flag_flag_flag(boolean lv_in, boolean lv_rst, boolean lv_set);
 boolean flag_edge01_det_flag_flag(boolean lv_0_old, boolean lv_1_act);
 boolean flag_edge10_det_flag_flag(boolean lv_1_old, boolean lv_0_act);
 boolean flag_xor_flag_flag(boolean lv_a, boolean lv_b);
 uint8 u8_move_flag_u8_flag(uint8 val, uint8 cnt, boolean bitval);
 uint16 u16_move_flag_u8_flag(uint16 val, uint8 cnt, boolean bitval);
 uint32 u32_move_flag_u8_flag(uint32 val, uint8 cnt, boolean bitval);
 uint64 u64_move_flag_u8_flag(uint64 val, uint8 cnt, boolean bitval);
