...
[!//
[!//
[!IF "((node:exists(FeeGeneral/FeeUseBlankCheck)) and (FeeGeneral/FeeUseBlankCheck = 'true') and (FeeGeneral/FeeConsistencyPattern = 'true'))"!][!//
  [!VAR "EndPatternSize" = "$VirPageSize"!][!//
  [!VAR "FeeFlsReadApi" = "FeeGeneral/FeeFlsReadApiType"!][!//
[!ELSE!][!//
  [!VAR "EndPatternSize" = "num:integer(0)"!][!//
  [!VAR "FeeFlsReadApi" = "'Fls_Read'"!][!//
[!ENDIF!][!//
[!//
[!//
