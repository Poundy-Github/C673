...
#define S_CUSTOM_PrjSpecQu_btf    	    S_JCNCTR_PrjSpecQu_btf // add MFC5J3CN15 speical condtion bitfile
...
#define S_LCFRCV_BrakePedalPostion_mm ((pLcfSenReqPorts->pLcfInputData->BrakePedalPostion_mm))
