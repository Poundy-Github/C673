 ...
 *
 * $Id: Os_userkernel.h 31037 2019-11-12 13:20:38Z sash270423 $
*/
...
extern os_result_t OS_KernActivateTaskAsyn(os_taskid_t);
...
extern os_result_t OS_KernSetEventAsyn(os_taskid_t, os_eventmask_t);
...
extern os_applicationid_t OS_KernGetCurrentApplicationId(void);
...
extern os_result_t OS_KernEnableInterruptSource(os_isrid_t, os_boolean_t);
extern os_result_t OS_KernClearPendingInterrupt(os_isrid_t);
extern os_result_t OS_KernControlIdle(os_coreid_t, os_idlemode_t);
