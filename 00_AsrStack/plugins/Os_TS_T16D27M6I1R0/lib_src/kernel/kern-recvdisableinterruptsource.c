 ...
 *
 * $Id: kern-recvdisableinterruptsource.c 35018 2021-08-23 09:29:21Z saga272975 $
*/
...
OS_TOOL_FUNCTION_ATTRIB_POST
{
	...
	if (OS_IsValidIsrId(isrId) && (msg->result != OS_NULL))
	{
		...
		replyParams[0] = (os_paramtype_t)OS_LocalDisableInterruptSource(&OS_isrTableBase[isrId]);
...
const os_uint8_t OS_dummy_kern_recvdisableinterruptsource_c = 0xeb;
