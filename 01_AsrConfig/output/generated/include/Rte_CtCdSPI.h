#ifndef RTE_CTCDSPI_H
#define RTE_CTCDSPI_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
/*
 * This file contains Rte component declarations for component type CtCdSPI
 *
...
/* ==================[Types]================================================== */
#ifndef RTE_CORE /* if included by software component */
typedef CONSTP2CONST(Rte_CDS_CtCdSPI, TYPEDEF, RTE_CONST) Rte_Instance;
#endif

/* ==================[Definition of variables with external linkage]========== */
#define RTE_START_SEC_OSAPPLICATION_C0_CONST_8
#include <Rte_MemMap.h>
extern CONST(Rte_CDS_CtCdSPI, RTE_CONST) Rte_Instance_CtCdSPI;
#define RTE_STOP_SEC_OSAPPLICATION_C0_CONST_8
#include <Rte_MemMap.h>
#define RTE_START_SEC_OSAPPLICATION_C0_CONST_UNSPECIFIED
#include <Rte_MemMap.h>
extern CONSTP2CONST(Rte_CDS_CtCdSPI, RTE_CONST, RTE_CONST) Rte_Inst_CtCdSPI;
...
extern FUNC(void, RTE_CODE) CtCdSPI_5ms (void);

extern FUNC(void, RTE_CODE) CtCdSPI_Init (void);
