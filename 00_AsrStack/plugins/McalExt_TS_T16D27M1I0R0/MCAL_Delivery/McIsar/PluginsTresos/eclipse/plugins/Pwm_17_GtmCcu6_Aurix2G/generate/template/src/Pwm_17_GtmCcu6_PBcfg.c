...
Generated File containing objects to data structures [/cover] */!]
                ...
                [!NOCODE!]
                  ...
                  [!SELECT "GtmTimerOutputModuleConfiguration/*[1]"!][!//
                    ...
                    [!IF "$TimerType  = 'Atom'"!]
                      ...
                      /* Set ATOM mode as Signal Output Mode PWM (SOMP) */
                  ...
                  [!ELSE!]
                    ...
                    [!ELSE!]
                      ...
                      [!IF "$ScaledDuty < $PeriodValue"!][!//
                        [!/* [cover parentID={2A2DF2BC-CBA8-4461-ABAC-F28CE9FCA8C6}]
                        Shift value calculation of Center aligned channel [/cover] */!]
                  ...
                  [!ELSE!]
                    ...
                    [!IF "$ShiftReset = num:i(1)"!][!//
                      ...
                      [!ELSE!]
                        [!/* [cover parentID={B68BB946-476D-4549-9023-0AE3B68F16C3}]
                        Compare and Shadow register update for Center aligned and shifted
                        channel when handle shift by offset is OFF [/cover] */!]
                    ...
                    [!ELSE!]
                      ...
                      [!/* [cover parentID={B68BB946-476D-4549-9023-0AE3B68F16C3}]
                      Compare and Shadow register update for shifted channel
                      when handle shift by offset is ON [/cover] */!]
                  ...
                  [!ENDIF!]
                  /* Set FREEZE bit to avoid SL changes on signal output */
                  [!VAR "CtrlReg" = "bit:bitset($CtrlReg,31)"!][!//
