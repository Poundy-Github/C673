/*! \file **********************************************************************
   ...
   File: vdy_matrix_inversion_3x3.h
...
#ifndef RTW_HEADER_vdy_matrix_inversion_3x3_h_
#define RTW_HEADER_vdy_matrix_inversion_3x3_h_
...
/* Block signals for system '<S14>/Matrix_Inversion_3x3' */
typedef struct {
  real32_T HPHt_R_inv[9];              /* '<S14>/Matrix_Inversion_3x3' */
  boolean_T det_flag;                  /* '<S14>/Matrix_Inversion_3x3' */
} rtB_vdy_matrix_inversion_3x3;

extern void vdy_matrix_inversion_3x3(const real32_T rtu_HPHt_R[9],
  rtB_vdy_matrix_inversion_3x3 *localB);

#endif                                 /* RTW_HEADER_vdy_matrix_inversion_3x3_h_ */
