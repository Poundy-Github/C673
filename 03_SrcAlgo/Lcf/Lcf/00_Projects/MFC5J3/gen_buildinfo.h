...
#define MK_PROJECT_ID_INFOBLOCK MFC5J3\0
// #define MK_OUTPUT_FILE_NAME_BASE mfc400_appl
// #define MK_EXE_ID_NAME= 1
// Default user, time and date
#define MK_BNAME uic39235
#define MK_BTIME 143233U
#define MK_BDATE 200325U
...
// SW Version Number 000.213.30
//
#define MK_EXE_VERSION ((( 0 ) << 16u) + (( 213 ) << 8u) + ( 30 ))
//
...
#define MK_OEM_BOOT_INIT  /* .OemId = */ MFC5J3, /* .SGBMId = */ { /* .ProcessClass = */ { 0x08 },	/* (SWFL) */ /* .Ident = */ { 0x00, 0x00, 0x0D, 0xB5 }, /* .Version = */ { 4, 31, 1 } }, /* .SerialNumber= */ { 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 }, /* .pSign = */ 0, /* .Reserved = */ 0
