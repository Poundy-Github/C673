 ...
 *
 * $Id: Os_atomics_tsplatforms.h 34867 2021-08-10 07:42:19Z thno272635 $
*/
...
#elif (OS_ARCH == OS_CORTEXM) && (OS_KERNEL_TYPE != OS_MICROKERNEL)
#include <CORTEXM/Os_atomics_tsplatforms_CORTEXM.h>
#elif ((OS_ARCH == OS_ARC) || \
	  (OS_ARCH == OS_ARM) || \
	  (OS_ARCH == OS_ARM64) || \
	 ((OS_ARCH == OS_CORTEXM) && (OS_KERNEL_TYPE == OS_MICROKERNEL)) || \
	  (OS_ARCH == OS_WINDOWS) || \
	  (OS_ARCH == OS_LINUX))
