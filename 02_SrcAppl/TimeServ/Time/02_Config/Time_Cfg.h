...
#define TIME_STM1_CLK_FREQ                      (100000000ul) /*unit is Hz*/
#define TIME_STM2_CLK_FREQ                      (100000000ul) /*unit is Hz*/
#define TIME_STM3_CLK_FREQ                      (100000000ul) /*unit is Hz*/
/*
...
/*
 * \brief 	TIME_STBM_RTE_USAGEE,
 *          means get the STBM current time use the RTE;
 *          
 * 
 * */
#define TIME_STBM_RTE_USAGE                             STD_OFF
