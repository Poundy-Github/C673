...
**  VERSION   : 9.0.0                                                         **
**                                                                            **
**  DATE, TIME: 2023-07-10, 16:12:16              !!!IGNORE-LINE!!!           **
**                                                                            **
...
#define SMU_STANDBY_SWITCH               (STD_ON)
...
#define SMU_CORE_FSP0_HWDIR              (0x0U)
...
#define SMU_CORE_FSP0_PORT_ENABLE        (0x0U)
...
#define SMU_E_ACTIVATE_RUN_STATE_FAILURE          (DemConf_DemEventParameter_SmuActivateRunStateFailureNotification)
...
#define SMU_E_CLEAR_ALARM_STATUS_FAILURE          (DemConf_DemEventParameter_SmuClearAlarmStatusFailureNotification)
...
#define SMU_E_RELEASE_FSP_FAILURE                 (DemConf_DemEventParameter_SmuReleaseFSPFailureNotification)
...
#define SMU_E_CORE_ALIVE_FAILURE                  (DemConf_DemEventParameter_SmuCoreAliveFailureNotification)
...
#define SMU_E_RT_STOP_FAILURE                     (DemConf_DemEventParameter_SmuRTStopFailureNotification)
...
#define SMU_E_ACTIVATE_PES_FAILURE                (DemConf_DemEventParameter_SmuActivatePESFailureNotification)
...
#define SMU_E_ACTIVATE_FSP_FAILURE                (DemConf_DemEventParameter_SmuActivateFSPFailureNotification)
...
#define SMU_E_SET_ALARM_STATUS_FAILURE            (DemConf_DemEventParameter_SmuSetAlarmStatusFailureNotification)
...
#define SMU_E_SFF_TEST_FAILURE                    (DemConf_DemEventParameter_SmuSffFailureNotification)
