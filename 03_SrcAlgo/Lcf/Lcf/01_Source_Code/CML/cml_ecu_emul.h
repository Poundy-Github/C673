/*! \file **********************************************************************
  ...
  VERSION:                   $Revision: 1.38.1.5 $

  ---*/ /*---
  CHANGES:                   $Log: cml_ecu_emul.h  $
  CHANGES:                   Revision 1.38.1.5 2019/09/20 12:42:56CEST Kotre, Jeevan (uidk9586) (uidk9586) 
  CHANGES:                   restrict keyword defined for c66xx platform
  CHANGES:                   Revision 1.38.1.3 2019/07/19 08:59:18CEST Kotre-EXT, Jeevan (uidk9586) 
  CHANGES:                   Restrict keyword is disabled on request for MFC431TA19
  CHANGES:                   Revision 1.38.1.2 2019/06/24 12:21:18CEST Reddy, Purushothama (uid33569) 
  CHANGES:                   updated with QAF warnings handled.
  CHANGES:                   Revision 1.38.1.1 2019/05/27 11:07:12CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   MFC431TA19: QAF L4 fixes added
  CHANGES:                   Revision 1.38 2018/07/18 12:48:52CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   Removed _MSC_VER switch from CML_f_MultAddGen
  CHANGES:                   Revision 1.37 2018/07/05 07:14:52CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   Introduced switch CML_GOLDDUST
  CHANGES:                   Revision 1.36 2018/06/19 10:32:06CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   Mapping of CML_f_Sqrt to CML_f_sqrt69 done
  CHANGES:                   Revision 1.35 2018/06/06 06:08:14CEST Kotre-EXT, Jeevan (uidk9586) 
  CHANGES:                   update cml_ecu_emul with macros for DCC compiler.
  CHANGES:                   Revision 1.33 2018/02/26 08:59:27CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Updated the source code with respect to AL_CML_01.09.18_INT-1
  CHANGES:                   Revision 1.32 2017/12/04 14:12:34CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Updated CML_INLINE definition for ARMCC in MFC5xx
  CHANGES:                   Revision 1.31 2017/11/14 18:41:34CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Updated to the code from AL_CML_01.09.13_INT-1
  CHANGES:                   Revision 1.30 2017/08/04 06:03:20CEST Arulkumar-EXT, Nandu (uidr5428) 
...
/*****************************************************************************
  INCLUDE PROTECTION
*****************************************************************************/
#ifndef CML_ECU_EMUL_INCLUDED
#define CML_ECU_EMUL_INCLUDED
...
#if (defined(__DCC__))
#include "01_Source_Code/common/GLOB/glob_type.h"
#endif
...
/*****************************************************************************
  MACROS
*****************************************************************************/
#if (defined(CPU_MPC5675K_EMU) || defined(CPU_MPC5775N_EMU))
   #define  CML_GOLDDUST  1
#endif

#if defined(_MSC_VER) /* Microsoft compiler -> code only for simulation */

  #define CML_RESTRICT            ///restrict keyword being ignored for microsoft compiler.
  ...
  #define CML_f_Neg(x)             (-(x)) ///< Negative number 
    ...
    #define CML_f_Sqrt(x)          CML_f_sqrt69(x) ///< square root 
  ...
  #define CML_RESTRICT            ///< restrict keyword is ignored for DCC compiler.
  ...
  #if defined(CML_OPT_c66x)
    #define CML_RESTRICT restrict   ///restrict keyword defined for c66xx platform, when optmization is enabled.
  #else
    #define CML_RESTRICT            ///restrict keyword disabled for c66xx platform, when optmization is not enabled.
  #endif
...
/*****************************************************************************
  ...
  \traceability   
*****************************************************************************/
/* PRQA S  3240, 3242, 3480, 3406 6 */
/* Deactivate QAF warning 3240, 3242, 3480, 3406 Date: 2019-06-14; Reviewer: uid33596;   
...
/*****************************************************************************
  ...
  \traceability   
*****************************************************************************/
/* PRQA S  3240, 3242, 3480, 3406, 3219 6 */
/* Deactivate QAF warning 3240, 3242, 3219, 3480, 3406 Date: 2019-06-14; Reviewer: uid33596;   
   Reason: Macro CML_INLINE used to handle inline keyword, which is compiler dependent*/
...
/*****************************************************************************
       Functionname:    CML_u_max                                     *//*!

  \brief           This computes maximum of two given unsigned values

  \description     The function calculates the maximum of two unsigned
                    numbers.
  ...
  \param[in]       x :  The first unsigned number for comparison
  \param[in]       y :  The second unsigned number for comparison

  \return          Maximum of the two unsigned numbers
...
/* Deactivate QAF warning 3240,  3219, 3480, Date: 2019-06-14; Reviewer: uid33596;   
   Reason: Macro CML_INLINE used to handle inline keyword, which is compiler dependent*/
CML_INLINE uint32 CML_u_max(uint32 x, uint32 y)
{
  return (x > y) ? x : y;
}

/*****************************************************************************
       Functionname:    CML_s_max                                     *//*!

  \brief           This computes maximum of two given signed values

  \description     The function calculates the maximum of two signed
                    numbers.
  ...
  \param[in]       x :  The first signed number for comparison
  \param[in]       y :  The second signed number for comparison

  \return          Maximum of the two signed numbers
...
/* Deactivate QAF warning 3240, 3219, 3480, Date: 2019-06-14; Reviewer: uid33596;   
   Reason: Macro CML_INLINE used to handle inline keyword, which is compiler dependent*/
CML_INLINE sint32 CML_s_max(sint32 x, sint32 y)
{
  return (x > y) ? x : y;
}
...
/*****************************************************************************
  ...
  \traceability   
*****************************************************************************/
/* PRQA S 3240, 3242, 3480, 3406, 3219 8 */
/* Deactivate QAF warning 3240, 3242, 3219, 3480, 3406 Date: 2019-06-14; Reviewer: uid33596;   
   Reason: Macro CML_INLINE used to handle inline keyword, which is compiler dependent*/
/* PRQA S 4395 6 */
/* Deactivate QAF warning 4395, Date: 2019-06-11; Reviewer: uid33596; 
   Reason: The function is reviewed.This warning is not applicable for the supported input range */
...
CML_INLINE float32 CML_f_MultAddGen(float32 a, float32 b, float32 d)
{
  /* The below code implement (a * b) + d; */
...
#endif /* #ifndef CML_ECU_EMUL_INCLUDED */
