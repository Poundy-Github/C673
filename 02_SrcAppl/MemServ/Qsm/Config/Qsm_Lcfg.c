...
s_Qsm_QSBlock_EcuSpecInfo_t  s_QSBlock_EcuSpecInfo = {0};
...
const s_Qsm_ReadAllInfo_t Qsm_ConfigAllTable[QSM_CONFIGBLOCKNUM] = 
{
	...
	{NvMConf_NvMBlockDescriptor_NvM_Block_EOLModeGate,      FeeConf_FeeBlockConfiguration_Fee_NvM_Block_EOLModeGate,     &s_QSBlock_EcuSpecInfo,         sizeof(s_QSBlock_EcuSpecInfo),         0x00u},
