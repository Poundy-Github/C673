...
MEMORY
{
  ...
  psram_local (w!xp): org = 0xc0000000, len = 8K
  ...
  /*PSPR for Flsloader demo */
  FLSLOADER_RAM_CODE(w!xp): org = 0x70100000, len = 5k    /*PSPR for Flsloader demo */
}
