/*! \file **********************************************************************
  ...
  VERSION:                   $Revision: 1.17.1.2 $

  ---*/ /*---
  CHANGES:                   $Log: cml_stat.h  $
  CHANGES:                   Revision 1.17.1.2 2019/06/24 10:39:52CEST Kotre, Jeevan (uidk9586) (uidk9586) 
  CHANGES:                   QAF level 3 warnings have been fixed.
  CHANGES:                   Revision 1.17.1.1 2019/05/27 11:04:17CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   MFC431TA19: QAF L4 fixes added
  CHANGES:                   Revision 1.17 2018/02/27 06:51:07CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Removed the spaces after \ ; The change was lost while updating to the legacy release.
  CHANGES:                   Revision 1.16 2018/02/26 08:52:40CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Updated the source code with respect to AL_CML_01.09.18_INT-1
  CHANGES:                   Revision 1.15 2017/12/20 06:43:11CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Correction for the compilation warning
  CHANGES:                   Revision 1.14 2017/11/14 18:41:50CET Arulkumar-EXT, Nandu (uidr5428) 
...
/*****************************************************************************
  INCLUDE PROTECTION
*****************************************************************************/
#ifndef CML_STAT_INCLUDED
#define CML_STAT_INCLUDED
...
/*****************************************************************************
  ...
  \InOutCorrelation
                   \f[ Result = \frac{\sigma{i=1}^{n} (x_i \times w_i)}{\sigma{i=1}^{n}(w_i)} \f]
                   
  \param[in]       f_inputValues    : input values 
                                      [Positive range of float]
  \param[in]       f_weights        : weights of teh input values
                                      [Positive range of float]
  ...
  \traceability    
*****************************************************************************/
extern float32 CML_f_calculateWeightedSum(const float32 f_inputValues[], const float32 f_weights[], const uint32 u_numberOfValues);
...
/*****************************************************************************
  ...
  \InOutCorrelation
                   ...
                   \f[ The \ values \ sum_{xQuant},\ sum_{x^2Quant} \ and \ sum_{v^2Quant} \ are \ clipped
                       \ in \ the \ range \ [0,Q_{us}] \\ whereas \\
                       values \ sum_{vQuant} \ and \ sum_{xvQuant} \ are \ clipped \  in \ the \ range \ [Q_{-s},Q_s]  \f]
...
#endif /* #ifndef CML_STAT_INCLUDED */
