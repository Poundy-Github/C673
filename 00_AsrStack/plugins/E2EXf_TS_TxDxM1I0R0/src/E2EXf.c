...
#if (!defined E2EXF_VENDOR_ID) /* configuration check */
...
#if (!defined E2EXF_AR_RELEASE_MAJOR_VERSION) /* configuration check */
...
#if (!defined E2EXF_AR_RELEASE_MINOR_VERSION) /* configuration check */
...
#if (!defined E2EXF_AR_RELEASE_REVISION_VERSION) /* configuration check */
...
#if (!defined E2EXF_SW_MAJOR_VERSION) /* configuration check */
...
#if (!defined E2EXF_SW_MINOR_VERSION) /* configuration check */
...
#if (!defined E2EXF_SW_PATCH_VERSION) /* configuration check */
#error E2EXF_SW_PATCH_VERSION must be defined
#endif

/* patch version check */
#if (E2EXF_SW_PATCH_VERSION < 34U)
#error E2EXF_SW_PATCH_VERSION wrong (< 34U)
#endif
