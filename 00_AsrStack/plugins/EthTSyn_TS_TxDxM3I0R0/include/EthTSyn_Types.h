...
/* !LINKSTO EthTSyn.ASR20-11.SWS_EthTSyn_00033, 1 */
...
typedef struct
{
  ...
  uint8 NrOfValidOfs; /* Contains the number of the valid Ofs Tlvs */
...
typedef struct
{
  ...
  uint8 OffsetIndex; /* Index to the starting Ofs tlv. */
