 ...
 *
 * $Id: Os_configuration_decls_c1.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
...
#if (1 == OS_SHAREDHWCOUNTERTIMESTAMP_COREID)
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE1 1
#else
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE1 0
#endif

#define OS_TOTALALARMS_CORE1 (OS_NALARMS_CORE1 + OS_NSCHEDULES_CORE1 + OS_NSHAREDHWCOUNTERTIMESTAMP_CORE1)
