/*! \file ********************************************************************
  ...
  CHANGES:                Revision 1.1 2020/05/08 07:19:46CEST uidm9800 
  CHANGES:                Initial revision
  CHANGES:                Member added to project /nfs/projekte1/PROJECTS/ARS400/06_Algorithm/04_Engineering/01_Source_Code/common/project.pj
  CHANGES:                Revision 1.1 2019/04/25 08:02:52CEST Wang, Jianan02 (uia93585) (uia93585) 
  CHANGES:                Initial revision
  CHANGES:                Member added to project /nfs/projekte1/SW/SW_ARS4xx/SW_ARS410SW29/M11_APPL/04_Engineering/01_Source_Code/common/project.pj
  CHANGES:                Revision 1.43.1.2 2018/11/16 14:21:25CET Hirani, Mohit (uidn6157) 
  CHANGES:                Added Macro for PCC RadarPedestrianCyclistClassification   COMP_ID_PCC    195U
  CHANGES:                Revision 1.43.1.1 2018/10/23 16:07:01CEST Hirani, Mohit (uidn6157) 
  CHANGES:                TO DO: Temporary compilation fix for facthing TASK_ID_EC, to been removed later, Confirmed with Saurabh 12/10/2018
  CHANGES:                Revision 1.43 2015/12/17 12:07:49CET Gehlert, Matthias (uidv0214) 
  CHANGES:                add COMP_ID_FRS for 'FreiRaumSchnittstelle'
  CHANGES:                Revision 1.42 2015/01/21 17:04:24CET Steelandt, Mathieu (uidg6511) 
  CHANGES:                Add U to constants
  CHANGES:                - Added comments -  uidg6511 [Jan 21, 2015 5:04:58 PM CET]
  CHANGES:                Change Package : 281665:11 http://mks-psad:7002/im/viewissue?selection=281665
  CHANGES:                Revision 1.41 2014/10/15 14:07:05CEST Sauter, Michael (sauterm) 
  CHANGES:                add comments to cycle ids
  CHANGES:                --- Added comments ---  sauterm [Oct 15, 2014 2:07:06 PM CEST]
  CHANGES:                Change Package : 242263:7 http://mks-psad:7002/im/viewissue?selection=242263
  CHANGES:                Revision 1.40 2014/10/13 08:59:03CEST Spruck, Jochen (spruckj) 
  CHANGES:                Add tsa extended meas freeze range, because of tsa meas freeze overlap with ecm
  CHANGES:                --- Added comments ---  spruckj [Oct 13, 2014 8:59:03 AM CEST]
  CHANGES:                Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
  CHANGES:                Revision 1.39 2014/07/22 14:54:54CEST Scherf, Steffen (uidu8201) 
  CHANGES:                added comp_id_externals for 3rd party modules
  CHANGES:                --- Added comments ---  uidu8201 [Jul 22, 2014 2:54:54 PM CEST]
  CHANGES:                Change Package : 239221:2 http://mks-psad:7002/im/viewissue?selection=239221
  CHANGES:                Revision 1.38 2014/07/11 15:31:12CEST Bresch, Axel (uidw5404) 
  CHANGES:                added ACCSM for ARS410_VW16
  CHANGES:                --- Added comments ---  uidw5404 [Jul 11, 2014 3:33:46 PM CEST]
  CHANGES:                Change Package : 231361:4 http://mks-psad:7002/im/viewissue?selection=231361
  CHANGES:                Revision 1.37 2014/05/21 17:08:22CEST Spruck, Jochen (spruckj) 
  CHANGES:                Add TLR Traffic Light Detection
  CHANGES:                --- Added comments ---  spruckj [May 21, 2014 5:08:23 PM CEST]
  CHANGES:                Change Package : 232002:2 http://mks-psad:7002/im/viewissue?selection=232002
  CHANGES:                Revision 1.36 2014/03/11 15:36:25CET Sauter, Michael (sauterm) 
  CHANGES:                add times for task ids
  CHANGES:                --- Added comments ---  sauterm [Mar 11, 2014 3:36:26 PM CET]
  CHANGES:                Change Package : 127906:1 http://mks-psad:7002/im/viewissue?selection=127906
  CHANGES:                Revision 1.35 2014/03/05 13:40:17CET Spruck, Jochen (spruckj) 
...
#define COMP_ID_ALN       19U      /* 0x2050.0000 <--> 0x2050.ffff     |   extended range 0x2090.0000 <--> 0x2090.ffff */
#define COMP_ID_FRS       30U      /* 0x2012.0000 <--> 0x2012.ffff     |   */
...
#define COMP_ID_SR        80U      /* 0x2042.0000 <--> 0x2042.ffff     | extended range 0x30D0.0000 <--> 0x30DF.FFFF |  SLA reserved range 2MB 0x0710.0000 - 0x072F.FFFF (including SR and SLAF) */
#define COMP_ID_TSA       81U      /* 0x2004.0000 <--> 0x2004.ffff     | extended range 0x3170.0000 <--> 0x317F.FFFF               */
...
#define COMP_ID_TLR       119U      /* 0x3160.0000 <--> 0x316f.ffff    |   */
...
/*      Component         ID  |      virtual address range            |   Info  */
/*----------------------------------------------------------------------------------------------------------------*/
#define COMP_ID_SYS       128U     /* 0x8000.0000 <--> 0x8000.ffff     |   */
                                   /* 0x800c.2008 <--> 0x800c.2fff     |   */
                                   /* 0x800e.1000 <--> 0x800e.1fff     |   */
#define COMP_ID_OS        129U     /* 0x8001.0000 <--> 0x8001.ffff     |    not used */
#define COMP_ID_NVM       130U     /* 0x8002.0000 <--> 0x8002.ffff     |    not used */
#define COMP_ID_HAL       131U     /* 0x8003.0000 <--> 0x8003.ffff     |    not used */
#define COMP_ID_IPC       132U     /* 0x8004.0000 <--> 0x8004.ffff     |    not used */
#define COMP_ID_MEAS_MF   133U     /* 0x8005.0000 <--> 0x8005.ffff     |   */
#define COMP_ID_HEAT      134U     /* 0x8006.0000 <--> 0x8006.0fff     |   */
#define COMP_ID_MEL       135U     /* 0x8006.1000 <--> 0x8006.ffff     |   */
#define COMP_ID_CAN       136U     /* 0x8007.0000 <--> 0x8007.ffff     |   */
#define COMP_ID_XCP       137U     /* 0x8008.0000 <--> 0x8008.ffff     |    not used */
#define COMP_ID_CM        138U     /* 0x8009.0000 <--> 0x8009.ffff     |    not used */
#define COMP_ID_VDATA     139U     /* 0x800a.0000 <--> 0x800b.ffff     |    not used */
#define COMP_ID_DEM       140U     /* 0x800c.0000 <--> 0x800c.2007     |   */
                                   /* 0x800c.8000 <--> 0x800c.ffff     |   */
#define COMP_ID_FIM       141U     /* 0x800c.0000 <--> 0x800c.2007     |    not used */
                                   /* 0x800c.8000 <--> 0x800c.ffff     |   */
#define COMP_ID_MON       142U     /* 0x800d.0000 <--> 0x800d.0fff     |   */
#define COMP_ID_ACTL      143U     /* 0x800d.1000 <--> 0x800d.ffff     |   */
#define COMP_ID_FPGA      144U     /* 0x800e.2000 <--> 0x800e.ffff     |    not used */
#define COMP_ID_DIAG      145U     /* 0x800f.0000 <--> 0x800f.3fff     |   */
#define COMP_ID_RFCOM     146U     /* 0x800f.4000 <--> 0x800f.7fff     |   */
#define COMP_ID_RTA       147U     /* 0x800f.8000 <--> 0x8010.7fff     |   */
#define COMP_ID_RAHE      148U     /* 0x8010.8000 <--> 0x8010.ffff     |   */
#define COMP_ID_ADPVDY    149U     /* 0x8020.0000 <--> 0x8020.ffff     |   */
#define COMP_ID_ACCSM     150U     /* 0x8021.0000 <--> 0x8021.ffff     |   */
#define COMP_IP_EXTERNAL  151U	   /* 0x8022.0000 <--> 0x8022.ffff     |   use for external software parts */
...
#define MTS_FUNC_ID_TLR    		COMP_ID_TLR
...
#define TASK_ID_SW_EVERY_100MS              214U   /* [1s] Ars4xx Ppar, PCB Version */
#define TASK_ID_SW_EVERY_10S                215U   /* Reserved, not yet supported by the ARS400 devices! */
#define TASK_ID_SW_06                       216U   /* SPT/ADC sigma delta freezes */
