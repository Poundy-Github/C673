 ...
 *
 * $Id: Os_timeconversion.h 34482 2021-07-14 07:37:46Z yash272833 $
*/
...
*/
#define OS_NsToTicks_200000(ns)		((ns)/5000u)
#define OS_TicksToNs_200000(tx)		(((tx) > 858993u) ? 0xffffffffu : ((tx)*5000u))

/* Clock Frequency 312.5 kHz
 *
 * Factor is 312500/1000000000
 *         = 1/3200
 * No mul-div-mul needed.
*/
#define OS_NsToTicks_312500(ns)	((ns)/3200u)
#define OS_TicksToNs_312500(tx)	(((tx) > 1342177u) ? 0xffffffffu : ((tx)*3200u))

/* Clock frequency 500 kHz
 *
 * Factor is 500000/1000000000
 *         = 1/2000
 * No mul-div-mul needed.
 * max = floor(PA_COUNTER_MAXALLOWEDVALUE / 2000) = 2147483
*/
#define OS_NsToTicks_500000(ns)		((ns)/2000u)
#define OS_TicksToNs_500000(tx)		(((tx) > 2147483u) ? 0xffffffffu : ((tx)*2000u))

/* Clock frequency 1 MHz
*/
#define OS_NsToTicks_1000000(ns)	((ns)/1000u)
#define OS_TicksToNs_1000000(tx)	(((tx) > 4294967u) ? 0xffffffffu : ((tx)*1000u))
 ...
 *
 * Factor is 2500000/1000000000
 *         = 1/400
 * No mul-div-mul needed.
*/
#define OS_NsToTicks_2500000(ns)	((ns)/400u)
#define OS_TicksToNs_2500000(tx)	(((tx) > 10737418u) ? 0xffffffffu : ((tx)*400u))
 ...
 *
 * Factor is 3125000/1000000000
 *         = 1/320
 * No mul-div-mul needed.
*/
#define OS_NsToTicks_3125000(ns)	((ns)/320u)
#define OS_TicksToNs_3125000(tx)	(((tx) > 13421772) ? 0xffffffffu : ((tx)*320u))
...
/* Clock frequency 7.8125 MHZ
 *
 * Factor is 7812500/1000000000
 *           = 1/128
 *
 */
 #define OS_NsToTicks_7812500(ns)       ((ns)/128u)
 #define OS_TicksToNs_7812500(tx)       (((tx) > 33554431u) ? 0xffffffffu : ((tx)*128u))
...
/* Clock frequency 19.8 MHz
 * Factor is 19800000/1000000000
 *         = 198/10000
 *         = 99/5000
 *         = 99/(100 * 50)
*/
#define OS_NsToTicks_19800000(ns)	OS_DivMulDiv((ns), 100u, 99u, 50u)
#define OS_TicksToNs_19800000(tx)	OS_SatMulDivMul((tx), 50u, 99u, 100u, 85040352u)
 ...
 *
 * Factor is 750000000/1000000000
 *         = 3/4
 * No mul-div-mul needed.
*/
#define OS_NsToTicks_750000000(ns)	(((ns)/4u)*3u)
#define OS_TicksToNs_750000000(tx)	(((tx) > 3221225469u) ? 0xffffffffu : (((tx)/3u)*4u))
