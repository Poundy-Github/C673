 ...
 *
 * $Id: Os_TRICORE_core.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
 ...
 */
typedef struct os_tricoreaccen_s
{
...
#define OS_SRN_TOSval(tos)	((os_uint32_t)(((os_uint32_t)(((os_uint32_t)(tos)) & 0x7u)) << 12u))
...
*/
#define OS_MTCCR(csfrBase, csfrId, val) \
	do { \
		OS_DSYNC(); \
		*((os_reg32_t *)(((os_uint32_t)(csfrBase))+(csfrId)))=(val); \
		OS_ISYNC(); \
	} while (0)
