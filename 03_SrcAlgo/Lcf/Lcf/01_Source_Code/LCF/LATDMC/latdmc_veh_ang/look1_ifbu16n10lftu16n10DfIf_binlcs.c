/* $Header: look1_ifbu16n10lftu16n10DfIf_binlcs.c 1.1.1.2 2019/03/07 18:12:34CET Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : look1_ifbu16n10lftu16n10DfIf_binlcs.c
   C source code generated on           : Fri Mar 01 18:10:17 2019
   Filename of Simulink Model           : DMC_Soc_Lat.mdl/.slx
   Revision of Simulink Model           : 1.4033
 ***************************************************************************************************
...
/* --- Includes --- */
#include "rtwtypes.h"
#include "look1_ifbu16n10lftu16n10DfIf_binlcs.h"

real32_T look1_ifbu16n10lftu16n10DfIf_binlcs(real32_T tmp_, const uint16_T
  tmp_0[], const uint16_T tmp_1[], uint32_T tmp_2)
{
  ...
  if (tmp_ < (((real32_T)tmp_0[(uint8_T)0U]) * 0.0009765625F)) {
    tmp_6 = (uint32_T)0U;
    tmp_4 = 0.0F;
  } else if (tmp_ < (((real32_T)tmp_0[tmp_2]) * 0.0009765625F)) {
    /* Binary Search */
    ...
    tmp_4 = (tmp_ - (((real32_T)tmp_0[tmp_6]) * 0.0009765625F)) / (((real32_T)
      ((uint16_T)(((uint32_T)tmp_0[tmp_6 + ((uint32_T)1U)]) - ((uint32_T)
      tmp_0[tmp_6])))) * 0.0009765625F);
  } else {
