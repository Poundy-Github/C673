/* $Header: DMC_Lat_TDF_Torque_Derating_Function_data.c 1.24 2020/08/20 10:43:17CEST Feick, Stefan (uidw0691) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : DMC_Lat_TDF_Torque_Derating_Function_data.c
...
const ConstParam_DMC_Lat_TDF_Torque_Derating_Function_T
   ...
   * Referenced by: '<S51>/TDF_Trq_Derating_Init_Corr'
   */
  { 0.0F, 10.0F, 20.0F, 30.0F, 40.0F, 60.0F, 80.0F, 100.0F, 120.0F, 180.0F,
    250.0F },
