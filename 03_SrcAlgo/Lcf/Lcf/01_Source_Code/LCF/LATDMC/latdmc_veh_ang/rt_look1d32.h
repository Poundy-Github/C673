/* $Header: rt_look1d32.h 1.1 2018/01/24 16:30:03CET Asong, Wedndah Asaha (uidj2187) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : rt_look1d32.h
...
/* --- Includes --- */
#ifndef RTW_HEADER_rt_look1d32_h_
#define RTW_HEADER_rt_look1d32_h_
#include "rtwtypes.h"
#include "rt_look32.h"

extern real32_T rt_Lookup32(const real32_T *x, int_T xlen, real32_T u, const
  real32_T *y);

#endif                                 /* RTW_HEADER_rt_look1d32_h_ */
