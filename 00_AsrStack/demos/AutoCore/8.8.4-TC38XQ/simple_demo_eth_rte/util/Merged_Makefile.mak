...
### merged from ProjectMode_CommonSettings
# provide name of project mode tests
PROJECT_NAME ?= simple_demo_eth_rte

# name of test sequence
TEST_SEQUENCE := simple_demo_eth_rte

# workflow of test sequence
TEST_WORKFLOW := M4_TEST_WORKFLOW

# provide location of tools base
TOOLS_BASE := $(WORK_BASE)/tools
