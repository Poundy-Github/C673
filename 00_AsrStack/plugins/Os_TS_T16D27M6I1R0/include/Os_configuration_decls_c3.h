 ...
 *
 * $Id: Os_configuration_decls_c3.h 33382 2021-03-03 08:00:10Z arla271030 $
*/
...
#if (3 == OS_SHAREDHWCOUNTERTIMESTAMP_COREID)
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE3 1
#else
#define OS_NSHAREDHWCOUNTERTIMESTAMP_CORE3 0
#endif

#define OS_TOTALALARMS_CORE3 (OS_NALARMS_CORE3 + OS_NSCHEDULES_CORE3 + OS_NSHAREDHWCOUNTERTIMESTAMP_CORE3)
