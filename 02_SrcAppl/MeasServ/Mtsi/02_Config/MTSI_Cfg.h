...
#define CFG_MTSI_SIZE_OF_ASYNC_QUEUE_CORE_1 150u
#define CFG_MTSI_SIZE_OF_ASYNC_QUEUE_CORE_2 10u
#define CFG_MTSI_SIZE_OF_ASYNC_QUEUE_CORE_3 150u
...
/** @brief Minimum size of an asynchronous job.
 ...
 Range: 0 - UINT32_MAX
*/
#define CFG_MTSI_MINIMUM_SIZE_OF_ASYNC_JOB 1uL 
...
#define MTSI_GetTimeStampMs                     Mtsi_GetSTM0Time_Ms
#define MTSI_GetTimeStampSec                    Mtsi_GetSTM0Time_Sec
