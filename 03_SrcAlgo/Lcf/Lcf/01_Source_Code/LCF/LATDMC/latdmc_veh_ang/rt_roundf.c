/* $Header: rt_roundf.c 1.1 2018/01/24 16:30:05CET Asong, Wedndah Asaha (uidj2187) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : rt_roundf.c
   C source code generated on           : Mon Nov 30 12:21:23 2015
   Filename of Simulink Model           : DMC.mdl
   Revision of Simulink Model           : 1.1972
 ***************************************************************************************************
...
real32_T rt_roundf(real32_T tmp_)
{
  real32_T tmp_0;
  if (((real32_T)fabs((real_T)tmp_)) < 8.388608E+6F) {
    if (tmp_ >= 0.5F) {
      tmp_0 = (real32_T)floor((real_T)((real32_T)(tmp_ + 0.5F)));
    } else if (tmp_ > -0.5F) {
      tmp_0 = 0.0F;
    } else {
      tmp_0 = (real32_T)ceil((real_T)((real32_T)(tmp_ - 0.5F)));
    }
  } else {
    tmp_0 = tmp_;
  }
