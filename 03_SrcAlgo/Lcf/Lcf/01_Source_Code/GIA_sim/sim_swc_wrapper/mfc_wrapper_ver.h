/*! \file **********************************************************************
  ...
  ---*/ /*---
  CHANGES:                   $Log: mfc_wrapper_ver.h  $  
  CHANGES:                   Revision 1.1 2021/12/13 17:22:52CET Wang, David (Wangd3)   
  CHANGES:                   Initial revision  
  CHANGES:                   Member added to project /ADAS/Projects/MFC5xx/MFC5J3/06_Algorithm/DPU/04_Engineering/01_Source_Code/GIA_sim/sim_swc_wrapper/project.pj  
  CHANGES:                   Revision 1.0 2017/03/03 10:34:21CET Sorge, Sven (uidg3181)   
  CHANGES:                   Initial revision  
  CHANGES:                   Member added to project /ADAS/SW/Integration/06_Simulation_Components/GIA_GenericInterfaceAdapter/04_Engineering/03_Workspace/Component_Workspace/GIA_sim/sim_swc_wrapper/project.pj  
  CHANGES:                   Revision 1.2 2014/04/01 10:36:46CEST Sorge, Sven (uidg3181)   
  CHANGES:                   Hla Wrapper Added  
  CHANGES:                   - Added comments -  uidg3181 [Apr 1, 2014 10:36:46 AM CEST]  
...
**************************************************************************** */
#ifndef mfc_wrapper_ver_h__
#define mfc_wrapper_ver_h__
...
*/
#define MFCWRAPPER_ALL_SW_MAIN_VER_NO             0x01U
#define MFCWRAPPER_ALL_SW_SUB_VER_NO              0x00U
#define MFCWRAPPER_ALL_SW_BUG_FIX_LEV             0x00U
#define MFCWRAPPER_ALL_SW_BUG_FIX_LEV2            0x00U


#endif // mfc_wrapper_ver_h__
