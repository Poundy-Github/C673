...
const real32_T vdy_ve_H_p[8] = { 1.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F
} ;

const real32_T vdy_ve_I_matrix_p[4] = { 1.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_ve_K_default_p[8] = { 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
  0.0F, 0.0F } ;

const real32_T vdy_ve_P_init_p[4] = { 1.0F, 0.0F, 0.0F, 1.0F } ;

const real32_T vdy_ve_Q_gain_p[3] = { 0.4F, 20.0F, 8.0F } ;

const real32_T vdy_ve_Q_sigmas_p[2] = { 225.0F, 12.5F } ;

const real32_T vdy_ve_a_v_zero_p[9] = { 0.0F, 0.0F, 2.0F, 0.001F, 0.001F, 0.5F,
  0.0F, 0.0F, 4.0F } ;

const real32_T vdy_ve_x_init_p = 0.0F;
