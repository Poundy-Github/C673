...
/* ASR 440 related code */
#else

#if ((CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON) || \
    (CAN_17_MCMCAN_RUNTIME_ERROR_DETECT == STD_ON))
/* Include default error detection header file if DET is Enabled */
#include "Det.h"
...
static void Can_17_McmCan_lInitTxMsgObj(const uint8 Controller,
    const Can_17_McmCan_CoreGlobalType *const CoreGlobalPtr,
    const Can_17_McmCan_CoreConfigType *const CoreConfigPtr);
...
static void Can_17_McmCan_lInitRxMsgObj(const uint8 Controller,
  const Can_17_McmCan_CoreConfigType *const CoreConfigPtr);
...
static void Can_17_McmCan_lErrorDataLost(uint8 ServiceId);
  ...
  if (E_OK == ReturnValue)
  {
    ...
    if (E_OK == ReturnValue)
    {
      ...
      #endif
      {
        ...
        Can_17_McmCan_lInitRxMsgObj(ControllerId, CoreConfigPtr);
        ...
        if (NULL_PTR != CoreConfigPtr->CanTxHwObjectConfigPtr)
        {
          ...
          Can_17_McmCan_lInitTxMsgObj(ControllerId,
...
**                                                                            **
**  Syntax           : static void Can_17_McmCan_lInitTxMsgObj                **
**                    (                                                       **
**                     const uint8 Controller                                 **
**                     Can_17_McmCan_CoreGlobalType *const CoreGlobalPtr      **
**                     const Can_17_McmCan_CoreConfigType *const CoreConfigPtr *
    ...
    const Can_17_McmCan_CoreConfigType *const CoreConfigPtr)
{
  ...
  Check if trigger transmit is enabled?
  [/cover] */
  if (TRUE == Can_17_McmCan_kGblConfigPtr->CanTriggerTransmitEnable)
  {
                      ...
                      const Can_17_McmCan_CoreGlobalType *const CoreGlobalPtr)
{
  ...
  if ((uint8)RxFIFOProcessing == (uint8)ProcessingType)
  {
    ...
    {
      /*Invoke the DET or RUNTIME handler to report CAN_E_DATALOST*/
      Can_17_McmCan_lErrorDataLost(CAN_17_MCMCAN_SID_RECEIVEHANDLER);
    ...
    const Can_17_McmCan_CoreConfigType *const CoreConfigPtr)
{
  ...
  {
      /*Raise a DET or RUNTIME error if DATA is lost*/
      Can_17_McmCan_lErrorDataLost(CAN_17_MCMCAN_SID_TRANSMITHANDLER);
...
/*******************************************************************************
            DET and RUNTIME condition check internal functions
*******************************************************************************/

/*******************************************************************************
** Traceability   : [cover parentID={74811484-F68A-487a-8964-E2C0A964F3D4}]   **
**                                                                            **
**                                                                            **
**  Syntax           :static Std_ReturnType Can_17_McmCan_lErrorDataLost      **
**                    (                                                       **
**                      const uint8 ServiceId                                 **
**                    )                                                       **
**                                                                            **
**  Description      : The function triggers CAN_E_DATALOST error when DET or **
**                     RUNTIME error is configured as per the AUTOSAR version **
**  [/cover]                                                                  **
**                                                                            **
**  Service ID       : NA                                                     **
**                                                                            **
...
**  Reentrancy       : Reentrant                                              **
**                                                                            **
**  Parameters(in)   : ServiceId - Service ID of the API which invokes        **
**                     the function                                           **
**                                                                            **
**  Parameters (out) : none                                                   **
**                                                                            **
...
static void Can_17_McmCan_lErrorDataLost(uint8 ServiceId)
{
  /*If AUTOSAR version used in 4.2.2*/
  /* [cover parentID={4776FBDD-9601-40fa-8225-03E3DC1581E4}]
  If AUTOSAR version is 4.2.2
  [/cover] */
  #if (MCAL_AR_VERSION == MCAL_AR_422)

  /*Check if DET is enabled*/
  /* [cover parentID={76EE91E5-1E90-4180-9403-823769A09809}]
  DET is enabled
  [/cover] */
  #if (CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON)

  /*Report DET error*/
  /* [cover parentID={E1C64E65-5216-4e9b-A79D-1D28297C70EC}]
  Report DET error CAN_17_MCMCAN_E_DATALOST
  [/cover] */
  (void)Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID,
                  ServiceId, CAN_17_MCMCAN_E_DATALOST);
  #else
  ...
  /*If AUTOSAR version used in 4.4.0*/
  /* [cover parentID={60C7AF3E-7865-479e-A7AA-86DDFB0A74B3}]
  If AUTOSAR version is 4.4.0
  [/cover] */
  #else

  /*Report RUNTIME error*/
  /* [cover parentID={1E8D556B-5C92-47f5-914D-A26DF4602DE7}]
  RUNTIME error detection is enabled
  [/cover] */
  #if (CAN_17_MCMCAN_RUNTIME_ERROR_DETECT == STD_ON)
  /* [cover parentID={3B1A79DD-6091-49a1-8C9C-930EC87F56D6}]
  Report runtime error CAN_17_MCMCAN_E_DATALOST
  [/cover] */
  (void)Det_ReportRuntimeError(CAN_17_MCMCAN_MODULE_ID,
                             CAN_17_MCMCAN_INSTANCE_ID, ServiceId,
