#ifndef RTE_INTERN_OSAPPLICATION_C3_H
#define RTE_INTERN_OSAPPLICATION_C3_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
#ifdef OS_NsToTicks_Rte_Counter_C3
#define RTE_NS_TO_TICKS OS_NsToTicks_Rte_Counter_C3
#else
#define RTE_NS_TO_TICKS(ns) ((TickType)((ns) / 1000000))
#endif
#define Rte_StartScheduleTable_SchM_DefaultScheduleTable_OsApplication_C3() StartScheduleTableRel(SchM_DefaultScheduleTable_OsApplication_C3, 10U)
#define Rte_StartScheduleTable_Rte_DefaultScheduleTable_OsApplication_C3() StartScheduleTableRel(Rte_DefaultScheduleTable_OsApplication_C3, 10U)
...
#define Rte_SetEvent_OIE_BD25944D0BD6171202C934A684479703() \
    do { \
    Rte_Task_SetEvent(Core3_OsTask_OperationInovkedProxy, Rte_OSTriggerExecutableEvent_Core3_OsTask_OperationInovkedProxy_OIE_BD25944D0BD6171202C934A684479703); \
    (void)SetEvent(Core3_OsTask_OperationInovkedProxy, Rte_OSTriggerExecutableEvent_Core3_OsTask_OperationInovkedProxy_OIE_BD25944D0BD6171202C934A684479703); \
    \
    } while (0)
...
#define Rte_SetEvent_MSSFE_FE04558BC80964D5FF00CB2D19E636F1() \
    do { \
    Rte_Task_SetEvent(Core2_OsTask_Bsw_20ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core2_OsTask_Bsw_20ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_351E09AA3FE0D811680109CF06871A47() \
    do { \
    Rte_Task_SetEvent(Core1_OsTask_Appl_10ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core1_OsTask_Appl_10ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_6A33C1C143B8627FCE326E917BFE0E49() \
    do { \
    Rte_Task_SetEvent(Core0_OsTask_Appl_60ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core0_OsTask_Appl_60ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_8FD0705A50198B63C94EF2ECCC6B82A4() \
    do { \
    Rte_Task_SetEvent(Core0_OsTask_Appl_20ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core0_OsTask_Appl_20ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_DD5BC30909449A85635CACA6E022D0D6() \
    do { \
    Rte_Task_SetEvent(Core1_OsTask_Appl_10ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core1_OsTask_Appl_10ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_01CF121052BCEE4A42EDFE9CCFD470B2() \
    do { \
    Rte_Task_SetEvent(Core0_OsTask_Appl_60ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core0_OsTask_Appl_60ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_0844A399FA12BB556EA2C8D02097D675() \
    do { \
    Rte_Task_SetEvent(Core0_OsTask_Appl_60ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core0_OsTask_Appl_60ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_A9B3D6BC7398B36456C53398B8256A52() \
    do { \
    Rte_Task_SetEvent(Core1_OsTask_Appl_10ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core1_OsTask_Appl_10ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_CB91B83989260DF80F22FF04C6D10F16() \
    do { \
    Rte_Task_SetEvent(Core2_OsTask_Appl_5ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core2_OsTask_Appl_5ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_SSFE_28ECDA10400F8AAC9D8C2295BAC16E5A() \
    do { \
    Rte_Task_SetEvent(Core0_OsTask_Appl_20ms, Rte_OSResolveWaitPointEvent); \
    (void)SetEvent(Core0_OsTask_Appl_20ms, Rte_OSResolveWaitPointEvent); \
    \
    } while (0)
#define Rte_SetEvent_IE_A490B13097B04A640DB5A3843D9A546B() \
    do { \
    Rte_Task_Activate(Core3_InitTask_Appl); \
    (void)ActivateTask(Core3_InitTask_Appl); \
    \
    } while (0)
...
#define RTE_TRANSITION_BswM_1_OsApplication_C3_BSWM_ModeGroupCrossCore 4U
#define RTE_MODE_BswM_1_OsApplication_C3_BSWM_ModeGroupCrossCore_BSWM_GO_OFF_ONE_D 0U
#define RTE_MODE_BswM_1_OsApplication_C3_BSWM_ModeGroupCrossCore_BSWM_STARTUP_TWO_B 1U
#define RTE_MODE_BswM_1_OsApplication_C3_BSWM_ModeGroupCrossCore_BSWM_STARTUP_TWO_D 2U
#define RTE_MODE_BswM_1_OsApplication_C3_BSWM_ModeGroupCrossCore_BSWM_SWC_CYCLIC_SHUTDOWN_C1 3U
#define RTE_TRANSITION_BswM_1_OsApplication_C3_DcmEcuReset 7U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmEcuReset_EXECUTE 0U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmEcuReset_HARD 1U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmEcuReset_JUMPTOBOOTLOADER 2U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmEcuReset_JUMPTOSYSSUPPLIERBOOTLOADER 3U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmEcuReset_KEYONOFF 4U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmEcuReset_NONE 5U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmEcuReset_SOFT 6U
#define RTE_TRANSITION_BswM_1_OsApplication_C3_DcmCommunicationControl 12U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_ENABLE_RX_TX_NORM 0U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_ENABLE_RX_DISABLE_TX_NORM 1U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_DISABLE_RX_ENABLE_TX_NORM 2U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_DISABLE_RX_TX_NORM 3U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_ENABLE_RX_TX_NM 4U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_ENABLE_RX_DISABLE_TX_NM 5U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_DISABLE_RX_ENABLE_TX_NM 6U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_DISABLE_RX_TX_NM 7U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_ENABLE_RX_TX_NORM_NM 8U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_ENABLE_RX_DISABLE_TX_NORM_NM 9U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_DISABLE_RX_ENABLE_TX_NORM_NM 10U
#define RTE_MODE_BswM_1_OsApplication_C3_DcmCommunicationControl_DCM_DISABLE_RX_TX_NORM_NM 11U
...
} Rte_ServerQueue_D7A8077F616686301C57F3DAFE27275B_RequestType;
typedef struct
{
  VAR(uint8, TYPEDEF) rteState;
  VAR(uint16, TYPEDEF) rteSequenceNumber;
} Rte_ClientRequestBufferType_OsApplication_C3;
typedef struct
{
  volatile VAR(uint8, TYPEDEF) head;
  volatile VAR(uint8, TYPEDEF) tail;
  VAR(Rte_ServerQueue_D7A8077F616686301C57F3DAFE27275B_RequestType, TYPEDEF) queue[1];
} Rte_ServerQueue_D7A8077F616686301C57F3DAFE27275B_Type;
typedef struct
{
  VAR(uint8, TYPEDEF) clientId;
  P2VAR(Rte_ClientRequestBufferType_OsApplication_C3, TYPEDEF, RTE_APPL_DATA) requestBuffer;
} Rte_ClientDS_D2E44595F0A772A85955801B103CDBEB_Type;
typedef struct
{
  VAR(uint8, TYPEDEF) clientId;
  P2VAR(Rte_ClientRequestBufferType_OsApplication_C3, TYPEDEF, RTE_APPL_DATA) requestBuffer;
} Rte_ClientDS_D0DAD4F3E775E8580342AB897AE7AB75_Type;
typedef struct
{
  VAR(uint8, TYPEDEF) clientId;
  P2VAR(Rte_ServerQueue_D7A8077F616686301C57F3DAFE27275B_RequestType, TYPEDEF, RTE_APPL_DATA) requestBuffer;
} Rte_ClientDS_A75EC9AB2000EDE9F4E250227D4A10BC_Type;
typedef struct
{
  VAR(uint8, TYPEDEF) clientId;
  P2VAR(Rte_ClientRequestBufferType_OsApplication_C3, TYPEDEF, RTE_APPL_DATA) requestBuffer;
} Rte_ClientDS_E570F3204B68D1067401D0964EED696A_Type;
...
#define Rte_WaitGetClearEvent_OsApplication_C3(e, ep, tid) (Rte_Task_WaitEvent(tid, e), OS_WaitGetClearEvent(e, ep), Rte_Task_WaitEventRet(tid, e), (*(ep) & (EventMaskType)~(EventMaskType)(e)) != 0U ? (SetEvent(tid, *(ep) & (EventMaskType)~(EventMaskType)(e)), *(ep) &= (e), E_OK) : E_OK)
#else
extern FUNC(StatusType, RTE_CODE) Rte_WaitGetClearEvent_OsApplication_C3 (EventMaskType eventToWait, P2VAR(EventMaskType, AUTOMATIC, RTE_APPL_DATA) eventReceived, TaskType myTaskId);
#endif
