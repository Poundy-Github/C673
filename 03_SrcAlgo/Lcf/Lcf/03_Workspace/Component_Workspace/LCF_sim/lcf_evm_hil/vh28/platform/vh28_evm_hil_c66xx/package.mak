...
override PKGDIR = vh28_evm_hil_c66xx
...
package/%.xdc.inc package/%_vh28_evm_hil_c66xx.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package vh28_evm_hil_c66xx" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedvh28_evm_hil_c66xxpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js vh28_evm_hil_c66xx $@
...
.PHONY: release,vh28_evm_hil_c66xx
vh28_evm_hil_c66xx.zip: package/package.bld.xml
vh28_evm_hil_c66xx.zip: package/build.cfg
vh28_evm_hil_c66xx.zip: package/package.xdc.inc
vh28_evm_hil_c66xx.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/vh28_evm_hil_c66xx.zip.dep
endif
package/rel/vh28_evm_hil_c66xx/vh28_evm_hil_c66xx/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

vh28_evm_hil_c66xx.zip: package/rel/vh28_evm_hil_c66xx.xdc.inc package/rel/vh28_evm_hil_c66xx/vh28_evm_hil_c66xx/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/vh28_evm_hil_c66xx.xdc.inc,package/rel/vh28_evm_hil_c66xx.zip.dep)


release release,vh28_evm_hil_c66xx: all vh28_evm_hil_c66xx.zip
clean:: .clean
	-$(RM) vh28_evm_hil_c66xx.zip
	-$(RM) package/rel/vh28_evm_hil_c66xx.xdc.inc
	-$(RM) package/rel/vh28_evm_hil_c66xx.zip.dep
