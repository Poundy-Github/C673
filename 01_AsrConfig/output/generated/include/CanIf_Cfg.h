...
#define CANIF_MULTIPLE_DRV_SUPPORT   STD_ON
...
#define CANIF_TRCV_SUPPORT   STD_ON
 ...
 ** Currently, CanIf is configured to be compatible with ASR422.
 */
#if (defined CANIF_CAN_ASR422_COMPATIBILITY)
#error CANIF_CAN_ASR422_COMPATIBILITY already defined!
#endif /* #if( defined CANIF_CAN_ASR422_COMPATIBILITY)*/
#define CANIF_CAN_ASR422_COMPATIBILITY    STD_ON
...
#define CANIF_CFG_SIGNATURE 309991485U
...
#define CANIF_PUBLIC_INFO_SIGNATURE  3439262691U
