/* $Header: linsearch_u8f.c 1.1 2018/04/19 09:35:38CEST Grosu, George (uidl9584) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : linsearch_u8f.c
...
uint8_T linsearch_u8f(real32_T tmp_, const real32_T tmp_0[], uint32_T tmp_1)
{
  uint32_T tmp_3;

  /* Linear Search */
  for (tmp_3 = tmp_1; tmp_ < tmp_0[tmp_3]; tmp_3--) {
  }

  while (tmp_ >= tmp_0[tmp_3 + ((uint32_T)1U)]) {
    tmp_3++;
  }

  return (uint8_T)tmp_3;
}
