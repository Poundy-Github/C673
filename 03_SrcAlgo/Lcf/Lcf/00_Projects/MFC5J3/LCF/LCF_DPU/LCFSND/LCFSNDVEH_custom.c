...
{
	pLcfVehProPorts->pLcfVehOutputData->LaDMC_StrAngReq_deg = (float32)(LAT_Steer_Angle_Command_deg * LADMC_STANGREQ_RES);  //MFC5J3
	pLcfVehProPorts->pLcfVehOutputData->LaDMC_StiffnessReq_nu = (float32)LAT_Stiffness_Request_per;  //MFC5J3
