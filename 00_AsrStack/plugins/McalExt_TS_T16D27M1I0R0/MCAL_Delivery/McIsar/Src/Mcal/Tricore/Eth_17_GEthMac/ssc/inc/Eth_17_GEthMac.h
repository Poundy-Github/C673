...
/* DEM header file */
/*As per requirement Dem.h shall be included in Eth_17_GEthMac.c file. But
the Ethernet module configuration structure defined in Eth_17_GEthMac.h file
refer the data type Dem_EventIdType from Dem module. Hence to avoid
compilation error, Dem.h is included in Eth_17_GEthMac.h file. This is
...
/* DEM error report Disable/Enable. */
