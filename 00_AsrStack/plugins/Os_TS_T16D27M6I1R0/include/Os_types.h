 ...
 *
 * $Id: Os_types.h 31037 2019-11-12 13:20:38Z sash270423 $
*/
 ...
 * Idle mode.
 *
 * Here, only the value(s) common for all architectures are defined.
 * For architecture-specific values, see the architecture-specific headers.
 * Architecture headers can also define extra idle modes, then OS_N_IDLE_MODES must be defined appropriately.
 */
#ifndef OS_ASM
typedef os_uint8_t os_idlemode_t;
#endif

/* !LINKSTO Kernel.Autosar.API.DataTypes.IdleModeType.Constants, 1
 */
#define IDLE_NO_HALT	OS_U(0)

#ifndef OS_N_IDLE_MODES
#define OS_N_IDLE_MODES OS_U(1)
#endif
