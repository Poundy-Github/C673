  ...
  if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].SimpleBridge == TRUE)
  {
    ...
    if(RetVal == E_OK)
    {
     ...
     if((PTPPayloadPtr[ETHTSYN_FUP_AUTOSAR_SUBTLV_START_ADDR] == ETHTSYN_FUP_SUBTLV_TIME_TYPE) &&
      ...
      {
        /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00209, 1 */
...
)
{
     ...
     )
  {
    ...
    {
      /* !LINKSTO EthTSyn.ASR20-11.PRS_TS_00208, 1 */
...
#endif
    {
      ...
      /* Save ProtocolParam from successfully received SyncFUp frame.
       * Shall be returned when EthTSyn_GetProtocolParam() is called */
      EthTSyn_Ctrl[EthTSynCtrlIdx].protocolParam.cumulativeScaledRateOffset =
          (sint32)((sint32)(DataPtr[ETHTSYN_PTP_HEADER_SIZE + ETHTSYN_TIME_STAMP_SIZE +
      ...
      EthTSyn_Ctrl[EthTSynCtrlIdx].protocolParam.lastGmPhaseChange =
          (sint32)((sint32)(DataPtr[ETHTSYN_PTP_HEADER_SIZE + ETHTSYN_TIME_STAMP_SIZE +
