/*! \file **********************************************************************
  ...
  VERSION:                   $Revision: 1.33.1.2 $

  ---*/ /*---
  CHANGES:                   $Log: cml_ext.h  $
  CHANGES:                   Revision 1.33.1.2 2019/06/24 12:22:34CEST Reddy, Purushothama (uid33569) 
  CHANGES:                   updated with QAF warnings handled.
  CHANGES:                   Revision 1.33.1.1 2019/05/27 11:07:45CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   MFC431TA19: QAF L4 fixes added
  CHANGES:                   Revision 1.33 2018/07/26 12:43:11CEST Kotre-EXT, Jeevan (uidk9586) 
  CHANGES:                   ga_global.h has been introduced for ARS540 project.
  CHANGES:                   Revision 1.32 2018/07/16 13:54:03CEST Kotre-EXT, Jeevan (uidk9586) 
  CHANGES:                   cml_type.h has been removed and CML_NO_RTE_DEPENDENCY is undefined.
  CHANGES:                   Revision 1.31 2018/04/26 04:55:24CEST Kotre-EXT, Jeevan (uidk9586) 
  CHANGES:                   Rte_type.h inclusion has been replaced by algo_glob.h.
  CHANGES:                   Revision 1.30 2018/04/10 07:33:45CEST Thomas, Jyothy (uid22555) 
  CHANGES:                   merged changes from v1.28
  CHANGES:                   Revision 1.29 2018/03/29 11:15:25CEST Kotre-EXT, Jeevan (uidk9586) 
  CHANGES:                   added cml_memory.h.
  CHANGES:                   Revision 1.27 2018/01/24 15:00:46CET Henn, Michael (uidg3755) 
  CHANGES:                   Fixing "non-portable include" Warning. (capitalization has to match the file name)
  CHANGES:                   Revision 1.26 2017/11/14 18:41:35CET Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Updated to the code from AL_CML_01.09.13_INT-1
  CHANGES:                   Revision 1.25 2017/08/07 08:59:01CEST Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Updated to include the radar module
  CHANGES:                   Revision 1.24 2017/06/22 16:34:41CEST Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   Updated the include order.
  CHANGES:                   Revision 1.23 2017/06/09 08:18:25CEST Arulkumar-EXT, Nandu (uidr5428) 
  CHANGES:                   - Updated the file includes
...
/* Deactivate QAF warning 0388, Date: 2019-06-18; Reviewer: uid33569;  
   ...
   There is no risk in suppressing. */
/*****************************************************************************
  INCLUDES
*****************************************************************************/
#if ((!defined(GA_ALGO_COMMON_IS_USED)) || (GA_ALGO_COMMON_IS_USED==1))
#include "algo_glob.h"
#else
  #include "ga_global.h"
#endif
...
#include "cml_mtrx.h"
#include "cml_misc.h"
#include "radar/cml_radar.h"
#include "cml_stat.h"
#include "cml_trigo.h"
#include "cml_exp.h"
#include "cml_vector.h"
#include "cml_interpol.h"
#include "cml_memory.h"
#include "cml_ver.h"
