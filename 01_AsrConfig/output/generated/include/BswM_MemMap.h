...
/* Memory section macros for BswM */
    ...
    #error Tried to open section BSWM_START_SEC_CODE within an already open section.
  #else
  ...
  #else
    #undef MEMMAP_ERROR_BSWM
    #error Tried to close section BSWM_STOP_SEC_CODE without prior opening BSWM_START_SEC_CODE.
  #endif

#elif (defined BSWM_START_SEC_CONFIG_DATA_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_BSWM
    #error Tried to open section BSWM_START_SEC_CONFIG_DATA_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_BSWM
    #error Tried to close section BSWM_STOP_SEC_CONFIG_DATA_UNSPECIFIED without prior opening BSWM_START_SEC_CONFIG_DATA_UNSPECIFIED.
  #endif

#elif (defined BSWM_START_CONFIG_DATA_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_BSWM
    #error Tried to open section BSWM_START_CONFIG_DATA_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_BSWM
    #error Tried to close section BSWM_STOP_CONFIG_DATA_UNSPECIFIED without prior opening BSWM_START_CONFIG_DATA_UNSPECIFIED.
  #endif

#elif (defined BSWM_START_SEC_CONST_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_BSWM
    #error Tried to open section BSWM_START_SEC_CONST_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_BSWM
    #error Tried to close section BSWM_STOP_SEC_CONST_UNSPECIFIED without prior opening BSWM_START_SEC_CONST_UNSPECIFIED.
  #endif

#elif (defined BSWM_START_SEC_VAR_CLEARED_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_BSWM
    #error Tried to open section BSWM_START_SEC_VAR_CLEARED_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_BSWM
    #error Tried to close section BSWM_STOP_SEC_VAR_CLEARED_UNSPECIFIED without prior opening BSWM_START_SEC_VAR_CLEARED_UNSPECIFIED.
  #endif

#elif (defined BSWM_START_SEC_VAR_INIT_UNSPECIFIED)
  #ifdef MEMMAP_SECTION_OPENED
    #undef MEMMAP_ERROR_BSWM
    #error Tried to open section BSWM_START_SEC_VAR_INIT_UNSPECIFIED within an already open section.
  #else
    #define MEMMAP_SECTION_OPENED
  ...
  #else
    #undef MEMMAP_ERROR_BSWM
    #error Tried to close section BSWM_STOP_SEC_VAR_INIT_UNSPECIFIED without prior opening BSWM_START_SEC_VAR_INIT_UNSPECIFIED.
  #endif
