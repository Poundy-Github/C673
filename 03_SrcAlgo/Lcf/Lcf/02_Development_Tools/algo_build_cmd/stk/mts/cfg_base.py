                ...
                if mode == '1':
                    ...
                    for prop_line in sections[key]:
                        ...
                        if len(prop_split) > 1:
                            ...
                            log.Logger.error('error in properties in line %s!' % prop_line)
...
if __name__ == '__main__':
    ...
    logger = log.Logger(str(sys._getframe().f_code.co_name), log.INFO)
    ...
    if not cmd_options[1]:
        ...
        if cmd_options[0].mode not in MODES.keys():
            ...
            for filecount in range(len(infiles)):
                ...
                if outfiles[filecount] in infiles:
                ...
                elif os.path.isfile(outfiles[filecount]):
                    ...
                    go_on = str(raw_input('   press Enter to continue or any key to break\n'))
                    if go_on:
