/* $Header: rt_look1d32.c 1.1 2018/01/24 16:30:02CET Asong, Wedndah Asaha (uidj2187) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : rt_look1d32.c
...
/* 1D lookup routine for data type of real32_T. */
real32_T rt_Lookup32(const real32_T *x, int_T xlen, real32_T u, const real32_T
                     *y)
{
