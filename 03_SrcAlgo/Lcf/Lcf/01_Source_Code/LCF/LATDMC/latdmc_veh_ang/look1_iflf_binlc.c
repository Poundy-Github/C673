/* $Header: look1_iflf_binlc.c 1.1 2018/01/24 16:29:54CET Asong, Wedndah Asaha (uidj2187) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : look1_iflf_binlc.c
   C source code generated on           : Mon Nov 30 12:20:55 2015
   Filename of Simulink Model           : DMC_Lat.mdl
   Revision of Simulink Model           : 1.1968
 ***************************************************************************************************
...
real32_T look1_iflf_binlc(real32_T tmp_, const real32_T tmp_0[], const real32_T
  tmp_1[], uint32_T tmp_2)
{
  ...
  if (tmp_ <= tmp_0[(uint8_T)0U]) {
    ...
    tmp_4 = (tmp_ - tmp_0[tmp_6]) / (tmp_0[tmp_6 + ((uint32_T)1U)] - tmp_0[tmp_6]);
  } else {
   ...
   */
  return ((tmp_1[tmp_6 + ((uint32_T)1U)] - tmp_1[tmp_6]) * tmp_4) + tmp_1[tmp_6];
}
