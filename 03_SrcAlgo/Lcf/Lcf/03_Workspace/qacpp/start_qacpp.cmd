...
if "%Prj%" == "1" (
  start C:\tools\qacpp\2.5\bin\QACPPANL.exe %PATH_QAC_PRJ_FILE%_mfc431.prj
) else if "%Prj%" == "2" (
  start C:\tools\qacpp\2.5\bin\QACPPANL.exe %PATH_QAC_PRJ_FILE%_mfc430hi17.prj
) else if "%Prj%" == "3" (
  start C:\tools\qacpp\2.5\bin\QACPPANL.exe %PATH_QAC_PRJ_FILE%_hfl110.prj
) else if "%Prj%" == "4" (
  start C:\tools\qacpp\2.5\bin\QACPPANL.exe %PATH_QAC_PRJ_FILE%_hfl110ta10.prj
) else if "%Prj%" == "5" (
  start C:\tools\qacpp\2.5\bin\QACPPANL.exe %PATH_QAC_PRJ_FILE%_ars441.prj
) else (
  echo Invalid Option !
  pause
)
