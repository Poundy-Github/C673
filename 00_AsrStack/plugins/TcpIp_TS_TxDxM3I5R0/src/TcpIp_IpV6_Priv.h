...
/** \brief ICMP Echo request */
#define TCPIP_IPV6_ICMP_CODE_ECHO                                     0U
/** \brief ICMP code neighbor discovery protocol */
#define TCPIP_IPV6_ICMP_CODE_NDP                                      0U
...
/** \brief Reads and resets dropped datagrams caused by invalid codes for ICMPv6 packets
 *
 * This function reads and resets dropped datagrams caused by invalid codes for ICMPv6 packets.
 *
 * \param[in] MeasurementResetNeeded   Flag to trigger a reset of the measurement
 * \param[out] MeasurementDataPtr      Reference to data buffer
 */
TS_MOD_PRIV_DECL FUNC(void, TCPIP_CODE) TcpIp_IpV6_GetAndResetInvalidIcmpCodeCount
(
  boolean MeasurementResetNeeded,
  P2VAR(uint32, AUTOMATIC, TCPIP_APPL_DATA) MeasurementDataPtr
);
