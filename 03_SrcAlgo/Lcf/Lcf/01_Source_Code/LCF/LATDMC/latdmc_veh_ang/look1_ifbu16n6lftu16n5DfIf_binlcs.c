/* $Header: look1_ifbu16n6lftu16n5DfIf_binlcs.c 1.1 2018/01/24 16:29:52CET Asong, Wedndah Asaha (uidj2187) none  $ */
 ...
 ***************************************************************************************************
   Filename of C source                 : look1_ifbu16n6lftu16n5DfIf_binlcs.c
   C source code generated on           : Tue Dec 05 09:26:49 2017
...
real32_T look1_ifbu16n6lftu16n5DfIf_binlcs(real32_T tmp_, const uint16_T tmp_0[],
  const uint16_T tmp_1[], uint32_T tmp_2)
{
   ...
   */
  return (((((real32_T)tmp_1[tmp_6 + ((uint32_T)1U)]) * 0.03125F) - (((real32_T)
             tmp_1[tmp_6]) * 0.03125F)) * tmp_4) + (((real32_T)tmp_1[tmp_6]) *
    0.03125F);
}
