#ifndef RTE_ESM_CORE1_H
#define RTE_ESM_CORE1_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
/*
 * This file contains Rte component declarations for component type Esm_Core1
 *
...
/* ==================[Types]================================================== */
#ifndef RTE_CORE /* if included by software component */
typedef CONSTP2CONST(Rte_CDS_Esm_Core1, TYPEDEF, RTE_CONST) Rte_Instance;
#endif

/* ==================[Definition of variables with external linkage]========== */
#define RTE_START_SEC_OSAPPLICATION_C1_CONST_8
#include <Rte_MemMap.h>
extern CONST(Rte_CDS_Esm_Core1, RTE_CONST) Rte_Instance_Esm_Core1;
#define RTE_STOP_SEC_OSAPPLICATION_C1_CONST_8
#include <Rte_MemMap.h>
#define RTE_START_SEC_OSAPPLICATION_C1_CONST_UNSPECIFIED
#include <Rte_MemMap.h>
extern CONSTP2CONST(Rte_CDS_Esm_Core1, RTE_CONST, RTE_CONST) Rte_Inst_Esm_Core1;
...
extern FUNC(void, RTE_CODE) Esm_Core1_InitFunction (void);

extern FUNC(void, RTE_CODE) Esm_Core1_MainFunction (void);
