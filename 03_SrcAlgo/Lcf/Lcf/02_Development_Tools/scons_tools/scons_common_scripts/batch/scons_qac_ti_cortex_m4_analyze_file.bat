...
REM  FILE NAME: batch\scons_qac_ti_cortex_m4_analyze_file.bat
...
REM #############################################################################
REM  CHANGES:                   $Log: scons_qac_ti_cortex_m4_analyze_file.bat  $
...
REM  CHANGES:                   Revision 1.1 2015/09/30 07:41:21CEST Singh, Vishal (uidj9083) 
REM  CHANGES:                   Initial revision
...
call scons.bat build_from_ide=1 %component%_qac_ti_cortex_m4 qac_source=%2
popd