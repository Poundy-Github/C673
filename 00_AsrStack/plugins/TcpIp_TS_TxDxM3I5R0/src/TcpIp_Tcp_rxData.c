...
/** \brief Reads and resets dropped datagrams caused by invalid destination TCP-Port
 *
 ...
 */
STATIC FUNC(void, TCPIP_CODE) TcpIp_Tcp_GetAndResetInvalidSocketCount
(
  boolean MeasurementResetNeeded,
  P2VAR(uint32, AUTOMATIC, TCPIP_APPL_DATA) MeasurementDataPtr
);

/** \brief Reads and resets dropped datagrams caused by invalid packet format for TCP packets
 *
 * This function reads and resets dropped datagrams caused by invalid packet format for TCP packets.
 *
 * \param[in] MeasurementResetNeeded   Flag to trigger a reset of the measurement
 * \param[out] MeasurementDataPtr      Reference to data buffer
 */
STATIC FUNC(void, TCPIP_CODE) TcpIp_Tcp_GetAndResetInvalidPacketFormatCount
(
  boolean MeasurementResetNeeded,
  P2VAR(uint32, AUTOMATIC, TCPIP_APPL_DATA) MeasurementDataPtr
);

/** \brief Reads and resets dropped datagrams caused by invalid checksum for TCP packets
 *
 * This function reads and resets dropped datagrams caused by invalid checksum for TCP packets.
 *
 * \param[in] MeasurementResetNeeded   Flag to trigger a reset of the measurement
 * \param[out] MeasurementDataPtr      Reference to data buffer
 */
STATIC FUNC(void, TCPIP_CODE) TcpIp_Tcp_GetAndResetInvalidChecksumCount
(
  boolean MeasurementResetNeeded,
  P2VAR(uint32, AUTOMATIC, TCPIP_APPL_DATA) MeasurementDataPtr
);
...
STATIC VAR(uint32, TCPIP_VAR) TcpIp_Tcp_InvalidChecksumCounter = 0U;
STATIC VAR(uint32, TCPIP_VAR) TcpIp_Tcp_InvalidPacketFormatCounter = 0U;
...
#if (TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON)
TS_MOD_PRIV_DEFN FUNC(void, TCPIP_CODE) TcpIp_Tcp_GetAndResetCounter
(
...
{
  DBG_TCPIP_TCP_GETANDRESETCOUNTER_ENTRY(MeasurementIdx, MeasurementResetNeeded, MeasurementDataPtr);
  ...
  switch(MeasurementIdx)
  {
    case TCPIP_MEAS_DROP_TCP:
      ...
      break;
    case TCPIP_MEAS_DROP_INVALID_PACKET_FORMAT_TCP:
      TcpIp_Tcp_GetAndResetInvalidPacketFormatCount(MeasurementResetNeeded, MeasurementDataPtr);
      break;
    case TCPIP_MEAS_DROP_INVALID_CHECKSUM_TCP:
      TcpIp_Tcp_GetAndResetInvalidChecksumCount(MeasurementResetNeeded, MeasurementDataPtr);
      break;
    case TCPIP_MEAS_ALL:
      TcpIp_Tcp_GetAndResetInvalidSocketCount(TRUE, NULL_PTR);
      TcpIp_Tcp_GetAndResetInvalidPacketFormatCount(TRUE, NULL_PTR);
      TcpIp_Tcp_GetAndResetInvalidChecksumCount(TRUE, NULL_PTR);
      break;
    /* CHECK: NOPARSE */
    default:
  ...
  DBG_TCPIP_TCP_GETANDRESETCOUNTER_EXIT(MeasurementIdx, MeasurementResetNeeded, MeasurementDataPtr);
}
...
)
{
  ...
  else if(calculateChecksum == TRUE)
  {
      ...
      )
    {
      ...
      /* !LINKSTO TcpIp.Design.Tcp.EA6.rxIndication,1 */
      SchM_Enter_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
      if(TcpIp_Tcp_InvalidChecksumCounter < 0xFFFFFFFFU)
      {
        /* !LINKSTO TcpIp.Design.Tcp.Atomic.GetAndResetInvalidTcpChecksum,1 */
        TS_AtomicAssign32(TcpIp_Tcp_InvalidChecksumCounter, (TcpIp_Tcp_InvalidChecksumCounter+1U));
      }
      /* !LINKSTO TcpIp.Design.Tcp.EA6.rxIndication,1 */
      SchM_Exit_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
#endif /* TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON */
...
#if (TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON)
  if(result == TCPIP_IP_RX_INVALID_HEADER)
  {
    /* invalid Tcp packet format */
    /* increment counter of dropped PDUs caused by invalid Tcp packet format */
    /* !LINKSTO TcpIp.Design.Tcp.EA6.rxIndication,1 */
    SchM_Enter_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
    if(TcpIp_Tcp_InvalidPacketFormatCounter < 0xFFFFFFFFU)
    {
      /* !LINKSTO TcpIp.Design.Tcp.Atomic.GetAndResetInvalidTcpPacketFormatCount,1 */
      TS_AtomicAssign32(TcpIp_Tcp_InvalidPacketFormatCounter, (TcpIp_Tcp_InvalidPacketFormatCounter+1U));
    }
    /* !LINKSTO TcpIp.Design.Tcp.EA6.rxIndication,1 */
    SchM_Exit_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
  }
...
)
{
  ...
  {
    /* !LINKSTO TcpIp.Design.Tcp.Atomic.GetAndResetInvalidTcpPacketFormatCount,1 */
    TS_AtomicAssign32(*MeasurementDataPtr, TcpIp_Tcp_InvalidPacketFormatCounter);
  }
  if(MeasurementResetNeeded)
  {
    /* !LINKSTO TcpIp.Design.Tcp.Atomic.GetAndResetInvalidTcpPacketFormatCount,1 */
    TS_AtomicAssign32(TcpIp_Tcp_InvalidPacketFormatCounter, 0U);
  }
}
...
)
{
  ...
  {
    /* !LINKSTO TcpIp.Design.Tcp.Atomic.GetAndResetInvalidTcpChecksum,1 */
    TS_AtomicAssign32(*MeasurementDataPtr, TcpIp_Tcp_InvalidChecksumCounter);
  }
  if(MeasurementResetNeeded)
  {
    /* !LINKSTO TcpIp.Design.Tcp.Atomic.GetAndResetInvalidTcpChecksum,1 */
    TS_AtomicAssign32(TcpIp_Tcp_InvalidChecksumCounter, 0U);
  }
}
#endif /* TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON */
