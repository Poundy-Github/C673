 ...
 *  \retval E_NOT_OK:  Partition was not restarted
 */
extern FUNC(Std_ReturnType, WDGM_CODE) [!"$RequestPartitionResetCalloutName"!]
(
 ...
 *  \return Success of operation.
 *  \retval E_OK:     No errors.
 *  \retval E_NOT_OK:  Application is not valid
 */
extern FUNC(Std_ReturnType, WDGM_CODE) [!"$GetApplicationStateCalloutName"!]
(
  ApplicationType Application,
