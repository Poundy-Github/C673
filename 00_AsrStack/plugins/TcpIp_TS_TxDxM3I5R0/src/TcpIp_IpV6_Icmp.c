 ...
 * \param[in] code             code of ICMP message
 *
...
#if ((TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON) && (TCPIP_ICMPV6_RX_FCT_ENABLED == STD_OFF))
/** \brief Increment TcpIp_IpV6_Icmp_InvalidCodeCounter value
 *
 * This function will increment TcpIp_IpV6_Icmp_InvalidCodeCounter if max value is not reached.
 *
 ...
 */
STATIC FUNC(void, TCPIP_CODE) TcpIp_IpV6_IncrementInvalidIcmpCodeCount
(
  void
);
#endif /* (TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON) && (TCPIP_ICMPV6_RX_FCT_ENABLED == STD_OFF) */
...
STATIC VAR(uint32, TCPIP_VAR) TcpIp_IpV6_Icmp_InvalidCodeCounter = 0U;
    ...
    if(lenByte >= TCPIP_IPV6_ICMP_HEADER_LENGTH)
    {
      ...
      if(checksum == 0U)
      {
        ...
        if(((type == TCPIP_IPV6_ICMP_TYPE_NEIGHBOR_SOLICIT) ||
           ...
           (code == TCPIP_IPV6_ICMP_CODE_ECHO))
        {
          /* handle Ndp message */
        ...
        else if(TcpIp_IpV6_Icmp_checkForEchoRequest(localIpAddrPtr, type, code))
        {
...
TS_MOD_PRIV_DEFN FUNC(void, TCPIP_CODE) TcpIp_IpV6_GetAndResetInvalidIcmpCodeCount
(
  boolean MeasurementResetNeeded,
  P2VAR(uint32, AUTOMATIC, TCPIP_APPL_DATA) MeasurementDataPtr
)
{
  ...
  {
    /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidIcmpCount,1 */
    TS_AtomicAssign32(*MeasurementDataPtr, TcpIp_IpV6_Icmp_InvalidCodeCounter);
  }
  if(MeasurementResetNeeded)
  {
    /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidIcmpCount,1 */
    TS_AtomicAssign32(TcpIp_IpV6_Icmp_InvalidCodeCounter, 0U);
  }
...
)
{
  ...
  if((icmpParameterPtr->code == TCPIP_IPV6_ICMP_CODE_NDP) &&
...
)
{
  ...
  if(type == TCPIP_IPV6_ICMP_TYPE_ECHO_REQUEST)
  {
    if(code == TCPIP_IPV6_ICMP_CODE_ECHO)
    {
      if(TCPIP_IPV6_ICMP_ECHO_REPLY_IS_ENABLED)
      {
    ...
    {
      /* Increment TcpIp_IpV6_Icmp_InvalidCodeCounter */
      TcpIp_IpV6_IncrementInvalidIcmpCodeCount();
    }
#endif /* (TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON) && (TCPIP_ICMPV6_RX_FCT_ENABLED == STD_OFF) */
  }
#if ((TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON) && (TCPIP_ICMPV6_RX_FCT_ENABLED == STD_OFF))
  else
  {
    if((type == TCPIP_IPV6_ICMP_TYPE_NEIGHBOR_SOLICIT) ||
       ...
       (type == TCPIP_IPV6_ICMP_TYPE_ROUTER_ADVERT))
    {
      /* Increment counter of dropped frames caused by invalid ICMv6 code because NDP type was correct */
      TcpIp_IpV6_IncrementInvalidIcmpCodeCount();
    }
    else
    {
      /* Increment counter of dropped frames caused by invalid ICMv6 type */
      ...
      {
        /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidIcmpCount,1 */
        TS_AtomicAssign32(TcpIp_IpV6_Icmp_InvalidTypeCounter, (TcpIp_IpV6_Icmp_InvalidTypeCounter+1U));
      }
      /* !LINKSTO TcpIp.Design.IpV6.EA6.rxIndication,1 */
...
{
  /* increment counter of dropped frames caused by invalid code in ICMv6 packets */
  /* !LINKSTO TcpIp.Design.IpV6.EA6.rxIndication,1 */
  SchM_Enter_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
  if(TcpIp_IpV6_Icmp_InvalidCodeCounter < 0xFFFFFFFFU)
  {
     /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidIcmpCodeCount,1 */
     TS_AtomicAssign32(TcpIp_IpV6_Icmp_InvalidCodeCounter, (TcpIp_IpV6_Icmp_InvalidCodeCounter+1U));
  }
  /* !LINKSTO TcpIp.Design.IpV6.EA6.rxIndication,1 */
  SchM_Exit_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
}
