...
)
{
   ...
   * Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_RSA_RSASSA_PSS_Reset function to call the
...
{
  switch(Crypto_xVIx_xAIx_RsaSsaPssVerifyCtx.Job->jobPrimitiveInfo->primitiveInfo->algorithm.secondaryFamily)
  {
#if(                                                    \
