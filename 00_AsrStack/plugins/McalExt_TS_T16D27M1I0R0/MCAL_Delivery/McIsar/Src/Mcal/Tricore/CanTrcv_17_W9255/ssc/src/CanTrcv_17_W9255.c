...
/* Check if Autosar version is AR440 */
    ...
    (CANTRCV_17_W9255_RUNTIME_ERROR_DETECT == STD_ON)
        #include "Det.h"
    #endif
#else
...
#if (CANTRCV_17_W9255_SW_MINOR_VERSION != 0U)
#error "CANTRCV_17_W9255_SW_MINOR_VERSION does not match. "
#endif

#if (CANTRCV_17_W9255_SW_PATCH_VERSION != 1U)
...
/* Wake-up reason bit posion */
#define CANTRCV_17_W9255_WU_REG_BIT_POS                      0

/* Wake-up reason data length */
#define CANTRCV_17_W9255_WU_REG_BIT_LEN                      31
  ...
  #endif
  {
                ...
                (ReturnValue == E_OK)); ChannelIndex++)
    {
      ...
      if(ReturnValue == E_OK)
      {
        ...
        Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WuReason[ChannelId]),
        CANTRCV_17_W9255_WU_REG_BIT_POS, CANTRCV_17_W9255_WU_REG_BIT_LEN,
                          CANTRCV_WU_RESET);
...
)
{
  ...
  #endif
  {
    ...
    if (TrcvWakeupMode == CANTRCV_WUMODE_ENABLE)
    {
      ...
      Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WakeupMode[Transceiver]),
                        CANTRCV_17_W9255_WU_REG_BIT_POS,
                        CANTRCV_17_W9255_WU_REG_BIT_LEN,
    ...
    if (ReturnValue == E_OK)
    {
           ...
           CANTRCV_17_W9255_SYSERR_CHECK))
      {
             ...
             == CANTRCV_17_W9255_WUF_CHECK))
        {
          ...
          Mcal_SetBitAtomic(&(CanTrcv_17_W9255_WuReason[Transceiver]),
                            CANTRCV_17_W9255_WU_REG_BIT_POS,
                            CANTRCV_17_W9255_WU_REG_BIT_LEN,
                            CANTRCV_WU_BY_BUS);
        }
      ...
      if(DetRaise == CANTRCV_17_W9255_REPORT_DET)
      {
        /* Runtime Error Detection is only available in Autosar version AR440 */
            ...
            /* Check Runtime error is ON */
                  ...
                  (void)Det_ReportRuntimeError(CANTRCV_17_W9255_MODULE_ID,
