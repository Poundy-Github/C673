 ...
 *
 * $Id: Os_api.h 33637 2021-04-07 07:51:31Z dypa272654 $
*/
 ...
 * !LINKSTO Kernel.Autosar.API.DataTypes.ApplicationStateType.Constants, 1
*/
...
/* Total number of cores available in the microcontroller */
/* !LINKSTO Kernel.Autosar.Constant.TotalNumberOfCores, 1 */
#define TotalNumberOfCores		OS_N_CORES_MAX
...
/* AUTOSAR API
*/
extern os_result_t OS_UserActivateTaskAsyn(os_taskid_t);
extern os_result_t OS_UserSetEventAsyn(os_taskid_t, os_eventmask_t);
...
extern os_result_t OS_UserEnableInterruptSource(os_isrid_t, os_boolean_t);
extern os_result_t OS_UserClearPendingInterrupt(os_isrid_t);
...
extern os_applicationid_t OS_UserGetCurrentApplicationId(void);
...
extern os_result_t OS_UserControlIdle(os_coreid_t, os_idlemode_t);
 ...
 * !LINKSTO Kernel.Autosar.ErrorHandling.ServiceId.DisableInterruptSource, 1
*/
#define DisableInterruptSource(i)					OS_DisableInterruptSource(i)
 ...
 * !LINKSTO Kernel.Autosar.ErrorHandling.ServiceId.EnableInterruptSource, 1
*/
#define EnableInterruptSource(i, f)				OS_UserEnableInterruptSource((i),(f))
#define OS_EnableInterruptSource(i)					EnableInterruptSource((i), 0)
#define OSServiceID_EnableInterruptSource			OS_SID_EnableInterruptSource
#define OSError_EnableInterruptSource_ISRID()		((ISRType)(OS_GetKernelData()->errorStatus.parameter[0]))
#define OSError_EnableInterruptSource_ClearPending()	((ISRType)(OS_GetKernelData()->errorStatus.parameter[1]))
/* !LINKSTO Kernel.API.InterruptHandling.ClearPendingInterrupt.API, 1
 * !LINKSTO Kernel.Autosar.ErrorHandling.ServiceId.ClearPendingInterrupt, 1
*/
#define ClearPendingInterrupt(i)					OS_UserClearPendingInterrupt(i)
#define OSServiceID_ClearPendingInterrupt			OS_SID_ClearPendingInterrupt
#define OSError_ClearPendingInterrupt_ISRID()		((ISRType)(OS_GetKernelData()->errorStatus.parameter[0]))
...
#define OS_GetStackInfo(t, s)				OS_UserGetStackInfo(t, s)
#define OSServiceId_GetStackInfo			OS_SID_GetStackInfo
...
#define ActivateTaskAsyn(t)			(void)OS_UserActivateTaskAsyn(t)
...
#define SetEventAsyn(t,e)			(void)OS_UserSetEventAsyn((t),(e))
 ...
 * !LINKSTO Kernel.Autosar.ErrorHandling.ServiceId.ActivateTaskAsyn, 1
 * !LINKSTO Kernel.Autosar.ErrorHandling.ServiceId.SetEventAsyn, 1
*/
#define OSServiceId_ActivateTask			OS_SID_ActivateTask
#define OSServiceId_ActivateTaskAsyn		OS_SID_ActivateTaskAsyn
...
#define OSServiceId_SetEventAsyn			OS_SID_SetEventAsyn
...
#define OSServiceId_TryToGetSpinlock		OS_SID_TryToGetSpinlock
#define OSServiceId_ReleaseSpinlock			OS_SID_ReleaseSpinlock
 ...
 * !LINKSTO Kernel.Autosar.API.DataTypes.IdleModeType, 1
 * !LINKSTO Kernel.Autosar.API.DataTypes.ApplicationStateType, 1
 * !LINKSTO Kernel.Autosar.API.DataTypes.ApplicationStateRefType, 1
*/
...
typedef os_idlemode_t           IdleModeType;
#endif
 ...
 * terms of the OS system-call stubs
 *
 * !LINKSTO Kernel.Autosar.API.SystemServices.GetApplicationID, 3
 ...
 * !LINKSTO Kernel.Autosar.API.SystemServices.GetCurrentApplicationID, 1
*/
...
#define ControlIdle(c,m)				OS_UserControlIdle((c),(m))
#define GetCoreID()						OS_GetCoreId()
#define GetNumberOfActivatedCores()		OS_N_CORES
#define GetCurrentApplicationID()		OS_UserGetCurrentApplicationId()
 ...
 * terms of the OS SIDs
 * !LINKSTO Kernel.Autosar.ErrorHandling.ServiceId.ControlIdle, 1
*/
...
#define OSServiceID_ControlIdle				OS_SID_ControlIdle
#define OSServiceID_GetCurrentApplicationId	OS_SID_GetCurrentApplicationId
...
#define OSError_ControlIdle_CoreID()						((CoreIdType)						(OS_GetKernelData()->errorStatus.parameter[0]))
#define OSError_ControlIdle_IdleMode()						((IdleModeType)						(OS_GetKernelData()->errorStatus.parameter[1]))
/* CHECK: RESTORE
*/
