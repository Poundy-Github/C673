...
#if (defined(Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Start)) && (RTE_VFB_TRACE == FALSE)
#undef Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Start
#endif
#if defined(Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Start)
#undef Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Start
extern FUNC(void, RTE_APPL_CODE) Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Start (uint8 mode);
#else
#define Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Start(mode) ((void)0)
#endif
#if (defined(Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Return)) && (RTE_VFB_TRACE == FALSE)
#undef Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Return
#endif
#if defined(Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Return)
#undef Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Return
extern FUNC(void, RTE_APPL_CODE) Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Return (uint8 mode);
#else
#define Rte_SwitchHook_ComM_UM_ComMUser_Public_currentMode_Return(mode) ((void)0)
#endif
#if (defined(Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Start)) && (RTE_VFB_TRACE == FALSE)
#undef Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Start
#endif
#if defined(Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Start)
#undef Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Start
extern FUNC(void, RTE_APPL_CODE) Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Start (uint8 mode);
#else
#define Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Start(mode) ((void)0)
#endif
#if (defined(Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Return)) && (RTE_VFB_TRACE == FALSE)
#undef Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Return
#endif
#if defined(Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Return)
#undef Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Return
extern FUNC(void, RTE_APPL_CODE) Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Return (uint8 mode);
#else
#define Rte_SwitchHook_ComM_UM_ComMUser_Private_currentMode_Return(mode) ((void)0)
#endif
...
#endif
#if (defined(Rte_Runnable_ComM_RE_Main_1_Start)) && (RTE_VFB_TRACE == FALSE)
#undef Rte_Runnable_ComM_RE_Main_1_Start
#endif
#if defined(Rte_Runnable_ComM_RE_Main_1_Start)
#undef Rte_Runnable_ComM_RE_Main_1_Start
extern FUNC(void, RTE_APPL_CODE) Rte_Runnable_ComM_RE_Main_1_Start (void);
#else
#define Rte_Runnable_ComM_RE_Main_1_Start() ((void)0)
#endif
#if (defined(Rte_Runnable_ComM_RE_Main_1_Return)) && (RTE_VFB_TRACE == FALSE)
#undef Rte_Runnable_ComM_RE_Main_1_Return
#endif
#if defined(Rte_Runnable_ComM_RE_Main_1_Return)
#undef Rte_Runnable_ComM_RE_Main_1_Return
extern FUNC(void, RTE_APPL_CODE) Rte_Runnable_ComM_RE_Main_1_Return (void);
#else
#define Rte_Runnable_ComM_RE_Main_1_Return() ((void)0)
#endif
