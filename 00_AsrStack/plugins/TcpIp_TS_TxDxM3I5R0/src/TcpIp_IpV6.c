...
/** \brief Reads and resets dropped datagrams caused by invalid IPv6 packet format
 *
 * This function reads and resets dropped datagrams caused by invalid IPv6 packet format.
 *
 * \param[in] MeasurementResetNeeded   Flag to trigger a reset of the measurement
 * \param[out] MeasurementDataPtr      Reference to data buffer
 */
STATIC FUNC(void, TCPIP_CODE) TcpIp_IpV6_GetAndResetInvalidPacketFormatCount
(
  boolean MeasurementResetNeeded,
  P2VAR(uint32, AUTOMATIC, TCPIP_APPL_DATA) MeasurementDataPtr
);

/** \brief Reads and resets dropped datagrams caused by invalid IPv6 extension header
 *
 * This function reads and resets dropped datagrams caused by invalid IPv6 extension header.
 *
 * \param[in] MeasurementResetNeeded   Flag to trigger a reset of the measurement
 * \param[out] MeasurementDataPtr      Reference to data buffer
 */
STATIC FUNC(void, TCPIP_CODE) TcpIp_IpV6_GetAndResetInvalidExtHeaderCount
(
  boolean MeasurementResetNeeded,
  P2VAR(uint32, AUTOMATIC, TCPIP_APPL_DATA) MeasurementDataPtr
);
...
STATIC VAR(uint32, TCPIP_VAR) TcpIp_IpV6_InvalidPacketFormatCounter = 0U;
STATIC VAR(uint32, TCPIP_VAR) TcpIp_IpV6_InvalidExtHeaderCounter = 0U;
...
)
{
  ...
  {
    /* invalid IPv6 packet format */
    /* increment counter of dropped PDUs caused by invalid packet format */
    /* !LINKSTO TcpIp.Design.IpV6.EA6.rxIndication,1 */
    SchM_Enter_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
    if(TcpIp_IpV6_InvalidPacketFormatCounter < 0xFFFFFFFFU)
    {
      /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidPacketFormatCount,1 */
      TS_AtomicAssign32(TcpIp_IpV6_InvalidPacketFormatCounter, (TcpIp_IpV6_InvalidPacketFormatCounter+1U));
    }
    /* !LINKSTO TcpIp.Design.IpV6.EA6.rxIndication,1 */
    SchM_Exit_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
  }
...
)
{
  ...
  switch(MeasurementIdx)
  {
    ...
    case TCPIP_MEAS_DROP_ICMPV6:
      ...
      break;
    case TCPIP_MEAS_DROP_INVALID_CODE_ICMPV6:
      TcpIp_IpV6_GetAndResetInvalidIcmpCodeCount(MeasurementResetNeeded, MeasurementDataPtr);
      break;
    case TCPIP_MEAS_DROP_INVALID_PACKET_FORMAT_IPV6:
      TcpIp_IpV6_GetAndResetInvalidPacketFormatCount(MeasurementResetNeeded, MeasurementDataPtr);
      break;
    case TCPIP_MEAS_DROP_INVALID_EXTENSION_HEADER_IPV6:
      TcpIp_IpV6_GetAndResetInvalidExtHeaderCount(MeasurementResetNeeded, MeasurementDataPtr);
      break;
    case TCPIP_MEAS_ALL:
      TcpIp_IpV6_GetAndResetInvalidIpAddrCount(TRUE, NULL_PTR);
      TcpIp_IpV6_GetAndResetInvalidIcmpCount(TRUE, NULL_PTR);
      TcpIp_IpV6_GetAndResetInvalidIcmpCodeCount(TRUE, NULL_PTR);
      TcpIp_IpV6_GetAndResetInvalidPacketFormatCount(TRUE, NULL_PTR);
      TcpIp_IpV6_GetAndResetInvalidExtHeaderCount(TRUE, NULL_PTR);
      break;
    /* CHECK: NOPARSE */
    default:
    ...
    else
    {
      ...
      if(RxRetCode == TCPIP_IP_RX_EXT_HDR_OK)
      {
       ...
       if(!TcpIp_IpV6_getExtensionHeaderFilter(currentHeader, localAddrId))
       {
         ...
         /* increment counter of dropped PDUs caused by invalid extension header */
         /* !LINKSTO TcpIp.Design.IpV6.EA6.rxIndication,1 */
         SchM_Enter_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
         if(TcpIp_IpV6_InvalidExtHeaderCounter < 0xFFFFFFFFU)
         {
           /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidExtHeaderCount,1 */
           TS_AtomicAssign32(TcpIp_IpV6_InvalidExtHeaderCounter, (TcpIp_IpV6_InvalidExtHeaderCounter+1U));
         }
         /* !LINKSTO TcpIp.Design.IpV6.EA6.rxIndication,1 */
         SchM_Exit_TcpIp_SCHM_TCPIP_EXCLUSIVE_AREA_6();
#endif /* TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON */
...
)
{
  ...
  {
    /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidPacketFormatCount,1 */
    TS_AtomicAssign32(*MeasurementDataPtr, TcpIp_IpV6_InvalidPacketFormatCounter);
  }
  if(MeasurementResetNeeded)
  {
    /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidPacketFormatCount,1 */
    TS_AtomicAssign32(TcpIp_IpV6_InvalidPacketFormatCounter, 0U);
  }
}
...
)
{
  ...
  {
    /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidExtHeaderCount,1 */
    TS_AtomicAssign32(*MeasurementDataPtr, TcpIp_IpV6_InvalidExtHeaderCounter);
  }
  if(MeasurementResetNeeded)
  {
    /* !LINKSTO TcpIp.Design.IpV6.Atomic.GetAndResetInvalidExtHeaderCount,1 */
    TS_AtomicAssign32(TcpIp_IpV6_InvalidExtHeaderCounter, 0U);
  }
}
#endif /* TCPIP_GETANDRESETMEASUREMENTDATA_API == STD_ON */
