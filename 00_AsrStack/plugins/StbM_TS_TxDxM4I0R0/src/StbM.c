...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00246,1 */
#include <EthIf.h>
...
/* minor version check */
#if (STBM_AR_RELEASE_MINOR_VERSION != 6U )
#error STBM_AR_RELEASE_MINOR_VERSION wrong (!= 6U)
#endif
...
#error STBM_SW_MAJOR_VERSION wrong (!= 4U)
#endif
...
#if (STBM_SYNC_TIME_RECORDING_USED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00308.Blocks,1 */
...
#if (STBM_OFFSET_TIME_RECORDING_USED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00311.Blocks,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00480,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00478,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00351,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_91006,1 */
...
)
{
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetCurrentVirtualLocalTime,1 */
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00445,1 */
    STBM_DET_REPORTERROR(STBM_API_GETCURRENTVIRTUALLOCALTIME, STBM_E_PARAM);
  }
  else if (localTimePtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00444,1 */
    STBM_DET_REPORTERROR(STBM_API_GETCURRENTVIRTUALLOCALTIME, STBM_E_PARAM_POINTER);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00437.Sync.ReturnVLT,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00437.Pure.ReturnVLT,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00437.Offset.ReturnVLT,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00437.Sync.E_NOT_OK,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00437.Pure.E_NOT_OK,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00437.Offset.E_NOT_OK,1 */
...
)
{
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00435.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00446.NotConfigured,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_91005,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00435.TimeTuple.VLT.DerivedFrom.Os,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00435.TimeTuple.VLT.DerivedFrom.Ethernet,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00435.TimeTuple.VLT.DerivedFrom.Gpt,1 */
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_BusGetCurrentTime,1 */
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00446.OffsetTimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00446.PureTimeBaseId,1 */
    STBM_DET_REPORTERROR(STBM_API_BUSGETCURRENTTIME, STBM_E_PARAM);
  }
  else if (globalTimePtr == NULL_PTR)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00447.globalTimePtr,1 */
    STBM_DET_REPORTERROR(STBM_API_BUSGETCURRENTTIME, STBM_E_PARAM_POINTER);
  }
  else if (localTimePtr == NULL_PTR)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00447.localTimePtr,1 */
    STBM_DET_REPORTERROR(STBM_API_BUSGETCURRENTTIME, STBM_E_PARAM_POINTER);
  }
  else if (userData == NULL_PTR)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00447.userData,1 */
    STBM_DET_REPORTERROR(STBM_API_BUSGETCURRENTTIME, STBM_E_PARAM_POINTER);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00434.VLT.NotRetrieved.StbM_BusGetCurrentTime.E_NOT_OK,1 */
    if(E_OK == retval)
    {
      ...
      if (retval == E_OK)
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00435.TimeTuple.VLT.DerivedFrom.Ethernet,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00435.TimeTuple.VLT.DerivedFrom.Gpt,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTime.UserData.setBy.StbM_SetGlobalTime,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTime.UserData.setBy.StbM_UpdateGlobalTime,1 */
        STBM_ASSIGN_TIMESTAMP(*globalTimePtr, timeStampLocalTime);

        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00435.TimeBaseStatus,1 */
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00435.UserData,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTime.UserData.setBy.StbM_SetGlobalTime,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTime.UserData.setBy.StbM_UpdateGlobalTime,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTime.UserData.setBy.StbM_SetUserData,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00278.NotificationEvents,1 */
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00434.VLT.NotRetrieved.StbM_GetCurrentTime.E_NOT_OK,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00434.VLT.NotRetrieved.StbM_GetCurrentTimeExtended.E_NOT_OK,1 */
  if(E_OK == retval)
  {
    /* First step: update synchronized time base with the actual time. */
    ...
    if (E_OK == retval)
    {
...
#endif /* (STBM_OFFSET_TIMEBASES_USED == STD_ON) */
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTime.timeOfTheTimeBase.derivedFromOs,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTime.timeOfTheTimeBase.derivedFromEthTSyn,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTime.timeOfTheTimeBase.derivedFromGpt,1 */
        STBM_ASSIGN_TIMESTAMP(*timeStamp, timeStampLocalTime);

        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTime.TimeBaseStatus,1 */
        /* copy timeBaseStatus member */
...
#endif /* (STBM_OFFSET_TIMEBASES_USED == STD_ON) */
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTime.UserData,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTime.UserData.setBy.StbM_SetGlobalTime,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTime.UserData.setBy.StbM_UpdateGlobalTime,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTime.UserData.setBy.StbM_SetUserData,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTimeExtended.UserData,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTimeExtended.UserData.setBy.StbM_SetGlobalTime,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTimeExtended.UserData.setBy.StbM_UpdateGlobalTime,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00398.StbM_GetCurrentTimeExtended.UserData.setBy.StbM_SetUserData,1 */
        /* initialize the user data address with the user data of this time base */
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00282.Callback_CalledOneTime,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00282.SRInterface_CalledOneTime,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00195,1 */
...
)
{
  ...
  if(StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetCurrentTime,1 */
    STBM_DET_REPORTERROR(STBM_API_GETCURRENTTIME, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00196,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTime.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00177.StbM_GetCurrentTime.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTime.PureTimeBaseId,1 */
    STBM_DET_REPORTERROR(STBM_API_GETCURRENTTIME, STBM_E_PARAM);
  }
  else if (timeStamp == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00197,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00200,1 */
...
)
{
  ...
  if(StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetCurrentTimeExtended,1 */
    STBM_DET_REPORTERROR(STBM_API_GETCURRENTTIMEEXTENDED, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTimeExtended.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTimeExtended.PureTimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00177.StbM_GetCurrentTimeExtended.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00201.NotConfigured,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00201.WithinReservedRange,1 */
    STBM_DET_REPORTERROR(STBM_API_GETCURRENTTIMEEXTENDED, STBM_E_PARAM);
  }
  else if (timeStamp == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00202.Invalid.timeStamp,1 */
    STBM_DET_REPORTERROR(STBM_API_GETCURRENTTIMEEXTENDED, STBM_E_PARAM_POINTER);
  }
  else if (userData == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00202.userData,1 */
    STBM_DET_REPORTERROR(STBM_API_GETCURRENTTIMEEXTENDED, STBM_E_PARAM_POINTER);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    if(E_OK == retval)
    {
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTimeExtended.timeOfTheTimeBase.derivedFromOs,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTimeExtended.timeOfTheTimeBase.derivedFromEthTSyn,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTimeExtended.timeOfTheTimeBase.derivedFromGpt,1 */
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00173.StbM_GetCurrentTimeExtended.TimeBaseStatus,1 */
      /* GLOBAL_TIME_BIT shall only be set if it is set in both sync and offset */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.GLOBAL_TIME_BASE.NoSync,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.GLOBAL_TIME_BASE.Sync,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.TIMEOUT.NoTimeout,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.TIMEOUT.TimeoutOccured,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.SYNC_TO_GATEWAY.NotBasedOnGateway,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.SYNC_TO_GATEWAY.BasedOnGateway,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.TIMELEAP_FUTURE.NoTimeleap,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.TIMELEAP_FUTURE.Timeleap,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.TIMELEAP_PAST.NoTimeleap,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTimeExtended.TIMELEAP_PAST.Timeleap,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00408,1 */
...
)
{
  ...
  if(StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetMasterConfig,1 */
    STBM_DET_REPORTERROR(STBM_API_GETMASTERCONFIG, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00415.NotConfigured.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00415.Reserved.TimeBaseId,1 */
    STBM_DET_REPORTERROR(STBM_API_GETMASTERCONFIG, STBM_E_PARAM);
  }
  else if (masterConfig == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00416,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00177.StbM_GetCurrentTime.AbsoluteTimeValue,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00177.StbM_GetCurrentTimeExtended.AbsoluteTimeValue,1 */
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.TIMEOUT.NoTimeout,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.TIMEOUT.TimeoutOccured,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.SYNC_TO_GATEWAY.NotBasedOnGateway,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.SYNC_TO_GATEWAY.BasedOnGateway,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.TIMELEAP_FUTURE.NoTimeleap,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.TIMELEAP_FUTURE.Timeleap,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.TIMELEAP_PAST.NoTimeleap,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.TIMELEAP_PAST.Timeleap,1 */
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.GLOBAL_TIME_BASE.NoSync,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00261.StbM_GetCurrentTime.GLOBAL_TIME_BASE.Sync,1 */
  /* GLOBAL_TIME_BIT shall only be set if it is set in both sync and offset */
...
#if (STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00385,1 */
...
)
{
  ...
  /* Get current Virtual Local Time */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00342.StbM_UpdateGlobalTime.GetVirtualLocalTime,1 */
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_UpdateGlobalTime,1 */
    STBM_DET_REPORTERROR(STBM_API_UPDATEGLOBALTIME, STBM_E_UNINIT);
  }
  else if (detectedDET == STBM_E_PARAM)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00340,1 */
    STBM_DET_REPORTERROR(STBM_API_UPDATEGLOBALTIME, STBM_E_PARAM);
  }
  else if (timeStamp == NULL_PTR)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00341,1 */
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00451,1 */
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00452,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    if(E_OK == retval)
    {
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00342.StbM_UpdateGlobalTime.UpdateTimeTuple,1 */
...
#if (STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00213,1 */
...
)
{
  ...
  /* Get current Virtual Local Time */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00342.StbM_SetGlobalTime.GetVirtualLocalTime,1 */
  retval = StbM_GetCurrentVirtualLocalTimeNoDet(underlyingTimeBaseId, &detectedDET, &currentTimeTupleGlobal, &currentTimeTupleVLT, &localTime);
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_SetGlobalTime,1 */
    STBM_DET_REPORTERROR(STBM_API_SETGLOBALTIME, STBM_E_UNINIT);
  }
  else if (detectedDET == STBM_E_PARAM)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00214,1 */
    STBM_DET_REPORTERROR(STBM_API_SETGLOBALTIME, STBM_E_PARAM);
  }
  else if (timeStamp == NULL_PTR)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00215,1 */
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00448,1 */
    STBM_DET_REPORTERROR(STBM_API_SETGLOBALTIME, STBM_E_PARAM_TIMESTAMP);
  }
  else if ((userData != NULL_PTR) && (userData->userDataLength > STBM_MAX_USER_DATA_LENGTH))
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00449,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    if(E_OK == retval)
    {
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00342.StbM_SetGlobalTime.UpdateTimeTuple,1 */
      retval = StbM_SetTime(timeBaseId, timeStamp, userData, &currentTimeTupleGlobal, &currentTimeTupleVLT, &localTime);
...
#endif /* (STBM_PURE_TIMEBASES_USED == STD_ON) */
      {
        ...
        if(E_OK == retval)
        {
          ...
          /* !LINKSTO StbM.ASR20-11.SWS_StbM_00350.StbM_SetGlobalTime.Sync,1 */
          /* !LINKSTO StbM.ASR20-11.SWS_StbM_00350.StbM_SetGlobalTime.Offset,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00272,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_StartTimer,1 */
    STBM_DET_REPORTERROR(STBM_API_STARTTIMER, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00296.CalledWith.NotConfigured.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00296.CalledWith.Reserved.TimeBaseId,1 */
...
#endif /* (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00270,1 */
    if(StbM_IsTimeBaseIdCustomerIdInList(timeBaseId, customerId) == FALSE)
    {
      ...
      if(StbM_CalculateLocalTime(timeBaseId, &timeStampLocalTime) == E_OK)
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00337.SameExpiryPoints,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00337.DifferentExpiryPoints,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00270.MaxNrOf.StbM_StartTimer.Calls,1 */
 ...
 /* !LINKSTO StbM.ASR20-11.SWS_StbM_00336.GPTTimerExpired.Call.StbM_TimerCallback,1 */
...
)
{
  ...
  if(found)
  {
    ...
    /* calculate the difference between CustomerTimerExpireTime and timeStampLocalTime */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00271.CalculateTimeDifference,1 */
    (void)StbM_SubtractTimeStamps
    (
      &timeStampA,
      &timeStampB,
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00271.Unexpected.StbM_TimerCallback,1 */
...
#if (STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00218,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_SetUserData,1 */
    STBM_DET_REPORTERROR(STBM_API_SETUSERDATA, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00219,1 */
    STBM_DET_REPORTERROR(STBM_API_SETUSERDATA, STBM_E_PARAM);
  }
  else if (userData == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00220,1 */
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00457,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.NotEquals.Zero.StbM_SetUserData,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.Equals.Zero.StbM_SetUserData,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.NotSetUserData.PreviousValueKept.StbM_SetUserData,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00223,1 */
...
)
{
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_SetOffset,1 */
    STBM_DET_REPORTERROR(STBM_API_SETOFFSET, STBM_E_UNINIT);
  }
  else if (detectedDET == STBM_E_PARAM)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00224.TimeBaseId.NotConfigured,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00224.WithinReservedValueRange,1 */
    STBM_DET_REPORTERROR(STBM_API_SETOFFSET, STBM_E_PARAM);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00191,1 */
  else if (!STBM_TIMEBASE_ID_IS_OFFSET(timeBaseId))
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00224.Synchronized.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00224.Pure.TimeBaseId,1 */
    STBM_DET_REPORTERROR(STBM_API_SETOFFSET, STBM_E_PARAM);
  }
  else if (timeStamp == NULL_PTR)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00225,1 */
    STBM_DET_REPORTERROR(STBM_API_SETOFFSET, STBM_E_PARAM_POINTER);
  }
  else if (timeStamp->nanoseconds > STBM_NANOSEC_MAX_VALID_VALUE)
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00453,1 */
    STBM_DET_REPORTERROR(STBM_API_SETOFFSET, STBM_E_PARAM_TIMESTAMP);
  }
  else if ((userData != NULL_PTR) && (userData->userDataLength > STBM_MAX_USER_DATA_LENGTH))
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00454,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    StbM_TimeBaseNotificationType StbM_NotificationEvents = 0U;
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00190,1 */
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00284.EV_RESYNC,1 */
       ...
       */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00181.SetOffset,1 */
      ...
      /* Store the userData bytes for the MASTER time base, based on userDataLength */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.NotEquals.Zero.StbM_SetOffset,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.Equals.Zero.StbM_SetOffset,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.NotSetUserData.PreviousValueKept.StbM_SetOffset,1 */
      StbM_SetUserDataBytes(index, userData);

#if(STBM_NUMBER_OF_SYNC_TIMEBASES > 0U)
      /* Increment the time base update counter, this is the defined and intended overflow */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00350.StbM_SetOffset,1 */
      StbM_TimeBaseUpdateCounter[index]++;
#endif /* (STBM_NUMBER_OF_SYNC_TIMEBASES > 0U) */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00228,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00192,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetOffset,1 */
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00229.NotConfigured.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00229.WithinReservedRange.TimeBaseId,1 */
    STBM_DET_REPORTERROR(STBM_API_GETOFFSET, STBM_E_PARAM);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00191,1 */
  else if (!STBM_TIMEBASE_ID_IS_OFFSET(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00229.Synchronized.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00229.Pure.TimeBaseId,1 */
    STBM_DET_REPORTERROR(STBM_API_GETOFFSET, STBM_E_PARAM);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00230.timeStamp,1 */
  else if (timeStamp == NULL_PTR)
  {
    STBM_DET_REPORTERROR(STBM_API_GETOFFSET, STBM_E_PARAM_POINTER);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00230.userData,1 */
  else if (userData == NULL_PTR)
  {
    STBM_DET_REPORTERROR(STBM_API_GETOFFSET, STBM_E_PARAM_POINTER);
  }
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00346,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_TriggerTimeTransmission,1 */
    STBM_DET_REPORTERROR(STBM_API_TRIGGERTIMETRANSMISSION, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE_NO_PURE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00349.TimeBaseId.NotConfigured.Or.WithinReservedRange,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00349.Pure.TimeBaseId,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* Increment the time base update counter, this is the defined and intended overflow */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00350.StbM_TriggerTimeTransmission.Sync,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00350.StbM_TriggerTimeTransmission.Offset,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00263,1 */
...
)
{
...
#if(STBM_DEV_ERROR_DETECT == STD_ON)
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetTimeBaseStatus,1 */
  if (StbM_InitStatus == STBM_NOINIT)
  {
    STBM_DET_REPORTERROR(STBM_API_GETTIMEBASESTATUS, STBM_E_UNINIT);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00264,1 */
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE(timeBaseId))
  {
    STBM_DET_REPORTERROR(STBM_API_GETTIMEBASESTATUS, STBM_E_PARAM);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00386,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00262.GetTimeBaseStatus.Sync,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00262.GetTimeBaseStatus.Pure,1 */
    *syncTimeBaseStatus = StbM_TimeStamps[STBM_GET_SYNC_TIMEBASE_INDEX(timeBaseId)].globalTime.timeBaseStatus;
     ...
     * time base. */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00262.GetTimeBaseStatus.Offset,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00262.GetTimeBaseStatus.Pure,1 */
    if(STBM_TIMEBASE_ID_IS_OFFSET(timeBaseId))
    {
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00378,1 */
...
)
{
  ...
  if(StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetRateDeviation,1 */
    STBM_DET_REPORTERROR(STBM_API_GETRATEDEVIATION, STBM_E_UNINIT);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00379,1 */
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE(timeBaseId))
  {
    STBM_DET_REPORTERROR(STBM_API_GETRATEDEVIATION, STBM_E_PARAM);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00380,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
     ...
     * return E_NOT_OK */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00397.Slave.E_NOT_OK,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00422.NoRateDeviation.Set,1 */
    ...
    {
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00397.Slave.Sync,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00397.Slave.Offset,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00422.RateDeviation.Set,1 */
...
#if(STBM_SYNC_SLAVE_TIMEBASES_CONFIGURED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00267,1 */
...
)
{
  ...
  if(StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetTimeLeap,1 */
    STBM_DET_REPORTERROR(STBM_API_GETTIMELEAP, STBM_E_UNINIT);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00268.NotConfiguredId,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00268.PureTimeBaseId,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00268.ReservedId,1 */
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE_NO_PURE(timeBaseId))
  {
    STBM_DET_REPORTERROR(STBM_API_GETTIMELEAP, STBM_E_PARAM);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00269,1 */
  ...
  else if(STBM_ONLY_MASTER_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.GetTimeLeap.MASTERTimeBaseId,1 */
    STBM_DET_REPORTERROR(STBM_API_GETTIMELEAP, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    uint8 commonIndex = STBM_TIMEBASE_ID_TO_COMMON_INDEX(timeBaseId);
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00425.FirstValidInvocationOfBusSetGlobalTime.StbM_GetTimeLeap.Returns.E_NOT_OK,1 */
    ...
    {
      /* !LINKSTO StbM.ASR20-11.GetTimeLeap.TimeLeapFeatureDisabled,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00425.Calculate.TimeDifference,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00390,1 */
...
)
{
...
#if (STBM_DEV_ERROR_DETECT == STD_ON)
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_SetRateCorrection,1 */
  if(detectedDET == STBM_E_UNINIT)
  {
    retval = E_NOT_OK;
    STBM_DET_REPORTERROR(STBM_API_SETRATECORRECTION, STBM_E_UNINIT);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00391,1 */
  else if (detectedDET == STBM_E_PARAM)
  {
    retval = E_NOT_OK;
    STBM_DET_REPORTERROR(STBM_API_SETRATECORRECTION, STBM_E_PARAM);
  }
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00392,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_SERVICE_DISABLED.StbM_SetRateCorrection,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    if(E_OK == retval)
    {
      ...
      /* Store notification events */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00278.NotificationEvents,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00345,1 */
      StbM_TimeBaseNotificationType StbM_NotificationEvents = 0U;
#endif /* STBM_STATUS_NOTIFICATIONS_USED == STD_ON */

      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00395,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00396,1 */
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00411,1 */
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00433.UpdateMainTimeTuple.AfterSetting.NewRateCorrection,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_GetCurrentTime.ReplaceMainTimeTuple.AfterSetting.NewRateCorrection.ByApplication,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_GetCurrentTimeExtended.ReplaceMainTimeTuple.AfterSetting.NewRateCorrection.ByApplication,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_BusGetCurrentTime.ReplaceMainTimeTuple.AfterSetting.NewRateCorrection.ByApplication,1 */

      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00442,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00443,1 */
      /* Update Time Tuple */
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00284.EV_RATECORRECTION.Master,1 */
...
#if (STBM_SYNC_TIME_RECORDING_USED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00319,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00320,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00326,1 */
...
)
{
  ...
  if(StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetSyncTimeRecordHead,1 */
    STBM_DET_REPORTERROR(STBM_API_GETSYNCTIMERECORDHEAD, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE_NO_PURE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00394.InvalidId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00394.PureLocalTimeBase,1 */
    STBM_DET_REPORTERROR(STBM_API_GETSYNCTIMERECORDHEAD, STBM_E_PARAM);
  }
  else if (STBM_TIMEBASE_ID_IS_OFFSET(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00394.OffsetId,1 */
    STBM_DET_REPORTERROR(STBM_API_GETSYNCTIMERECORDHEAD, STBM_E_PARAM);
  }
  else if (syncRecordTableHead == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00405,1 */
    STBM_DET_REPORTERROR(STBM_API_GETSYNCTIMERECORDHEAD, STBM_E_PARAM_POINTER);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00315,1 */
...
#if (STBM_OFFSET_TIME_RECORDING_USED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00325,1 */
...
)
{
  ...
  if(StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetOffsetTimeRecordHead,1 */
    STBM_DET_REPORTERROR(STBM_API_GETOFFSETTIMERECORDHEAD, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE_NO_PURE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00327.InvalidId,1 */
    STBM_DET_REPORTERROR(STBM_API_GETOFFSETTIMERECORDHEAD, STBM_E_PARAM);
  }
  else if (!STBM_TIMEBASE_ID_IS_OFFSET(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00327.SyncId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00327.PureId,1 */
    STBM_DET_REPORTERROR(STBM_API_GETOFFSETTIMERECORDHEAD, STBM_E_PARAM);
  }
  else if (offsetRecordTableHead == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00404,1 */
  ...
  {
#if(STBM_OFFSET_TIME_RECORDING_USED == STD_ON)
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00316,1 */
...
FUNC(void, STBM_CODE) StbM_Init(P2CONST(StbM_ConfigType, AUTOMATIC, STBM_APPL_DATA)ConfigPtr)
{
...
#if(STBM_DEV_ERROR_DETECT == STD_ON)
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_INIT_FAILED,1 */
...
#endif /* (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00170,1 */
    /* Deviation TASKING-1 */
    for (i = 0U; i < (STBM_NUMBER_OF_SYNC_TIMEBASES + STBM_NUMBER_OF_OFFSET_TIMEBASES); i++)
    {
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00344,1 */
    ...
    for (i = 0U; i < (STBM_NUMBER_OF_SYNC_TIMEBASES + STBM_NUMBER_OF_OFFSET_TIMEBASES + STBM_NUMBER_OF_PURE_TIMEBASES); i++)
    {
      ...
      else /* store and load TimeStamp in NvM */
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00171,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00172,1 */
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00427,1 */
...
#if (STBM_SYNC_TIME_RECORDING_USED == STD_ON)
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00306,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00314,1 */
    /* Deviation TASKING-1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00424.AllowRate,1 */
#if (STBM_OFFSET_CORRECTION_USED == STD_ON)
  /* Deviation TASKING-1 */
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00431.MasterRateCorrection.Sync,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00431.MasterRateCorrection.Offset,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00412.SlaveRateCorrection.Sync,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00412.SlaveRateCorrection.Offset,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00094,1 */
#if (STBM_DEV_ERROR_DETECT == STD_ON)
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00057,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00407,1 */
FUNC(void, STBM_CODE) StbM_MainFunction(void)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_MainFunction,1 */
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00084,1 */
#if (STBM_TRIGGERED_CUSTOMERS_USED == STD_ON)
    /* Deviation TASKING-1 */
    for (idx = 0U; idx < STBM_NUMBER_OF_TRIGGERED_CUSTOMERS; idx++)
    {
      ...
      if (StbM_TriggeredCustomerThreshold[idx] == 0U)
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00107,1 */
    ...
    /* !LINKSTO StbM.dsn.ExclusiveArea_StbM_TimeStamps,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00317.DataIntegrity,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00318.DataIntegrity,1 */
    ...
    for (idx = 0U; idx < (STBM_NUMBER_OF_SYNC_TIMEBASES + STBM_NUMBER_OF_OFFSET_TIMEBASES); idx++)
    {
      ...
      if (StbM_TimeBaseTimeout[idx] != 0U)
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00187.SET_SYNC_TO_GATEWAY_BIT,1 */
        if (StbM_TimeBaseTimeout[idx] == 0U)
        {
#if (STBM_TIME_BASES_THAT_SHARE_DATA_USED == STD_ON)
          ...
          /* timeout occurred */
          /* !LINKSTO StbM.ASR20-11.SWS_StbM_00183.SET_TIMEOUT_BIT,1 */
          /* !LINKSTO StbM.ASR20-11.SWS_StbM_00187.SET_TIMEOUT_BIT,1 */
...
STATIC FUNC(void, STBM_CODE) StbM_SendSyncMeasurementData(void)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00317.NotifyApp,1 */
  /* Deviation TASKING-1 */
...
STATIC FUNC(void, STBM_CODE) StbM_SendOffsetMeasurementData(void)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00318.NotifyApp,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00476.TimeMaster.SetMasterTimingData.CAN,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00476.TimeGateway.SetMasterTimingData.CAN,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00475.TimeSlave.SetSlaveTimingData.CAN,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00475.TimeGateway.SetSlaveTimingData.CAN,1 */
  if(numberOfBlocks != 0)
  {
    /* only a few blocks were recorded without wrapping or wrapping occured */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00476.TimeMaster.SetMasterTimingData.FR,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00476.TimeGateway.SetMasterTimingData.FR,1 */
  if(numberOfBlocks != 0)
  {
    /* only a few blocks were recorded without wrapping or wrapping occured */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00475.TimeSlave.SetSlaveTimingData.FR,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00475.TimeGateway.SetSlaveTimingData.FR,1 */
  if(numberOfBlocks != 0)
  {
    /* only a few blocks were recorded without wrapping or wrapping occured */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00476.TimeMaster.SetMasterTimingData.ETH,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00476.TimeGateway.SetMasterTimingData.ETH,1 */
  if(numberOfBlocks != 0)
  {
    /* only a few blocks were recorded without wrapping or wrapping occured */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00475.TimeSlave.SetSlaveTimingData.ETH,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00475.TimeGateway.SetSlaveTimingData.ETH,1 */
  if(numberOfBlocks != 0)
  {
    /* only a few blocks were recorded without wrapping or wrapping occured */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00481,1 */
  if(numberOfBlocks != 0)
  {
    /* only a few blocks were recorded without wrapping or wrapping occured */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00479,1 */
  if(numberOfBlocks != 0)
  {
    /* only a few blocks were recorded without wrapping or wrapping occured */
...
)
{
  ...
  for(customerNotifIdx = 0U; customerNotifIdx < STBM_NUMBER_OF_NOTIFICATION_CUSTOMERS; customerNotifIdx++)
  {
    ...
    if((currentTimeBaseId == timebaseId) && (currentCustomerId == customerId))
    {
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00271.NotifyCustomer,1 */
...
)
{
  ...
  if(callGpt == TRUE)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00336.DifferenceElapsedStbMTimerStartThreshold.Call.Gpt_StartTimer,1 */
  ...
  for(current = Head; current != NULL_PTR; current = current->next)
  {
    ...
    if(current->Data.pendingStartGptTimer == TRUE)
    {
      ...
      if(localTimes[commonIndex].retVal == E_OK)
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00432,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00335,1 */
  ...
  for(current = Head; current != NULL_PTR; current = current->next)
  {
    ...
    if(localTimes[commonIndex].retVal == E_OK)
    {
      ...
      else /* calculate gptExpireTime and try to call Gpt_StartTimer if not running */
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00336.Difference.HasNotElapsed.StbMTimerStartThreshold.Gpt_StartTimer.NotCalled,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00233,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_BusSetGlobalTime,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
   ...
   oldTimeleapFlags = flags;
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00183.CLEAR_TIMEOUT_BIT,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00185,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00187.CLEAR_TIMEOUT_BIT,1 */
    STBM_FLAG_SET(flags, STBM_GLOBAL_TIME_BASE_FLAG);
#if (STBM_STATUS_NOTIFICATIONS_USED == STD_ON)
    STBM_FLAG_SET(StbM_NotificationEvents, STBM_EV_GLOBAL_TIME);
#endif /* STBM_STATUS_NOTIFICATIONS_USED == STD_ON */

    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00184,1 */
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00438,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00439,1 */
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00179,1 */
    ...
    if (retval == E_OK)
    {
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00372,1 */
#if (STBM_SLAVE_RATE_CORRECTION_USED == STD_ON)
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.NotEquals.Zero.StbM_BusSetGlobalTime,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.Equals.Zero.StbM_BusSetGlobalTime,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.NotSetUserData.PreviousValueKept.StbM_BusSetGlobalTime,1 */
      StbM_SetUserDataBytes(commonIndex, userDataPtr);

#if (STBM_NUMBER_OF_SYNC_TIMEBASES  > 0U)
      /* Increment the time base update counter, this is the defined and intended overflow */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00350.StbM_BusSetGlobalTime.Sync,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00350.StbM_BusSetGlobalTime.Offset,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00400,1 */
...
)
{
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00312,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00471.Copy.Slave.MeasureDataPtr.ReceivedFrom.CAN.ToTable,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00471.Copy.Slave.MeasureDataPtr.ReceivedFrom.FR.ToTable,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00471.Copy.Slave.MeasureDataPtr.ReceivedFrom.ETH.ToTable,1 */
...
)
{
  ...
  if(userData != NULL_PTR)
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.Equals.Zero.StbM_BusSetGlobalTime,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.Equals.Zero.StbM_UpdateGlobalTime,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.Equals.Zero.StbM_SetGlobalTime,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.Equals.Zero.StbM_SetUserData,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.Equals.Zero.StbM_SetOffset,1 */
    for(userDataBytesChanged = 0U; userDataBytesChanged < userData->userDataLength; userDataBytesChanged++)
    {
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.NotEquals.Zero.StbM_BusSetGlobalTime,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.NotSetUserData.PreviousValueKept.StbM_BusSetGlobalTime,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.NotEquals.Zero.StbM_UpdateGlobalTime,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.NotSetUserData.PreviousValueKept.StbM_UpdateGlobalTime,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.NotEquals.Zero.StbM_SetGlobalTime,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.NotSetUserData.PreviousValueKept.StbM_SetGlobalTime,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.NotEquals.Zero.StbM_SetUserData,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.NotSetUserData.PreviousValueKept.StbM_SetUserData,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.userDataLength.NotEquals.Zero.StbM_SetOffset,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00381.NotSetUserData.PreviousValueKept.StbM_SetOffset,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00181.SetGlobalTime,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00181.UpdateGlobalTime,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00399.GLOBAL_TIME_BASE.setBy.StbM_SetGlobalTime,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00399.GLOBAL_TIME_BASE.setBy.StbM_UpdateGlobalTime,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00433.UpdateMainTimeTuple.AfterSetting.NewGlobalTime,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_GetCurrentTime.ReplaceMainTimeTuple.AfterSetting.NewGlobalTime.ByApplication,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_GetCurrentTimeExtended.ReplaceMainTimeTuple.AfterSetting.NewGlobalTime.ByApplication,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_BusGetCurrentTime.ReplaceMainTimeTuple.AfterSetting.NewGlobalTime.ByApplication,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00433.UpdateMainTimeTuple.AfterReceivingTimeTuple.FromTimeSyncModule,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_GetCurrentTime.ReplaceMainTimeTuple.AfterReceiving.NewTimeTuple.FromTSynModule,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_GetCurrentTimeExtended.ReplaceMainTimeTuple.AfterReceiving.NewTimeTuple.FromTSynModule,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_BusGetCurrentTime.ReplaceMainTimeTuple.AfterReceiving.NewTimeTuple.FromTSynModule,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00347,1 */
...
)
{
  ...
  {
    RetVal = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetTimeBaseUpdateCounter,1 */
    STBM_DET_REPORTERROR(STBM_API_GETTIMEBASEUPDATECOUNTER, STBM_E_UNINIT);
  }
  else if (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE_NO_PURE(timeBaseId))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00348.TimeBaseId.NotConfigured.Or.WithinResevedRange,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00348.Pure.TimeBaseId,1 */
...
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00414,1 */
...
)
{
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00234.TimeBaseId.Invalid.TimeBaseId,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00234.Pure.TimeBaseId,1 */
    STBM_DET_REPORTERROR(STBM_API_BUSSETGLOBALTIME, STBM_E_PARAM);
  }
  else if (timeStampPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00235.globalTimePtr,1 */
    STBM_DET_REPORTERROR(STBM_API_BUSSETGLOBALTIME, STBM_E_PARAM_POINTER);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00235.measureDataPtr,1 */
    STBM_DET_REPORTERROR(STBM_API_BUSSETGLOBALTIME, STBM_E_PARAM_POINTER);
  }
  else if (localTimePtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00235.localTimePtr,1 */
    STBM_DET_REPORTERROR(STBM_API_BUSSETGLOBALTIME, STBM_E_PARAM_POINTER);
  }
  else if (STBM_ONLY_MASTER_PORT_CONNECTED(timeBaseId))
  {
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00455,1 */
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00456,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00180,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00413,1 */
STATIC FUNC(Std_ReturnType, STBM_CODE) StbM_SetGlobalTimeInternal
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_TimeStampType, AUTOMATIC, STBM_VAR) timeStampPtr,
...
)
{
  ...
  if (STBM_TIMEBASE_ID_IS_OFFSET(timeBaseId))
  {
    ...
    if(TRUE == checkGlobalTimeBit)
    {
      ...
      {
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00304.StbM_SetGlobalTime.GLOBAL_TIME_BASE.NotSet,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00304.StbM_UpdateGlobalTime.GLOBAL_TIME_BASE.NotSet,1 */
        retval = E_NOT_OK;
      }
    }
    /* slave side */
    ...
    {
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00393,1 */
    ...
    if(TRUE == calculateOffsetTime)
    {
      ...
      if (retval == E_OK)
      {
         ...
         * an offset time base. */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00304.StbM_SetGlobalTime.GLOBAL_TIME_BASE.Set.CalculateOffsetTime,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00304.StbM_UpdateGlobalTime.GLOBAL_TIME_BASE.Set.CalculateOffsetTime,1 */
    ...
    if (retval == E_OK)
    {
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00304.StbM_SetGlobalTime.GLOBAL_TIME_BASE.Set.UpdateOffsetTime.GreaterOrEqualThan0,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00304.StbM_UpdateGlobalTime.GLOBAL_TIME_BASE.Set.UpdateOffsetTime.GreaterOrEqualThan0,1 */
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00304.StbM_SetGlobalTime.GLOBAL_TIME_BASE.Set.UpdateOffsetTime.LessThan0,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00304.StbM_UpdateGlobalTime.GLOBAL_TIME_BASE.Set.UpdateOffsetTime.LessThan0,1 */
  }
  else
...
)
{
  ...
  if(E_OK == StbM_GetCurrentVirtualLocalTimeNoChecks(timeBaseId, &localTime))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00433.UpdateMainTimeTuple.AfterSetting.UpdateAfter3sec,1 */
    /* Update Time Tuple */
    STBM_ASSIGN_TIMESTAMP(StbM_TimeStamps[commonIndex].globalTime, *timeStampPtr);
    STBM_ASSIGN_VIRTUAL_LOCAL_TIME(StbM_TimeStamps[commonIndex].virtualLocalTime, localTime);
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00020,1 */
  if (StbM_Os_GetScheduleTableStatus(scheduleTblIdx, &scheduleTblStatus) == E_OK)
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00092,1 */
       ...
       )
    {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00077,1 */
        if (STBM_FLAG_IS_SET(tempTimeBaseStatus, STBM_GLOBAL_TIME_BASE_FLAG))
        {
          ...
          if (StbM_CalculateLocalTime(timeBaseId, &timeStampLocalTime) == E_OK)
          {
              ...
              /* !LINKSTO StbM.ASR20-11.SWS_StbM_00303.AllCalculations.DoneIn.Nanoseconds,1 */
              ...
              /* !LINKSTO StbM.ASR20-11.SWS_StbM_00020,1 */
              /* !LINKSTO StbM.ASR20-11.SWS_StbM_00302,1 */
...
)
{
  ...
  {
#if (STBM_TIMELEAP_DETECTION_USED == STD_ON)
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00182.SET_TIMELEAP_FUTURE_BIT,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00305.SET_TIMELEAP_PAST_BIT,1 */
    STBM_FLAG_SET(*flagsOutPtr, TimeLeapStatusFlagsOut);

    /* !LINKSTO StbM.ASR20-11.ECUC_StbM_00037_Conf,1 */
...
)
{
     ...
     )
  {
    ...
    {
#if (STBM_TIMELEAP_DETECTION_USED == STD_ON)
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00182.ZERO_THRESHOLD,1 */
      ...
      if(STBM_TIME_LEAP_FUTURE_THRESHOLD_DISABLED(commonIndex) == FALSE)
      {
        ...
        /* !LINKSTO StbM.ASR20-11.ECUC_StbM_00041_Conf,1 */
    ...
    else
    {
      ...
      if(TRUE == StbM_TimeStampIsGreaterEqual(&TimeStampDiffValue, &maxAllowedValue))
      {
        ...
        {
          /* !LINKSTO StbM.ASR20-11.SWS_StbM_00425.DifferenceExceeds.MaximumNegative.Range,1 */
          StbM_TimeLeapInfo[commonIndex].timejump = STBM_MAX_NEGATIVE_SINT32_VALUE;
        }
        else
        {
          /* !LINKSTO StbM.ASR20-11.SWS_StbM_00425.DifferenceExceeds.MaximumPositive.Range,1 */
    ...
    {
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00182.THRESHOLD,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00305.THRESHOLD,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00278.NotificationMask,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00278.NotificationEvents,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00282.ReportedThrough_Callback_SRInterface,1 */
  if((NotificationMask & StbM_NotificationEvents) != 0U)
  {
      StbM_NotificationEvents &= NotificationMask;

      /* CDD is notified */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00277.NoNotification,1 */
      if(StbM_CallbacksPtrList[commonIdx].statusNotificationCbkFctPtr != NULL_PTR)
      {
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00282.SetEventNotificationParameter,1 */
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00280,1 */
      }
...
)
{
  ...
  if (StbM_Os_GetCounterValue(STBM_OS_COUNTER_ID, &osTicks) == E_OK)
  {
    ...
    if(tempOsTicks == StbM_VirtualLocalTimeSources.StbM_PreviousOsTicks_OsCounter)
    {
      ...
      /* check for overflow */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00515,1 */
...
)
{
  ...
  else
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00178.EthIf_GetCurrentTime.ETH_UNCERTAIN, 1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00178.EthIf_GetCurrentTime.ETH_INVALID, 1 */
...
)
{
  ...
  /* !LINKSTO StbM.dsn.GptTimeSource,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00512,1 */
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00352.VLT_DerivedFrom_GPT,1 */
...
)
{
...
#if (STBM_MASTER_RATE_CORRECTION_USED == STD_ON)
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00424.Calculation,1 */
  ...
  if(FALSE == StbM_TimeStampIsGreaterEqual(&virtualLocalTimeDiff, &maxAllowedValue))
  {
    ...
    if(TRUE == StbM_SlaveRateCorrectionData[rcDataIndex].beforeAdaptionInterval)
    {
      ...
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00355,1 */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00353,1 */


      /* calculate local time with additional rate */
      /* !LINKSTO StbM.ASR20-11.SWS_StbM_00356,1 */
      ...
      else
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00433.UpdateMainTimeTuple.AfterOffsetCorrection,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_GetCurrentTime.ReplaceMainTimeTuple.After.OffsetCorrection.ByRateAdaptionInterval,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_GetCurrentTimeExtended.ReplaceMainTimeTuple.After.OffsetCorrection.ByRateAdaptionInterval,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00436.StbM_BusGetCurrentTime.ReplaceMainTimeTuple.After.OffsetCorrection.ByRateAdaptionInterval,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00359,1 */
  if (STBM_FLAG_IS_SET(StbM_TimeStamps[commonIndex].globalTime.timeBaseStatus,
                       STBM_GLOBAL_TIME_BASE_FLAG
                      )
     )
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00359,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00440,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00441,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00368,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00367.ParalellMeasurements,1 */
  intervalCounter = StbM_SlaveRateCorrectionData[rcDataIndex].intervalCounter;

  extendDiscard = StbM_CheckFlagChanges(rcDataIndex);

  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00367.MeasurementOverlap,1 */
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00371.Sync,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00371.Offset,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00370,1 */
  if(StbM_CheckIntervalTiming(timeBaseId, intervalCounter) == TRUE)
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00364,1 */
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00366,1 */
...
)
{
  ...
  if(FALSE == StbM_TimeStampIsGreaterEqual(&virtualLocalTimeDiff, &maxAllowedValue))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00360,1 */
    ...
    if((FALSE == StbM_TimeStampIsGreaterEqual(&globalTimeDiff, &maxAllowedValue)) && (retval == E_OK))
    {
      ...
      if(rc_ppm_verified <= STBM_RATE_DEVIATION_MAX_VALUE)
      {
        ...
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00361,1 */
        /* !LINKSTO StbM.ASR20-11.SWS_StbM_00362,1 */
...
)
{
  ...
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00376,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00375,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00374,1 */
  /* !LINKSTO StbM.ASR20-11.SWS_StbM_00373,1 */
...
)
{
  ...
  if (*timeLeapCounterPtr == 0U)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00182.CLEAR_TIMELEAP_FUTURE_BIT,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00305.CLEAR_TIMELEAP_PAST_BIT,1 */
...
)
{
...
#if (STBM_OFFSET_TIME_RECORDING_USED == STD_ON)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00388,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00428,1 */
...
#if (STBM_SYNC_TIME_RECORDING_USED == STD_ON)
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00313,1 */
...
)
{
  ...
  if((!STBM_SLAVE_RATE_CORRECTION_DISABLED(commonIndex)) && (StbM_SlaveRateCorrectionData[rcDataIndex].newValues == TRUE))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00284.EV_RATECORRECTION.Normal.SlaveRateCorrection,1 */
...
#if (STBM_HAS_AT_LEAST_ONE_CANTSYN_MASTER_LINKED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00493.CAN.StbM_CanSetMasterTimingData,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00490,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_CanSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_CANSETMASTERTIMINGDATA, STBM_E_UNINIT);
  }
  else if (!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00494.TimeBaseId.StbM_CanSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_CANSETMASTERTIMINGDATA, STBM_E_PARAM);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00495.Null.MeasureDataPtr.StbM_CanSetMasterTimingData,1 */
  ...
  else if (STBM_ONLY_SLAVE_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00494.SLAVETimeBaseId.StbM_CanSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_CANSETMASTERTIMINGDATA, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00474.Master.NoNotification.OverwriteBlock.CAN,1 */
    currentBlockIndex = StbM_CanMasterTimingDataRecordTableBlocksInfo[commonIndex].counter;

    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00468.MasterPort.CAN,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00469.Master.CanTSyn_Provider,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00473.Copy.Master.MeasureDataPtr.ReceivedFrom.CAN.ToTable,1 */
...
#if (STBM_HAS_AT_LEAST_ONE_FRTSYN_MASTER_LINKED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00493.FR.StbM_FrSetMasterTimingData,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00491,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_FrSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_FRSETMASTERTIMINGDATA, STBM_E_UNINIT);
  }
  else if (!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00494.TimeBaseId.StbM_FrSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_FRSETMASTERTIMINGDATA, STBM_E_PARAM);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00495.Null.MeasureDataPtr.StbM_FrSetMasterTimingData,1 */
  ...
  else if (STBM_ONLY_SLAVE_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00494.SLAVETimeBaseId.StbM_FrSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_FRSETMASTERTIMINGDATA, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* set current block index */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00474.Master.NoNotification.OverwriteBlock.FR,1 */
    currentBlockIndex = StbM_FrMasterTimingDataRecordTableBlocksInfo[commonIndex].counter;

    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00468.MasterPort.FR,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00469.Master.FrTSyn_Provider,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00473.Copy.Master.MeasureDataPtr.ReceivedFrom.FR.ToTable,1 */
...
#if (STBM_HAS_AT_LEAST_ONE_ETHTSYN_LINKED_TO_A_TIMEBASE_WHICH_HAS_TIMEVALIDATION_ENABLED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00493.ETH,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00492,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_EthSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETMASTERTIMINGDATA, STBM_E_UNINIT);
  }
  else if (!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00494.TimeBaseId.StbM_EthSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETMASTERTIMINGDATA, STBM_E_PARAM);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00495.Null.MeasureDataPtr.StbM_EthSetMasterTimingData,1 */
  ...
  else if (STBM_ONLY_SLAVE_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00494.SLAVETimeBaseId.StbM_EthSetMasterTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETMASTERTIMINGDATA, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* set current block index */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00474.Master.NoNotification.OverwriteBlock.ETH,1 */
    currentBlockIndex = StbM_EthMasterTimingDataRecordTableBlocksInfo[commonIndex].counter;

    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00468.ETH.MappedToEthTSynTimeDomain,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00469.Master.EthTSyn_Provider,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00473.Copy.Master.MeasureDataPtr.ReceivedFrom.ETH.ToTable,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00501,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00500,1 */
...
)
{
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_EthSetPdelayResponderData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETPDELAYRESPONDERDATA, STBM_E_UNINIT);
  }
  else if (!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00502,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETPDELAYRESPONDERDATA, STBM_E_PARAM);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00503,1 */
  ...
  else if (STBM_ONLY_SLAVE_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00494.SLAVETimeBaseId.StbM_EthSetPdelayResponderData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETPDELAYRESPONDERDATA, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
...
#if (STBM_HAS_AT_LEAST_ONE_CANTSYN_SLAVE_LINKED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00487.CAN.StbM_CanSetSlaveTimingData,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00484,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_CanSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_CANSETSLAVETIMINGDATA, STBM_E_UNINIT);
  }
  else if (!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00488.TimeBaseId.StbM_CanSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_CANSETSLAVETIMINGDATA, STBM_E_PARAM);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00489.Null.MeasureDataPtr.StbM_CanSetSlaveTimingData,1 */
  ...
  else if (STBM_ONLY_MASTER_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00488.MASTERTimeBaseId.StbM_CanSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_CANSETSLAVETIMINGDATA, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* set current block index */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00472.Slave.NoNotification.OverwriteBlock.CAN,1 */
    currentBlockIndex = StbM_CanSlaveTimingDataRecordTableBlocksInfo[commonIndex].counter;

    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00466.SlavePort.CAN,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00467.Slave.CanTSyn_Provider,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00471.Copy.Slave.MeasureDataPtr.ReceivedFrom.CAN.ToTable,1 */
...
#if (STBM_HAS_AT_LEAST_ONE_FRTSYN_SLAVE_LINKED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00487.FR.StbM_FrSetSlaveTimingData,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00485,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_FrSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_FRSETSLAVETIMINGDATA, STBM_E_UNINIT);
  }
  else if (!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00488.TimeBaseId.StbM_FrSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_FRSETSLAVETIMINGDATA, STBM_E_PARAM);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00489.Null.MeasureDataPtr.StbM_FrSetSlaveTimingData,1 */
  ...
  else if (STBM_ONLY_MASTER_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00488.MASTERTimeBaseId.StbM_FrSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_FRSETSLAVETIMINGDATA, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* set current block index */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00472.Slave.NoNotification.OverwriteBlock.FR,1 */
    currentBlockIndex = StbM_FrSlaveTimingDataRecordTableBlocksInfo[commonIndex].counter;

    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00466.SlavePort.FR,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00467.Slave.FrTSyn_Provider,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00471.Copy.Slave.MeasureDataPtr.ReceivedFrom.FR.ToTable,1 */
...
#if (STBM_HAS_AT_LEAST_ONE_ETHTSYN_LINKED_TO_A_TIMEBASE_WHICH_HAS_TIMEVALIDATION_ENABLED == STD_ON)
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00487.ETH,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00486,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_EthSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETSLAVETIMINGDATA, STBM_E_UNINIT);
  }
  else if (!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00488.TimeBaseId.StbM_EthSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETSLAVETIMINGDATA, STBM_E_PARAM);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00489.Null.MeasureDataPtr.StbM_EthSetSlaveTimingData,1 */
  ...
  else if (STBM_ONLY_MASTER_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00488.MASTERTimeBaseId.StbM_EthSetSlaveTimingData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETSLAVETIMINGDATA, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* set current block index */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00472.Slave.NoNotification.OverwriteBlock.ETH,1 */
    currentBlockIndex = StbM_EthSlaveTimingDataRecordTableBlocksInfo[commonIndex].counter;

    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00466.ETH.MappedToEthTSynTimeDomain,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00467.Slave.EthTSyn_Provider,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00471.Copy.Slave.MeasureDataPtr.ReceivedFrom.ETH.ToTable,1 */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00497,1 */
/* !LINKSTO StbM.ASR20-11.SWS_StbM_00496,1 */
...
)
{
  ...
  {
    retval = E_NOT_OK;
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_EthSetPdelayInitiatorData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETPDELAYINITIATORDATA, STBM_E_UNINIT);
  }
  else if (!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00498,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETPDELAYINITIATORDATA, STBM_E_PARAM);
  }
  else if (measureDataPtr == NULL_PTR)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00499,1 */
  ...
  else if (STBM_ONLY_MASTER_PORT_CONNECTED(timeBaseId))
  {
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00498.MASTERTimeBaseId.StbM_EthSetPdelayInitiatorData,1 */
    STBM_DET_REPORTERROR(STBM_API_ETHSETPDELAYINITIATORDATA, STBM_E_PARAM);
  }
  else
#endif /* #if (STBM_DEV_ERROR_DETECT == STD_ON) */
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_91008,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_SetBusProtocolParam,1 */
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00520,1 */
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00521,1 */
...
#endif /* (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00516.TimeBaseMappedToEthernet.And.protocolType.SetTo.STBM_TIMESYNC_ETHERNET.ForwardValuesToEthTSyn,1 */
    ...
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00516.TimeBase.NotMappedTo.Ethernet.Return.E_NOT_OK,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00516.protocolType.NotSetTo.STBM_TIMESYNC_ETHERNET.Return.E_NOT_OK,1 */
  }
...
/* !LINKSTO StbM.ASR20-11.SWS_StbM_91007,1 */
...
)
{
  ...
  if (StbM_InitStatus == STBM_NOINIT)
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00041.STBM_E_UNINIT.StbM_GetBusProtocolParam,1 */
    STBM_DET_REPORTERROR(STBM_API_GETBUSPROTOCOLPARAM, STBM_E_UNINIT);
  }
  else if ((!(STBM_IS_SYNC_TIMEBASE_ID(timeBaseId))) || (STBM_TIMEBASE_ID_NOT_CONFIGURED_OR_WITHIN_RESERVED_RANGE(timeBaseId)))
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00518,1 */
  ...
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00519,1 */
...
#endif /* (STBM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00517.protocolType.SetTo.STBM_TIMESYNC_ETHERNET.ReadValuesFromEthTSyn,1 */
    if((STBM_IS_TIMEBASE_CONNECTED_TO_ETHTSYN_TIMEDOMAIN(timeBaseId) == TRUE) && (protocolParam->protocolType == STBM_TIMESYNC_ETHERNET))
    {
      /* Get the protocolParam from EthTSyn */
      retval = EthTSyn_GetProtocolParam(timeBaseId, protocolParam);
    }
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00517.TimeBase.NotMappedTo.Ethernet.Return.E_NOT_OK,1 */
    /* !LINKSTO StbM.ASR20-11.SWS_StbM_00517.protocolType.NotSetTo.STBM_TIMESYNC_ETHERNET.Return.E_NOT_OK,1 */
  }
