...
REM  FILE NAME: batch\scons_qac_ti_c66xx_analyze_file.bat
...
REM  LAST CHANGE:      $Date: 2021/12/13 19:04:58CET $
REM                    $Author: Wang, David (Wangd3) $

REM  CURRENT VERSION:  $Revision: 1.1 $
REM #############################################################################
REM  CHANGES:                   $Log: scons_qac_ti_c66xx_analyze_file.bat  $
REM  CHANGES:                   Revision 1.1 2021/12/13 19:04:58CET Wang, David (Wangd3) 
...
REM  CHANGES:                   Revision 1.2 2015/06/26 13:30:32CEST uidr0826 
REM  CHANGES:                   Add revision label with module description for all GSCons files (Issue 320651)
REM  CHANGES:                   - Added comments -  uidr0826 [Jun 26, 2015 1:30:32 PM CEST]
...
call scons.bat build_from_ide=1 %component%_qac_ti_c66xx qac_source=%2
popd