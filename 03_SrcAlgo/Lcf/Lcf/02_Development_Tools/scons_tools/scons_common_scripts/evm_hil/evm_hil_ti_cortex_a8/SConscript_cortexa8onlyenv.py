"""
Filename                  : scons_common_scripts\evm_hil\evm_hil_ti_cortex_a8\SConscript_cortexa8onlyenv.py
...
# CHANGES:                   Revision 1.31 2017/05/30 13:49:21CEST Bhagawati, Tridip (uidr2134) 
# CHANGES:                   GSCons update for Mainstream
# CHANGES:                   Revision 1.30 2017/04/27 16:17:48CEST Singh, Vishal (uidj9083) 
# CHANGES:                   Updated for mainstream
# CHANGES:                   Revision 1.29 2017/03/30 13:31:21CEST Bhagawati, Tridip (uidr2134) 
# CHANGES:                   Updated
# CHANGES:                   Revision 1.28 2017/02/06 08:37:16CET Bhagawati, Tridip (uidr2134) 
# CHANGES:                   [Scons]: Remove no longer existing include path from evm hil CCS projects
# CHANGES:                   Revision 1.27 2016/07/12 06:25:24CEST Annashamachar, Shwetha (uidj8746) 
# CHANGES:                   Error and Exception handled in GSCons
# CHANGES:                   Revision 1.26 2016/07/01 06:06:03CEST Annashamachar, Shwetha (uidj8746) 
# CHANGES:                   File header added
# CHANGES:                   Revision 1.25 2016/05/30 14:52:54CEST Singh, Vishal (uidj9083) 
# CHANGES:                   Changed Alias name for VME and VH28 ram/rom calculation
# CHANGES:                   Revision 1.24 2016/05/12 14:12:25CEST Singh, Vishal (uidj9083) 
    ...
    if env["variant"] == "release":	
      ...
      if user_file_list == True:  
          for Obj in Obj_Size_cortexA8:		  
              outfile_fiels = File(cortexA8_sim_build_dir + os.path.splitext(File(Obj).name)[0]+'.txt')	  
              objfile_files = File(release_libpaths[0] + "/" + Obj)			  
              ca8_libsize_out+= generateLibSize(env, objfile_files, mapfile, outfile_fiels)
              SideEffect(File(objfile_files).abspath, ti_cortexA8_sim_out)
